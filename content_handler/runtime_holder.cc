...
void RuntimeHolder::InitScenicInternal() {
  ...
  Dart_Handle views_v1_internal =
      Dart_LookupLibrary(ToDart("dart:views_v1.internal"));

  DART_CHECK_VALID(Dart_SetNativeResolver(views_v1_internal, views_v1::NativeLookup,
                                          views_v1::NativeSymbol));

  DART_CHECK_VALID(
      Dart_SetField(views_v1_internal, ToDart("_context"),
                    DartConverter<uint64_t>::ToDart(reinterpret_cast<intptr_t>(
                        static_cast<views_v1::NativesDelegate*>(this)))));

  DART_CHECK_VALID(Dart_SetField(views_v1_internal, ToDart("_viewContainer"),
