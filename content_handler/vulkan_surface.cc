...
bool VulkanSurface::PushSessionImageSetupOps(scenic_lib::Session* session,
  ...
  image_info->pixel_format = gfx::ImageInfo::PixelFormat::BGRA_8;
  image_info->color_space = gfx::ImageInfo::ColorSpace::SRGB;
  image_info->tiling = gfx::ImageInfo::Tiling::LINEAR;
