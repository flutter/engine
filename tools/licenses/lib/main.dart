...
class _RepositoryIcuLicenseFile extends _RepositoryLicenseFile {
  ...
  static const String gplExemptionExplanation =
  ...
  static List<License> _parseLicense(fs.TextFile io) {
    ...
    if (!match.group(12).contains(gplExemptionExplanation) || !match.group(13).contains(gplExemptionExplanation)) {
      throw 'did not find GPL exemption in GPL-licensed files';
    }
