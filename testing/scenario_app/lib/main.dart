...
Map<String, Scenario> _scenarios = <String, Scenario>{
  ...
  'platform_view_no_overlay_intersection': PlatformViewNoOverlayIntersectionScenario(window, 'Hello from Scenarios (Platform View)', id: 1),
  'platform_view_partial_intersection': PlatformViewPartialIntersectionScenario(window, 'Hello from Scenarios (Platform View)', id: 2),
  'platform_view_two_intersecting_overlays': PlatformViewTwoIntersectingOverlaysScenario(window, 'Hello from Scenarios (Platform View)', id: 3),
  'platform_view_one_overlay_two_intersecting_overlays': PlatformViewOneOverlayTwoIntersectingOverlaysScenario(window, 'Hello from Scenarios (Platform View)', id: 4),
  'platform_view_multiple_without_overlays': MultiPlatformViewWithoutOverlaysScenario(window, 'Hello from Scenarios (Platform View)', firstId: 5, secondId: 6),
  'platform_view_max_overlays': PlatformViewMaxOverlaysScenario(window, 'Hello from Scenarios (Platform View)', id: 7),
  'platform_view_cliprect': PlatformViewClipRectScenario(window, 'PlatformViewClipRect', id: 8),
  'platform_view_cliprrect': PlatformViewClipRRectScenario(window, 'PlatformViewClipRRect', id: 9),
  'platform_view_clippath': PlatformViewClipPathScenario(window, 'PlatformViewClipPath', id: 10),
  'platform_view_transform': PlatformViewTransformScenario(window, 'PlatformViewTransform', id: 11),
  'platform_view_opacity': PlatformViewOpacityScenario(window, 'PlatformViewOpacity', id: 12),
  'platform_view_multiple': MultiPlatformViewScenario(window, firstId: 13, secondId: 14),
  'platform_view_multiple_background_foreground': MultiPlatformViewBackgroundForegroundScenario(window, firstId: 15, secondId: 16),
  'poppable_screen': PoppableScreenScenario(window),
  'platform_view_rotate': PlatformViewScenario(window, 'Rotate Platform View', id: 17),
  'platform_view_gesture_reject_eager': PlatformViewForTouchIOSScenario(window, 'platform view touch', id: 18, accept: false),
  'platform_view_gesture_accept': PlatformViewForTouchIOSScenario(window, 'platform view touch', id: 19, accept: true),
  'platform_view_gesture_reject_after_touches_ended': PlatformViewForTouchIOSScenario(window, 'platform view touch', id: 20, accept: false, rejectUntilTouchesEnded: true),
  'platform_view_obstructed': PlatformViewObstructedScenario(window, 'Platform view obstructed', id: 21),
