 ...
 * <p>
 * TODO(matanlurey): Eliminate this interface.
 * <p>
 * This interface is ... not ideal. Not every implementation (of which there are only 3) even
...
public interface SurfaceRenderer {
     ...
     * <p>
     * This is a flawed method that acts more like a constructor, that is, classes that implement it
     * (and they must, because there is no other way to get access to these parameters) must at
