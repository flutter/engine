...
- (BOOL)application:(UIApplication*)application
  ...
  NSDictionary<NSString*, NSString*>* launchArgsMap = @{
    ...
    @"--platform-view-large-cliprrect-multiple-clips" : @"platform_view_large_cliprrect_multiple_clips",
    ...
    @"--platform-view-cliprrect-with-transform-multiple-clips" : @"platform_view_cliprrect_with_transform_multiple_clips",
    ...
    @"--platform-view-cliprect-with-transform-multiple-clips" : @"platform_view_cliprect_with_transform_multiple_clips",
    @"--platform-view-clippath-with-transform" : @"platform_view_clippath_with_transform",
    @"--platform-view-clippath-with-transform-multiple-clips" : @"platform_view_clippath_with_transform_multiple_clips",
    ...
    @"--platform-views-with-clips-scrolling-multiple-clips" : @"platform_views_with_clips_scrolling_multiple_clips",
    @"--platform-view-cliprect-after-moved" : @"platform_view_cliprect_after_moved",
    @"--platform-view-cliprect-after-moved-multiple-clips" : @"platform_view_cliprect_after_moved_multiple_clips",
