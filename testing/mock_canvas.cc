...
SkCanvas::SaveLayerStrategy MockCanvas::getSaveLayerStrategy(const SaveLayerRec& rec) {
...
void MockCanvas::onDrawPaint(const SkPaint&) { FML_DCHECK(false); }
...
void MockCanvas::onDrawRect(const SkRect&, const SkPaint&) { FML_DCHECK(false); }
void MockCanvas::onDrawRegion(const SkRegion&, const SkPaint&) {
  FML_DCHECK(false);
}
void MockCanvas::onDrawOval(const SkRect&, const SkPaint&) { FML_DCHECK(false); }
...
void MockCanvas::onDrawPath(const SkPath&, const SkPaint&) { FML_DCHECK(false); }
