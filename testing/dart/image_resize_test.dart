...
void main() {
  ...
  test('Maintain aspect ratio: none', () async {
    final Uint8List bytes = await readFile('2x2.png');
    final Codec codec = await instantiateImageCodec(
      ...
      targetAspectRatioConstraint: AspectRatioConstraint.none,
    );
    final FrameInfo frame = await codec.getNextFrame();
    final int codecHeight = frame.image.height;
    final int codecWidth = frame.image.width;
  ...
  test('Maintain aspect ratio: width', () async {
    final Uint8List bytes = await readFile('2x2.png');
    final Codec codec = await instantiateImageCodec(
      bytes,
      targetWidth: 10,
      targetHeight: 1,
      allowUpscaling: false,
      targetAspectRatioConstraint: AspectRatioConstraint.maintainWidth,
    );
    final FrameInfo frame = await codec.getNextFrame();
    final int codecHeight = frame.image.height;
    final int codecWidth = frame.image.width;
  ...
  test('Maintain aspect ratio: height', () async {
    final Uint8List bytes = await readFile('2x2.png');
    final Codec codec = await instantiateImageCodec(
      bytes,
      targetWidth: 10,
      targetHeight: 1,
      allowUpscaling: false,
      targetAspectRatioConstraint: AspectRatioConstraint.maintainHeight,
    );
    final FrameInfo frame = await codec.getNextFrame();
    final int codecHeight = frame.image.height;
    final int codecWidth = frame.image.width;
  ...
  test('Maintain aspect ratio: largest', () async {
    final Uint8List bytes = await readFile('2x2.png');
    final Codec codec = await instantiateImageCodec(
      bytes,
      targetWidth: 10,
      targetHeight: 1,
      allowUpscaling: false,
      targetAspectRatioConstraint: AspectRatioConstraint.maintainLargest,
    );
    final FrameInfo frame = await codec.getNextFrame();
    final int codecHeight = frame.image.height;
    final int codecWidth = frame.image.width;
  ...
  test('Maintain aspect ratio: smallest', () async {
    final Uint8List bytes = await readFile('2x2.png');
    final Codec codec = await instantiateImageCodec(
      bytes,
      targetWidth: 10,
      targetHeight: 1,
      allowUpscaling: false,
      targetAspectRatioConstraint: AspectRatioConstraint.maintainSmallest,
    );
    final FrameInfo frame = await codec.getNextFrame();
    final int codecHeight = frame.image.height;
    final int codecWidth = frame.image.width;
