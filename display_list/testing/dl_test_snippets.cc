...
std::vector<DisplayListInvocationGroup> CreateAllAttributesOps() {
  return {
      {"SetAntiAlias",
       {
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setAntiAlias(true); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setAntiAlias(false); }},
       }},
      {"SetDither",
       {
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setDither(true); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setDither(false); }},
       }},
      {"SetInvertColors",
       {
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setInvertColors(true); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setInvertColors(false); }},
       }},
      {"SetStrokeCap",
       {
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setStrokeCap(DlStrokeCap::kRound); }},
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setStrokeCap(DlStrokeCap::kSquare); }},
           {0, 0, 0, 0,
            [](DlOpReceiver& b) { b.setStrokeCap(DlStrokeCap::kButt); }},
       }},
      {"SetStrokeJoin",
       {
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setStrokeJoin(DlStrokeJoin::kBevel); }},
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setStrokeJoin(DlStrokeJoin::kRound); }},
           {0, 0, 0, 0,
            [](DlOpReceiver& b) { b.setStrokeJoin(DlStrokeJoin::kMiter); }},
       }},
      {"SetStyle",
       {
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setStyle(DlDrawStyle::kStroke); }},
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setStyle(DlDrawStyle::kStrokeAndFill); }},
           {0, 0, 0, 0,
            [](DlOpReceiver& b) { b.setStyle(DlDrawStyle::kFill); }},
       }},
      {"SetStrokeWidth",
       {
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setStrokeWidth(1.0); }},
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setStrokeWidth(5.0); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setStrokeWidth(0.0); }},
       }},
      {"SetStrokeMiter",
       {
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setStrokeMiter(0.0); }},
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setStrokeMiter(5.0); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setStrokeMiter(4.0); }},
       }},
      {"SetColor",
       {
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setColor(SK_ColorGREEN); }},
           {0, 8, 0, 0, [](DlOpReceiver& b) { b.setColor(SK_ColorBLUE); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setColor(SK_ColorBLACK); }},
       }},
      {"SetBlendMode",
       {
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setBlendMode(DlBlendMode::kSrcIn); }},
           {0, 8, 0, 0,
            [](DlOpReceiver& b) { b.setBlendMode(DlBlendMode::kDstIn); }},
           {0, 0, 0, 0,
            [](DlOpReceiver& b) { b.setBlendMode(DlBlendMode::kSrcOver); }},
       }},
      {"SetColorSource",
       {
           {0, 96, 0, 0,
            [](DlOpReceiver& b) { b.setColorSource(&kTestSource1); }},
           // stop_count * (sizeof(float) + sizeof(uint32_t)) = 80
           {0, 80 + 6 * 4, 0, 0,
            [](DlOpReceiver& b) { b.setColorSource(kTestSource2.get()); }},
           {0, 80 + 6 * 4, 0, 0,
            [](DlOpReceiver& b) { b.setColorSource(kTestSource3.get()); }},
           {0, 88 + 6 * 4, 0, 0,
            [](DlOpReceiver& b) { b.setColorSource(kTestSource4.get()); }},
           {0, 80 + 6 * 4, 0, 0,
            [](DlOpReceiver& b) { b.setColorSource(kTestSource5.get()); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setColorSource(nullptr); }},
       }},
      {"SetImageFilter",
       {
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestBlurImageFilter1); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestBlurImageFilter2); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestBlurImageFilter3); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestBlurImageFilter4); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) {
           ...
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestErodeImageFilter1); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestErodeImageFilter2); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestErodeImageFilter3); }},
           {0, 64, 0, 0,
            [](DlOpReceiver& b) {
           ...
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestCFImageFilter1); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setImageFilter(&kTestCFImageFilter2); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setImageFilter(nullptr); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) {
              b.setImageFilter(
      ...
      {"SetColorFilter",
       {
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setColorFilter(&kTestBlendColorFilter1); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setColorFilter(&kTestBlendColorFilter2); }},
           {0, 24, 0, 0,
            [](DlOpReceiver& b) { b.setColorFilter(&kTestBlendColorFilter3); }},
           {0, 96, 0, 0,
            [](DlOpReceiver& b) {
           ...
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setColorFilter(nullptr); }},
       }},
      {"SetPathEffect",
       {
           // sizeof(DlDashPathEffect) + 2 * sizeof(SkScalar)
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setPathEffect(kTestPathEffect1.get()); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setPathEffect(kTestPathEffect2.get()); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setPathEffect(nullptr); }},
       }},
      {"SetMaskFilter",
       {
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setMaskFilter(&kTestMaskFilter1); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setMaskFilter(&kTestMaskFilter2); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setMaskFilter(&kTestMaskFilter3); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setMaskFilter(&kTestMaskFilter4); }},
           {0, 32, 0, 0,
            [](DlOpReceiver& b) { b.setMaskFilter(&kTestMaskFilter5); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.setMaskFilter(nullptr); }},
       }},
  };
}
      ...
      {"Translate",
       {
           ...
           {1, 16, 1, 16, [](DlOpReceiver& b) { b.translate(10, 10); }},
           {1, 16, 1, 16, [](DlOpReceiver& b) { b.translate(10, 15); }},
           {1, 16, 1, 16, [](DlOpReceiver& b) { b.translate(15, 10); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.translate(0, 0); }},
       }},
      {"Scale",
       {
           // cv.scale(1, 1) is ignored
           {1, 16, 1, 16, [](DlOpReceiver& b) { b.scale(2, 2); }},
           {1, 16, 1, 16, [](DlOpReceiver& b) { b.scale(2, 3); }},
           {1, 16, 1, 16, [](DlOpReceiver& b) { b.scale(3, 2); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.scale(1, 1); }},
       }},
      {"Rotate",
       {
           // cv.rotate(0) is ignored, otherwise expressed as concat(rotmatrix)
           {1, 8, 1, 32, [](DlOpReceiver& b) { b.rotate(30); }},
           {1, 8, 1, 32, [](DlOpReceiver& b) { b.rotate(45); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.rotate(0); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.rotate(360); }},
       }},
      {"Skew",
       {
           // cv.skew(0, 0) is ignored, otherwise expressed as
           // concat(skewmatrix)
           {1, 16, 1, 32, [](DlOpReceiver& b) { b.skew(0.1, 0.1); }},
           {1, 16, 1, 32, [](DlOpReceiver& b) { b.skew(0.1, 0.2); }},
           {1, 16, 1, 32, [](DlOpReceiver& b) { b.skew(0.2, 0.1); }},
           {0, 0, 0, 0, [](DlOpReceiver& b) { b.skew(0, 0); }},
       }},
      {"Transform2DAffine",
       {
           {1, 32, 1, 32,
            [](DlOpReceiver& b) { b.transform2DAffine(0, 1, 12, 1, 0, 33); }},
           // b.transform(identity) is ignored
           {0, 0, 0, 0,
            [](DlOpReceiver& b) { b.transform2DAffine(1, 0, 0, 0, 1, 0); }},
       }},
...
std::vector<DisplayListInvocationGroup> CreateAllRenderingOps() {
  return {
      {"DrawPaint",
       {
           {1, 8, 1, 8, [](DlOpReceiver& b) { b.drawPaint(); }},
       }},
      {"DrawColor",
       {
      ...
      {"DrawRRect",
       {
           {1, 56, 1, 56, [](DlOpReceiver& b) { b.drawRRect(kTestRRect); }},
           {1, 56, 1, 56,
            [](DlOpReceiver& b) { b.drawRRect(kTestRRect.makeOffset(5, 5)); }},
       }},
      {"DrawDRRect",
       {
           {1, 112, 1, 112,
            [](DlOpReceiver& b) { b.drawDRRect(kTestRRect, kTestInnerRRect); }},
           {1, 112, 1, 112,
            [](DlOpReceiver& b) {
      ...
      {"DrawPath",
       {
           {1, 24, 1, 24, [](DlOpReceiver& b) { b.drawPath(kTestPath1); }},
           {1, 24, 1, 24, [](DlOpReceiver& b) { b.drawPath(kTestPath2); }},
           {1, 24, 1, 24, [](DlOpReceiver& b) { b.drawPath(kTestPath3); }},
           {1, 24, 1, 24, [](DlOpReceiver& b) { b.drawPath(kTestPathRect); }},
           {1, 24, 1, 24, [](DlOpReceiver& b) { b.drawPath(kTestPathOval); }},
       }},
      {"DrawArc",
       {
           {1, 32, 1, 32,
            [](DlOpReceiver& b) { b.drawArc(kTestBounds, 45, 270, false); }},
           {1, 32, 1, 32,
            [](DlOpReceiver& b) {
              b.drawArc(kTestBounds.makeOffset(1, 1), 45, 270, false);
            }},
           {1, 32, 1, 32,
            [](DlOpReceiver& b) { b.drawArc(kTestBounds, 30, 270, false); }},
           {1, 32, 1, 32,
            [](DlOpReceiver& b) { b.drawArc(kTestBounds, 45, 260, false); }},
           {1, 32, 1, 32,
            [](DlOpReceiver& b) { b.drawArc(kTestBounds, 45, 270, true); }},
       }},
      {"DrawPoints",
       {
      ...
      {"DrawVertices",
       {
           {1, 112, 1, 16,
            [](DlOpReceiver& b) {
              b.drawVertices(TestVertices1.get(), DlBlendMode::kSrcIn);
            }},
           {1, 112, 1, 16,
            [](DlOpReceiver& b) {
              b.drawVertices(TestVertices1.get(), DlBlendMode::kDstIn);
            }},
           {1, 112, 1, 16,
            [](DlOpReceiver& b) {
              b.drawVertices(TestVertices2.get(), DlBlendMode::kSrcIn);
            }},
       }},
      {"DrawImage",
       {
      ...
      {"DrawDisplayList",
       {
           ...
           {1, 16, -1, 16,
            [](DlOpReceiver& b) { b.drawDisplayList(TestDisplayList1); }},
           {1, 16, -1, 16,
            [](DlOpReceiver& b) { b.drawDisplayList(TestDisplayList2); }},
           {1, 16, -1, 16,
            [](DlOpReceiver& b) {
      ...
      {"DrawTextBlob",
       {
           {1, 24, 1, 24,
            [](DlOpReceiver& b) { b.drawTextBlob(TestBlob1, 10, 10); }},
           {1, 24, 1, 24,
            [](DlOpReceiver& b) { b.drawTextBlob(TestBlob1, 20, 10); }},
           {1, 24, 1, 24,
            [](DlOpReceiver& b) { b.drawTextBlob(TestBlob1, 10, 20); }},
           {1, 24, 1, 24,
            [](DlOpReceiver& b) { b.drawTextBlob(TestBlob2, 10, 10); }},
       }},
