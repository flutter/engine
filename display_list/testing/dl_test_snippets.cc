...
sk_sp<DisplayList> GetSampleDisplayList() {
  ...
  builder.DrawRect(DlFRect::MakeXYWH(10, 10, 80, 80), DlPaint(DlColor::kRed()));
...
sk_sp<DisplayList> GetSampleNestedDisplayList() {
  ...
  for (int y = 10; y <= 60; y += 10) {
    for (int x = 10; x <= 60; x += 10) {
      ...
      builder.DrawRect(DlFRect::MakeXYWH(x, y, 80, 80), paint);
    }
  }
            ...
            [](DlOpReceiver& r) {
              r.setImageFilter(
                  kTestBlurImageFilter1
                      .makeWithLocalMatrix(DlTransform::MakeTranslate(2, 2))
                      .get());
            }},
       }},
      {"SetColorFilter",
      ...
      {"ClipRect",
       {
           ...
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.clipRect(kTestBounds.Translate(1, 1),
                         DlCanvas::ClipOp::kIntersect, true);
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
      ...
      {"ClipRRect",
       {
           ...
           {1, 64, 1, 64,
            [](DlOpReceiver& r) {
              r.clipRRect(kTestRRect.Translate(1, 1),
                          DlCanvas::ClipOp::kIntersect, true);
            }},
           {1, 64, 1, 64,
            [](DlOpReceiver& r) {
      ...
      {"DrawRect",
       {
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawRect(DlFRect::MakeLTRB(0, 0, 10, 10));
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawRect(DlFRect::MakeLTRB(0, 1, 10, 10));
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawRect(DlFRect::MakeLTRB(0, 0, 20, 10));
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawRect(DlFRect::MakeLTRB(0, 0, 10, 20));
            }},
       }},
      {"DrawOval",
       {
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawOval(DlFRect::MakeLTRB(0, 0, 10, 10));
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawOval(DlFRect::MakeLTRB(0, 1, 10, 10));
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawOval(DlFRect::MakeLTRB(0, 0, 20, 10));
            }},
           {1, 24, 1, 24,
            [](DlOpReceiver& r) {
              r.drawOval(DlFRect::MakeLTRB(0, 0, 10, 20));
            }},
       }},
      {"DrawCircle",
       {
      ...
      {"DrawRRect",
       {
           ...
           {1, 56, 1, 56,
            [](DlOpReceiver& r) { r.drawRRect(kTestRRect.Translate(5, 5)); }},
       }},
      {"DrawDRRect",
       {
           {1, 112, 1, 112,
           ...
           {1, 112, 1, 112,
            [](DlOpReceiver& r) {
              r.drawDRRect(kTestRRect.Translate(5, 5),
                           kTestInnerRRect.Translate(4, 4));
            }},
       }},
      {"DrawPath",
       {
      ...
      {"DrawArc",
       {
           ...
           {1, 32, 1, 32,
            [](DlOpReceiver& r) {
              r.drawArc(kTestBounds.Translate(1, 1), 45, 270, false);
            }},
           {1, 32, 1, 32,
      ...
      {"DrawImageRect",
       {
           {1, 56, -1, 80,
            [](DlOpReceiver& r) {
              r.drawImageRect(TestImage1, DlFRect::MakeLTRB(10, 10, 20, 20),
                              DlFRect::MakeLTRB(10, 10, 80, 80),
           ...
           {1, 56, -1, 80,
            [](DlOpReceiver& r) {
              r.drawImageRect(TestImage1, DlFRect::MakeLTRB(10, 10, 25, 20),
                              DlFRect::MakeLTRB(10, 10, 80, 80),
                              kNearestSampling, false,
                              DlCanvas::SrcRectConstraint::kFast);
            }},
           ...
           {1, 56, -1, 80,
            [](DlOpReceiver& r) {
              r.drawImageRect(TestImage2, DlFRect::MakeLTRB(10, 10, 15, 15),
                              DlFRect::MakeLTRB(10, 10, 80, 80),
                              kNearestSampling, false,
                              DlCanvas::SrcRectConstraint::kFast);
            }},
           {1, 56, -1, 80,
            [](DlOpReceiver& r) {
              auto dl_image = DlImage::Make(TestSkImage);
              r.drawImageRect(dl_image, DlFRect::MakeLTRB(10, 10, 15, 15),
                              DlFRect::MakeLTRB(10, 10, 80, 80),
                              kNearestSampling, false,
                              DlCanvas::SrcRectConstraint::kFast);
            }},
