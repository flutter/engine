...
std::shared_ptr<DlPathEffect> DlPathEffect::MakeDash(const SkScalar* intervals,
                                                     int count,
                                                     SkScalar phase) {
...
std::shared_ptr<DlPathEffect> DlDashPathEffect::Make(const SkScalar* intervals,
  ...
  return std::shared_ptr<DlPathEffect>(
      new (storage) DlDashPathEffect(intervals, count, phase),
      DlPathEffectDeleter);
}
