...
/// library.
const Map<String, LibraryInfo> libraries = <String, LibraryInfo>{
  ...
  'developer': LibraryInfo('developer/developer.dart',
      categories: 'Client,Server,Embedded',
      maturity: Maturity.UNSTABLE,
      dart2jsPatchPath: '_internal/js_runtime/lib/developer_patch.dart'),
  'html': LibraryInfo('html/dart2js/html_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      platforms: DART2JS_PLATFORM),
  'html_common': LibraryInfo('html/html_common/html_common.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      dart2jsPath: 'html/html_common/html_common_dart2js.dart',
      documented: false,
      implementation: true),
  'indexed_db': LibraryInfo('indexed_db/dart2js/indexed_db_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      platforms: DART2JS_PLATFORM),
  '_http':
      LibraryInfo('_http/http.dart', categories: '', documented: false),
  'io': LibraryInfo('io/io.dart',
      categories: 'Server',
      dart2jsPatchPath: '_internal/js_runtime/lib/io_patch.dart'),
  'isolate': LibraryInfo('isolate/isolate.dart',
      categories: 'Client,Server',
      maturity: Maturity.STABLE,
      dart2jsPatchPath: '_internal/js_runtime/lib/isolate_patch.dart'),
  'js': LibraryInfo('js/dart2js/js_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.STABLE,
      platforms: DART2JS_PLATFORM),
  'js_util': LibraryInfo('js_util/dart2js/js_util_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.STABLE,
      platforms: DART2JS_PLATFORM),
  ...
  'mirrors': LibraryInfo('mirrors/mirrors.dart',
      categories: 'Client,Server',
      maturity: Maturity.UNSTABLE,
      dart2jsPatchPath: '_internal/js_runtime/lib/mirrors_patch.dart'),
  'nativewrappers': LibraryInfo('html/dartium/nativewrappers.dart',
      categories: 'Client',
      implementation: true,
      documented: false,
      platforms: DART2JS_PLATFORM),
  'typed_data': LibraryInfo('typed_data/typed_data.dart',
      categories: 'Client,Server,Embedded',
      maturity: Maturity.STABLE,
      dart2jsPatchPath: '_internal/js_runtime/lib/typed_data_patch.dart'),
  '_native_typed_data': LibraryInfo(
      '_internal/js_runtime/lib/native_typed_data.dart',
      categories: '',
      implementation: true,
      documented: false,
      platforms: DART2JS_PLATFORM),
  'cli': LibraryInfo('cli/cli.dart',
      categories: 'Server',
      dart2jsPatchPath: '_internal/js_runtime/lib/cli_patch.dart'),
  'svg': LibraryInfo('svg/dart2js/svg_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      platforms: DART2JS_PLATFORM),
  'web_audio': LibraryInfo('web_audio/dart2js/web_audio_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      platforms: DART2JS_PLATFORM),
  'web_gl': LibraryInfo('web_gl/dart2js/web_gl_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      platforms: DART2JS_PLATFORM),
  'web_sql': LibraryInfo('web_sql/dart2js/web_sql_dart2js.dart',
      categories: 'Client',
      maturity: Maturity.WEB_STABLE,
      platforms: DART2JS_PLATFORM),
  '_internal': LibraryInfo('internal/internal.dart',
      categories: '',
      documented: false,
      dart2jsPatchPath: '_internal/js_runtime/lib/internal_patch.dart'),
  '_js_helper': LibraryInfo('_internal/js_runtime/lib/js_helper.dart',
      categories: '', documented: false, platforms: DART2JS_PLATFORM),
  '_interceptors': LibraryInfo(
      '_internal/js_runtime/lib/interceptors.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  '_foreign_helper': LibraryInfo(
      '_internal/js_runtime/lib/foreign_helper.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  '_isolate_helper': LibraryInfo(
      '_internal/js_runtime/lib/isolate_helper.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  '_js_mirrors': LibraryInfo('_internal/js_runtime/lib/js_mirrors.dart',
      categories: '', documented: false, platforms: DART2JS_PLATFORM),
  '_js_primitives': LibraryInfo(
      '_internal/js_runtime/lib/js_primitives.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  '_metadata': LibraryInfo('html/html_common/metadata.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  '_debugger': LibraryInfo('_internal/js_runtime/lib/debugger.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  '_runtime': LibraryInfo(
      '_internal/js_runtime/lib/ddc_runtime/runtime.dart',
      categories: '',
      documented: false,
      platforms: DART2JS_PLATFORM),
  'ui': LibraryInfo('ui/ui.dart', documented: true, platforms:DART2JS_PLATFORM),
};
