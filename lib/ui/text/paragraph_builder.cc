...
const int psBoundingLineHeightBehaviorIndex = 6;
...
const int psBoundingLineHeightBehaviorMask =
    1 << psBoundingLineHeightBehaviorIndex;
...
ParagraphBuilder::ParagraphBuilder(
  ...
  if (mask & psBoundingLineHeightBehaviorMask) {
    style.bounding_line_height_behavior =
        encoded[psBoundingLineHeightBehaviorIndex];
  }
