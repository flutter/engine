...
// This jump table function is 2x faster than a Map and is generated by:
// https://gist.github.com/gaaclarke/533d5948ec242defb408eec1ce04c55f
String _deprecatedRegionSubtagMap(String x) {
  final List<int> units = x.codeUnits;
  if (units.length != 2) {
    return x;
  }
  switch (units[0]) {
...
// This jump table function is 2x faster than a Map and is generated by:
// https://gist.github.com/gaaclarke/533d5948ec242defb408eec1ce04c55f
String _deprecatedLanguageSubtagMap(String x) {
  final List<int> units = x.codeUnits;
  if (units.length == 2) {
    switch (units[0]) {
      case 105 /*i*/ :
...
class Locale {
  ...
  ///    [Locale] objects.
  String get languageCode => _deprecatedLanguageSubtagMap(_languageCode);
  ...
  ///  * [Locale.fromSubtags], which describes the conventions for creating
  ///    [Locale] objects.
  String? get countryCode => _countryCode == null ? null : _deprecatedRegionSubtagMap(_countryCode!);
  ...
  bool operator ==(Object other) {
    ...
    if (scriptCode != other.scriptCode) {
      // Prioritize the field with the direct accessor.
      // scriptCode cannot be '';
      return false;
    }
    if (other.languageCode != languageCode) {
      // Short circuit to avoid calls to countryCode.
      return false;
    }
    final String? thisCountryCode = countryCode;
    final String? otherCountryCode = other.countryCode;
    return (other.countryCode == thisCountryCode // Treat '' as equal to null.
