...
class Path extends NativeFieldWrapperClass2 {
  ...
  /// Specify whether the path is volatile. It's Default to false so we'll cache
  /// it and reuse it between repeated draws. Mark temporary paths, discarded
  /// or modified after use, as volatile to inform the engine that the path need
  /// not be cached.
  ///
  /// Mark animating paths volatile to improve performance. Mark unchanging
  /// paths non-volatile to improve repeated rendering.
  void setIsVolatile(bool isVolatile) native 'Path_setIsVolatile';
}
