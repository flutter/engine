...
SKWASM_EXPORT void textStyle_setFontStyle(
    TextStyle *style,
    int weight,
...
SKWASM_EXPORT void textStyle_addShadow(
    TextStyle *style,
    SkColor color,
    SkScalar offsetX,
    SkScalar offsetY,
    ...
    style->addShadow(
        TextShadow(color, {offsetX, offsetY}, blurSigma)
    );
}

SKWASM_EXPORT void textStyle_addFontFeature(
    TextStyle *style,
