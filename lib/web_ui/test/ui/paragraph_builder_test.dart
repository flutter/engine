...
Future<void> testMain() async {
  ...
  test('the presence of foreground style should not throw', () {
    final ParagraphBuilder builder = ParagraphBuilder(ParagraphStyle());
    builder.pushStyle(
      TextStyle(foreground: Paint()..color = const Color(0xFFABCDEF)),
    );
    builder.addText('hi');
  ...
  test(
    'getLineBoundary at the last character position gives correct results',
    () {
      final ParagraphBuilder builder = ParagraphBuilder(ParagraphStyle());
      builder.addText('hello world');
      ...
      final TextRange lineBoundary = paragraph.getLineBoundary(
