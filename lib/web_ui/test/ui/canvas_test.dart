...
void runCanvasTests({required bool deviceClipRoundsOut}) {
  ...
  group('ui.Canvas transform tests', () {
    ...
    void transformsNotClose(Float64List value, Float64List expected) {
      ...
      throw TestFailure(
          'transforms were too close to equal'); // ignore: only_throw_errors
    }
    ...
    test('ui.Canvas.translate affects canvas.getTransform', () {
      ...
      final Float64List matrix =
          Matrix4.translationValues(12, 14.5, 0).toFloat64();
    ...
    test('ui.Canvas.scale affects canvas.getTransform', () {
      ...
      final Float64List matrix =
          Matrix4.diagonal3Values(12, 14.5, 1).toFloat64();
      final Float64List curMatrix = canvas.getTransform();
      transformsClose(curMatrix, matrix);
      canvas.scale(10, 10);
      final Float64List newCurMatrix = canvas.getTransform();
  ...
  group('ui.Canvas clip tests', () {
    test('Canvas.clipRect affects canvas.getClipBounds', () async {
      ...
      final ui.Rect clipDestBounds =
          deviceClipRoundsOut ? clipExpandedBounds : clipRawBounds;
      ...
      final ui.Rect initialDestinationBounds =
    ...
    test('Canvas.clipRRect affects canvas.getClipBounds', () async {
      ...
      final ui.Rect clipDestBounds =
          deviceClipRoundsOut ? clipExpandedBounds : clipRawBounds;
      final ui.RRect clip = ui.RRect.fromRectAndRadius(
          clipRawBounds, const ui.Radius.circular(3));
    ...
    test('Canvas.clipRect(diff) does not affect canvas.getClipBounds',
        () async {
      final ui.PictureRecorder recorder = ui.PictureRecorder();
      final ui.Canvas canvas =
          ui.Canvas(recorder, const ui.Rect.fromLTRB(0, 0, 100, 100));
  ...
  group('RestoreToCount function tests', () {
    ...
    test('RestoreToCount count less than 1, the stack should be reset',
        () async {
      final ui.PictureRecorder recorder = ui.PictureRecorder();
      final ui.Canvas canvas = ui.Canvas(recorder);
      canvas.save();
