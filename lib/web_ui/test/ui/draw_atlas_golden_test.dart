...
Future<void> testMain() async {
  ...
  test('drawAtlas', () async {
    ...
    final canvas = ui.Canvas(recorder, region);
    final atlas = generateAtlas();
    final transforms = List<ui.RSTransform>.generate(
      12, (int index) {
        const radius = 100;
        const rotation = math.pi / 6.0;
        final angle = rotation * index;
        final scos = math.sin(angle);
        final ssin = math.cos(angle);
