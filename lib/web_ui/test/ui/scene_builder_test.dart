  ...
  group('${ui.SceneBuilder}', () {
    ...
    test('Test offset layer', () async {
      ...
      await matchGoldenFile(
        'scene_builder_centered_circle.png',
        region: region,
      );
    });
    ...
    test('Test transform layer', () async {
      ...
      await renderScene(sceneBuilder.build());
      await matchGoldenFile(
        'scene_builder_rotated_rounded_square.png',
        region: region,
      );
    });
    ...
    test('Test clipRect layer', () async {
      ...
      await renderScene(sceneBuilder.build());
      await matchGoldenFile(
        'scene_builder_circle_clip_rect.png',
        region: region,
      );
    });
    ...
    test('Test clipRRect layer', () async {
      ...
      await renderScene(sceneBuilder.build());
      await matchGoldenFile(
        'scene_builder_circle_clip_rrect.png',
        region: region,
      );
    });
    ...
    test('Test clipPath layer', () async {
      ...
      await renderScene(sceneBuilder.build());
      await matchGoldenFile(
        'scene_builder_rectangle_clip_circular_path.png',
        region: region,
      );
    });
    ...
    test('Test opacity layer', () async {
      ...
      await renderScene(sceneBuilder.build());
      await matchGoldenFile(
        'scene_builder_opacity_circles_on_square.png',
        region: region,
      );
    });
    ...
    test('backdrop filter layer', () async {
      ...
      sceneBuilder.addPicture(
        ...
        drawPicture((ui.Canvas canvas) {
          ...
          final ui.Paint redPaint =
              ui.Paint()..color = const ui.Color(0xFFFF0000);
          final ui.Paint bluePaint =
              ui.Paint()..color = const ui.Color(0xFF0000FF);
      ...
      await renderScene(sceneBuilder.build());
      await matchGoldenFile(
        'scene_builder_backdrop_filter.png',
        region: region,
      );
    });
