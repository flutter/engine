    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          expect(
            renderer.fontCollection.fontFallbackManager!.globalFontFallbacks,
            <String>['Roboto', 'Noto Color Emoji', 'Noto Sans Arabic'],
          );
        },
      );
      ...
      test(
        'findMinimumFontsForCodePoints for all supported code points',
        () async {
          ...
          expect(
            supportedUniqueCodePoints.length,
            greaterThan(10000),
          ); // sanity check
          expect(
            testedFonts,
          ...
          final List<int> supportedCodePoints =
              supportedUniqueCodePoints.toList()..shuffle(random);
      ...
      test(
        'fallback fonts do not download when debugDisableFontFallbacks is set',
        () async {
