...
typedef _TextStylePropertyPopulator = void Function(
    _TestTextStyleBuilder builder);
...
final Map<String, _TextStylePropertyPopulator> _populatorsA =
    <String, _TextStylePropertyPopulator>{
  ...
  'fontFeatures': (_TestTextStyleBuilder builder) {
    builder.fontFeatures = <ui.FontFeature>[
      const ui.FontFeature.caseSensitiveForms()
    ];
  },
  'fontVariations': (_TestTextStyleBuilder builder) {
    builder.fontVariations = <ui.FontVariation>[
      const ui.FontVariation.italic(0.1)
    ];
  },
};

// Intentionally do not use const List expressions to make sure Object.hashAll is used to compute hashCode
final Map<String, _TextStylePropertyPopulator> _populatorsB =
    <String, _TextStylePropertyPopulator>{
  'color': (_TestTextStyleBuilder builder) {
  ...
  'fontFeatures': (_TestTextStyleBuilder builder) {
    builder.fontFeatures = <ui.FontFeature>[
      const ui.FontFeature.alternative(2)
    ];
  },
  'fontVariations': (_TestTextStyleBuilder builder) {
    builder.fontVariations = <ui.FontVariation>[
      const ui.FontVariation.italic(0.4)
    ];
  },
};
