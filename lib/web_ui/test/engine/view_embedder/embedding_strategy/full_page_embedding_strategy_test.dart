...
void doTests() {
  group('initialize', () {
    test('Prepares target environment', () {
      ...
      DomElement? userMeta = domDocument.querySelector(
        '#my_viewport_meta_for_testing',
      );
      ...
      final DomElement? flutterMeta = domDocument.querySelector(
        'meta[name="viewport"]',
      );
  ...
  group('attachViewRoot', () {
    test('Should attach glasspane into embedder target (body)', () async {
      ...
      expect(
        style.top,
        '',
        reason: 'Should not have any top/right/bottom/left positioning/inset.',
      );
