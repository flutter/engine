...
class SemanticsTester {
  ...
  SemanticsNodeUpdate updateNode({
    ...
    double? thickness,
    ui.Rect? rect,
    ui.AttributedString? attributedLabel,
    ui.AttributedString? attributedValue,
    ui.AttributedString? attributedIncreasedValue,
    ui.AttributedString? attributedDecreasedValue,
    ui.AttributedString? attributedHint,
    ...
    final SemanticsNodeUpdate update = SemanticsNodeUpdate(
      ...
      rect: effectiveRect,
      attributedLabel: attributedLabel ?? ui.AttributedString(''),
      attributedValue: attributedValue ?? ui.AttributedString(''),
      attributedIncreasedValue: attributedIncreasedValue ?? ui.AttributedString(''),
      attributedDecreasedValue: attributedDecreasedValue ?? ui.AttributedString(''),
      attributedHint: attributedHint ?? ui.AttributedString(''),
