  ...
  test('Can create multiple views each with its own semantics tree', () async {
    ...
    expect(
      domDocument.querySelectorAll(
        'flutter-view[flt-view-id="${view1.viewId}"]',
      ),
      hasLength(1),
    );
    expect(
      domDocument.querySelectorAll(
        'flutter-view[flt-view-id="${view2.viewId}"]',
      ),
      hasLength(1),
    );
    expect(
    ...
    // Add some children
    tester1.updateNode(id: 0, children: <SemanticsNodeUpdate>[
      tester1.updateNode(
        id: 1,
        isFocusable: true,
        hasTap: true,
    ...
    tester2.updateNode(id: 0, children: <SemanticsNodeUpdate>[
      tester2.updateNode(
        id: 2,
        hasIncrease: true,
        label: 'd',
...
''');
    ...
    EnginePlatformDispatcher.instance.viewManager.disposeAndUnregisterView(
      view1.viewId,
    );
