...
mixin _ButtonedEventMixin on _BasicEventContext {
  ...
  html.Event wheel({
    ...
    return js_util.callConstructor(jsWheelEvent, js_util.jsify(eventArgs) as List<Object?>?) as html.Event;
  }
}
...
class _MouseEventContext extends _BasicEventContext
  ...
  html.MouseEvent _createMouseEvent(
    ...
    return js_util.callConstructor(jsMouseEvent, js_util.jsify(eventArgs) as List<Object?>?) as html.MouseEvent;
  }
}
