...
void testMain() {
  ...
  test('_PointerEventContext generates expected events', () {
    ...
    event = expectCorrectType(
      context.mouseLeave(clientX: 1000, clientY: 2000, buttons: 6),
    );
  ...
  test('event listeners are attached to the bubble phase', () {
    ...
    final DomEventListener stopPropagationListener = createDomEventListener((
      DomEvent event,
    ) {
  ...
  test(
    ...
    () {
      ...
      void shouldNotSynthesizeDownIfLeftPressed(String key, int modifiers) {
        ...
        keyboardConverter.handleEvent(
          keyDownEvent('${key}Left', key, modifiers, kLocationLeft),
        );
      ...
      void shouldNotSynthesizeDownIfRightPressed(String key, int modifiers) {
        ...
        keyboardConverter.handleEvent(
          keyDownEvent('${key}Right', key, modifiers, kLocationRight),
        );
        expect(keyboardConverter.keyIsPressed(physicalLeft), false);
  ...
  test(
    ...
    () {
      ...
      final DomElement semanticsPlaceholder = createDomElement(
        'flt-semantics-placeholder',
      );
      rootElement.append(semanticsPlaceholder);

      // Press on the semantics placeholder.
      semanticsPlaceholder.dispatchEvent(
        context.primaryDown(clientX: 10.0, clientY: 10.0),
      );
      expect(packets, hasLength(1));
      ...
      semanticsPlaceholder.dispatchEvent(
        context.primaryMove(clientX: 12.0, clientY: 10.0),
      );
      expect(packets, hasLength(1));
      ...
      // Keep dragging.
      semanticsPlaceholder.dispatchEvent(
        context.primaryMove(clientX: 15.0, clientY: 10.0),
      );
      expect(packets[0].data, hasLength(1));
      expect(packets[0].data[0].change, equals(ui.PointerChange.move));
      ...
      rootElement.dispatchEvent(
        context.primaryUp(clientX: 100.0, clientY: 200.0),
      );
      expect(packets, hasLength(1));
      expect(packets[0].data, hasLength(2));
      expect(packets[0].data[0].change, equals(ui.PointerChange.move));
  ...
  test(
    ...
    () {
      ...
      rootElement.dispatchEvent(
        context.primaryDown(clientX: 20.0, clientY: 20.0),
      );
      expect(packets, hasLength(1));
      expect(packets[0].data, hasLength(1));
      expect(packets[0].data[0].change, equals(ui.PointerChange.move));
  ...
  test(
    'wheel event - framework can stop preventDefault (allowPlatformDefault)',
    () {
        ...
        packet.data
            .where(
              (ui.PointerData datum) =>
                  datum.signalKind == ui.PointerSignalKind.scroll,
            )
  ...
  test(
    'wheel event - once allowPlatformDefault is set to true, it cannot be rolled back',
    () {
      // The framework calls `data.respond(allowPlatformDefault: true)`
      ui.PlatformDispatcher.instance.onPointerDataPacket = (
        ui.PointerDataPacket packet,
  ...
  test('does choose scroll vs scale based on ctrlKey', () {
    ...
    keyboardConverter.handleEvent(
      keyDownEvent('ControlLeft', 'Control', kCtrl),
    );
    ...
    expect(packets[1].data[0].physicalDeltaY, equals(0.0));
    expect(
      packets[1].data[0].scale,
      closeTo(0.60653065971, 1e-10),
    ); // math.exp(-100/200)
  ...
  test('does calculate delta and pointer identifier correctly', () {
    ...
    rootElement.dispatchEvent(
      context.primaryMove(clientX: 40.0, clientY: 30.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.move));
    ...
    rootElement.dispatchEvent(
      context.primaryDown(clientX: 20.0, clientY: 10.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.down));
  ...
  test('correctly converts buttons of down, move, leave, and up events', () {
    ...
    rootElement.dispatchEvent(
      context.mouseUp(button: 0, clientX: 20.0, clientY: 21.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.up));
    ...
    rootElement.dispatchEvent(
      context.mouseUp(button: 2, clientX: 30.0, clientY: 31.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.up));
    ...
    rootElement.dispatchEvent(
      context.mouseUp(button: 1, clientX: 40.0, clientY: 41.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.up));
    ...
    rootElement.dispatchEvent(
      context.mouseLeave(buttons: 1, clientX: 1000.0, clientY: 2000.0),
    );
    expect(packets, isEmpty);
    packets.clear();

    rootElement.dispatchEvent(
      context.mouseLeave(buttons: 0, clientX: 1000.0, clientY: 2000.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.hover));
  ...
  test(
    ...
    () {
      ...
      rootElement.dispatchEvent(
        context.mouseDown(button: 2, buttons: 2, clientX: 10, clientY: 11),
      );
      ...
      rootElement.dispatchEvent(
        context.mouseUp(button: 2, clientX: 20.0, clientY: 21.0),
      );
      expect(packets, hasLength(1));
      expect(packets[0].data, hasLength(1));
      expect(packets[0].data[0].change, equals(ui.PointerChange.up));
  ...
  test(
    ...
    () {
      ...
      rootElement.dispatchEvent(
        context.mouseMove(button: _kNoButtonChange, buttons: 3),
      );
      expect(packets, hasLength(1));
      expect(packets[0].data, hasLength(1));
      expect(packets[0].data[0].change, equals(ui.PointerChange.move));
  ...
  test(
    ...
    () {
      ...
      // User now hovers.
      rootElement.dispatchEvent(
        context.mouseMove(button: _kNoButtonChange, buttons: 0),
      );
      expect(packets, hasLength(1));
      expect(packets[0].data, hasLength(2));
      expect(packets[0].data[0].change, equals(ui.PointerChange.up));
  ...
  test(
    ...
    () {
      ...
      // Release RMB.
      rootElement.dispatchEvent(
        context.mouseUp(button: 2, clientX: 20.0, clientY: 20.0),
      );
      expect(packets, hasLength(1));
      expect(packets[0].data, hasLength(1));
      expect(packets[0].data[0].change, equals(ui.PointerChange.up));
  ...
  test('correctly handles two consecutive RMB clicks with up in between', () {
    ...
    // RMB up.
    rootElement.dispatchEvent(
      context.mouseUp(button: 2, clientX: 10.0, clientY: 10.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.up));
  ...
  test('correctly detects up event outside of flutterViewElement', () {
    ...
    rootElement.dispatchEvent(
      context.primaryMove(clientX: 20.0, clientY: 10.0),
    );
    packets.clear();

    // Move outside the flutterViewElement.
    rootElement.dispatchEvent(
      context.primaryMove(clientX: 900.0, clientY: 1900.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(1));
    expect(packets[0].data[0].change, equals(ui.PointerChange.move));
    ...
    rootElement.dispatchEvent(
      context.primaryUp(clientX: 1000.0, clientY: 2000.0),
    );
    expect(packets, hasLength(1));
    expect(packets[0].data, hasLength(2));
    expect(packets[0].data[0].change, equals(ui.PointerChange.move));
  ...
  test('treats each pointer separately', () {
    ...
    // One pointer up
    context
        .multiTouchUp(const <_TouchDetails>[
          _TouchDetails(pointer: 3, clientX: 300, clientY: 302),
        ])
        .forEach(rootElement.dispatchEvent);
    expect(packets, hasLength(1));
...
void _testClickDebouncer({required PointerBinding Function() getBinding}) {
  ...
  setUp(() {
    ...
    EnginePlatformDispatcher.instance.onSemanticsActionEvent = (
  ...
  testWithSemantics(
    'Accumulates pointer events starting from pointerdown',
    () async {
      expect(EnginePlatformDispatcher.instance.semanticsEnabled, true);
      expect(PointerBinding.clickDebouncer.isDebouncing, false);
      ...
      expect(
        PointerBinding.clickDebouncer.debugState!.queue.map<String>(
          (QueuedEvent e) => e.event.type,
        ),
  ...
  testWithSemantics(
    'Flushes events to framework when target changes',
    () async {
      expect(EnginePlatformDispatcher.instance.semanticsEnabled, true);
      expect(PointerBinding.clickDebouncer.isDebouncing, false);
  ...
  testWithSemantics(
    'Forwards click to framework when not debouncing but listening',
    () async {
      expect(PointerBinding.clickDebouncer.isDebouncing, false);
  ...
  testWithSemantics(
    'Forwards click to framework when debouncing and listening',
    () async {
      expect(PointerBinding.clickDebouncer.isDebouncing, false);
...
class _PointerEventContext extends _BasicEventContext
  ...
  List<DomEvent> multiTouchCancel(List<_TouchDetails> touches) {
    return touches
        .map(
          (_TouchDetails details) => createDomPointerEvent(
            'pointercancel',
            <String, dynamic>{
              'bubbles': true,
