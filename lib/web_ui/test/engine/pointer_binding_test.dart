...
void testMain() {
  ...
  final DomElement appRoot = flutterViewEmbedder.appRoot;
  late double dpi;
  ...
  _testEach<_BasicEventContext>(
    ...
    (_BasicEventContext context) {
      ...
      appRoot.dispatchEvent(context.primaryDown());
  ...
  _testEach<_ButtonedEventMixin>(
    ...
    (_ButtonedEventMixin context) {
      ...
      appRoot.append(semanticsPlaceholder);
      ...
      appRoot.dispatchEvent(context.primaryUp(
        clientX: 100.0,
        clientY: 200.0,
      ));
      expect(packets, hasLength(1));
  ...
  _testEach<_ButtonedEventMixin>(
    ...
    (_ButtonedEventMixin context) {
      ...
      appRoot.dispatchEvent(context.hover());
  ...
  _testEach<_ButtonedEventMixin>(
    ...
    (_ButtonedEventMixin context) {
      ...
      appRoot.dispatchEvent(context.wheel(
        buttons: 0,
        clientX: 10,
        clientY: 10,
        deltaX: 10,
      ...
      appRoot.dispatchEvent(context.mouseDown(
        button: 0,
        buttons: 1,
        clientX: 20.0,
        clientY: 50.0,
  ...
  _testEach<_ButtonedEventMixin>(
    ...
    (_ButtonedEventMixin context) {
      ...
      appRoot.dispatchEvent(context.primaryMove(
        clientX: 40.0,
        clientY: 30.0,
      ));
      expect(packets, hasLength(1));
  ...
  _testEach<_ButtonedEventMixin>(
    ...
    (_ButtonedEventMixin context) {
      ...
      appRoot.dispatchEvent(context.mouseMove(
      ...
      appRoot.dispatchEvent(context.mouseUp(
        button: 0,
        clientX: 20.0,
        clientY: 21.0,
      ));
      ...
      appRoot.dispatchEvent(context.mouseLeave(
        buttons: 1,
        clientX: 1000.0,
        clientY: 2000.0,
      ));
  ...
  _testEach<_ButtonedEventMixin>(
    ...
    'correctly detects up event outside of appRoot',
    (_ButtonedEventMixin context) {
      PointerBinding.instance!.debugOverrideDetector(context);
