...
void testMain() {
  ...
  group('$SingleEntryBrowserHistory', () {
    ...
    test('disposes of its listener without touching history', () async {
      ...
      final Map<String, dynamic> wrappedOriginState = _wrapOriginState(
        unwrappedOriginState,
      );
  ...
  group('$MultiEntriesBrowserHistory', () {
    ...
    test('disposes of its listener without touching history', () async {
      ...
      final Map<String, dynamic> taggedState = _tagStateWithSerialCount(
        untaggedState,
        0,
      );
  ...
  group('$BrowserPlatformLocation', () {
    ...
    test('throws if removing an invalid listener', () {
      ...
      expect(
        () => location.removePopStateListener(myAddedListener),
        returnsNormally,
      );
      ...
      expect(
        () => location.removePopStateListener(myNonAddedListener),
        throwsAssertionError,
      );
    });
...
Future<void> routeUpdated(String routeName) {
  ...
  EnginePlatformDispatcher.instance.sendPlatformMessage(
    ...
    codec.encodeMethodCall(
      MethodCall('routeUpdated', <String, dynamic>{'routeName': routeName}),
    ),
