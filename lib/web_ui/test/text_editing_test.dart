...
Future<void> testMain() async {
  ...
  group('EditingState', () {
    ...
    test('Compare two editing states', () {
      ...
      final EditingState editingState1 = EditingState.fromDomElement(input as
          DomHTMLInputElement);
      final EditingState editingState2 = EditingState.fromDomElement(input as
          DomHTMLInputElement);

      input.setSelectionRange(1, 3);

      final EditingState editingState3 = EditingState.fromDomElement(input as
          DomHTMLInputElement);
