...
Future<void> testMain() async {
  ...
  test(
    'Renders shader mask with linear gradient BlendMode dst',
    () async {
      _renderCirclesScene(BlendMode.dst);
      await matchGoldenFile(
        'shadermask_linear_dst.png',
  ...
  test(
    'Renders shader mask with linear gradient BlendMode srcIn',
    () async {
  ...
  test(
    'Renders shader mask with linear gradient BlendMode color',
    () async {
      _renderCirclesScene(BlendMode.color);
      await matchGoldenFile(
  ...
  test(
    'Renders shader mask with linear gradient BlendMode xor',
    () async {
      _renderCirclesScene(BlendMode.xor);
      await matchGoldenFile(
        'shadermask_linear_xor.png',
        region: const Rect.fromLTWH(0, 0, 360, 200),
      );
    },
    skip: isSafari || isFirefox,
  ...
  test(
    'Renders shader mask with linear gradient BlendMode plus',
    () async {
  ...
  test(
    'Renders shader mask with linear gradient BlendMode modulate',
    () async {
  ...
  test(
    'Renders shader mask with linear gradient BlendMode overlay',
    () async {
  ...
  test(
    'Renders shader mask with linear gradient BlendMode src',
    () async {
      _renderCirclesScene(BlendMode.src);
      await matchGoldenFile(
        'shadermask_linear_src.png',
        region: const Rect.fromLTWH(0, 0, 360, 200),
      );
    },
    skip: isSafari || isFirefox,
