...
Future<void> testMain() async {
  ...
  test(
    "Creating lots of gradients doesn't create too many webgl contexts",
    () async {
      final DomCanvasElement sideCanvas = createDomCanvasElement(
        width: 5,
        height: 5,
      );
  ...
  test('Paints linear gradient properly when within svg context', () async {
    final RecordingCanvas canvas = RecordingCanvas(
      const Rect.fromLTRB(0, 0, 500, 240),
    );
    canvas.save();
