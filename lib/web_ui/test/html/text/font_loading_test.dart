  ...
  group('loadFontFromList', () {
    ...
    test(
      ...
      () async {
        ...
        const ui.ParagraphConstraints constraints = ui.ParagraphConstraints(
          width: 30.0,
        );

        final CanvasParagraphBuilder canvasBuilder = CanvasParagraphBuilder(
          style,
        );
