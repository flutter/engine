...
Future<void> testMain() async {
  ...
  test('pushClipRect', () async {
    ...
    final html.Element scene = builder.build().webOnlyRootElement!;
    hostTestScene(scene);
