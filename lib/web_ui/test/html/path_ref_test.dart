...
void testMain() {
  test('PathRef.getRRect with radius', () {
    ...
    final rrect = RRect.fromLTRBR(0, 0, 10, 10, const Radius.circular(2));
    path.addRRect(rrect);
  ...
  test('PathRef.getRRect with radius larger than rect', () {
    final path = SurfacePath();
    final rrect = RRect.fromLTRBR(0, 0, 10, 10, const Radius.circular(20));
    path.addRRect(rrect);
    expect(
      path.toRoundedRect(),
  ...
  test('PathRef.getRRect with zero radius', () {
    final path = SurfacePath();
    final rrect = RRect.fromLTRBR(0, 0, 10, 10, Radius.zero);
    path.addRRect(rrect);
  ...
  test('PathRef.getRRect elliptical', () {
    final path = SurfacePath();
    final rrect = RRect.fromLTRBR(0, 0, 10, 10, const Radius.elliptical(2, 4));
    path.addRRect(rrect);
    expect(path.toRoundedRect(), rrect);
  });
  ...
  test('PathRef.getRRect elliptical zero x', () {
    final path = SurfacePath();
    final rrect = RRect.fromLTRBR(0, 0, 10, 10, const Radius.elliptical(0, 3));
    path.addRRect(rrect);
    expect(path.toRoundedRect(), isNull);
    expect(path.toRect(), rrect.outerRect);
  });
  ...
  test('PathRef.getRRect elliptical zero y', () {
    final path = SurfacePath();
    final rrect = RRect.fromLTRBR(0, 0, 10, 10, const Radius.elliptical(3, 0));
    path.addRRect(rrect);
    expect(path.toRoundedRect(), isNull);
    expect(path.toRect(), rrect.outerRect);
  });
  ...
  test('PathRef.getRRect with nearly zero corner', () {
    final path = SurfacePath();
    final original = RRect.fromLTRBR(0, 0, 10, 10, const Radius.elliptical(0.00000001, 5));
