...
Future<void> testMain() async {
  ...
  testEachCanvas('clips multiline text against rectangle', (
    EngineCanvas canvas,
  ) {
    ...
    if (canvas is! DomCanvas) {
      ...
      return goldenTester.diffCanvasScreenshot(
        canvas,
        'multiline_text_clipping_rect',
      );
    }
    return null;
  });

  testEachCanvas('clips multiline text against rectangle with transform', (
    EngineCanvas canvas,
  ) {
    // [DomCanvas] doesn't support clip commands.
    if (canvas is! DomCanvas) {
      ...
      return goldenTester.diffCanvasScreenshot(
        canvas,
        'multiline_text_clipping_rect_translate',
      );
    }
    return null;
  });

  testEachCanvas('clips multiline text against round rectangle', (
    EngineCanvas canvas,
  ) {
    // [DomCanvas] doesn't support clip commands.
    if (canvas is! DomCanvas) {
      ...
      return goldenTester.diffCanvasScreenshot(
        canvas,
        'multiline_text_clipping_roundrect',
      );
    }
    return null;
  });
  ...
  testEachCanvas('clips multiline text against path', (EngineCanvas canvas) {
    ...
    if (canvas is! DomCanvas) {
      ...
      return goldenTester.diffCanvasScreenshot(
        canvas,
        'multiline_text_clipping_path',
      );
    }
    return null;
  });

  testEachCanvas('clips multiline text against stack of rects', (
    EngineCanvas canvas,
  ) {
    // [DomCanvas] doesn't support clip commands.
    if (canvas is! DomCanvas) {
      ...
      return goldenTester.diffCanvasScreenshot(
        canvas,
        'multiline_text_clipping_stack1',
      );
    }
    return null;
  });
