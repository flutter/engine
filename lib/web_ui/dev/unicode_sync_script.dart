...
/// ```
/// dart dev/unicode_sync_script.dart -w <path/to/word/break/properties>
/// ```
///
/// To generate code for line break properties:
/// ```
/// dart dev/unicode_sync_script.dart -l <path/to/line/break/properties>
/// ```
///
/// To do a dry run, add the `-d` flag:
///
/// ```
/// dart dev/unicode_sync_script.dart -d ...
/// ```
///
...
// AUTO-GENERATED FILE.
// Generated by: dev/unicode_sync_script.dart
//
// Source:
// ${header.join('\n// ')}
