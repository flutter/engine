  ...
  try {
    ...
    const dart2wasmRuntime = (() => {
      function stringFromDartString(string) {
        var length = data.dartInstance.exports.$stringLength(string);
        var array = new Array(length);
        for (var i = 0; i < length; i++) {
          array[i] = data.dartInstance.exports.$stringRead(string, i);
        }
      ...
      function stringToDartString(string) {
        ...
        if (range < 256) {
          var dartString = data.dartInstance.exports.$stringAllocate1(length);
          for (var i = 0; i < length; i++) {
            data.dartInstance.exports.$stringWrite1(dartString, i, string.codePointAt(i));
          }
          return dartString;
        } else {
          var dartString = data.dartInstance.exports.$stringAllocate2(length);
          for (var i = 0; i < length; i++) {
            data.dartInstance.exports.$stringWrite2(dartString, i, string.charCodeAt(i));
          }
          return dartString;
        }
      }
      ...
      function arrayFromDartList(constructor, list) {
        var length = data.dartInstance.exports.$listLength(list);
        var array = new constructor(length);
        for (var i = 0; i < length; i++) {
          array[i] = data.dartInstance.exports.$listRead(list, i);
        }
        return array;
      }
      ...
      function dataViewFromDartByteData(byteData, byteLength) {
        ...
        for (var i = 0; i < byteLength; i++) {
          dataView.setUint8(i, data.dartInstance.exports.$byteDataGetUint8(byteData, i));
        }
        return dataView;
      }
      ...
      return {
        ...
        scheduleCallback: function (milliseconds, closure) {
          setTimeout(function () {
            data.dartInstance.exports.$call0(closure);
          }, milliseconds);
        },
        futurePromise: new WebAssembly.Function(
          ...
          function (future) {
            return new Promise(function (resolve, reject) {
              data.dartInstance.exports.$awaitCallback(future, resolve);
            });
          },
          { suspending: 'first' }),
        ...
        callAsyncBridge: function (args, completer) {
          ...
          data.asyncBridge(args, completer);
        },
        ...
        wrapDartFunction: function (dartFunction, exportFunctionName) {
          var wrapped = function (...args) {
            return data.dartInstance.exports[`${exportFunctionName}`](
              dartFunction, ...args.map(data.dartInstance.exports.$dartifyRaw));
          }
    ...
    data.dartInstance = await WebAssembly.instantiate(dartModule, {
    ...
    data.asyncBridge = new WebAssembly.Function(
      {parameters: ['externref', 'externref'], results: ['externref']},
      data.dartInstance.exports.$asyncBridge,
      {promising: 'first'}
    );    

    data.dartInstance.exports.$main();
  } catch (exception) {
