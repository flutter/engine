...
class SemanticsAction {
  ...
  static const SemanticsAction longPress = SemanticsAction._(
    _kLongPressIndex,
    'longPress',
  );
  static const SemanticsAction scrollLeft = SemanticsAction._(
    _kScrollLeftIndex,
    'scrollLeft',
  );
  static const SemanticsAction scrollRight = SemanticsAction._(
    _kScrollRightIndex,
    'scrollRight',
  );
  static const SemanticsAction scrollUp = SemanticsAction._(
    _kScrollUpIndex,
    'scrollUp',
  );
  static const SemanticsAction scrollDown = SemanticsAction._(
    _kScrollDownIndex,
    'scrollDown',
  );
  static const SemanticsAction increase = SemanticsAction._(
    _kIncreaseIndex,
    'increase',
  );
  static const SemanticsAction decrease = SemanticsAction._(
    _kDecreaseIndex,
    'decrease',
  );
  ...
  static const SemanticsAction setText = SemanticsAction._(
    _kSetTextIndex,
    'setText',
  );
  ...
  static const SemanticsAction dismiss = SemanticsAction._(
    _kDismissIndex,
    'dismiss',
  );
  ...
  static List<SemanticsAction> get values => _kActionById.values.toList(
    growable: false,
  );
...
class SemanticsFlag {
  ...
  static const SemanticsFlag isChecked = SemanticsFlag._(
    _kIsCheckedIndex,
    'isChecked',
  );
  static const SemanticsFlag isSelected = SemanticsFlag._(
    _kIsSelectedIndex,
    'isSelected',
  );
  static const SemanticsFlag isButton = SemanticsFlag._(
    _kIsButtonIndex,
    'isButton',
  );
  static const SemanticsFlag isTextField = SemanticsFlag._(
    _kIsTextFieldIndex,
    'isTextField',
  );
  static const SemanticsFlag isSlider = SemanticsFlag._(
    _kIsSliderIndex,
    'isSlider',
  );
  static const SemanticsFlag isKeyboardKey = SemanticsFlag._(
    _kIsKeyboardKeyIndex,
    'isKeyboardKey',
  );
  static const SemanticsFlag isReadOnly = SemanticsFlag._(
    _kIsReadOnlyIndex,
    'isReadOnly',
  );
  static const SemanticsFlag isLink = SemanticsFlag._(_kIsLinkIndex, 'isLink');
  static const SemanticsFlag isFocusable = SemanticsFlag._(
    _kIsFocusableIndex,
    'isFocusable',
  );
  static const SemanticsFlag isFocused = SemanticsFlag._(
    _kIsFocusedIndex,
    'isFocused',
  );
  ...
  static const SemanticsFlag isEnabled = SemanticsFlag._(
    _kIsEnabledIndex,
    'isEnabled',
  );
  ...
  static const SemanticsFlag isHeader = SemanticsFlag._(
    _kIsHeaderIndex,
    'isHeader',
  );
  static const SemanticsFlag isObscured = SemanticsFlag._(
    _kIsObscuredIndex,
    'isObscured',
  );
  static const SemanticsFlag isMultiline = SemanticsFlag._(
    _kIsMultilineIndex,
    'isMultiline',
  );
  static const SemanticsFlag scopesRoute = SemanticsFlag._(
    _kScopesRouteIndex,
    'scopesRoute',
  );
  static const SemanticsFlag namesRoute = SemanticsFlag._(
    _kNamesRouteIndex,
    'namesRoute',
  );
  static const SemanticsFlag isHidden = SemanticsFlag._(
    _kIsHiddenIndex,
    'isHidden',
  );
  static const SemanticsFlag isImage = SemanticsFlag._(
    _kIsImageIndex,
    'isImage',
  );
  static const SemanticsFlag isLiveRegion = SemanticsFlag._(
    _kIsLiveRegionIndex,
    'isLiveRegion',
  );
  ...
  static const SemanticsFlag isToggled = SemanticsFlag._(
    _kIsToggledIndex,
    'isToggled',
  );
  ...
  static const SemanticsFlag isExpanded = SemanticsFlag._(
    _kIsExpandedIndex,
    'isExpanded',
  );
  ...
  static List<SemanticsFlag> get values => _kFlagById.values.toList(
    growable: false,
  );
...
class LocaleStringAttribute extends StringAttribute {
  LocaleStringAttribute({required super.range, required this.locale})
    : super._();
