...
class CanvasKitRenderer implements Renderer {
  ...
  ({ui.Scene scene, ui.FlutterView view, Completer<void> completer})? _currentRender;
  ({ui.Scene scene, ui.FlutterView view, Completer<void> completer})? _nextRender;
  ...
  Future<void> _kickRenderLoop() async {
    final ({ui.Scene scene, ui.FlutterView view, Completer<void> completer}) current = _currentRender!;
