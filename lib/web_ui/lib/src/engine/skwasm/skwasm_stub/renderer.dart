...
class SkwasmRenderer implements Renderer {
  ...
  @override
  ui.ImageShader createImageShader(ui.Image image, ui.TileMode tmx,
      ui.TileMode tmy, Float64List matrix4, ui.FilterQuality? filterQuality) {
    throw UnimplementedError('Skwasm not implemented on this platform.');
  }
  ...
  Future<ui.Codec> instantiateImageCodec(Uint8List list,
      {int? targetWidth, int? targetHeight, bool allowUpscaling = true}) {
    throw UnimplementedError('Skwasm not implemented on this platform.');
  }
  ...
  @override
  ui.Image createImageFromTextureSource(JSAny object,
      {required int width,
      required int height,
