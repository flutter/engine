...
@Native<TextStyleHandle Function(TextStyleHandle)>(
    symbol: 'textStyle_copy', isLeaf: true)
external TextStyleHandle textStyleCopy(TextStyleHandle handle);

@Native<Void Function(TextStyleHandle)>(
    symbol: 'textStyle_dispose', isLeaf: true)
external void textStyleDispose(TextStyleHandle handle);

@Native<Void Function(TextStyleHandle, Int32)>(
    symbol: 'textStyle_setColor', isLeaf: true)
external void textStyleSetColor(TextStyleHandle handle, int color);

@Native<Void Function(TextStyleHandle, Int)>(
    symbol: 'textStyle_setDecoration', isLeaf: true)
external void textStyleSetDecoration(TextStyleHandle handle, int decoration);

@Native<Void Function(TextStyleHandle, Int32)>(
    symbol: 'textStyle_setDecorationColor', isLeaf: true)
external void textStyleSetDecorationColor(
    TextStyleHandle handle, int decorationColor);

@Native<Void Function(TextStyleHandle, Int)>(
    symbol: 'textStyle_setDecorationStyle', isLeaf: true)
external void textStyleSetDecorationStyle(
    TextStyleHandle handle, int decorationStyle);

@Native<Void Function(TextStyleHandle, Float)>(
    symbol: 'textStyle_setDecorationThickness', isLeaf: true)
external void textStyleSetDecorationThickness(
    TextStyleHandle handle, double decorationThickness);

@Native<Void Function(TextStyleHandle, Int, Int)>(
    symbol: 'textStyle_setFontStyle', isLeaf: true)
external void textStyleSetFontStyle(
    TextStyleHandle handle, int weight, int slant);

@Native<Void Function(TextStyleHandle, Int)>(
    symbol: 'textStyle_setTextBaseline', isLeaf: true)
external void textStyleSetTextBaseline(TextStyleHandle handle, int baseline);

@Native<Void Function(TextStyleHandle)>(
    symbol: 'textStyle_clearFontFamilies', isLeaf: true)
...
external void textStyleAddFontFamilies(
    TextStyleHandle handle, Pointer<SkStringHandle> families, int count);

@Native<Void Function(TextStyleHandle, Float)>(
    symbol: 'textStyle_setFontSize', isLeaf: true)
external void textStyleSetFontSize(TextStyleHandle handle, double size);

@Native<Void Function(TextStyleHandle, Float)>(
    symbol: 'textStyle_setLetterSpacing', isLeaf: true)
external void textStyleSetLetterSpacing(TextStyleHandle handle, double spacing);

@Native<Void Function(TextStyleHandle, Float)>(
    symbol: 'textStyle_setWordSpacing', isLeaf: true)
external void textStyleSetWordSpacing(TextStyleHandle handle, double spacing);

@Native<Void Function(TextStyleHandle, Float)>(
    symbol: 'textStyle_setHeight', isLeaf: true)
external void textStyleSetHeight(TextStyleHandle handle, double height);

@Native<Void Function(TextStyleHandle, Bool)>(
    symbol: 'textStyle_setHalfLeading', isLeaf: true)
external void textStyleSetHalfLeading(TextStyleHandle handle, bool halfLeading);

@Native<Void Function(TextStyleHandle, SkStringHandle)>(
    symbol: 'textStyle_setLocale', isLeaf: true)
...
@Native<Void Function(TextStyleHandle, PaintHandle)>(
    symbol: 'textStyle_setBackground', isLeaf: true)
external void textStyleSetBackground(TextStyleHandle handle, PaintHandle paint);

@Native<Void Function(TextStyleHandle, PaintHandle)>(
    symbol: 'textStyle_setForeground', isLeaf: true)
