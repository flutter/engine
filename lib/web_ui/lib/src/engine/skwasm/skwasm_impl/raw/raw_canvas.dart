...
@Native<Void Function(CanvasHandle, RawRect, PaintHandle)>(symbol: 'canvas_saveLayer', isLeaf: true)
...
@Native<Void Function(CanvasHandle, Float, Float, Float, Float, PaintHandle)>(symbol: 'canvas_drawLine', isLeaf: true)
...
@Native<Void Function(CanvasHandle, RawRRect, PaintHandle)>(symbol: 'canvas_drawRRect', isLeaf: true)
external void canvasDrawRRect(
    CanvasHandle canvas, RawRRect rrect, PaintHandle paint);

@Native<Void Function(CanvasHandle, RawRRect, RawRRect, PaintHandle)>(symbol: 'canvas_drawDRRect', isLeaf: true)
...
@Native<Void Function(CanvasHandle, Float, Float, Float, PaintHandle)>(symbol: 'canvas_drawCircle', isLeaf: true)
external void canvasDrawCircle(CanvasHandle canvas, double x, double y,
    double radius, PaintHandle paint);

@Native<Void Function(CanvasHandle, RawRect, Float, Float, Bool, PaintHandle)>(symbol: 'canvas_drawCircle', isLeaf: true)
...
@Native<Void Function(CanvasHandle, PathHandle, PaintHandle)>(symbol: 'canvas_drawPath', isLeaf: true)
