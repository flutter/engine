...
@Native<ImageFilterHandle Function(Float, Float)>(
  symbol: 'imageFilter_createDilate',
  isLeaf: true,
)
...
@Native<ImageFilterHandle Function(Float, Float)>(
  symbol: 'imageFilter_createErode',
  isLeaf: true,
)
...
@Native<Void Function(ImageFilterHandle)>(
  symbol: 'imageFilter_dispose',
  isLeaf: true,
)
...
external void imageFilterGetFilterBounds(
  ImageFilterHandle handle,
  RawIRect inOutRect,
);

@Native<ColorFilterHandle Function(Int, Int)>(
  symbol: 'colorFilter_createMode',
  isLeaf: true,
)
...
@Native<ColorFilterHandle Function()>(
  symbol: 'colorFilter_createSRGBToLinearGamma',
  isLeaf: true,
)
external ColorFilterHandle colorFilterCreateSRGBToLinearGamma();

@Native<ColorFilterHandle Function()>(
  symbol: 'colorFilter_createLinearToSRGBGamma',
  isLeaf: true,
)
...
@Native<Void Function(ColorFilterHandle)>(
  symbol: 'colorFilter_dispose',
  isLeaf: true,
)
external void colorFilterDispose(ColorFilterHandle handle);

@Native<MaskFilterHandle Function(Int, Float)>(
  symbol: 'maskFilter_createBlur',
  isLeaf: true,
)
external MaskFilterHandle maskFilterCreateBlur(int blurStyle, double sigma);

@Native<Void Function(MaskFilterHandle)>(
  symbol: 'maskFilter_dispose',
  isLeaf: true,
)
