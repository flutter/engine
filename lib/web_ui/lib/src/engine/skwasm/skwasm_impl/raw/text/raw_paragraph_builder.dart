...
@Native<
  ParagraphBuilderHandle Function(ParagraphStyleHandle, FontCollectionHandle)
...
@Native<Void Function(ParagraphBuilderHandle)>(
  symbol: 'paragraphBuilder_dispose',
  isLeaf: true,
)
