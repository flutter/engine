...
@Native<
    ParagraphBuilderHandle Function(
...
@Native<Void Function(ParagraphBuilderHandle)>(
    symbol: 'paragraphBuilder_dispose', isLeaf: true)
...
external Pointer<Uint8> paragraphBuilderGetUtf8Text(
    ParagraphBuilderHandle handle, Pointer<Uint32> outSize);
...
external Pointer<Uint32> unicodePositionBufferGetDataPointer(
    UnicodePositionBufferHandle handle);
...
external Pointer<LineBreak> lineBreakBufferGetDataPointer(
    LineBreakBufferHandle handle);
