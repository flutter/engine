...
class _WebGlRenderer implements GlRenderer {
  ...
  void drawVertices(
    ...
    final Object positionAttributeLocation = gl.getAttributeLocation(
      glProgram.program,
      'position',
    );
    ...
    if (imageShader == null) {
      ...
      final Object colorLoc = gl.getAttributeLocation(
        glProgram.program,
        'color',
      );
      vertexAttribPointerGlContext(
  ...
  void drawRectToGl(
    ...
    final Object resolution = gl.getUniformLocation(
      glProgram.program,
      'u_scale',
    );
    gl.setUniform4f(
    ...
    gl.drawElements(
      gl.kTriangles,
      VertexShaders.vertexIndicesForRect.length,
      gl.kUnsignedShort,
    );
  }
