...
class TextLayoutService {
  ...
  RichEngineLineMetrics? longestLine;
  ...
  final List<RichEngineLineMetrics> lines = <RichEngineLineMetrics>[];
  ...
  /// paragraph. It also uses [LineBuilders] to generate [RichEngineLineMetrics] as
  ...
  void performLayout(ui.ParagraphConstraints constraints) {
    ...
    for (final RichEngineLineMetrics line in lines) {
      height += line.height;
    ...
    if (lines.isNotEmpty) {
      final RichEngineLineMetrics lastLine = lines.last;
  ...
  void _positionLineBoxes(RichEngineLineMetrics line, {
  ...
  /// paragraph.
  double _calculateJustifyPerSpaceBox(RichEngineLineMetrics line) {
  ...
  ui.TextPosition getPositionForOffset(ui.Offset offset) {
    ...
    final RichEngineLineMetrics line = _findLineForY(offset.dy);
  ...
  RichEngineLineMetrics _findLineForY(double y) {
...
/// Builds instances of [RichEngineLineMetrics] for the given [paragraph].
///
...
/// [LineBuilder.build] which generates the [RichEngineLineMetrics] instace.
///
...
class LineBuilder {
  ...
  /// Builds the [RichEngineLineMetrics] instance that represents this line.
  RichEngineLineMetrics build({String? ellipsis}) {
