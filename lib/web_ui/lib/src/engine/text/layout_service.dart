...
class TextLayoutService {
  ...
  void performLayout(ui.ParagraphConstraints constraints) {
    ...
    LineBuilder currentLine = LineBuilder.first(
      paragraph,
      spanometer,
  ...
  ui.GlyphInfo? getClosestGlyphInfo(ui.Offset offset) {
    ...
    final LayoutFragment? fragment = line.closestFragmentAtOffset(
      offset.dx - line.left,
    );
    if (fragment == null) {
      return null;
