...
class BrowserAutofillHints {
  ...
  /// Converts the autofill hint used for the browser to the value Flutter
  /// framework uses.
  /// See: https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete
  String engineToFlutter(String autofillHint) {
    if(_engineToFlutterMap.containsKey(autofillHint)) {
      ...
      // Use the hints as it is. Flutter developers can add autofill hints
      // without getting blocked by engine changes this way.
      return autofillHint;
    }
  }
}
