...
class AppBootstrap {
  ...
  /// Creates an engine initializer that calls initEngine, and then runApp.
  FlutterEngineInitializer prepareAutomaticEngineInitializer() {
    return AutomaticFlutterEngineInitializer(initializeEngine: allowInterop((InitializeEngineFnParameters? params) {
  ...
  FlutterEngineInitializer prepareCustomEngineInitializer() {
    ...
    return CustomFlutterEngineInitializer(initializeEngine: allowInterop((InitializeEngineFnParameters? params) {
