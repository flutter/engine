...
class ContextStateHandle {
  ...
  void setUpPaint(SurfacePaintData paint, ui.Rect? shaderBounds) {
    ...
    if (paint.shader != null) {
      ...
      } else if (paint.shader is ImageShader) {
        strokeStyle = '';
        fillStyle = _imageShaderToFillPattern(paint.shader as ImageShader);
      }
  ...
  String _tileModeToHtmlRepeatAttribute(ui.TileMode tileModeX,
    ...
    String patternTileMode = 'no-repeat';
  ...
  dynamic _imageShaderToFillPattern(ImageShader imageShader) {
    final ui.TileMode tileX = imageShader.tileModeX;
    final ui.TileMode tileY = imageShader.tileModeY;
    print('creating pattern with ${_tileModeToHtmlRepeatAttribute(tileX, tileY)}');
    return context.createPattern(
        //_resolveTiledImageSource(imageShader._image, tileX, tileY)!,
