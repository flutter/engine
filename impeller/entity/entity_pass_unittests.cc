...
//   Rect()); EXPECT_EQ(recorder.GetReplayEntities().size(), 1u);

//   recorder.RecordEntity(entity, Contents::ClipCoverage::Type::kRestore,
//   Rect()); EXPECT_TRUE(recorder.GetReplayEntities().empty());
// }
...
// // Since clip entities return the outer coverage we can only cull axis
// aligned
...
//     EXPECT_FALSE(result.should_render);
//     EXPECT_FALSE(result.clip_did_change);
//     EXPECT_EQ(recorder.CurrentClipCoverage(), Rect::MakeLTRB(0, 0, 100,
//     100));
//   }
// }
