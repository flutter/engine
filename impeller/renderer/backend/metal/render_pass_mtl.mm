...
void PassBindingsCache::SetEncoder(id<MTLRenderCommandEncoder> encoder) {
  encoder_ = encoder;
}

void PassBindingsCache::SetRenderPipelineState(
...
void PassBindingsCache::SetDepthStencilState(
...
bool PassBindingsCache::SetBuffer(ShaderStage stage,
                                  uint64_t index,
                                  uint64_t offset,
                                  id<MTLBuffer> buffer) {
...
bool PassBindingsCache::SetTexture(ShaderStage stage,
                                   uint64_t index,
...
bool PassBindingsCache::SetSampler(ShaderStage stage,
                                   uint64_t index,
...
void PassBindingsCache::SetViewport(const Viewport& viewport) {
...
void PassBindingsCache::SetScissor(const IRect& scissor) {
