...
3. Start RenderDoc and (if necessary) select "Launch Application" button from the menu:
   ...
   ![Launch App](https://github.com/flutter/assets-for-api-docs/blob/5da33067f5cfc7f177d9c460d618397aad9082ca/assets/engine/impeller/renderdoc_frame_capture/launch-app.avif)
...
5. For the frame you wish to capture, press `F12`, you will now be able to see the frame capture and inspect the state:
   ...
   ![Renderdoc Capture](https://github.com/flutter/assets-for-api-docs/blob/5da33067f5cfc7f177d9c460d618397aad9082ca/assets/engine/impeller/renderdoc_frame_capture/render-doc-capture.avif)
