...
typedef void* NativeCursor;
typedef ax::ViewAndroid* NativeView;
typedef ax::WindowAndroid* NativeWindow;
...
#if defined(USE_AURA)
const ax::mojom::CursorType kNullCursor =
    static_cast<ax::mojom::CursorType>(-1);
#else
