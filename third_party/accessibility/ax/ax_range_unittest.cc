...
bool ContainerEQ(std::vector<SkRect> actual, std::vector<SkRect> expected) {
...
class TestAXRangeScreenRectDelegate : public AXRangeRectDelegate {
 public:
  ...
  SkRect GetInnerTextRangeBoundsRect(
      AXTreeID tree_id,
      AXNode::AXID node_id,
      int start_offset,
      int end_offset,
  ...
  SkRect GetBoundsRect(AXTreeID tree_id,
                       AXNode::AXID node_id,
                       AXOffscreenResult* offscreen_result) override {
    if (tree_manager_->GetTreeID() != tree_id)
      return SkRect();
...
class AXRangeTest : public testing::Test, public TestAXTreeManager {
 ...
 private:
  FML_DISALLOW_COPY_AND_ASSIGN(AXRangeTest);
};
...
void AXRangeTest::SetUp() {
  ...
  root_.role = ax::Role::kDialog;
  root_.AddState(ax::State::kFocusable);
  root_.SetName(ALL_TEXT);
  root_.relative_bounds.bounds = SkRect::MakeXYWH(0, 0, 800, 600);

  div1_.role = ax::Role::kGenericContainer;
  div1_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  ...
  button_.relative_bounds.bounds = SkRect::MakeXYWH(20, 20, 100, 30);
  button_.AddIntAttribute(ax::IntAttribute::kNextOnLineId, check_box1_.id);

  div2_.role = ax::Role::kGenericContainer;
  div2_.child_ids.push_back(check_box1_.id);
  div2_.child_ids.push_back(check_box2_.id);

  check_box1_.role = ax::Role::kCheckBox;
  check_box1_.SetCheckedState(ax::CheckedState::kTrue);
  check_box1_.SetName("Checkbox 1");
  check_box1_.relative_bounds.bounds = SkRect::MakeXYWH(120, 20, 30, 30);
  check_box1_.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId, button_.id);
  check_box1_.AddIntAttribute(ax::IntAttribute::kNextOnLineId, check_box2_.id);

  check_box2_.role = ax::Role::kCheckBox;
  check_box2_.SetCheckedState(ax::CheckedState::kTrue);
  check_box2_.SetName("Checkbox 2");
  check_box2_.relative_bounds.bounds = SkRect::MakeXYWH(150, 20, 30, 30);
  check_box2_.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                              check_box1_.id);
  ...
  inline_box1_.relative_bounds.bounds = SkRect::MakeXYWH(20, 50, 30, 30);
  ...
  inline_box1_.AddIntListAttribute(ax::IntListAttribute::kCharacterOffsets,
                                   character_offsets1);
  ...
  inline_box1_.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
                               line_break1_.id);

  line_break1_.role = ax::Role::kLineBreak;
  line_break1_.AddState(ax::State::kEditable);
  line_break1_.SetName(NEWLINE);
  line_break1_.relative_bounds.bounds = SkRect::MakeXYWH(50, 50, 0, 30);
  line_break1_.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                               inline_box1_.id);
  ...
  inline_box2_.relative_bounds.bounds = SkRect::MakeXYWH(20, 80, 42, 30);
  ...
  inline_box2_.AddIntListAttribute(ax::IntListAttribute::kCharacterOffsets,
                                   character_offsets2);
  ...
  inline_box2_.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                   std::vector<int32_t>{4, 6});
  inline_box2_.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
                               line_break2_.id);

  line_break2_.role = ax::Role::kLineBreak;
  line_break2_.AddState(ax::State::kEditable);
  line_break2_.SetName(NEWLINE);
  line_break2_.relative_bounds.bounds = SkRect::MakeXYWH(62, 80, 0, 30);
  line_break2_.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                               inline_box2_.id);

  paragraph_.role = ax::Role::kParagraph;
  paragraph_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  paragraph_.child_ids.push_back(static_text3_.id);
  root_.child_ids.push_back(paragraph_.id);

  static_text3_.role = ax::Role::kStaticText;
  static_text3_.SetName(AFTER_LINE);
  static_text3_.child_ids.push_back(inline_box3_.id);

  inline_box3_.role = ax::Role::kInlineTextBox;
  inline_box3_.SetName(AFTER_LINE);
  inline_box3_.relative_bounds.bounds = SkRect::MakeXYWH(20, 110, 50, 30);
  ...
  inline_box3_.AddIntListAttribute(ax::IntListAttribute::kCharacterOffsets,
                                   character_offsets3);
  inline_box3_.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                   std::vector<int32_t>{0});
  inline_box3_.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
...
TEST_F(AXRangeTest, GetTextWithWholeObjects) {
  ...
  // Button
  start = AXNodePosition::CreateTextPosition(GetTreeID(), button_.id,
                                             0 /* text_offset */,
                                             ax::TextAffinity::kDownstream);
  ASSERT_TRUE(start->IsTextPosition());
  end = AXNodePosition::CreateTextPosition(GetTreeID(), button_.id,
                                           BUTTON.length() /* text_offset */,
                                           ax::TextAffinity::kDownstream);
  ASSERT_TRUE(end->IsTextPosition());
  ...
  // text_field_
  start = AXNodePosition::CreateTextPosition(GetTreeID(), text_field_.id,
                                             0 /* text_offset */,
                                             ax::TextAffinity::kDownstream);
  ...
  // static_text1_
  start = AXNodePosition::CreateTextPosition(GetTreeID(), static_text1_.id,
                                             0 /* text_offset */,
                                             ax::TextAffinity::kDownstream);
  ASSERT_TRUE(start->IsTextPosition());
  end = AXNodePosition::CreateTextPosition(GetTreeID(), static_text1_.id,
                                           LINE_1.length() /* text_offset */,
                                           ax::TextAffinity::kDownstream);
  ASSERT_TRUE(end->IsTextPosition());
  ...
  // static_text2_
  start = AXNodePosition::CreateTextPosition(GetTreeID(), static_text2_.id,
                                             0 /* text_offset */,
                                             ax::TextAffinity::kDownstream);
  ASSERT_TRUE(start->IsTextPosition());
  end = AXNodePosition::CreateTextPosition(GetTreeID(), static_text2_.id,
                                           LINE_2.length() /* text_offset */,
                                           ax::TextAffinity::kDownstream);
  ASSERT_TRUE(end->IsTextPosition());
...
TEST_F(AXRangeTest, GetTextWithEmptyRanges) {
  ...
  start = AXNodePosition::CreateTextPosition(GetTreeID(), inline_box1_.id,
                                             0 /* text_offset */,
                                             ax::TextAffinity::kDownstream);
  ...
  start = AXNodePosition::CreateTextPosition(GetTreeID(), root_.id,
                                             0 /* text_offset */,
                                             ax::TextAffinity::kDownstream);
...
TEST_F(AXRangeTest, GetRects) {
  ...
  std::vector<SkRect> expected_screen_rects = {
      SkRect::MakeXYWH(20, 20, 100, 30)};
  EXPECT_TRUE(
  ...
  expected_screen_rects = {SkRect::MakeXYWH(120, 20, 30, 30)};
  EXPECT_TRUE(
  ...
  TestPositionRange button_check_box2_range(button->Clone(),
                                            check_box2->Clone());
  expected_screen_rects = {SkRect::MakeXYWH(20, 20, 100, 30),
                           SkRect::MakeXYWH(120, 20, 30, 30),
                           SkRect::MakeXYWH(150, 20, 30, 30)};
  ...
  expected_screen_rects = {SkRect::MakeXYWH(20, 50, 30, 30)};
  ...
  TestPositionRange line1_first_half_range(line1_start->Clone(),
                                           line1_middle->Clone());
  expected_screen_rects = {SkRect::MakeXYWH(20, 50, 15, 30)};
  ...
  TestPositionRange line1_second_half_range(line1_middle->Clone(),
                                            line1_end->Clone());
  expected_screen_rects = {SkRect::MakeXYWH(35, 50, 15, 30)};
  ...
  expected_screen_rects = {SkRect::MakeXYWH(25, 50, 20, 30)};
  EXPECT_TRUE(
  ...
  expected_screen_rects = {SkRect::MakeXYWH(20, 80, 42, 30)};
  ...
  TestPositionRange line2_first_half_range(line2_start->Clone(),
                                           line2_middle->Clone());
  expected_screen_rects = {SkRect::MakeXYWH(20, 80, 21, 30)};
  ...
  TestPositionRange line2_second_half_range(line2_middle->Clone(),
                                            line2_end->Clone());
  expected_screen_rects = {SkRect::MakeXYWH(41, 80, 21, 30)};
  ...
  expected_screen_rects = {SkRect::MakeXYWH(27, 80, 28, 30)};
  EXPECT_TRUE(
  ...
  TestPositionRange check_box2_line2_mid_range(check_box2->Clone(),
                                               line2_middle->Clone());
  expected_screen_rects = {SkRect::MakeXYWH(150, 20, 30, 30),
                           SkRect::MakeXYWH(20, 50, 30, 30),
                           SkRect::MakeXYWH(20, 80, 21, 30)};
  ...
  expected_screen_rects = {
      SkRect::MakeXYWH(20, 20, 100, 30), SkRect::MakeXYWH(120, 20, 30, 30),
      SkRect::MakeXYWH(150, 20, 30, 30), SkRect::MakeXYWH(20, 50, 30, 30),
      SkRect::MakeXYWH(20, 80, 42, 30),  SkRect::MakeXYWH(20, 110, 50, 30)};
...
TEST_F(AXRangeTest, GetRectsOffscreen) {
  ...
  new_root_node_data.relative_bounds.bounds = SkRect::MakeXYWH(0, 50, 800, 60);
  ...
  TestPositionRange entire_test_range(button->Clone(), after_line_end->Clone());
  std::vector<SkRect> expected_screen_rects = {
      SkRect::MakeXYWH(20, 50, 30, 30), SkRect::MakeXYWH(20, 80, 42, 30)};
  EXPECT_TRUE(ContainerEQ(entire_test_range.GetRects(&delegate),
                          expected_screen_rects));
