...
#ifndef ACCESSIBILITY_AX_AX_LANGUAGE_DETECTION_H_
#define ACCESSIBILITY_AX_AX_LANGUAGE_DETECTION_H_
...
class AX_EXPORT AXLanguageDetectionObserver : public ax::AXTreeObserver {
 public:
 ...
 private:
  void OnAtomicUpdateFinished(ax::AXTree* tree,
                              bool root_changed,
...
class AX_EXPORT AXLanguageDetectionManager {
 public:
  ...
  // GetLanguageAnnotationForStringAttribute(*node, ax::StringAttribute::
...
#endif  // ACCESSIBILITY_AX_AX_LANGUAGE_DETECTION_H_
