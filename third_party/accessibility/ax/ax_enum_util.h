...
AX_BASE_EXPORT ax::ActionFlags ParseActionFlags(
...
AX_BASE_EXPORT std::string ToLocalizedString(
    ax::DefaultActionVerb action_verb);
...
// ax::StringAttribute
AX_BASE_EXPORT const char* ToString(
    ax::StringAttribute string_attribute);
...
AX_BASE_EXPORT ax::IntAttribute ParseIntAttribute(
...
AX_BASE_EXPORT ax::BoolAttribute ParseBoolAttribute(
    const char* bool_attribute);

// ax::IntListAttribute
AX_BASE_EXPORT const char* ToString(
    ax::IntListAttribute int_list_attribute);
...
AX_BASE_EXPORT ax::MoveDirection ParseMoveDirection(
...
AX_BASE_EXPORT ax::TextBoundary ParseTextBoundary(
...
AX_BASE_EXPORT ax::TextPosition ParseTextPosition(
...
// ax::AriaCurrentState
AX_BASE_EXPORT const char* ToString(
    ax::AriaCurrentState aria_current_state);
...
AX_BASE_EXPORT ax::InvalidState ParseInvalidState(
...
AX_BASE_EXPORT ax::CheckedState ParseCheckedState(
    const char* checked_state);

// ax::SortDirection
AX_BASE_EXPORT const char* ToString(ax::SortDirection sort_direction);
AX_BASE_EXPORT ax::SortDirection ParseSortDirection(
...
AX_BASE_EXPORT ax::TextAffinity ParseTextAffinity(
