...
TEST(AXEventGeneratorTest, LoadCompleteSameTree) {
  ...
  initial_state.nodes[0].relative_bounds.bounds =
...
TEST(AXEventGeneratorTest, LoadCompleteNewTree) {
  ...
  load_complete_update.nodes[0].relative_bounds.bounds =
      SkRect::MakeXYWH(0, 0, 800, 600);
  load_complete_update.nodes[0].AddStringAttribute(ax::StringAttribute::kUrl,
                                                   "chrome-search://foo");
  load_complete_update.has_tree_data = true;
  load_complete_update.tree_data.loaded = true;
...
TEST(AXEventGeneratorTest, ExpandedAndRowCount) {
  ...
  initial_state.nodes[1].role = ax::Role::kTable;
  initial_state.nodes[1].child_ids.push_back(3);
  initial_state.nodes[2].id = 3;
  initial_state.nodes[2].role = ax::Role::kRow;
  initial_state.nodes[3].id = 4;
  initial_state.nodes[3].role = ax::Role::kPopUpButton;
  initial_state.nodes[3].AddState(ax::State::kExpanded);
  AXTree tree(initial_state);

  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[2].AddState(ax::State::kExpanded);
...
TEST(AXEventGeneratorTest, SelectedAndSelectedChildren) {
  ...
  initial_state.nodes[0].child_ids.push_back(4);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kMenu;
  initial_state.nodes[1].child_ids.push_back(3);
  initial_state.nodes[2].id = 3;
  initial_state.nodes[2].role = ax::Role::kMenuItem;
  initial_state.nodes[3].id = 4;
  initial_state.nodes[3].role = ax::Role::kListBoxOption;
  initial_state.nodes[3].AddBoolAttribute(ax::BoolAttribute::kSelected, true);
  AXTree tree(initial_state);

  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[2].AddBoolAttribute(ax::BoolAttribute::kSelected, true);
  update.nodes.pop_back();
  update.nodes.emplace_back();
  update.nodes[3].id = 4;
  update.nodes[3].role = ax::Role::kListBoxOption;
  update.nodes[3].AddBoolAttribute(ax::BoolAttribute::kSelected, false);
...
TEST(AXEventGeneratorTest, StringValueChanged) {
  ...
  initial_state.nodes.resize(1);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].role = ax::Role::kTextField;
  initial_state.nodes[0].AddStringAttribute(ax::StringAttribute::kValue,
                                            "Before");
  AXTree tree(initial_state);
  ...
  update.nodes[0].AddStringAttribute(ax::StringAttribute::kValue, "After");
...
TEST(AXEventGeneratorTest, FloatValueChanged) {
  ...
  initial_state.nodes.resize(1);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].role = ax::Role::kSlider;
  initial_state.nodes[0].AddFloatAttribute(ax::FloatAttribute::kValueForRange,
                                           1.0);
  AXTree tree(initial_state);
  ...
  update.nodes[0].AddFloatAttribute(ax::FloatAttribute::kValueForRange, 2.0);
...
TEST(AXEventGeneratorTest, InvalidStatusChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].SetInvalidState(ax::InvalidState::kTrue);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, AddLiveRegionAttribute) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].AddStringAttribute(ax::StringAttribute::kLiveStatus,
                                     "polite");
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
  ...
  event_generator.ClearEvents();
  update.nodes[0].AddStringAttribute(ax::StringAttribute::kLiveStatus, "off");
...
TEST(AXEventGeneratorTest, CheckedStateChanged) {
  ...
  initial_state.nodes.resize(1);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].role = ax::Role::kCheckBox;
  AXTree tree(initial_state);

  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].SetCheckedState(ax::CheckedState::kTrue);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, ActiveDescendantChanged) {
  ...
  initial_state.nodes[0].AddIntAttribute(ax::IntAttribute::kActivedescendantId,
                                         2);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kListBoxOption;
  initial_state.nodes[2].id = 3;
  initial_state.nodes[2].role = ax::Role::kListBoxOption;
  AXTree tree(initial_state);
...
TEST(AXEventGeneratorTest, CreateAlertAndLiveRegion) {
  ...
  update.nodes[1].id = 2;
  update.nodes[1].AddStringAttribute(ax::StringAttribute::kLiveStatus,
                                     "polite");
...
TEST(AXEventGeneratorTest, LiveRegionChanged) {
  ...
  initial_state.nodes.resize(3);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].AddStringAttribute(ax::StringAttribute::kLiveStatus,
                                            "polite");
  initial_state.nodes[0].AddStringAttribute(
      ax::StringAttribute::kContainerLiveStatus, "polite");
  initial_state.nodes[0].child_ids.push_back(2);
  initial_state.nodes[0].child_ids.push_back(3);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kStaticText;
  initial_state.nodes[1].AddStringAttribute(
      ax::StringAttribute::kContainerLiveStatus, "polite");
  initial_state.nodes[1].AddStringAttribute(ax::StringAttribute::kName,
                                            "Before 1");
  initial_state.nodes[2].id = 3;
  initial_state.nodes[2].role = ax::Role::kStaticText;
  initial_state.nodes[2].AddStringAttribute(
      ax::StringAttribute::kContainerLiveStatus, "polite");
  initial_state.nodes[2].AddStringAttribute(ax::StringAttribute::kName,
                                            "Before 2");
  AXTree tree(initial_state);
  ...
  update.nodes[1].AddStringAttribute(ax::StringAttribute::kContainerLiveStatus,
                                     "polite");
  update.nodes[1].AddStringAttribute(ax::StringAttribute::kName, "After 1");
  update.nodes[2].string_attributes.clear();
  update.nodes[2].AddStringAttribute(ax::StringAttribute::kContainerLiveStatus,
                                     "polite");
  update.nodes[2].AddStringAttribute(ax::StringAttribute::kName, "After 2");
...
TEST(AXEventGeneratorTest, LiveRegionOnlyTextChanges) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[1].AddStringAttribute(ax::StringAttribute::kDescription,
                                     "Description 1");
  update.nodes[2].SetCheckedState(ax::CheckedState::kTrue);
...
TEST(AXEventGeneratorTest, BusyLiveRegionChanged) {
  ...
  initial_state.nodes[0].AddStringAttribute(
      ax::StringAttribute::kContainerLiveStatus, "polite");
  initial_state.nodes[0].AddBoolAttribute(ax::BoolAttribute::kBusy, true);
  initial_state.nodes[0].child_ids.push_back(2);
  initial_state.nodes[0].child_ids.push_back(3);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kStaticText;
...
TEST(AXEventGeneratorTest, ScrollHorizontalPositionChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].AddIntAttribute(ax::IntAttribute::kScrollX, 10);
...
TEST(AXEventGeneratorTest, ScrollVerticalPositionChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].AddIntAttribute(ax::IntAttribute::kScrollY, 10);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
      HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, TextAttributeChanged) {
  ...
  initial_state.nodes[11].AddIntListAttribute(
      ax::IntListAttribute::kMarkerTypes,
      {static_cast<int32_t>(ax::MarkerType::kTextMatch)});
  initial_state.nodes[11].AddIntListAttribute(
      ax::IntListAttribute::kMarkerStarts, {5});
  initial_state.nodes[11].AddIntListAttribute(ax::IntListAttribute::kMarkerEnds,
                                              {10});
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[1].AddIntAttribute(ax::IntAttribute::kColor, 0);
  update.nodes[2].AddIntAttribute(ax::IntAttribute::kBackgroundColor, 0);
  update.nodes[3].AddIntAttribute(
      ax::IntAttribute::kTextDirection,
      static_cast<int32_t>(ax::WritingDirection::kRtl));
  update.nodes[4].AddIntAttribute(
      ax::IntAttribute::kTextPosition,
      static_cast<int32_t>(ax::TextPosition::kSuperscript));
  update.nodes[5].AddIntAttribute(ax::IntAttribute::kTextStyle,
                                  static_cast<int32_t>(ax::TextStyle::kBold));
  update.nodes[6].AddIntAttribute(
      ax::IntAttribute::kTextOverlineStyle,
      static_cast<int32_t>(ax::TextDecorationStyle::kSolid));
  update.nodes[7].AddIntAttribute(
      ax::IntAttribute::kTextStrikethroughStyle,
      static_cast<int32_t>(ax::TextDecorationStyle::kWavy));
  update.nodes[8].AddIntAttribute(
      ax::IntAttribute::kTextUnderlineStyle,
      static_cast<int32_t>(ax::TextDecorationStyle::kDotted));
  update.nodes[9].AddIntListAttribute(
      ax::IntListAttribute::kMarkerTypes,
      {static_cast<int32_t>(ax::MarkerType::kSpelling)});
  update.nodes[10].AddIntListAttribute(
      ax::IntListAttribute::kMarkerTypes,
      {static_cast<int32_t>(ax::MarkerType::kGrammar)});
  update.nodes[11].AddIntListAttribute(ax::IntListAttribute::kMarkerEnds, {11});
  ...
  update.nodes[13].AddIntListAttribute(
      ax::IntListAttribute::kMarkerTypes,
      {static_cast<int32_t>(ax::MarkerType::kSuggestion)});
  update.nodes[14].AddFloatAttribute(ax::FloatAttribute::kFontSize, 12.0f);
  update.nodes[15].AddFloatAttribute(ax::FloatAttribute::kFontWeight, 600.0f);
  update.nodes[16].AddStringAttribute(ax::StringAttribute::kFontFamily, "sans");
...
TEST(AXEventGeneratorTest, ObjectAttributeChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[1].AddIntAttribute(ax::IntAttribute::kTextAlign, 2);
  update.nodes[2].AddFloatAttribute(ax::FloatAttribute::kTextIndent, 10.0f);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
      HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, OtherAttributeChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[1].AddStringAttribute(ax::StringAttribute::kLanguage, "de");
  update.nodes[2].AddIntAttribute(ax::IntAttribute::kAriaCellColumnIndex, 7);
  update.nodes[3].AddFloatAttribute(ax::FloatAttribute::kFontSize, 12.0f);
  update.nodes[4].AddBoolAttribute(ax::BoolAttribute::kModal, true);
  std::vector<int> ids = {2};
  update.nodes[5].AddIntListAttribute(ax::IntListAttribute::kControlsIds, ids);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, NameChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[1].AddStringAttribute(ax::StringAttribute::kName, "Hello");
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
      HasEvent(event_generator, AXEventGenerator::Event::NAME_CHANGED, 2));
}
...
TEST(AXEventGeneratorTest, DescriptionChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].AddStringAttribute(ax::StringAttribute::kDescription,
                                     "Hello");
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, MenuItemSelected) {
  ...
  initial_state.nodes[0].AddIntAttribute(ax::IntAttribute::kActivedescendantId,
                                         2);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kMenuListOption;
  initial_state.nodes[2].id = 3;
...
TEST(AXEventGeneratorTest, NodeBecomesIgnored) {
  ...
  initial_state.nodes[0].child_ids.push_back(2);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kArticle;
  initial_state.nodes[1].child_ids.push_back(3);
  initial_state.nodes[2].id = 3;
  ...
  initial_state.nodes[3].id = 4;
  initial_state.nodes[3].role = ax::Role::kGroup;
  initial_state.nodes[3].child_ids.push_back(5);
  initial_state.nodes[4].id = 5;
  initial_state.nodes[4].role = ax::Role::kStaticText;
...
TEST(AXEventGeneratorTest, NodeBecomesUnignored) {
  ...
  initial_state.nodes[3].id = 4;
  initial_state.nodes[3].role = ax::Role::kGroup;
  initial_state.nodes[3].AddState(ax::State::kIgnored);
  initial_state.nodes[3].child_ids.push_back(5);
  initial_state.nodes[4].id = 5;
  initial_state.nodes[4].role = ax::Role::kStaticText;
...
TEST(AXEventGeneratorTest, SubtreeBecomesUnignored) {
  ...
  update.nodes[2].RemoveState(ax::State::kIgnored);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
      HasEvent(event_generator, AXEventGenerator::Event::CHILDREN_CHANGED, 1));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly1) {
  ...
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].role = ax::Role::kRootWebArea;
  initial_state.nodes[0].AddState(ax::State::kIgnored);
  initial_state.nodes[0].child_ids = {2, 3};
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly2) {
  ...
  AXTreeUpdate update = initial_state;
  update.nodes[2].AddState(ax::State::kIgnored);
  update.nodes[3].RemoveState(ax::State::kIgnored);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
      HasEvent(event_generator, AXEventGenerator::Event::CHILDREN_CHANGED, 2));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly4) {
  ...
  initial_state.nodes[4].id = 5;
  initial_state.nodes[4].role = ax::Role::kGroup;
  initial_state.nodes[4].child_ids = {6, 7, 8};

  initial_state.nodes[5].id = 6;
  initial_state.nodes[5].role = ax::Role::kStaticText;
  initial_state.nodes[5].AddState(ax::State::kIgnored);

  initial_state.nodes[6].id = 7;
  initial_state.nodes[6].role = ax::Role::kStaticText;
  initial_state.nodes[6].AddState(ax::State::kIgnored);

  initial_state.nodes[7].id = 8;
  initial_state.nodes[7].role = ax::Role::kStaticText;

  AXTree tree(initial_state);

  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[5].RemoveState(ax::State::kIgnored);
  update.nodes[6].RemoveState(ax::State::kIgnored);
  update.nodes[7].AddState(ax::State::kIgnored);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly5) {
  ...
  update.nodes[0].AddState(ax::State::kIgnored);
  update.nodes[5].RemoveState(ax::State::kIgnored);
  update.nodes[6].AddState(ax::State::kIgnored);
  update.nodes[7].AddState(ax::State::kIgnored);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
      HasEvent(event_generator, AXEventGenerator::Event::CHILDREN_CHANGED, 5));
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly6) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].RemoveState(ax::State::kIgnored);
  update.nodes[5].RemoveState(ax::State::kIgnored);
  update.nodes[6].RemoveState(ax::State::kIgnored);
  update.nodes[7].AddState(ax::State::kIgnored);
  ASSERT_TRUE(tree.Unserialize(update));
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly7) {
  ...
  initial_state.nodes[4].id = 5;
  initial_state.nodes[4].role = ax::Role::kStaticText;
  initial_state.nodes[4].AddState(ax::State::kIgnored);
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly8) {
  ...
  update.nodes[2].RemoveState(ax::State::kIgnored);
  update.nodes[3].RemoveState(ax::State::kIgnored);
  update.nodes[4].RemoveState(ax::State::kIgnored);
  update.nodes[5].RemoveState(ax::State::kIgnored);
  update.nodes[6].AddState(ax::State::kIgnored);
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, ImageAnnotationChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].AddStringAttribute(ax::StringAttribute::kImageAnnotation,
                                     "Hello");
  ASSERT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, ImageAnnotationStatusChanged) {
  ...
  update.nodes[0].SetImageAnnotationStatus(
      ax::ImageAnnotationStatus::kAnnotationSucceeded);
...
TEST(AXEventGeneratorTest, StringPropertyChanges) {
  ...
  struct {
    ax::StringAttribute id;
    std::string old_value;
    std::string new_value;
  } attributes[] = {
      {ax::StringAttribute::kAccessKey, "a", "b"},
      {ax::StringAttribute::kClassName, "a", "b"},
      {ax::StringAttribute::kKeyShortcuts, "a", "b"},
      {ax::StringAttribute::kLanguage, "a", "b"},
      {ax::StringAttribute::kPlaceholder, "a", "b"},
  };
...
TEST(AXEventGeneratorTest, IntPropertyChanges) {
  ...
  struct {
    ...
    int new_value;
      ...
      {ax::IntAttribute::kHierarchicalLevel, 1, 2},
      {ax::IntAttribute::kPosInSet, 1, 2},
      {ax::IntAttribute::kSetSize, 1, 2},
  };
  for (auto&& attrib : attributes) {
    initial_state.nodes.push_back({});
    initial_state.nodes.back().id = initial_state.nodes.size();
...
TEST(AXEventGeneratorTest, IntListPropertyChanges) {
  ...
  struct {
    ax::IntListAttribute id;
    std::vector<int> old_value;
    std::vector<int> new_value;
  } attributes[] = {
      {ax::IntListAttribute::kDescribedbyIds, {1}, {2}},
      {ax::IntListAttribute::kFlowtoIds, {1}, {2}},
      {ax::IntListAttribute::kLabelledbyIds, {1}, {2}},
  };
  for (auto&& attrib : attributes) {
    initial_state.nodes.push_back({});
    initial_state.nodes.back().id = initial_state.nodes.size();
...
TEST(AXEventGeneratorTest, AriaBusyChanged) {
  ...
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[0].AddBoolAttribute(ax::BoolAttribute::kBusy, false);
...
TEST(AXEventGeneratorTest, MultiselectableStateChanged) {
  ...
  initial_state.nodes.resize(1);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].role = ax::Role::kGrid;

  AXTree tree(initial_state);
  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;

  update.nodes[0].AddState(ax::State::kMultiselectable);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, RequiredStateChanged) {
  ...
  update.nodes[0].AddState(ax::State::kRequired);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, FlowToChanged) {
  ...
  initial_state.nodes.resize(6);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].role = ax::Role::kGenericContainer;
  initial_state.nodes[0].child_ids.assign({2, 3, 4, 5, 6});
  initial_state.nodes[1].id = 2;
  initial_state.nodes[1].role = ax::Role::kGenericContainer;
  initial_state.nodes[1].AddIntListAttribute(ax::IntListAttribute::kFlowtoIds,
                                             {3, 4});
  initial_state.nodes[2].id = 3;
  ...
  initial_state.nodes[4].id = 5;
  initial_state.nodes[4].role = ax::Role::kGenericContainer;
  initial_state.nodes[5].id = 6;
  initial_state.nodes[5].role = ax::Role::kGenericContainer;

  AXTree tree(initial_state);

  AXEventGenerator event_generator(&tree);
  AXTreeUpdate update = initial_state;
  update.nodes[1].AddIntListAttribute(ax::IntListAttribute::kFlowtoIds,
                                      {4, 5, 6});
...
TEST(AXEventGeneratorTest, ControlsChanged) {
  ...
  std::vector<int> ids = {2};
  update.nodes[0].AddIntListAttribute(ax::IntListAttribute::kControlsIds, ids);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, AtomicChanged) {
  ...
  update.nodes[0].AddBoolAttribute(ax::BoolAttribute::kLiveAtomic, true);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, DropeffectChanged) {
  ...
  update.nodes[0].AddDropeffect(ax::Dropeffect::kCopy);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, GrabbedChanged) {
  ...
  update.nodes[0].AddBoolAttribute(ax::BoolAttribute::kGrabbed, true);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, HasPopupChanged) {
  ...
  update.nodes[0].SetHasPopup(ax::HasPopup::kTrue);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(
...
TEST(AXEventGeneratorTest, LiveRelevantChanged) {
  ...
  update.nodes[0].AddStringAttribute(ax::StringAttribute::kLiveRelevant, "all");
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
...
TEST(AXEventGeneratorTest, MultilineStateChanged) {
  ...
  update.nodes[0].AddState(ax::State::kMultiline);
  EXPECT_TRUE(tree.Unserialize(update));
  EXPECT_TRUE(HasEvent(event_generator,
