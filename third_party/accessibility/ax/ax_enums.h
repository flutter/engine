...
#ifndef ACCESSIBILITY_AX_AX_ENUMS_H_
#define ACCESSIBILITY_AX_AX_ENUMS_H_
...
enum class StringAttribute {
  ...
  // ax::Role::kImage. See kImageAnnotationStatus, too.
  kImageAnnotation,
  kImageDataUrl,
  kInnerHtml,
  kInputType,
...
// For internal use by ax::AXTreeID / ax::AXTreeID.
