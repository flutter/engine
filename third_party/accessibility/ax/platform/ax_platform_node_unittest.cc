...
void AXPlatformNodeTest::Init(
  ...
  static ax::AXNodeData empty_data;
...
AXTreeUpdate AXPlatformNodeTest::BuildTextField() {
  ...
  text_field_node.role = ax::Role::kTextField;
  text_field_node.AddState(ax::State::kEditable);
...
AXTreeUpdate AXPlatformNodeTest::BuildTextFieldWithSelectionRange(
  ...
  text_field_node.role = ax::Role::kTextField;
  text_field_node.AddState(ax::State::kEditable);
  text_field_node.AddBoolAttribute(ax::BoolAttribute::kSelected, true);
  text_field_node.AddIntAttribute(ax::IntAttribute::kTextSelStart, start);
  text_field_node.AddIntAttribute(ax::IntAttribute::kTextSelEnd, stop);
  text_field_node.SetValue("How now brown cow.");
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditable() {
  ...
  content_editable_node.role = ax::Role::kGroup;
  content_editable_node.AddState(ax::State::kRichlyEditable);
  content_editable_node.AddBoolAttribute(ax::BoolAttribute::kEditableRoot,
                                         true);
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditableWithSelectionRange(
  ...
  content_editable_node.role = ax::Role::kGroup;
  content_editable_node.AddState(ax::State::kRichlyEditable);
  content_editable_node.AddBoolAttribute(ax::BoolAttribute::kSelected, true);
  content_editable_node.AddBoolAttribute(ax::BoolAttribute::kEditableRoot,
                                         true);
  content_editable_node.SetValue("How now brown cow.");
...
AXTreeUpdate AXPlatformNodeTest::AXPlatformNodeTest::Build3X3Table() {
  ...
  */
  ...
  table.AddIntAttribute(ax::IntAttribute::kTableRowCount, 3);
  table.AddIntAttribute(ax::IntAttribute::kTableColumnCount, 3);
  ...
  table_row_header.role = ax::Role::kRow;
  ...
  table_column_header_1.role = ax::Role::kColumnHeader;
  table_column_header_1.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex,
                                        0);
  table_column_header_1.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex,
                                        0);

  AXNodeData table_column_header_2;
  table_column_header_2.id = 52;
  table_column_header_2.role = ax::Role::kColumnHeader;
  table_column_header_2.SetName("column header 1");
  table_column_header_2.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex,
                                        0);
  table_column_header_2.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex,
                                        1);

  AXNodeData table_column_header_3;
  table_column_header_3.id = 53;
  table_column_header_3.role = ax::Role::kColumnHeader;
  // Either ax::StringAttribute::kName -or-
  // ax::StringAttribute::kDescription is acceptable for a description
  table_column_header_3.AddStringAttribute(ax::StringAttribute::kDescription,
                                           "column header 2");
  table_column_header_3.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex,
                                        0);
  table_column_header_3.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex,
                                        2);

  // Row 1
  AXNodeData table_row_1;
  table_row_1.id = 2;
  table_row_1.role = ax::Role::kRow;

  AXNodeData table_row_header_1;
  table_row_header_1.id = 3;
  table_row_header_1.role = ax::Role::kRowHeader;
  table_row_header_1.SetName("row header 1");
  table_row_header_1.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex, 1);
  table_row_header_1.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex,
                                     0);
  table_row_1.child_ids.push_back(table_row_header_1.id);

  AXNodeData table_cell_1;
  table_cell_1.id = 4;
  table_cell_1.role = ax::Role::kCell;
  table_cell_1.SetName("1");
  table_cell_1.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex, 1);
  table_cell_1.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex, 1);
  table_row_1.child_ids.push_back(table_cell_1.id);

  AXNodeData table_cell_2;
  table_cell_2.id = 5;
  table_cell_2.role = ax::Role::kCell;
  table_cell_2.SetName("2");
  table_cell_2.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex, 1);
  table_cell_2.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex, 2);
  table_row_1.child_ids.push_back(table_cell_2.id);

  // Row 2
  AXNodeData table_row_2;
  table_row_2.id = 10;
  table_row_2.role = ax::Role::kRow;

  AXNodeData table_row_header_2;
  table_row_header_2.id = 11;
  table_row_header_2.role = ax::Role::kRowHeader;
  // Either ax::StringAttribute::kName -or-
  // ax::StringAttribute::kDescription is acceptable for a description
  table_row_header_2.AddStringAttribute(ax::StringAttribute::kDescription,
                                        "row header 2");
  table_row_header_2.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex, 2);
  table_row_header_2.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex,
                                     0);
  table_row_2.child_ids.push_back(table_row_header_2.id);

  AXNodeData table_cell_3;
  table_cell_3.id = 12;
  table_cell_3.role = ax::Role::kCell;
  table_cell_3.SetName("3");
  table_cell_3.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex, 2);
  table_cell_3.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex, 1);
  table_row_2.child_ids.push_back(table_cell_3.id);

  AXNodeData table_cell_4;
  table_cell_4.id = 13;
  table_cell_4.role = ax::Role::kCell;
  table_cell_4.SetName("4");
  table_cell_4.AddIntAttribute(ax::IntAttribute::kTableCellRowIndex, 2);
  table_cell_4.AddIntAttribute(ax::IntAttribute::kTableCellColumnIndex, 2);
...
AXTreeUpdate AXPlatformNodeTest::BuildAriaColumnAndRowCountGrids() {
  AXNodeData root;
  root.id = 1;
  root.role = ax::Role::kNone;

  // Empty Grid
  AXNodeData empty_grid;
  empty_grid.id = 2;
  empty_grid.role = ax::Role::kGrid;
  ...
  rowcolindex_grid.role = ax::Role::kGrid;
  root.child_ids.push_back(rowcolindex_grid.id);

  AXNodeData rowcolindex_row;
  rowcolindex_row.id = 4;
  rowcolindex_row.role = ax::Role::kRow;
  rowcolindex_grid.child_ids.push_back(rowcolindex_row.id);

  AXNodeData rowcolindex_cell;
  rowcolindex_cell.id = 5;
  rowcolindex_cell.role = ax::Role::kCell;
  rowcolindex_cell.AddIntAttribute(ax::IntAttribute::kAriaCellColumnIndex, 5);
  rowcolindex_cell.AddIntAttribute(ax::IntAttribute::kAriaCellRowIndex, 4);
  ...
  rowcolcount_grid.role = ax::Role::kGrid;
  rowcolcount_grid.AddIntAttribute(ax::IntAttribute::kAriaRowCount, 2);
  rowcolcount_grid.AddIntAttribute(ax::IntAttribute::kAriaColumnCount, 3);
  root.child_ids.push_back(rowcolcount_grid.id);

  // Grid that specifies aria-rowcount and aria-colcount are (-1)
  // ax::kUnknownAriaColumnOrRowCount
  AXNodeData unknown_grid;
  unknown_grid.id = 7;
  unknown_grid.role = ax::Role::kGrid;
  unknown_grid.AddIntAttribute(ax::IntAttribute::kAriaRowCount,
                               ax::kUnknownAriaColumnOrRowCount);
  unknown_grid.AddIntAttribute(ax::IntAttribute::kAriaColumnCount,
                               ax::kUnknownAriaColumnOrRowCount);
...
AXTreeUpdate AXPlatformNodeTest::BuildListBox(
  ...
  AXNodeData option_1;
  option_1.id = 2;
  option_1.role = ax::Role::kListBoxOption;
  option_1.SetName("Option1");
  if (option_1_is_selected)
    option_1.AddBoolAttribute(ax::BoolAttribute::kSelected, true);
  listbox.child_ids.push_back(option_1.id);

  AXNodeData option_2;
  option_2.id = 3;
  option_2.role = ax::Role::kListBoxOption;
  option_2.SetName("Option2");
  if (option_2_is_selected)
    option_2.AddBoolAttribute(ax::BoolAttribute::kSelected, true);
  listbox.child_ids.push_back(option_2.id);

  AXNodeData option_3;
  option_3.id = 4;
  option_3.role = ax::Role::kListBoxOption;
  option_3.SetName("Option3");
  if (option_3_is_selected)
    option_3.AddBoolAttribute(ax::BoolAttribute::kSelected, true);
