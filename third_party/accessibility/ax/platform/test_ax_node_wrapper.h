...
#ifndef ACCESSIBILITY_AX_PLATFORM_TEST_AX_NODE_WRAPPER_H_
#define ACCESSIBILITY_AX_PLATFORM_TEST_AX_NODE_WRAPPER_H_
...
class TestAXNodeWrapper : public AXPlatformNodeDelegateBase {
 public:
  ...
  static void SetGlobalCoordinateOffset(const SkPoint& offset);
  ...
  AXPlatformNode* GetFromTreeIDAndNodeID(const ax::AXTreeID& ax_tree_id,
                                         int32_t id) override;
  ...
  std::u16string GetLocalizedStringForImageAnnotationStatus(
      ax::ImageAnnotationStatus status) const override;
  std::u16string GetStyleNameAttributeAsLocalizedString() const override;
  bool ShouldIgnoreHoveredStateForTesting() override;
  const ax::AXUniqueId& GetUniqueId() const override;
  ...
  std::set<AXPlatformNode*> GetReverseRelations(
      ax::IntListAttribute attr) override;
 ...
 private:
  ...
  void ReplaceIntAttribute(int32_t node_id,
                           ...
                           int32_t value);
  void ReplaceFloatAttribute(ax::FloatAttribute attribute, float value);
  void ReplaceBoolAttribute(ax::BoolAttribute attribute, bool value);
  void ReplaceStringAttribute(ax::StringAttribute attribute, std::string value);
...
#endif  // ACCESSIBILITY_AX_PLATFORM_TEST_AX_NODE_WRAPPER_H_
