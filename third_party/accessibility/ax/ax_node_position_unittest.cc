...
class AXPositionTest : public testing::Test, public TestAXTreeManager {
 ...
 private:
  FML_DISALLOW_COPY_AND_ASSIGN(AXPositionTest);
};
...
class AXPositionTextNavigationTestWithParam
 ...
 public:
  ...
  FML_DISALLOW_COPY_AND_ASSIGN(AXPositionTextNavigationTestWithParam);
};
...
void AXPositionTest::SetUp() {
  ...
  root_.role = ax::Role::kRootWebArea;
  root_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);

  button_.role = ax::Role::kButton;
  button_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  button_.SetHasPopup(ax::HasPopup::kMenu);
  button_.SetName("Button");
  button_.relative_bounds.bounds = SkRect::MakeXYWH(20, 20, 200, 30);
  root_.child_ids.push_back(button_.id);

  check_box_.role = ax::Role::kCheckBox;
  check_box_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  check_box_.SetCheckedState(ax::CheckedState::kTrue);
  check_box_.SetName("Check box");
  check_box_.relative_bounds.bounds = SkRect::MakeXYWH(20, 50, 200, 30);
  root_.child_ids.push_back(check_box_.id);

  text_field_.role = ax::Role::kTextField;
  text_field_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  text_field_.AddState(ax::State::kEditable);
  text_field_.SetValue(TEXT_VALUE);
  text_field_.AddIntListAttribute(ax::IntListAttribute::kCachedLineStarts,
  ...
  static_text1_.role = ax::Role::kStaticText;
  static_text1_.AddState(ax::State::kEditable);
  static_text1_.SetName("Line 1");
  static_text1_.child_ids.push_back(inline_box1_.id);
  static_text1_.AddIntAttribute(ax::IntAttribute::kTextStyle,
                                static_cast<int32_t>(ax::TextStyle::kBold));

  inline_box1_.role = ax::Role::kInlineTextBox;
  inline_box1_.AddState(ax::State::kEditable);
  inline_box1_.SetName("Line 1");
  inline_box1_.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                   std::vector<int32_t>{0, 5});
  inline_box1_.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                   std::vector<int32_t>{4, 6});
  inline_box1_.AddIntAttribute(ax::IntAttribute::kNextOnLineId, line_break_.id);

  line_break_.role = ax::Role::kLineBreak;
  line_break_.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  line_break_.AddState(ax::State::kEditable);
  line_break_.SetName("\n");
  line_break_.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                              inline_box1_.id);

  static_text2_.role = ax::Role::kStaticText;
  static_text2_.AddState(ax::State::kEditable);
  static_text2_.SetName("Line 2");
  static_text2_.child_ids.push_back(inline_box2_.id);
  static_text2_.AddFloatAttribute(ax::FloatAttribute::kFontSize, 1.0f);

  inline_box2_.role = ax::Role::kInlineTextBox;
  inline_box2_.AddState(ax::State::kEditable);
  inline_box2_.SetName("Line 2");
  inline_box2_.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                   std::vector<int32_t>{0, 5});
  inline_box2_.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                   std::vector<int32_t>{4, 6});
...
std::unique_ptr<AXTree> AXPositionTest::CreateMultipageDocument(
    ...
    AXNodeData& page_3_text_data) const {
  root_data.id = 1;
  root_data.role = ax::Role::kDocument;

  page_1_data.id = 2;
  page_1_data.role = ax::Role::kRegion;
  page_1_data.AddBoolAttribute(ax::BoolAttribute::kIsPageBreakingObject, true);

  page_1_text_data.id = 3;
  page_1_text_data.role = ax::Role::kStaticText;
  page_1_text_data.SetName("some text on page 1");
  page_1_text_data.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                    true);
  page_1_data.child_ids = {3};

  page_2_data.id = 4;
  page_2_data.role = ax::Role::kRegion;
  page_2_data.AddBoolAttribute(ax::BoolAttribute::kIsPageBreakingObject, true);

  page_2_text_data.id = 5;
  page_2_text_data.role = ax::Role::kStaticText;
  page_2_text_data.SetName("some text on page 2");
  page_2_text_data.AddIntAttribute(ax::IntAttribute::kTextStyle,
                                   static_cast<int32_t>(ax::TextStyle::kBold));
  page_2_data.child_ids = {5};

  page_3_data.id = 6;
  page_3_data.role = ax::Role::kRegion;
  page_3_data.AddBoolAttribute(ax::BoolAttribute::kIsPageBreakingObject, true);

  page_3_text_data.id = 7;
  page_3_text_data.role = ax::Role::kStaticText;
...
std::unique_ptr<AXTree> AXPositionTest::CreateMultilingualDocument(
  ...
  AXNodeData root_data;
  root_data.id = 1;
  root_data.role = ax::Role::kRootWebArea;

  AXNodeData text_data1;
  text_data1.id = 2;
  text_data1.role = ax::Role::kStaticText;
  text_data1.SetName(english_text);

  AXNodeData text_data2;
  text_data2.id = 3;
  text_data2.role = ax::Role::kStaticText;
  text_data2.SetName(hindi_text);

  AXNodeData text_data3;
  text_data3.id = 4;
  text_data3.role = ax::Role::kStaticText;
...
TEST_F(AXPositionTest, Clone) {
  ...
  EXPECT_EQ(ax::TextAffinity::kUpstream, copy_position->affinity());
  ...
  EXPECT_EQ(text_field_.id, copy_position->anchor_id());
  EXPECT_EQ(0, copy_position->text_offset());
  EXPECT_EQ(ax::TextAffinity::kDownstream, copy_position->affinity());
...
TEST_F(AXPositionTest, IsIgnored) {
  ...
  inline_box_data_1.role = ax::Role::kInlineTextBox;
  inline_box_data_1.SetName("One");
  inline_box_data_1.AddState(ax::State::kIgnored);

  AXNodeData container_data;
  container_data.id = 4;
  container_data.role = ax::Role::kGenericContainer;
  container_data.AddState(ax::State::kIgnored);
  ...
  inline_box_data_2.role = ax::Role::kInlineTextBox;
...
TEST_F(AXPositionTest, GetTextFromRoot) {
  TestPositionType text_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), root_.id, 0 /* text_offset */, ax::TextAffinity::kUpstream);
  ASSERT_NE(nullptr, text_position);
  ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, GetMaxTextOffsetUpdate) {
  ...
  text_data.id = 2;
  text_data.role = ax::Role::kStaticText;
  text_data.SetName("some text");

  AXNodeData more_text_data;
  more_text_data.id = 3;
  more_text_data.role = ax::Role::kStaticText;
...
TEST_F(AXPositionTest, AtStartOfLineStaticTextExtraPrecedingSpace) {
  ...
  AXNodeData root;
  root.id = 1;
  root.role = ax::Role::kRootWebArea;
  // "kIsLineBreakingObject" is not strictly necessary but is added for
  // completeness.
  root.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  AXNodeData label_text;
  label_text.id = 2;
  label_text.role = ax::Role::kLabelText;

  AXNodeData static_text1;
  static_text1.id = 3;
  static_text1.role = ax::Role::kStaticText;
  static_text1.SetName(" *");

  AXNodeData inline_text1;
  inline_text1.id = 4;
  inline_text1.role = ax::Role::kInlineTextBox;
...
TEST_F(AXPositionTest, AtStartOfBlankLine) {
  ...
  inline_box1_.RemoveIntAttribute(ax::IntAttribute::kNextOnLineId);
  line_break_.RemoveIntAttribute(ax::IntAttribute::kPreviousOnLineId);
  AXTreeUpdate update;
...
TEST_F(AXPositionTest, AtStartAndEndOfLineWhenAtEndOfTextSpan) {
  ...
  // "kIsLineBreakingObject" is not strictly necessary but is added for
  // completeness.
  root_data.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);
  ...
  inline_box_data_2.role = ax::Role::kInlineTextBox;
  inline_box_data_1.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
                                    inline_box_data_2.id);
  inline_box_data_2.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
  ...
  inline_box_data_3.role = ax::Role::kInlineTextBox;
  inline_box_data_3.SetName("testing");

  AXNodeData inline_box_data_4;
  inline_box_data_4.id = 6;
  inline_box_data_4.role = ax::Role::kInlineTextBox;
  inline_box_data_3.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
                                    inline_box_data_4.id);
  inline_box_data_4.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
  ...
  inline_box_data_5.role = ax::Role::kInlineTextBox;
...
TEST_F(AXPositionTest, AtStartAndEndOfLineInsideTextField) {
  ...
  text_field_data_1.role = ax::Role::kTextField;
  // "kIsLineBreakingObject" and the "kEditable" state are not strictly
  // necessary but are added for completeness.
  text_field_data_1.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                     true);
  text_field_data_1.AddState(ax::State::kEditable);
  ...
  inline_box_data_3.role = ax::Role::kInlineTextBox;
  inline_box_data_2.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
                                    inline_box_data_3.id);
  inline_box_data_3.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                                    inline_box_data_2.id);
  inline_box_data_3.SetName(" ");

  AXNodeData text_field_data_2;
  text_field_data_2.id = 7;
  text_field_data_2.role = ax::Role::kTextField;
  // "kIsLineBreakingObject" and the "kEditable" state are not strictly
  // necessary but are added for completeness.
  text_field_data_2.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                     true);
  text_field_data_1.AddState(ax::State::kEditable);
  ...
  inline_box_data_6.role = ax::Role::kInlineTextBox;
...
TEST_F(AXPositionTest, ParagraphEdgesWithPreservedNewLine) {
  ...
  some_text_data.id = 3;
  some_text_data.role = ax::Role::kInlineTextBox;
  some_text_data.SetName("some text");

  AXNodeData container_data;
  container_data.id = 4;
  container_data.role = ax::Role::kGenericContainer;
  container_data.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                  true);
  ...
  preserved_newline_data.role = ax::Role::kInlineTextBox;
  preserved_newline_data.SetName("\n");
  preserved_newline_data.AddBoolAttribute(
      ax::BoolAttribute::kIsLineBreakingObject, true);

  AXNodeData more_text_data;
  more_text_data.id = 7;
  more_text_data.role = ax::Role::kInlineTextBox;
  more_text_data.SetName("more text");
...
TEST_F(
  ...
  static_text_data_a.role = ax::Role::kStaticText;
  static_text_data_a.SetName("first");

  AXNodeData container_data_a;
  container_data_a.id = 3;
  container_data_a.role = ax::Role::kGenericContainer;
  container_data_a.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                    true);

  AXNodeData container_data_b;
  container_data_b.id = 4;
  container_data_b.role = ax::Role::kGenericContainer;
  container_data_b.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                    true);

  AXNodeData static_text_data_b;
  static_text_data_b.id = 5;
  static_text_data_b.role = ax::Role::kStaticText;
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphOnAListMarker) {
  ...
  inline_box1.role = ax::Role::kInlineTextBox;
  inline_box1.SetName("Before list.");

  list.role = ax::Role::kList;
  list.child_ids = {list_item1.id, list_item2.id};

  list_item1.role = ax::Role::kListItem;
  list_item1.child_ids = {list_marker_legacy.id, static_text3.id};
  list_item1.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);

  list_marker_legacy.role = ax::Role::kListMarker;
  list_marker_legacy.child_ids = {static_text2.id};

  static_text2.role = ax::Role::kStaticText;
  static_text2.child_ids = {inline_box2.id};
  static_text2.SetName("1. ");

  inline_box2.role = ax::Role::kInlineTextBox;
  inline_box2.SetName("1. ");
  inline_box2.AddIntAttribute(ax::IntAttribute::kNextOnLineId, inline_box3.id);

  static_text3.role = ax::Role::kStaticText;
  static_text3.child_ids = {inline_box3.id};
  static_text3.SetName("First item.");

  inline_box3.role = ax::Role::kInlineTextBox;
  inline_box3.SetName("First item.");
  inline_box3.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                              inline_box2.id);

  list_item2.role = ax::Role::kListItem;
  list_item2.child_ids = {list_marker_ng.id, static_text4.id};
  list_item2.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);

  list_marker_ng.role = ax::Role::kListMarker;
  list_marker_ng.SetName("2. ");
  list_marker_ng.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
                                 inline_box4.id);

  static_text4.role = ax::Role::kStaticText;
  static_text4.child_ids = {inline_box4.id};
  static_text4.SetName("Second item.");

  inline_box4.role = ax::Role::kInlineTextBox;
  inline_box4.SetName("Second item.");
  inline_box4.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                              list_marker_ng.id);

  static_text5.role = ax::Role::kStaticText;
  static_text5.child_ids = {inline_box5.id};
  static_text5.SetName("After list.");

  inline_box5.role = ax::Role::kInlineTextBox;
  ...
  text_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), list.id, 0 /* text_offset */, ax::TextAffinity::kDownstream);
  ASSERT_NE(nullptr, text_position);
  EXPECT_TRUE(text_position->AtStartOfParagraph());
  EXPECT_FALSE(text_position->AtEndOfParagraph());
  ...
  text_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), list.id, 14 /* text_offset */, ax::TextAffinity::kUpstream);
  ASSERT_NE(nullptr, text_position);
  EXPECT_FALSE(text_position->AtStartOfParagraph());
  EXPECT_TRUE(text_position->AtEndOfParagraph());
...
TEST_F(AXPositionTest,
  ...
  inline_text_data_a.role = ax::Role::kInlineTextBox;
  inline_text_data_a.SetName("\n");
  inline_text_data_a.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                      true);
  ...
  inline_text_data_b_1.role = ax::Role::kInlineTextBox;
  inline_text_data_b_1.SetName("some");

  AXNodeData inline_text_data_b_2;
  inline_text_data_b_2.id = 8;
  inline_text_data_b_2.role = ax::Role::kInlineTextBox;
  inline_text_data_b_2.SetName(" ");

  AXNodeData inline_text_data_b_3;
  inline_text_data_b_3.id = 9;
  inline_text_data_b_3.role = ax::Role::kInlineTextBox;
  inline_text_data_b_3.SetName("text");

  AXNodeData container_data_c;
  container_data_c.id = 10;
  container_data_c.role = ax::Role::kGenericContainer;
  container_data_c.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                    true);

  AXNodeData static_text_data_c;
  static_text_data_c.id = 11;
  static_text_data_c.role = ax::Role::kStaticText;
  static_text_data_c.SetName("\n");

  AXNodeData inline_text_data_c;
  inline_text_data_c.id = 12;
  inline_text_data_c.role = ax::Role::kInlineTextBox;
  inline_text_data_c.SetName("\n");
  inline_text_data_c.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                      true);
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithIgnoredNodes) {
  ...
  container_data_a.id = 2;
  container_data_a.role = ax::Role::kGenericContainer;
  container_data_a.AddState(ax::State::kIgnored);
  container_data_a.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                    true);
  ...
  static_text_data_a.AddState(ax::State::kIgnored);

  AXNodeData inline_text_data_a;
  inline_text_data_a.id = 4;
  inline_text_data_a.role = ax::Role::kInlineTextBox;
  inline_text_data_a.SetName("ignored text");
  inline_text_data_a.AddState(ax::State::kIgnored);
  ...
  container_data_c.id = 10;
  container_data_c.role = ax::Role::kGenericContainer;
  container_data_c.AddState(ax::State::kIgnored);
  container_data_c.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject,
                                    true);
  ...
  static_text_data_c.AddState(ax::State::kIgnored);

  AXNodeData inline_text_data_c;
  inline_text_data_c.id = 12;
  inline_text_data_c.role = ax::Role::kInlineTextBox;
  inline_text_data_c.SetName("ignored text");
  inline_text_data_c.AddState(ax::State::kIgnored);
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithEmbeddedObjectCharacter) {
  ...
  root_1.AddBoolAttribute(ax::BoolAttribute::kIsLineBreakingObject, true);

  link_2.role = ax::Role::kLink;
...
TEST_F(AXPositionTest, AsTextPositionWithTreePosition) {
  ...
  EXPECT_EQ(ax::TextAffinity::kDownstream, test_position->affinity());
...
TEST_F(AXPositionTest, AsLeafTreePositionWithTextPosition) {
  ...
  // box.
  text_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), root_.id, 6 /* text_offset */, ax::TextAffinity::kUpstream);
  ASSERT_NE(nullptr, text_position);
  ASSERT_TRUE(text_position->IsTextPosition());
  test_position = text_position->AsLeafTreePosition();
  ASSERT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPosition) {
  ...
  text_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), root_.id, 10 /* text_offset */, ax::TextAffinity::kUpstream);
  ASSERT_NE(nullptr, text_position);
  test_position = text_position->AsLeafTextPosition();
  ASSERT_NE(nullptr, test_position);
  EXPECT_TRUE(test_position->IsLeafTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPositionAndEmptyTextSandwich) {
  ...
  AXNodeData text_data;
  text_data.id = 2;
  text_data.role = ax::Role::kInlineTextBox;
  text_data.SetName("some text");

  AXNodeData button_data;
  button_data.id = 3;
  button_data.role = ax::Role::kButton;
  button_data.SetName("");
...
TEST_F(AXPositionTest, AsUnignoredPosition) {
  ...
  inline_box_data_2.AddState(ax::State::kIgnored);
  ...
  root_data.AddState(ax::State::kIgnored);
  SetTree(CreateAXTree({root_data, static_text_data_1, inline_box_data_1,
                        inline_box_data_2, container_data, static_text_data_2,
                        inline_box_data_3}));
...
TEST_F(AXPositionTest, CreatePositionAtTextBoundaryDocumentStartEndIsIgnored) {
  ...
  inline_box_data_1.SetName("One");
  inline_box_data_1.AddState(ax::State::kIgnored);
  inline_box_data_1.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                        std::vector<int32_t>{0});
  inline_box_data_1.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
  ...
  inline_box_data_2.role = ax::Role::kInlineTextBox;
  inline_box_data_2.SetName("Two");
  inline_box_data_2.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                        std::vector<int32_t>{0});
  inline_box_data_2.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                        std::vector<int32_t>{3});
  inline_box_data_2.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                                    INLINE_BOX1_ID);
  inline_box_data_2.AddIntAttribute(ax::IntAttribute::kNextOnLineId,
  ...
  inline_box_data_3.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                        std::vector<int32_t>{0});
  inline_box_data_3.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
  ...
  static_text_data_4.role = ax::Role::kStaticText;
  ...
  inline_box_data_4.AddState(ax::State::kIgnored);
  inline_box_data_3.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                        std::vector<int32_t>{0});
  inline_box_data_3.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
  ...
  TestPositionType test_position = text_position->CreatePositionAtTextBoundary(
      ax::TextBoundary::kWordStart, ax::MoveDirection::kForward,
  ...
  test_position = text_position->CreatePositionAtTextBoundary(
      ax::TextBoundary::kWordStart, ax::MoveDirection::kBackward,
      AXBoundaryBehavior::StopAtLastAnchorBoundary);
  ASSERT_NE(nullptr, test_position);
  EXPECT_TRUE(test_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtInvalidGraphemeBoundary) {
  ...
  EXPECT_EQ(ax::TextAffinity::kUpstream, test_position->affinity());
}
...
TEST_F(AXPositionTest, MoveByFormatWithIgnoredNodes) {
  ...
  generic_container_2.role = ax::Role::kGenericContainer;
  generic_container_2.child_ids = {button_3.id};

  button_3.role = ax::Role::kButton;
  button_3.child_ids = {static_text_4.id, svg_root_6.id};

  static_text_4.role = ax::Role::kStaticText;
  static_text_4.child_ids = {inline_box_5.id};
  static_text_4.SetName("Button");

  inline_box_5.role = ax::Role::kInlineTextBox;
  inline_box_5.SetName("Button");

  svg_root_6.role = ax::Role::kSvgRoot;
  svg_root_6.child_ids = {generic_container_7.id};
  svg_root_6.AddState(ax::State::kIgnored);

  generic_container_7.role = ax::Role::kGenericContainer;
  generic_container_7.AddState(ax::State::kIgnored);

  generic_container_8.role = ax::Role::kGenericContainer;
  generic_container_8.child_ids = {heading_9.id, static_text_12.id,
                                   generic_container_14.id};

  heading_9.role = ax::Role::kHeading;
  heading_9.child_ids = {static_text_10.id};

  static_text_10.role = ax::Role::kStaticText;
  static_text_10.child_ids = {inline_box_11.id};
  static_text_10.SetName("Heading");

  inline_box_11.role = ax::Role::kInlineTextBox;
  inline_box_11.SetName("Heading");

  static_text_12.role = ax::Role::kStaticText;
  static_text_12.child_ids = {inline_box_13.id};
  static_text_12.SetName("3.14");

  inline_box_13.role = ax::Role::kInlineTextBox;
  inline_box_13.SetName("3.14");

  generic_container_14.role = ax::Role::kGenericContainer;
  generic_container_14.AddState(ax::State::kIgnored);

  generic_container_15.role = ax::Role::kGenericContainer;
  generic_container_15.child_ids = {heading_16.id};

  heading_16.role = ax::Role::kHeading;
  heading_16.child_ids = {static_text_17.id};

  static_text_17.role = ax::Role::kStaticText;
  static_text_17.child_ids = {inline_box_18.id};
  static_text_17.SetName("Heading");

  inline_box_18.role = ax::Role::kInlineTextBox;
  inline_box_18.SetName("Heading");

  generic_container_19.role = ax::Role::kGenericContainer;
  generic_container_19.child_ids = {generic_container_20.id, static_text_21.id,
                                    heading_23.id};

  generic_container_20.role = ax::Role::kGenericContainer;
  generic_container_20.AddState(ax::State::kIgnored);

  static_text_21.role = ax::Role::kStaticText;
  static_text_21.child_ids = {inline_box_22.id};
  static_text_21.SetName("3.14");

  inline_box_22.role = ax::Role::kInlineTextBox;
  inline_box_22.SetName("3.14");

  heading_23.role = ax::Role::kHeading;
  heading_23.child_ids = {static_text_24.id};

  static_text_24.role = ax::Role::kStaticText;
  static_text_24.child_ids = {inline_box_25.id};
  static_text_24.SetName("Heading");

  inline_box_25.role = ax::Role::kInlineTextBox;
...
TEST_F(AXPositionTest, AsValidPositionInDescendantOfEmptyObject) {
  ...
  TestPositionType text_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), inline_box_4.id, 3, ax::TextAffinity::kDownstream);
  ASSERT_NE(nullptr, text_position);
  EXPECT_TRUE(text_position->IsTextPosition());
  EXPECT_TRUE(text_position->IsValid());
  ...
  static_text_3.AddState(ax::State::kIgnored);
  inline_box_4.AddState(ax::State::kIgnored);
  AXTreeUpdate update;
...
TEST_F(AXPositionTest, CreatePreviousCharacterPositionAtGraphemeBoundary) {
  ...
  TestPositionType test_position = AXNodePosition::CreateTextPosition(
      GetTreeID(), GetTree()->root()->id(),
      text_offsets.back() /* text_offset */, ax::TextAffinity::kDownstream);
  ASSERT_NE(nullptr, test_position);
  ASSERT_TRUE(test_position->IsTextPosition());
...
TEST_F(AXPositionTest, Swap) {
  ...
  EXPECT_EQ(ax::TextAffinity::kDownstream, null_position1->affinity());
...
TEST_F(AXPositionTest, CreateNextAnchorPosition) {
  ...
  text_field_data.role = ax::Role::kTextField;

  AXNodeData empty_text_data;
  empty_text_data.id = 4;
  empty_text_data.role = ax::Role::kStaticText;
...
TEST_F(AXPositionTest, CreateLinePositionsMultipleAnchorsInSingleLine) {
  ...
  inline_box1.AddIntAttribute(ax::IntAttribute::kNextOnLineId, inline_box2.id);

  inline_block.role = ax::Role::kGenericContainer;
  ...
  inline_box2.AddIntAttribute(ax::IntAttribute::kPreviousOnLineId,
                              inline_box1.id);
  inline_box2.AddIntAttribute(ax::IntAttribute::kNextOnLineId, inline_box3.id);
...
TEST_F(AXPositionTest, CreateNextWordPositionInList) {
  ...
  list_marker1.role = ax::Role::kListMarker;
  ...
  inline_box1.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                  std::vector<int32_t>{0});
  inline_box1.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                  std::vector<int32_t>{3});
  ...
  inline_box2.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                  std::vector<int32_t>{0, 6});
  inline_box2.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                  std::vector<int32_t>{5});
  ...
  list_marker2.role = ax::Role::kListMarker;
  ...
  inline_box3.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                  std::vector<int32_t>{0});
  inline_box3.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                  std::vector<int32_t>{3});
  ...
  inline_box4.role = ax::Role::kInlineTextBox;
  inline_box4.SetName("second item");
  inline_box4.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                  std::vector<int32_t>{0, 7});
  inline_box4.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
...
TEST_F(AXPositionTest, EmptyObjectReplacedByCharacterTextNavigation) {
  ...
  static_text_2.role = ax::Role::kStaticText;
  static_text_2.SetName("Hello ");
  static_text_2.child_ids = {inline_box_3.id};

  inline_box_3.role = ax::Role::kInlineTextBox;
  inline_box_3.SetName("Hello ");
  inline_box_3.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                   std::vector<int32_t>{0});
  inline_box_3.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                   std::vector<int32_t>{6});

  text_field_4.role = ax::Role::kTextField;
  text_field_4.child_ids = {generic_container_5.id};

  generic_container_5.role = ax::Role::kGenericContainer;
  ...
  inline_box_7.role = ax::Role::kInlineTextBox;
  inline_box_7.SetName(" world");
  inline_box_7.AddIntListAttribute(ax::IntListAttribute::kWordStarts,
                                   std::vector<int32_t>{1});
  inline_box_7.AddIntListAttribute(ax::IntListAttribute::kWordEnds,
                                   std::vector<int32_t>{6});

  heading_8.role = ax::Role::kHeading;
  heading_8.child_ids = {static_text_9.id};

  static_text_9.role = ax::Role::kStaticText;
  static_text_9.child_ids = {inline_box_10.id};
  static_text_9.SetName("3.14");

  inline_box_10.role = ax::Role::kInlineTextBox;
  inline_box_10.SetName("3.14");

  generic_container_11.role = ax::Role::kGenericContainer;
  generic_container_11.AddBoolAttribute(
      ax::BoolAttribute::kIsLineBreakingObject, true);
  generic_container_11.AddState(ax::State::kIgnored);

  generic_container_12.role = ax::Role::kGenericContainer;
  generic_container_12.AddBoolAttribute(
      ax::BoolAttribute::kIsLineBreakingObject, true);

  static_text_13.role = ax::Role::kStaticText;
  static_text_13.SetName("hey");

  button_14.role = ax::Role::kButton;
  button_14.child_ids = {generic_container_15.id};

  generic_container_15.role = ax::Role::kGenericContainer;
  generic_container_15.AddState(ax::State::kIgnored);
  ...
  // character.
  position = AXNodePosition::CreateTextPosition(GetTreeID(), root_1.id,
                                                0 /* text_offset */,
                                                ax::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, TextNavigationWithCollapsedCombobox) {
  ...
  inline_box_3.AddIntListAttribute(ax::IntListAttribute::kWordStarts, {0});
  inline_box_3.AddIntListAttribute(ax::IntListAttribute::kWordEnds, {2});

  popup_button_4.role = ax::Role::kPopUpButton;
  popup_button_4.child_ids = {menu_list_popup_5.id};
  popup_button_4.AddState(ax::State::kCollapsed);

  menu_list_popup_5.role = ax::Role::kMenuListPopup;
  menu_list_popup_5.child_ids = {menu_list_option_6.id};

  menu_list_option_6.role = ax::Role::kMenuListOption;
  menu_list_option_6.SetName("Option");

  static_text_7.role = ax::Role::kStaticText;
  static_text_7.SetName("3.14");
  static_text_7.child_ids = {inline_box_8.id};

  inline_box_8.role = ax::Role::kInlineTextBox;
  inline_box_8.SetName("3.14");
  inline_box_8.AddIntListAttribute(ax::IntListAttribute::kWordStarts, {0});
  inline_box_8.AddIntListAttribute(ax::IntListAttribute::kWordEnds, {4});
  ...
  TestPositionType position = AXNodePosition::CreateTextPosition(
      GetTreeID(), inline_box_3.id, 0, ax::TextAffinity::kDownstream);
  ...
  position = AXNodePosition::CreateTextPosition(GetTreeID(), inline_box_8.id, 4,
                                                ax::TextAffinity::kDownstream);
  ASSERT_NE(nullptr, position);
  ...
  popup_button_4.RemoveState(ax::State::kCollapsed);
  popup_button_4.AddState(ax::State::kExpanded);
  AXTreeUpdate update;
  update.nodes = {popup_button_4};
  ASSERT_TRUE(GetTree()->Unserialize(update));

  // Expanded - Forward navigation.
  position = AXNodePosition::CreateTextPosition(GetTreeID(), inline_box_3.id, 0,
                                                ax::TextAffinity::kDownstream);
  ASSERT_NE(nullptr, position);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kCharacter, AXRangeExpandBehavior::kLeftFirst,
            ...
            "annotated_text=Line 1\n<L>ine 2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kCharacter, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=8 affinity=downstream "
            "annotated_text=Line 1\nL<i>ne 2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kFormat, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kFormat, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kLineEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kLineEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kLineStart, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kLineStart, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kLineStartOrEnd,
        ...
        ExpandToEnclosingTextBoundaryTestParam{
            ...
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kObject, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kObject, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kParagraphEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=upstream "
            "annotated_text=Line 1\n<L>ine 2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kParagraphEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=upstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kParagraphStart,
            AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
        ...
        ExpandToEnclosingTextBoundaryTestParam{
            ...
            "annotated_text=Line 1\nLine 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kParagraphStartOrEnd,
            AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=upstream "
        ...
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWebPage, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=1 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=9 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWebPage, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=1 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=9 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWordEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=11 affinity=downstream "
            "annotated_text=Line 1\nLine< >2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWordEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=11 affinity=downstream "
            "annotated_text=Line 1\nLine< >2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWordStart, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=5 affinity=downstream "
            "annotated_text=Line <1>\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWordStart, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=12 affinity=downstream "
            "annotated_text=Line 1\nLine <2>"},
        ExpandToEnclosingTextBoundaryTestParam{
            ax::TextBoundary::kWordStartOrEnd,
            AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=5 affinity=downstream "
            "annotated_text=Line <1>\nLine 2",
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kCharacter, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=7 text_offset=0 affinity=downstream "
            "annotated_text=<\n>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kCharacter, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=1 affinity=downstream "
            "annotated_text=L<i>ne 2"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kFormat, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=7 text_offset=0 affinity=downstream "
            "annotated_text=<\n>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kFormat, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kLineEnd, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=7 text_offset=0 affinity=downstream "
            "annotated_text=<\n>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kLineEnd, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kLineStart, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kLineStart, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary, "NullPosition"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kLineStartOrEnd, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kLineStartOrEnd, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kObject, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 2"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kObject, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kParagraphEnd, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=3 text_offset=0 affinity=downstream "
            "annotated_text=<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kParagraphEnd, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kParagraphStart, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kParagraphStart, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary, "NullPosition"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kParagraphStartOrEnd,
            ax::MoveDirection::kBackward, AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kParagraphStartOrEnd, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        // TODO(accessibility): Add tests for sentence boundary.
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kWebPage, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=1 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kWebPage, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=9 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kWordEnd, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=6 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kWordEnd, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
        ...
        CreatePositionAtTextBoundaryTestParam{
            ...
            "annotated_text=Line <2>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kWordStartOrEnd, ax::MoveDirection::kBackward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=6 text_offset=5 affinity=downstream "
            "annotated_text=Line <1>"},
        CreatePositionAtTextBoundaryTestParam{
            ax::TextBoundary::kWordStartOrEnd, ax::MoveDirection::kForward,
            AXBoundaryBehavior::CrossBoundary,
            "TextPosition anchor_id=8 text_offset=4 affinity=downstream "
            "annotated_text=Line< >2"}));
