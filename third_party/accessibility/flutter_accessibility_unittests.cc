...
TEST(FlutterAccessibilityTest, canPerfomActions) {
  ...
  TestFlutterAccessibility* accessibility =
      static_cast<TestFlutterAccessibility*>(FlutterAccessibility::Create());
  ...
  ASSERT_EQ(accessibility->performed_actions[0],
  ...
  ASSERT_EQ(
      accessibility->performed_actions[1],
  ...
  ASSERT_EQ(accessibility->performed_actions[2],
