...
struct Damage {
  ...
  // If embedder supports
  // partial update, this is the region that needs to be updated.
  SkIRect surface_damage;

  // Reflects actual change to target framebuffer; This is surface_damage +
  // damage previously acumulated for the framebuffer.
  // All drawing will be clipped to this region
