...
TEST_F(OpacityLayerTest, HalfTransparent) {
  ...
  DlFRect opacity_bounds =
      DlFRect::MakeRoundedOut(expected_layer_bounds.MakeOffset(-layer_offset));
...
TEST_F(OpacityLayerTest, Nested) {
  ...
  DlFRect opacity1_bounds = expected_layer1_bounds.MakeOffset(-layer1_offset);
  DlFRect opacity2_bounds = expected_layer2_bounds.MakeOffset(-layer2_offset);
