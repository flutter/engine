...
PrerollContext CreatePrerollContext(MockCanvas* canvas, Stopwatch& stopwatch, MutatorsStack& mutators_stack, TextureRegistry& texture_registry) {
  return {
...
Layer::PaintContext CreatePaintContext(MockCanvas* canvas, Stopwatch& stopwatch, TextureRegistry& texture_registry) {
  return {
...
LayerTest::LayerTest(MockCanvas* canvas) : preroll_context_(CreatePrerollContext(canvas, stopwatch_, mutators_stack_, texture_registry_)), paint_context_(CreatePaintContext(canvas, stopwatch_, texture_registry_)) {}
