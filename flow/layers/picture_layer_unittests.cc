...
TEST_F(PictureLayerTest, OpacityInheritanceCacheablePicture) {
  ...
  auto* picture_cacheable_item = layer->raster_cache_item();
  ...
  ASSERT_EQ(picture_cacheable_item->cache_state(),
            RasterCacheItem::CacheState::kCurrent);
  // Cache this picture layer
  EXPECT_TRUE(picture_cacheable_item->TryToPrepareRasterCache(paint_context()));
