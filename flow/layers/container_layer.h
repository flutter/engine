...
class ContainerLayer : public Layer {
 public:
  ...
  const DlFRect& child_paint_bounds() const { return child_paint_bounds_; }
  void set_child_paint_bounds(const DlFRect& bounds) {
 ...
 protected:
  void PrerollChildren(PrerollContext* context, DlFRect* child_paint_bounds);

 private:
  std::vector<std::shared_ptr<Layer>> layers_;
  DlFRect child_paint_bounds_;
