...
static uint64_t event_to_logical_key(GdkEventKey* event, GHashTable* table) {
...
void fl_keyboard_manager_send_key_event(FlKeyboardManager* plugin, GdkEventKey* event) {
  ...
  logical_event.struct_size = sizeof(logical_event);
  ...
  physical_event.struct_size = sizeof(physical_event);
