...
// flutter::GroupLayout kLayoutUs0 = {
...
// flutter::GroupLayout kLayoutRussian2 = {
//     //         +0x0    Shift   +0x1    Shift   +0x2    Shift   +0x3    Shift
//     /* 0x00 */ 0x0000, 0xffff, 0x0000, 0xffff, 0x0000, 0xffff, 0x0000, 0xffff,
//     /* 0x04 */ 0x0000, 0xffff, 0x0000, 0xffff, 0x0000, 0xffff, 0x0000, 0xffff,
...
static void fl_mock_view_keyboard_delegate_iface_init(
  ...
  iface->subscribe_to_layout_change = [](FlKeyboardViewDelegate* delegate,KeyboardLayoutNotifier notifier) {
  };
  iface->lookup_key = [](FlKeyboardViewDelegate* delegate, const GdkKeymapKey* key) -> guint {
    return 0;
  };
}
