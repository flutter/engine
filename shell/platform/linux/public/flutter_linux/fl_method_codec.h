 ...
 * FlMethodCodec:
 *
 * #FlMethodCodec is an abstract class that encode and decode method calls on a
 * platform channel. Override this class to implemented an encoding.
 */
...
struct _FlMethodCodecClass {
   ...
   * Return: %TRUE if successfully decoded.
   */
  gboolean (*decode_response)(FlMethodCodec* codec,
                              GBytes* message,
                              gchar** error_code,
                              gchar** error_message,
                              FlValue** result,
