...
void initialize_gtk_keyval_to_logical_key(GHashTable* table) {
  insert_record(table, 0x0000ff08, 0x000000008);  // BackSpace
  insert_record(table, 0x0000ff09, 0x000000009);  // Tab
  insert_record(table, 0x0000ff89, 0x000000009);  // KP_Tab
  insert_record(table, 0x0000fe20, 0x000000009);  // ISO_Left_Tab
  insert_record(table, 0x0000ff0d, 0x00000000d);  // Return
  insert_record(table, 0x0000fe34, 0x00000000d);  // ISO_Enter
  insert_record(table, 0x0000fd1e, 0x00000000d);  // 3270_Enter
  insert_record(table, 0x0000ff1b, 0x00000001b);  // Escape
  insert_record(table, 0x0000ff80, 0x000000020);  // KP_Space
  insert_record(table, 0x0000ffae, 0x00000002e);  // KP_Decimal
  insert_record(table, 0x0000ffff, 0x00000007f);  // Delete
  insert_record(table, 0x0000ffe5, 0x000000104);  // Caps_Lock
  insert_record(table, 0x0000ffed, 0x000000108);  // Hyper_L
  insert_record(table, 0x0000ffee, 0x000000108);  // Hyper_R
  insert_record(table, 0x0000ff7f, 0x00000010a);  // Num_Lock
  insert_record(table, 0x0000ff14, 0x00000010c);  // Scroll_Lock
  insert_record(table, 0x0000ffeb, 0x00000010e);  // Super_L
  insert_record(table, 0x0000ffec, 0x00000010e);  // Super_R
  insert_record(table, 0x0000ff54, 0x000000301);  // Down
  insert_record(table, 0x0000ff51, 0x000000302);  // Left
  insert_record(table, 0x0000ff53, 0x000000303);  // Right
  insert_record(table, 0x0000ff52, 0x000000304);  // Up
  insert_record(table, 0x0000ff57, 0x000000305);  // End
  insert_record(table, 0x0000ff50, 0x000000306);  // Home
  insert_record(table, 0x0000ff56, 0x000000307);  // Page_Down
  insert_record(table, 0x0000ff55, 0x000000308);  // Page_Up
  insert_record(table, 0x0000ff0b, 0x000000401);  // Clear
  insert_record(table, 0x0000fd15, 0x000000402);  // 3270_Copy
  insert_record(table, 0x1008ff57, 0x000000402);  // Copy
  insert_record(table, 0x1008ff58, 0x000000404);  // Cut
  insert_record(table, 0x0000fd06, 0x000000405);  // 3270_EraseEOF
  insert_record(table, 0x0000fd1b, 0x000000406);  // 3270_ExSelect
  insert_record(table, 0x0000ff63, 0x000000407);  // Insert
  insert_record(table, 0x1008ff6d, 0x000000408);  // Paste
  insert_record(table, 0x0000ff66, 0x000000409);  // Redo
  insert_record(table, 0x0000ff65, 0x00000040a);  // Undo
  insert_record(table, 0x0000fd0e, 0x000000503);  // 3270_Attn
  insert_record(table, 0x0000ff69, 0x000000504);  // Cancel
  insert_record(table, 0x0000ff67, 0x000000505);  // Menu
  insert_record(table, 0x0000ff62, 0x000000506);  // Execute
  insert_record(table, 0x0000ff68, 0x000000507);  // Find
  insert_record(table, 0x0000ff6a, 0x000000508);  // Help
  insert_record(table, 0x0000ff13, 0x000000509);  // Pause
  insert_record(table, 0x0000ff60, 0x00000050c);  // Select
  insert_record(table, 0x1008ff8b, 0x00000050d);  // ZoomIn
  insert_record(table, 0x1008ff8c, 0x00000050e);  // ZoomOut
  insert_record(table, 0x1008ff03, 0x000000601);  // MonBrightnessDown
  insert_record(table, 0x1008ff02, 0x000000602);  // MonBrightnessUp
  insert_record(table, 0x1008ff2c, 0x000000604);  // Eject
  insert_record(table, 0x1008ff61, 0x000000605);  // LogOff
  insert_record(table, 0x1008ff2a, 0x000000607);  // PowerOff
  insert_record(table, 0x0000fd1d, 0x000000608);  // 3270_PrintScreen
  insert_record(table, 0x1008ff10, 0x00000060a);  // Standby
  insert_record(table, 0x1008ff2b, 0x00000060b);  // WakeUp
  insert_record(table, 0x0000ff37, 0x000000703);  // Codeinput
  insert_record(table, 0x0000fe0c, 0x000000707);  // ISO_First_Group
  insert_record(table, 0x0000fe0e, 0x000000708);  // ISO_Last_Group
  insert_record(table, 0x0000fe08, 0x000000709);  // ISO_Next_Group
  insert_record(table, 0x0000fe0a, 0x00000070a);  // ISO_Prev_Group
  insert_record(table, 0x0000ff7e, 0x00000070b);  // Mode_switch
  insert_record(table, 0x0000ff3e, 0x00000070e);  // PreviousCandidate
  insert_record(table, 0x0000ff3c, 0x000000710);  // SingleCandidate
  insert_record(table, 0x0000ff31, 0x000000711);  // Hangul
  insert_record(table, 0x0000ff34, 0x000000712);  // Hangul_Hanja
  insert_record(table, 0x0000ff2f, 0x000000714);  // Eisu_Shift
  insert_record(table, 0x0000ff29, 0x000000715);  // Hankaku
  insert_record(table, 0x0000ff25, 0x000000716);  // Hiragana
  insert_record(table, 0x0000ff27, 0x000000717);  // Hiragana_Katakana
  insert_record(table, 0x0000ff7e, 0x000000718);  // kana_switch
  insert_record(table, 0x0000ff21, 0x000000719);  // Kanji
  insert_record(table, 0x0000ff26, 0x00000071a);  // Katakana
  insert_record(table, 0x0000ff24, 0x00000071b);  // Romaji
  insert_record(table, 0x0000ff28, 0x00000071c);  // Zenkaku
  insert_record(table, 0x0000ff2a, 0x00000071d);  // Zenkaku_Hankaku
  insert_record(table, 0x0000ff91, 0x000000801);  // KP_F1
  insert_record(table, 0x0000ffbe, 0x000000801);  // F1
  insert_record(table, 0x0000ff92, 0x000000802);  // KP_F2
  insert_record(table, 0x0000ffbf, 0x000000802);  // F2
  insert_record(table, 0x0000ff93, 0x000000803);  // KP_F3
  insert_record(table, 0x0000ffc0, 0x000000803);  // F3
  insert_record(table, 0x0000ff94, 0x000000804);  // KP_F4
  insert_record(table, 0x0000ffc1, 0x000000804);  // F4
  insert_record(table, 0x0000ffc2, 0x000000805);  // F5
  insert_record(table, 0x0000ffc3, 0x000000806);  // F6
  insert_record(table, 0x0000ffc4, 0x000000807);  // F7
  insert_record(table, 0x0000ffc5, 0x000000808);  // F8
  insert_record(table, 0x0000ffc6, 0x000000809);  // F9
  insert_record(table, 0x0000ffc7, 0x00000080a);  // F10
  insert_record(table, 0x0000ffc8, 0x00000080b);  // F11
  insert_record(table, 0x0000ffc9, 0x00000080c);  // F12
  insert_record(table, 0x0000ffca, 0x00000080d);  // F13
  insert_record(table, 0x0000ffcb, 0x00000080e);  // F14
  insert_record(table, 0x0000ffcc, 0x00000080f);  // F15
  insert_record(table, 0x0000ffcd, 0x000000810);  // F16
  insert_record(table, 0x0000ffce, 0x000000811);  // F17
  insert_record(table, 0x0000ffcf, 0x000000812);  // F18
  insert_record(table, 0x0000ffd0, 0x000000813);  // F19
  insert_record(table, 0x0000ffd1, 0x000000814);  // F20
  insert_record(table, 0x0000ffd2, 0x000000815);  // F21
  insert_record(table, 0x0000ffd3, 0x000000816);  // F22
  insert_record(table, 0x0000ffd4, 0x000000817);  // F23
  insert_record(table, 0x0000ffd5, 0x000000818);  // F24
  insert_record(table, 0x1008ff56, 0x000000a01);  // Close
  insert_record(table, 0x1008ff90, 0x000000a02);  // MailForward
  insert_record(table, 0x1008ff72, 0x000000a03);  // Reply
  insert_record(table, 0x1008ff7b, 0x000000a04);  // Send
  insert_record(table, 0x1008ff15, 0x000000a07);  // AudioStop
  insert_record(table, 0x1008ff17, 0x000000a08);  // AudioNext
  insert_record(table, 0x1008ff16, 0x000000a09);  // AudioPrev
  insert_record(table, 0x1008ff68, 0x000000a0a);  // New
  insert_record(table, 0x1008ff6b, 0x000000a0b);  // Open
  insert_record(table, 0x0000ff61, 0x000000a0c);  // Print
  insert_record(table, 0x1008ff77, 0x000000a0d);  // Save
  insert_record(table, 0x1008ff7c, 0x000000a0e);  // Spell
  insert_record(table, 0x1008ff11, 0x000000a0f);  // AudioLowerVolume
  insert_record(table, 0x1008ff13, 0x000000a10);  // AudioRaiseVolume
  insert_record(table, 0x1008ff12, 0x000000a11);  // AudioMute
  insert_record(table, 0x1008ff20, 0x000000b02);  // Calendar
  insert_record(table, 0x1008ff19, 0x000000b03);  // Mail
  insert_record(table, 0x1008ff2d, 0x000000b07);  // ScreenSaver
  insert_record(table, 0x1008ff6e, 0x000000b0d);  // Phone
  insert_record(table, 0x1008ff26, 0x000000c01);  // Back
  insert_record(table, 0x1008ff30, 0x000000c02);  // Favorites
  insert_record(table, 0x1008ff27, 0x000000c03);  // Forward
  insert_record(table, 0x1008ff18, 0x000000c04);  // HomePage
  insert_record(table, 0x1008ff29, 0x000000c05);  // Refresh
  insert_record(table, 0x1008ff1b, 0x000000c06);  // Search
  insert_record(table, 0x1008ff28, 0x000000c07);  // Stop
  insert_record(table, 0x1008ff97, 0x000000d2c);  // AudioForward
  insert_record(table, 0x1008ff31, 0x000000d2e);  // AudioPause
  insert_record(table, 0x0000fd16, 0x000000d2f);  // 3270_Play
  insert_record(table, 0x1008ff14, 0x000000d2f);  // AudioPlay
  insert_record(table, 0x1008ff1c, 0x000000d30);  // AudioRecord
  insert_record(table, 0x1008ff3e, 0x000000d31);  // AudioRewind
  insert_record(table, 0x1008ffa7, 0x100000014);  // Suspend
  insert_record(table, 0x1008ff2f, 0x100010082);  // Sleep
  insert_record(table, 0x000000a5, 0x100070089);  // yen
  ...
  insert_record(table, 0x0000fe03, 0x400000102);  // ISO_Level3_Shift
