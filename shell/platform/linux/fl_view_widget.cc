        ...
        G_IMPLEMENT_INTERFACE(fl_renderable_get_type(),
            ...
            G_IMPLEMENT_INTERFACE(fl_plugin_registry_get_type(),
                ...
                G_IMPLEMENT_INTERFACE(
                    ...
                    G_IMPLEMENT_INTERFACE(
                        fl_scrolling_view_delegate_get_type(),
...
static GdkGLContext* create_context_cb(FlViewWidget* self) {
  ...
  self->mouse_cursor_handler =
      fl_mouse_cursor_handler_new(messenger, FL_VIEW(self));
...
static gboolean fl_view_widget_key_press_event(GtkWidget* widget,
                                               GdkEventKey* event) {
  FlViewWidget* self = FL_VIEW_WIDGET(widget);
...
static void fl_view_widget_class_init(FlViewWidgetClass* klass) {
  ...
  fl_view_widget_signals[kSignalFirstFrame] =
      g_signal_new("first-frame", fl_view_widget_get_type(), G_SIGNAL_RUN_LAST,
...
G_MODULE_EXPORT FlView* fl_view_widget_new(FlDartProject* project) {
  ...
  FlViewWidget* self =
      FL_VIEW_WIDGET(g_object_new(fl_view_widget_get_type(), nullptr));
