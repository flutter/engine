...
// Can be called on any thread. String passed into the function will NOT be
...
// thread. Can be called on any thread. String passed into the function will NOT
// be copied when added to the timeline. Only string literals may be passed in.
FLUTTER_EXPORT
...
// on any thread. String passed into the function will NOT be copied when added
