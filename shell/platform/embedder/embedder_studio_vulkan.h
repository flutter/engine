...
#ifndef FLUTTER_SHELL_PLATFORM_EMBEDDER_EMBEDDER_STUDIO_VULKAN_H_
#define FLUTTER_SHELL_PLATFORM_EMBEDDER_EMBEDDER_STUDIO_VULKAN_H_
...
class EmbedderStudioVulkan final : public EmbedderStudio,
 ...
 private:
  ...
  FML_DISALLOW_COPY_AND_ASSIGN(EmbedderStudioVulkan);
};

}  // namespace flutter

#endif  // FLUTTER_SHELL_PLATFORM_EMBEDDER_EMBEDDER_STUDIO_VULKAN_H_
