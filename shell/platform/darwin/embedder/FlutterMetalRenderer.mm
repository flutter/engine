...
static FlutterMetalTexture OnGetNextDrawable(FlutterEmbedderEngine* engine,
...
static bool OnPresentDrawable(FlutterEmbedderEngine* engine, const FlutterMetalTexture* texture) {
