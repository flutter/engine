...
class IOSRenderTargetGL final : public IOSRenderTarget {
 public:
  IOSRenderTargetGL(fml::scoped_nsobject<CALayer> layer,
                    fml::scoped_nsobject<EAGLContext> context,
                    fml::scoped_nsobject<EAGLContext> resource_context);

  // |IOSRenderTarget|
  ~IOSRenderTargetGL() override;
 ...
 private:
  ...
  // |IOSRenderTarget|
  bool PresentRenderBuffer() const override;

  // |IOSRenderTarget|
  intptr_t GetFramebuffer() const override;
