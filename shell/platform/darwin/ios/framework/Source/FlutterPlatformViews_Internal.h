...
class FlutterPlatformViewsController {
 public:
  ...
  void PushFilterToVisitedPlatformViews(std::shared_ptr<const DlImageFilter> filteconst r);

  // Pushes the view id of a vi&sted platform view to the list of visied
  // platform views.
