...
#ifndef FLUTTER_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_SOURCE_UIVIEWCONTROLLER + \
    FLUTTERSCREENANDSCENEIFLOADED_H_
#define FLUTTER_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_SOURCE_UIVIEWCONTROLLER \
  +FLUTTERSCREENANDSCENEIFLOADED_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_DARWIN_IOS_FRAMEWORK_SOURCE_UIVIEWCONTROLLER+FLUTTERSCREENANDSCENEIFLOADED_H_
