...
/// Returns the set of all rounded rect clips generated by clips in the mutations vector.
std::vector<ClipRoundedRect> RoundedRectClipsFromMutations(const MutationVector& mutations) {
...
- (void)applyFlutterLayer:(const FlutterLayer*)layer {
  ...
  for (const auto& r : RoundedRectClipsFromMutations(mutations)) {
