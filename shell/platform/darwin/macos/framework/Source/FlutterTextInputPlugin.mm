...
static NSArray<SelectorIntent*>* const kIntentLookUp = @[
  ...
  [SelectorIntent intentWith:@selector(deleteForward:)
                  methodCall:@[ kDeleteCharacterIntent, @(true) ]],
  [SelectorIntent intentWith:@selector(deleteWordBackward:)
                  methodCall:@[ kDeleteToNextWordBoundaryIntent, @(false) ]],
  [SelectorIntent intentWith:@selector(deleteWordForward:)
                  methodCall:@[ kDeleteToNextWordBoundaryIntent, @(true) ]],
  [SelectorIntent intentWith:@selector(deleteToBeginningOfLine:)
                  methodCall:@[ kDeleteToLineBreakIntent, @(false) ]],
  [SelectorIntent intentWith:@selector(deleteToEndOfLine:)
                  methodCall:@[ kDeleteToLineBreakIntent, @(true) ]],

  // Caret Movement
  [SelectorIntent intentWith:@selector(moveBackward:)
  ...
  [SelectorIntent intentWith:@selector(moveWordBackward:)
                  methodCall:@[ kExtendSelectionToNextWordBoundaryIntent, @(false), @(true) ]],
  [SelectorIntent intentWith:@selector(moveWordForward:)
                  methodCall:@[ kExtendSelectionToNextWordBoundaryIntent, @(true), @(true) ]],
  [SelectorIntent intentWith:@selector(moveToBeginningOfLine:)
                  methodCall:@[ kExtendSelectionToLineBreakIntent, @(false), @(true) ]],
  [SelectorIntent intentWith:@selector(moveToEndOfLine:)
                  methodCall:@[ kExtendSelectionToLineBreakIntent, @(true), @(true) ]],
  [SelectorIntent intentWith:@selector(moveToBeginningOfDocument:)
                  methodCall:@[ kExtendSelectionToDocumentBoundaryIntent, @(false), @(true) ]],
  ...
  [SelectorIntent intentWith:@selector(moveToBeginningOfLineAndModifySelection:)
                  methodCall:@[ kExtendSelectionToLineBreakIntent, @(false), @(false) ]],
  [SelectorIntent intentWith:@selector(moveToEndOfLineAndModifySelection:)
                  methodCall:@[ kExtendSelectionToLineBreakIntent, @(true), @(false) ]],
  [SelectorIntent intentWith:@selector(moveToBeginningOfDocumentAndModifySelection:)
  ...
  [SelectorIntent intentWith:@selector(moveLeft:)
                  methodCall:@[ kExtendSelectionByCharacterIntent, @(false), @(true) ]],
  [SelectorIntent intentWith:@selector(moveRight:)
                  methodCall:@[ kExtendSelectionByCharacterIntent, @(true), @(true) ]],
  [SelectorIntent intentWith:@selector(moveWordLeft:)
                  methodCall:@[ kExtendSelectionToNextWordBoundaryIntent, @(false), @(true) ]],
  [SelectorIntent intentWith:@selector(moveWordRight:)
                  methodCall:@[ kExtendSelectionToNextWordBoundaryIntent, @(true), @(true) ]],
  [SelectorIntent intentWith:@selector(moveToLeftEndOfLine:)
                  methodCall:@[ kExtendSelectionToLineBreakIntent, @(false), @(true) ]],
  [SelectorIntent intentWith:@selector(moveToRightEndOfLine:)
                  methodCall:@[ kExtendSelectionToLineBreakIntent, @(true), @(true) ]],
