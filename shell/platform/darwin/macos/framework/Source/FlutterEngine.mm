...
- (void)updateWindowMetrics {
  ...
  const FlutterWindowMetricsEvent windowMetricsEvent = {
      ...
      .left = static_cast<int64_t>(scaledBounds.origin.x),
      .top = static_cast<int64_t>(scaledBounds.origin.y),
      .window_id = 0,
  };
...
- (void)updateScreenMetrics {
  ...
  const FlutterScreenMetricsEvent screenMetricsEvent = {
      ...
      .screen_id = 0,
      .left = static_cast<int64_t>(screenBounds.origin.x),
      .top = static_cast<int64_t>(screenBounds.origin.y),
