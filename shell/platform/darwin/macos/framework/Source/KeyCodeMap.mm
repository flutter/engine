...
const NSDictionary* keyCodeToLogicalKey = @{
  @0x00000033 : @0x01000000008,  // Backspace
  @0x00000035 : @0x0100000001b,  // Escape
  @0x00000075 : @0x0100000007f,  // Delete
  @0x00000039 : @0x01000000104,  // CapsLock
  @0x0000003f : @0x01000000106,  // Fn
  @0x00000047 : @0x0100000010a,  // NumLock
  @0x0000007d : @0x01000000301,  // ArrowDown
  @0x0000007b : @0x01000000302,  // ArrowLeft
  @0x0000007c : @0x01000000303,  // ArrowRight
  @0x0000007e : @0x01000000304,  // ArrowUp
  @0x00000077 : @0x01000000305,  // End
  @0x00000073 : @0x01000000306,  // Home
  @0x00000079 : @0x01000000307,  // PageDown
  @0x00000074 : @0x01000000308,  // PageUp
  @0x00000072 : @0x01000000407,  // Insert
  @0x0000006e : @0x01000000505,  // ContextMenu
  @0x0000007a : @0x01000000801,  // F1
  @0x00000078 : @0x01000000802,  // F2
  @0x00000063 : @0x01000000803,  // F3
  @0x00000076 : @0x01000000804,  // F4
  @0x00000060 : @0x01000000805,  // F5
  @0x00000061 : @0x01000000806,  // F6
  @0x00000062 : @0x01000000807,  // F7
  @0x00000064 : @0x01000000808,  // F8
  @0x00000065 : @0x01000000809,  // F9
  @0x0000006d : @0x0100000080a,  // F10
  @0x00000067 : @0x0100000080b,  // F11
  @0x0000006f : @0x0100000080c,  // F12
  @0x00000069 : @0x0100000080d,  // F13
  @0x0000006b : @0x0100000080e,  // F14
  @0x00000071 : @0x0100000080f,  // F15
  @0x0000006a : @0x01000000810,  // F16
  @0x00000040 : @0x01000000811,  // F17
  @0x0000004f : @0x01000000812,  // F18
  @0x00000050 : @0x01000000813,  // F19
  @0x0000005a : @0x01000000814,  // F20
  @0x00000049 : @0x01000000a0f,  // AudioVolumeDown
  @0x00000048 : @0x01000000a10,  // AudioVolumeUp
  @0x0000004a : @0x01000000a11,  // AudioVolumeMute
  @0x0000005e : @0x01100070087,  // IntlRo
  @0x0000005d : @0x01100070089,  // IntlYen
  @0x00000068 : @0x01100070090,  // Lang1
  @0x00000066 : @0x01100070091,  // Lang2
  @0x0000003a : @0x30000000102,  // AltLeft
  @0x0000003b : @0x30000000105,  // ControlLeft
  @0x00000037 : @0x30000000109,  // MetaLeft
  @0x00000038 : @0x3000000010d,  // ShiftLeft
  @0x0000003d : @0x40000000102,  // AltRight
  @0x0000003e : @0x40000000105,  // ControlRight
  @0x00000036 : @0x40000000109,  // MetaRight
  @0x0000003c : @0x4000000010d,  // ShiftRight
  @0x0000004c : @0x5000000000d,  // NumpadEnter
  @0x00000043 : @0x5000000002a,  // NumpadMultiply
  @0x00000045 : @0x5000000002b,  // NumpadAdd
  @0x0000005f : @0x5000000002c,  // NumpadComma
  @0x0000004e : @0x5000000002d,  // NumpadSubtract
  @0x00000041 : @0x5000000002e,  // NumpadDecimal
  @0x0000004b : @0x5000000002f,  // NumpadDivide
  @0x00000052 : @0x50000000030,  // Numpad0
  @0x00000053 : @0x50000000031,  // Numpad1
  @0x00000054 : @0x50000000032,  // Numpad2
  @0x00000055 : @0x50000000033,  // Numpad3
  @0x00000056 : @0x50000000034,  // Numpad4
  @0x00000057 : @0x50000000035,  // Numpad5
  @0x00000058 : @0x50000000036,  // Numpad6
  @0x00000059 : @0x50000000037,  // Numpad7
  @0x0000005b : @0x50000000038,  // Numpad8
  @0x0000005c : @0x50000000039,  // Numpad9
  @0x00000051 : @0x5000000003d,  // NumpadEqual
};
