...
const std::vector<LayoutPreset> layoutPresets = {
  LayoutPreset{0x31, 0x20, false}, // Space
  LayoutPreset{0x27, 0x22, false}, // Quote
  LayoutPreset{0x2b, 0x2c, false}, // Comma
  LayoutPreset{0x1b, 0x2d, false}, // Minus
  LayoutPreset{0x2f, 0x2e, false}, // Period
  LayoutPreset{0x2c, 0x2f, false}, // Slash
  LayoutPreset{0x1d, 0x30, true},  // Digit0
  LayoutPreset{0x12, 0x31, true},  // Digit1
  LayoutPreset{0x13, 0x32, true},  // Digit2
  LayoutPreset{0x14, 0x33, true},  // Digit3
  LayoutPreset{0x15, 0x34, true},  // Digit4
  LayoutPreset{0x17, 0x35, true},  // Digit5
  LayoutPreset{0x16, 0x36, true},  // Digit6
  LayoutPreset{0x1a, 0x37, true},  // Digit7
  LayoutPreset{0x1c, 0x38, true},  // Digit8
  LayoutPreset{0x19, 0x39, true},  // Digit9
  LayoutPreset{0x29, 0x3b, false}, // Semicolon
  LayoutPreset{0x18, 0x3d, false}, // Equal
  LayoutPreset{0x21, 0x5b, false}, // BracketLeft
  LayoutPreset{0x2a, 0x5c, false}, // Backslash
  LayoutPreset{0x1e, 0x5d, false}, // BracketRight
  LayoutPreset{0x32, 0x60, false}, // Backquote
  LayoutPreset{0x00, 0x61, true},  // KeyA
  LayoutPreset{0x0b, 0x62, true},  // KeyB
  LayoutPreset{0x08, 0x63, true},  // KeyC
  LayoutPreset{0x02, 0x64, true},  // KeyD
  LayoutPreset{0x0e, 0x65, true},  // KeyE
  LayoutPreset{0x03, 0x66, true},  // KeyF
  LayoutPreset{0x05, 0x67, true},  // KeyG
  LayoutPreset{0x04, 0x68, true},  // KeyH
  LayoutPreset{0x22, 0x69, true},  // KeyI
  LayoutPreset{0x26, 0x6a, true},  // KeyJ
  LayoutPreset{0x28, 0x6b, true},  // KeyK
  LayoutPreset{0x25, 0x6c, true},  // KeyL
  LayoutPreset{0x2e, 0x6d, true},  // KeyM
  LayoutPreset{0x2d, 0x6e, true},  // KeyN
  LayoutPreset{0x1f, 0x6f, true},  // KeyO
  LayoutPreset{0x23, 0x70, true},  // KeyP
  LayoutPreset{0x0c, 0x71, true},  // KeyQ
  LayoutPreset{0x0f, 0x72, true},  // KeyR
  LayoutPreset{0x01, 0x73, true},  // KeyS
  LayoutPreset{0x11, 0x74, true},  // KeyT
  LayoutPreset{0x20, 0x75, true},  // KeyU
  LayoutPreset{0x09, 0x76, true},  // KeyV
  LayoutPreset{0x0d, 0x77, true},  // KeyW
  LayoutPreset{0x07, 0x78, true},  // KeyX
  LayoutPreset{0x10, 0x79, true},  // KeyY
  LayoutPreset{0x06, 0x7a, true},  // KeyZ
};
