...
#ifndef FLUTTER_SHELL_PLATFORM_DARWIN_GRAPHICS_IOS_EXTERNAL_TEXTURE_METAL_H_
#define FLUTTER_SHELL_PLATFORM_DARWIN_GRAPHICS_IOS_EXTERNAL_TEXTURE_METAL_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_DARWIN_GRAPHICS_IOS_EXTERNAL_TEXTURE_METAL_H_
