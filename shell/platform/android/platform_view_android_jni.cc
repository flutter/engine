...
static void RunBundleAndSnapshot(JNIEnv* env,
  ...
  return PLATFORM_VIEW->RunBundleAndSnapshot(env, bundlePath, snapshotOverride);
}
...
void RunBundleAndSource(JNIEnv* env,
                        ...
                        jstring main,
                        jstring packages) {
  return PLATFORM_VIEW->RunBundleAndSource(env, bundlePath, main, packages);
}
...
static void DispatchPlatformMessage(JNIEnv* env,
                                    ...
                                    jstring message,
                                    jint responseId) {
  return PLATFORM_VIEW->DispatchPlatformMessage(env, channel, message,
                                                responseId);
}
...
static void InvokePlatformMessageResponseCallback(JNIEnv* env,
                                                  ...
                                                  jint responseId,
                                                  jstring message) {
  return PLATFORM_VIEW->InvokePlatformMessageResponseCallback(env, responseId,
                                                              message);
}
