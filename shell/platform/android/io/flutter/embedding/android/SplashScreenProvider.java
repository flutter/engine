 ...
 * it's no longer necessary to display a splash screen to wait for the Flutter first frame, and thus,
 * there is no longer a need to provide an implementation of this interface.
 *
 * @deprecated
 */
@Deprecated
