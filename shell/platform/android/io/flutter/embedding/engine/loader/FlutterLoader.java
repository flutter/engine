...
public class FlutterLoader {
  ...
  private static final String DISABLE_PARTIAL_REPAINT_META_DATA_KEY =
      "io.flutter.embedding.android.DisablePartialRepaint";
  ...
  public void ensureInitializationComplete(
    ...
    try {
      ...
      if (metaData != null && metaData.getBoolean(DISABLE_PARTIAL_REPAINT_META_DATA_KEY, false)) {
        shellArgs.add("--disable-partial-repaint");
      }
