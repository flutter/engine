 ...
 *       android.app.Activity} should invoke {@link #attachToHostComponent( ExclusiveAppComponent,
 *       Lifecycle)}. At this point the {@link io.flutter.embedding.engine.FlutterEngine} is
 *       considered "attached" to the {@link android.app.Activity} and all {@link
 *       HostComponentAware} plugins are given access to the {@link android.app.Activity}.
 ...
 *       an opportunity to clean up its references before the {@link android.app.Activity is
 *       destroyed}.
 ...
 *       should invoke {@link #detachFromHostComponent()}.
 ...
 * all {@link HostComponentAware} plugins that are added to the attached {@link
 * io.flutter.embedding.engine.FlutterEngine}.
 */
public interface HostComponentControlSurface {
   ...
   * {@link ExclusiveAppComponent}'s {@link android.app.Activity}.
   */
