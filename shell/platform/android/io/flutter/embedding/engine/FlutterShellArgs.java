...
public class FlutterShellArgs {
  ...
  public static final String ARG_KEY_IMPELLER_USE_GL = "impeller-use-gl";
  public static final String ARG_IMPELLER_USE_GL = "--impeller-use-gl";
  ...
  public static FlutterShellArgs fromIntent(@NonNull Intent intent) {
    ...
    if (intent.getBooleanExtra(ARG_KEY_IMPELLER_USE_GL, false)) {
      args.add(ARG_IMPELLER_USE_GL);
    }
