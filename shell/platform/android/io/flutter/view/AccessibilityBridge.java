...
public class AccessibilityBridge extends AccessibilityNodeProvider {
    ...
    // The virtual ID of the currently embedded focused node.
    //
    ...
    public AccessibilityNodeInfo findFocus(int focus) {
        switch (focus) {
            ...
            case AccessibilityNodeInfo.FOCUS_ACCESSIBILITY: {
                ...
                if (embeddedFocusedNodeId != -1) {
                    return createAccessibilityNodeInfo(embeddedFocusedNodeId);
                }
            }
        }
        return null;
    ...
    public boolean externalViewRequestSendAccessibilityEvent(View embeddedView, View eventOrigin, AccessibilityEvent event) {
        boolean didSendEvent = accessibilityViewEmbedder.requestSendAccessibilityEvent(embeddedView, eventOrigin, event);
        if (didSendEvent && event.getEventType() == AccessibilityEvent.TYPE_VIEW_ACCESSIBILITY_FOCUSED) {
            Integer virtualNodeId = accessibilityViewEmbedder.getRecordFlutterId(embeddedView, event);
            if (virtualNodeId != null) {
                embeddedFocusedNodeId = virtualNodeId;
                accessibilityFocusedSemanticsNode = null;
            }
        }
        return didSendEvent;
