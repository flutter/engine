 ...
 */
@TargetApi(23)
class TextureLayerPlatformViewWrapper extends PlatformViewWrapper {
  private static final String TAG = "TextureLayerPlatformViewWrapper";
  ...
  public TextureLayerPlatformViewWrapper(@NonNull Context context) {
    super(context);
    setWillNotDraw(false);
  }

  public TextureLayerPlatformViewWrapper(
