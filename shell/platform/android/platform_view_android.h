...
class PlatformViewAndroid : public PlatformView {
 ...
 private:
  ...
  bool InitializeGPUSurface(ftl::RefPtr<AndroidNativeWindow> native_window);

  bool InitializeGLSurface(ftl::RefPtr<AndroidNativeWindow> native_window);

  bool InitializeVulkanSurface(ftl::RefPtr<AndroidNativeWindow> native_window);
