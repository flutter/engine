...
public class ScribePluginTest {
  ...
  public void respondsToSpellCheckChannelMessage() {
    ...
    ScribeChannel.ScribeMethodHandler mockHandler =
        mock(ScribeChannel.ScribeMethodHandler.class);
  ...
  public void initiateSpellCheckPerformsSpellCheckWhenNoResultPending() {
    ScribeChannel fakeScribeChannel = mock(ScribeChannel.class);
    ...
    ScribePlugin scribePlugin =
        spy(new ScribePlugin(testView, testImm, fakeScribeChannel));
