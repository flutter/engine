...
public class TextInputPluginTest {
  ...
  // Verifies the above test does not crash on lower API levels.
  @Config(sdk = 26)
  @Test
  public void setTextInputEditingState_alwaysRestartsOnAffectedDevicesSDK26() {
    // Initialize a TextInputPlugin with a Samsung keypad.
    ShadowBuild.setManufacturer("samsung");
    final ShadowPackageManager packageManager =
        Shadows.shadowOf(
  ...
  @Config(sdk = 26)
  @Test
  public void setTextInputEditingState_DontForceRestartOnNewSamsungKeyboardSDK26() {
    // Initialize a TextInputPlugin with a Samsung keypad.
    ShadowBuild.setManufacturer("samsung");
    final ShadowPackageManager packageManager =
        Shadows.shadowOf(
