...
public class ListenableEditingStateTest {
    ...
    public void testBatchEditing() {
        final ListenableEditingState editingState = new ListenableEditingState(null, new View(RuntimeEnvironment.application));
    ...
    public void inputMethod_testSetSelection() {
        ...
        final Listener listener = new Listener();
        final View testView = new View(RuntimeEnvironment.application);
        final InputConnectionAdaptor inputConnection = new InputConnectionAdaptor(testView, 0, mock(TextInputChannel.class), editingState, new EditorInfo());
