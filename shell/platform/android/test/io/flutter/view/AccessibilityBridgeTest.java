...
public class AccessibilityBridgeTest {
    ...
    AccessibilityBridge setUpBridge() {
        ...
        PlatformViewsAccessibilityDelegate platformViewsAccessibilityDelegate = mock(PlatformViewsAccessibilityDelegate.class);
        AccessibilityBridge accessibilityBridge = new AccessibilityBridge(
            view,
