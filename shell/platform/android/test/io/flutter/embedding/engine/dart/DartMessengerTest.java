...
public class DartMessengerTest {
  ...
  private static class SynchronousTaskQueue implements BinaryMessenger.TaskQueue {
  ...
  public void itHandlesErrors() {
    ...
    messenger.setMessageHandler("test", throwingHandler, synchronousTaskQueue);
  ...
  public void givesDirectByteBuffer() {
    ...
    messenger.setMessageHandler(channel, handler, synchronousTaskQueue);
