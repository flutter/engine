...
class AndroidShellHolder {
 ...
 public:
  ...
  // `io.flutter.embedded_views_preview` flag. This can be static because it is determined by
  // the application and it is safe when there are multiple `AndroidSurface`s.
  // TODO(cyanglaz): remove this when dynamic thread merging is enabled on android.
