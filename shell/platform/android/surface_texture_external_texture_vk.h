...
class SurfaceTextureExternalTextureImpellerVK final
 ...
 public:
  ...
  ~SurfaceTextureExternalTextureImpellerVK() override;
 ...
 private:
  ...
  FML_DISALLOW_COPY_AND_ASSIGN(SurfaceTextureExternalTextureImpellerVK);
};
