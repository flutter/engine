...
class PlatformAndroidThreadConfigurer : public flutter::ThreadConfigurer {
 public:
  void SetThreadPriority(fml::ThreadPriority priority) {
    switch (priority) {
...
AndroidShellHolder::AndroidShellHolder(
  ...
  thread_host_ = std::make_shared<ThreadHost>(
      ...
      std::make_unique<PlatformAndroidThreadConfigurer>());
