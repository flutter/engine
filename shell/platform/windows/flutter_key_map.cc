...
std::map<uint64_t, uint64_t> KeyboardKeyEmbedderHandler::windowsToLogicalMap_ =
    {
        ...
        {0x00000008, 0x01000000008},  // BACK
        {0x00000009, 0x01000000009},  // TAB
        {0x0000000d, 0x0100000000d},  // RETURN
        {0x0000001b, 0x0100000001b},  // ESCAPE
        {0x0000002e, 0x0100000007f},  // DELETE
        {0x00000014, 0x01000000104},  // CAPITAL
        {0x00000090, 0x0100000010a},  // NUMLOCK
        {0x00000091, 0x0100000010c},  // SCROLL
        {0x00000028, 0x01000000301},  // DOWN
        {0x00000025, 0x01000000302},  // LEFT
        {0x00000027, 0x01000000303},  // RIGHT
        {0x00000026, 0x01000000304},  // UP
        {0x00000023, 0x01000000305},  // END
        {0x00000024, 0x01000000306},  // HOME
        {0x00000022, 0x01000000307},  // NEXT
        {0x00000021, 0x01000000308},  // PRIOR
        {0x0000000c, 0x01000000401},  // CLEAR
        {0x0000002d, 0x01000000407},  // INSERT
        {0x0000001e, 0x01000000501},  // ACCEPT
        {0x000000f6, 0x01000000503},  // ATTN
        {0x00000003, 0x01000000504},  // CANCEL
        {0x0000005d, 0x01000000505},  // APPS
        {0x0000002b, 0x01000000506},  // EXECUTE
        {0x0000002f, 0x01000000508},  // HELP
        {0x00000013, 0x01000000509},  // PAUSE
        {0x000000fa, 0x0100000050a},  // PLAY
        {0x00000029, 0x0100000050c},  // SELECT
        {0x0000001c, 0x01000000705},  // CONVERT
        {0x00000018, 0x01000000706},  // FINAL
        {0x0000001f, 0x0100000070b},  // MODECHANGE
        {0x00000019, 0x01000000712},  // HANJA
        {0x00000017, 0x01000000713},  // JUNJA
        {0x00000019, 0x01000000719},  // KANJI
        {0x00000070, 0x01000000801},  // F1
        {0x00000071, 0x01000000802},  // F2
        {0x00000072, 0x01000000803},  // F3
        {0x00000073, 0x01000000804},  // F4
        {0x00000074, 0x01000000805},  // F5
        {0x00000075, 0x01000000806},  // F6
        {0x00000076, 0x01000000807},  // F7
        {0x00000077, 0x01000000808},  // F8
        {0x00000078, 0x01000000809},  // F9
        {0x00000079, 0x0100000080a},  // F10
        {0x0000007a, 0x0100000080b},  // F11
        {0x0000007b, 0x0100000080c},  // F12
        {0x0000007c, 0x0100000080d},  // F13
        {0x0000007d, 0x0100000080e},  // F14
        {0x0000007e, 0x0100000080f},  // F15
        {0x0000007f, 0x01000000810},  // F16
        {0x00000080, 0x01000000811},  // F17
        {0x00000081, 0x01000000812},  // F18
        {0x00000082, 0x01000000813},  // F19
        {0x00000083, 0x01000000814},  // F20
        {0x00000084, 0x01000000815},  // F21
        {0x00000085, 0x01000000816},  // F22
        {0x00000086, 0x01000000817},  // F23
        {0x00000087, 0x01000000818},  // F24
        {0x000000b3, 0x01000000a05},  // MEDIA_PLAY_PAUSE
        {0x000000b2, 0x01000000a07},  // MEDIA_STOP
        {0x0000002a, 0x01000000a0c},  // PRINT
        {0x000000ae, 0x01000000a0f},  // VOLUME_DOWN
        {0x000000af, 0x01000000a10},  // VOLUME_UP
        {0x000000ad, 0x01000000a11},  // VOLUME_MUTE
        {0x000000b4, 0x01000000b03},  // LAUNCH_MAIL
        {0x000000a6, 0x01000000c01},  // BROWSER_BACK
        {0x000000ab, 0x01000000c02},  // BROWSER_FAVORITES
        {0x000000a7, 0x01000000c03},  // BROWSER_FORWARD
        {0x000000ac, 0x01000000c04},  // BROWSER_HOME
        {0x000000a8, 0x01000000c05},  // BROWSER_REFRESH
        {0x000000aa, 0x01000000c06},  // BROWSER_SEARCH
        {0x000000a9, 0x01000000c07},  // BROWSER_STOP
        {0x000000c3, 0x0100005ff08},  // GAMEPAD_A
        {0x000000c4, 0x0100005ff09},  // GAMEPAD_B
        {0x000000c5, 0x0100005ff0a},  // GAMEPAD_X
        {0x000000c6, 0x0100005ff0b},  // GAMEPAD_Y
        {0x000000c7, 0x0100005ff0c},  // GAMEPAD_RIGHT_SHOULDER
        {0x000000c8, 0x0100005ff0d},  // GAMEPAD_LEFT_SHOULDER
        {0x000000c9, 0x0100005ff0e},  // GAMEPAD_LEFT_TRIGGER
        {0x000000ca, 0x0100005ff0f},  // GAMEPAD_RIGHT_TRIGGER
        {0x000000cb, 0x0100005ff10},  // GAMEPAD_DPAD_UP
        {0x0000005f, 0x01100010082},  // SLEEP
        {0x00000015, 0x01100070090},  // KANA, HANGEUL, HANGUL
        {0x000000a4, 0x30000000102},  // LMENU
        {0x00000011, 0x30000000105},  // CONTROL
        {0x000000a2, 0x30000000105},  // LCONTROL
        {0x0000005b, 0x30000000109},  // LWIN
        {0x00000010, 0x3000000010d},  // SHIFT
        {0x000000a0, 0x3000000010d},  // LSHIFT
        {0x000000a5, 0x40000000102},  // RMENU
        {0x000000a3, 0x40000000105},  // RCONTROL
        {0x0000005c, 0x40000000109},  // RWIN
        {0x000000a1, 0x4000000010d},  // RSHIFT
        {0x0000006a, 0x5000000002a},  // MULTIPLY
        {0x0000006b, 0x5000000002b},  // ADD
        {0x0000006d, 0x5000000002d},  // SUBTRACT
        {0x0000006e, 0x5000000002e},  // DECIMAL
        {0x0000006f, 0x5000000002f},  // DIVIDE
        {0x00000060, 0x50000000030},  // NUMPAD0
        {0x00000061, 0x50000000031},  // NUMPAD1
        {0x00000062, 0x50000000032},  // NUMPAD2
        {0x00000063, 0x50000000033},  // NUMPAD3
        {0x00000064, 0x50000000034},  // NUMPAD4
        {0x00000065, 0x50000000035},  // NUMPAD5
        {0x00000066, 0x50000000036},  // NUMPAD6
        {0x00000067, 0x50000000037},  // NUMPAD7
        {0x00000068, 0x50000000038},  // NUMPAD8
        {0x00000069, 0x50000000039},  // NUMPAD9
        {0x00000092, 0x5000000003d},  // OEM_NEC_EQUAL
};

std::map<uint64_t, uint64_t> KeyboardKeyEmbedderHandler::scanCodeToLogicalMap_ =
    {
        {0x0000e01d, 0x40000000105},  // ControlRight
        {0x0000e038, 0x40000000102},  // AltRight
        {0x0000004f, 0x50000000031},  // Numpad1
        {0x00000050, 0x50000000032},  // Numpad2
        {0x00000051, 0x50000000033},  // Numpad3
        {0x0000004b, 0x50000000034},  // Numpad4
        {0x0000004c, 0x50000000035},  // Numpad5
        {0x0000004d, 0x50000000036},  // Numpad6
        {0x00000047, 0x50000000037},  // Numpad7
        {0x00000048, 0x50000000038},  // Numpad8
        {0x00000049, 0x50000000039},  // Numpad9
        {0x00000052, 0x50000000030},  // Numpad0
        {0x0000004e, 0x5000000002b},  // NumpadAdd
        {0x00000053, 0x5000000002e},  // NumpadDecimal
        {0x0000e035, 0x5000000002f},  // NumpadDivide
        {0x00000059, 0x5000000003d},  // NumpadEqual
        {0x00000037, 0x5000000002a},  // NumpadMultiply
        {0x0000004a, 0x5000000002d},  // NumpadSubtract
};
