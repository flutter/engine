...
uint64_t KeyboardKeyEmbedderHandler::getPhysicalKey(int scancode, bool extended) {
...
uint64_t KeyboardKeyEmbedderHandler::getLogicalKey(int key, bool extended, int scancode) {
