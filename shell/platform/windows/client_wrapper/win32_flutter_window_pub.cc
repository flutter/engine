...
//FlutterDesktopViewControllerRef Win32FlutterWindowPub::CreateWin32FlutterWindowPub(
//    const int width,
//    const int height) {
//  auto state = std::make_unique<FlutterDesktopViewControllerState>();
//  state->view = std::make_unique<flutter::Win32FlutterWindowPub>(width, height);
//
...
//void Win32FlutterWindowPub::SetState(FLUTTER_API_SYMBOL(FlutterEngine) eng) {
//  engine_ = eng;
//
...
//FlutterDesktopPluginRegistrarRef Win32FlutterWindowPub::GetRegistrar() {
...
//// are available.
//void Win32FlutterWindowPub::HandlePlatformMessage(
//    const FlutterPlatformMessage* engine_message) {
...
//void Win32FlutterWindowPub::SetEventLocationFromCursorPosition(
...
//void Win32FlutterWindowPub::SetEventPhaseFromCursorButtonState(
//    FlutterPointerEvent* event_data) {
...
//void Win32FlutterWindowPub::SendPointerDown(double x, double y) {
//  FlutterPointerEvent event = {};
//  SetEventPhaseFromCursorButtonState(&event);
//  event.x = x;
//  event.y = y;
...
//void Win32FlutterWindowPub::SendPointerUp(double x, double y) {
//  FlutterPointerEvent event = {};
//  SetEventPhaseFromCursorButtonState(&event);
//  event.x = x;
//  event.y = y;
...
//void Win32FlutterWindowPub::SendText(const std::u16string& text) {
//  for (const auto& handler : keyboard_hook_handlers_) {
//    handler->TextHook(this, text);
//  }
//}

//void Win32FlutterWindowPub::SendKey(int key,
//                                 int scancode,
//                                 int action,
//                                 char32_t character) {
//  for (const auto& handler : keyboard_hook_handlers_) {
...
//void Win32FlutterWindowPub::SendScroll(double delta_x, double delta_y) {
//  FlutterPointerEvent event = {};
...
//void Win32FlutterWindowPub::SendPointerEventWithData(
