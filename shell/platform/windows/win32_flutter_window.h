...
class Win32FlutterWindow : public Win32Window {
 public:
  ...
  // |Win32Window|
  void OnKey(int key, int scancode, int action, int mods, char32_t character) override;
 ...
 private:
  ...
  void SendKey(int key, int scancode, int action, int mods, char32_t character);
