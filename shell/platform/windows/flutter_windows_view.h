...
class FlutterWindowsView : public WindowBindingHandlerDelegate {
 public:
  ...
  // |WindowBindingHandlerDelegate|
  void OnKey(int key, int scancode, int action, char32_t character, int repeats) override;
 ...
 private:
  ...
  void SendKey(int key, int scancode, int action, char32_t character, int repeats);
