...
#ifndef FLUTTER_SHELL_PLATFORM_CPP_PUBLIC_FLUTTER_EXPORT_H_
#define FLUTTER_SHELL_PLATFORM_CPP_PUBLIC_FLUTTER_EXPORT_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_CPP_PUBLIC_FLUTTER_EXPORT_H_