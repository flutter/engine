...
#ifndef SHELL_PLATFORM_FUCHSIA_FLUTTER_INTEGRATION_FLUTTER_TESTS_EMBEDDER_FLUTTER_EMBEDDER_TEST_H_
#define SHELL_PLATFORM_FUCHSIA_FLUTTER_INTEGRATION_FLUTTER_TESTS_EMBEDDER_FLUTTER_EMBEDDER_TEST_H_
...
constexpr zx::duration kTestTimeout = zx::sec(20);
 ...
 public:
  ...
  void SetUp() override {
    ...
    environment_ = CreateNewEnclosingEnvironment(
        "flutter_runner_integration_tests", std::move(services),
...
#endif  // SHELL_PLATFORM_FUCHSIA_FLUTTER_INTEGRATION_FLUTTER_TESTS_EMBEDDER_FLUTTER_EMBEDDER_TEST_H_
