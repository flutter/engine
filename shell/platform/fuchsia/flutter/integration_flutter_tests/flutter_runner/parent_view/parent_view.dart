...
// `engine`.
const _kChildAppUrl =
    'fuchsia-pkg://fuchsia.com/flutter_runner_integration_tests#meta/child_view.cmx';
...
void main(List<String> args) {
  ...
  for (final option in arguments.options) {
    print('parent_view: $option: ${arguments[option]}');
  }
...
class TestApp {
  ...
  void run() {
    childView.create(hitTestable, focusable, (ByteData reply) {
        // The child_view should be attached to Scenic now.
