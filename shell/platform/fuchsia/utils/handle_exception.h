...
#ifndef FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_HANDLE_EXCEPTION_H_
#define FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_HANDLE_EXCEPTION_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_HANDLE_EXCEPTION_H_
