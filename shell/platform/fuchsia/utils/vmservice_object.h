...
#ifndef FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_VMSERVICE_OBJECT_H_
#define FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_VMSERVICE_OBJECT_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_VMSERVICE_OBJECT_H_
