...
#ifndef FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_FILES_H_
#define FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_FILES_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_FUCHSIA_UTILS_FILES_H_
