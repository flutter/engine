...
fuchsia::feedback::CrashReport BuildCrashReport(
  ...
  // Truncate error message to the maximum length allowed for the crash_reporter FIDL
  // call
  error_message = error_message.substr(0, fuchsia::feedback::MAX_EXCEPTION_MESSAGE_LENGTH - 1);
