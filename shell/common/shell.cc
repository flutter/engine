...
void Shell::SetAssetBundlePathInPlatformView(uintptr_t view_id,
  ...
  blink::Threads::UI()->PostTask([this, view_id,
                                  asset_directory, view_existed,
                                  dart_isolate_id, isolate_name, &latch]() {
    SetAssetBundlePathInPlatformViewUIThread(view_id,
                              asset_directory, view_existed, dart_isolate_id,
                              isolate_name, &latch);
  });
  latch.Wait();
...
void Shell::SetAssetBundlePathInPlatformViewUIThread(uintptr_t view_id,
    const std::string& assets_directory,
    bool* view_existed,
    int64_t* dart_isolate_id,
    std::string* isolate_name,
