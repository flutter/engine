...
vars = {
  ...
  'skia_revision': '2bcc2e8682a6027275f096895f074dca692b5614',
  ...
  'dart_revision': 'ee7aaca9adcca9896fa5e3a013a6689a302dd8ff',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '1169f6b4ae5caa36c9300d0322f717e1b768c83f',
     ...
     'packages': [
       {
        ...
        'version': 'LnToEykA8o68jv58KK__qkkikDLpUI4MCKQUqKv2dRkC'
       }
     ],
