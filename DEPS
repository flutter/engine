...
vars = {
  ...
  'skia_revision': 'd6266ef14a7efb9531d7e7f9234d74f2de27861b',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'c4c880ad2d944295c43211facb9ce454bdb2857c',
     ...
     'packages': [
       {
        ...
        'version': 'sk7JBGzW1Jw10Wy-TPCTa9rp1SvNoaleR0wHIpz7HBEC'
       }
     ],
