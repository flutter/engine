...
vars = {
  ...
  'dart_revision': 'eb38d2a03bd29fb6facc9ee69c5a3c1597b3556e',
     ...
     'packages': [
       {
        ...
        'version': 'phQJtGCXSvLRoDa5FmDDsRjtlVYXaWOObX2QGIDvQkYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'mrlGt8orrctB1odPPi2y86zcePIljNeeXc_2GIsrHgYC'
       }
     ],
