...
vars = {
  ...
  'skia_revision': '93f245da00971442509c7059948683691d9e1eae',
  ...
  'dart_revision': '7896a944fe67888de5e2ff038a28aa98eb41af89',
     ...
     'packages': [
       {
        ...
        'version': 'T1xAi_ww_mWEiDkVNUaQtFwBwGxODzd7riEluRrecIoC'
       }
     ],
