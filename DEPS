...
vars = {
  ...
  'skia_revision': '7b931f8f78269eeaffecc711576264c3655354ec',
  ...
  'dart_revision': '93ff88f22f01a563f68584b016dc8eba616c2324',
     ...
     'packages': [
       {
        ...
        'version': '2Py2O7FIT6t_qqFiA88r7xvHhejcOwTMZ_XpM2BNjZYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
