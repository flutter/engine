...
vars = {
  ...
  'skia_revision': 'f123f06aabd662ccf10bb2fd4eb2fc3a53d3aa64',
  ...
  'dart_revision': 'd074bb1596560b43d853d046b06633b1cec916b5',
     ...
     'packages': [
       {
        ...
        'version': 'SuveIis7aHH0QCiznkm9L1vYSYJWBdjGVg5w6_XdrLgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'lgSTCr2XPzOhNq3b5Z8wN8QT9ma9NKDb_7sAfj-5ztYC'
       }
     ],
