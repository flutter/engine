...
vars = {
  ...
  'skia_revision': '39872b74befa16c78197191fab3d96eb2a87020f',
     ...
     'packages': [
       {
        ...
        'version': 'zMsA25xanikJHkHihg9RHQtVdbkDoyBSoO3Zw9OMBXEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'SKwp79KB0ajYPfbazRYKmmz1SujBNTSgBjQRebPGjfAC'
       }
     ],
