...
vars = {
  ...
  'skia_revision': '44444cccb802de3e1e2a7a5e5315e9dd5ebd48a2',
  ...
  'dart_revision': '717fb4444b62737fd003fd68fb6d53825993137d',
     ...
     'packages': [
       {
        ...
        'version': 'n15jC19RAzU7V69ppXjbuI5IdxBzpGzfNAiQpjERu4QC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'GA424pgEx-L7gAXR5WYO_TUHMlSyrpn5Ejaj3T8A3KgC'
       }
     ],
