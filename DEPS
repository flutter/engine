...
vars = {
  ...
  'skia_revision': 'c983b97d03a8824113692ad9c5a483c9c03719df',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'b28ba57e06b134c547bb49ad891d40f6eec2c216',
     ...
     'packages': [
       {
        ...
        'version': 'ct6r5YjdG2xpZPhkTTJkokFODHwFqgEKjaveh0_J9HEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '4mkuVtlGBaumKSe8xhISF66DxEPddK90UzI63dvenl8C'
       }
     ],
