...
vars = {
  ...
  'skia_revision': 'e0d023562bd90bc92f1b54392bc0ba4045afc549',
  ...
  'dart_revision': '5e24a66b1bb8ed90a3ebb0f6558f6181427023c8',
     ...
     'packages': [
       {
        ...
        'version': '7nZajqutFE39XjVchh6Btns8fZccGl66LVU0tt2LCMUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'UGavhI1zvSQpQBZG9QVV9QHE9AEqAKR5a9dm2drTFSIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
