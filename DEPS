...
vars = {
  ...
  'skia_revision': '4019d8957cffe178af3bb5e7834e6a419d0088ba',
  ...
  'dart_revision': '673b3aa8558a4af94a6c9f424b7c4569899bef9b',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@a152cfa21129510e9227962a01ec12918e192ecc',
     ...
     'packages': [
       {
        ...
        'version': 'RDVdjRvCxkJh2NLxSNxIJAMkgPq1ZUAC9S128I33218C'
       }
     ],
