...
vars = {
  ...
  'skia_revision': '4cf00a814f7d8e6428a10441930515f5a6a527e3',
  ...
  'dart_revision': '0ed6ae6d709e545ff691910494d45892a8b31e7b',
     ...
     'packages': [
       {
        ...
        'version': 'tuXjGvikzZ9OM75zctu49gyTOrj_zVSr-VxQxIFx_hIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_ABSfRa7CjeFP0XezPTUR5FMCJcODGI2E8gLRjlv11IC'
       }
     ],
