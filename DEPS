...
vars = {
  ...
  'skia_revision': 'ae33954b4932e71f2bdfbe58ad3d1cde7980db7c',
  ...
  'dart_revision': '692a86b72ffcf77662d1be213cef5d0f23a85d2a',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/async':
   Var('dart_git') + '/async.git@06774f59a7cf9780e08148298d438c1043e2b063',
  ...
  'src/third_party/dart/tools/sdks':
   {'packages': [{'version': 'version:2.13.0-211.13.beta', 'package': 'dart/dart-sdk/${{platform}}'}], 'dep_type': 'cipd'},
