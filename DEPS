...
vars = {
  ...
  'skia_revision': 'd15c52d2333e9b3f732fe2b14e38c1952298d5ec',
  ...
  'dart_revision': '1f7230a9dabff548b27ecd67cc8d0a4552f223e4',
     ...
     'packages': [
       {
        ...
        'version': '0c-7C5noHq4bi9MxP0yV67Zg5O8emoNpNT8-sGGWP40C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '8unxeSvw26l3KUIVS9AoSsmTYoyNDNWEdPCUl3YMXZMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
