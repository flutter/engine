...
vars = {
  ...
  'dart_revision': 'ab5cf0f854f4cae1c0adad5f7a8aa158b1d646ca',
     ...
     'packages': [
       {
        ...
        'version': 'XcaoMSXfWFsCkt_giGaUOk3isEOMGjIv6LWtd8FPgjgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'uiUtXsNH0tEjW0rzKkOgTVmpGUw6ob8y1LHynxevgIIC'
       }
     ],
