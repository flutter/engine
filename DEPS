...
vars = {
  ...
  'skia_revision': 'cb66e25d23d84fcecb4cf98e89d373958dfbfeb5',
  ...
  'dart_revision': '6186a3ef5ffa8326dc8058dd86614bb5c8997edf',
     ...
     'packages': [
       {
        ...
        'version': 'DvgL0sNJVziyO36boRalnOW-KbEd7cm77ux0ZPVCrgEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
