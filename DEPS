...
vars = {
  ...
  'skia_revision': '4b20dbcc9f7216f59baf72307318012f7f222ba7',
  ...
  'dart_revision': '4f5e556d1e333ff9f3d470c236e86f42677edc8c',
     ...
     'packages': [
       {
        ...
        'version': 'bgoY4OWR_LNeyEMQ4eIEgMtQea2oIhyQtmLJ2wcwC5IC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'QnyyW1cqoxQ2yykYPuvDs36lOoHs5fHd_Ch5Uab6GacC'
       }
     ],
