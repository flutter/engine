...
vars = {
  ...
  'skia_revision': '1f84e9d51bbad13879dc03197cd64c3662a8bf03',
  ...
  'dart_revision': '921613a055ffbe06ad24afba3af10fcf57757a80',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '2e190280f5c5919ce4f6c9e03b56c449788a0a68',
     ...
     'packages': [
       {
        ...
        'version': 'gpjF3QRGg_KH0guW5V-RoIr5LqkUU4ygjJrq5ubSBsEC'
       }
     ],
