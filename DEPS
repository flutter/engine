...
vars = {
  ...
  'skia_revision': '68fea8aa589bef20a52be7763ca1645d813c124f',
  ...
  'dart_revision': '8b45ba3fdbfa521d043b15982fe98971d6a23bfb',
  ...
  'dart_tools_rev': '42996fde8524cb772cabbf08aef148c242fc281e',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/logging':
   Var('dart_git') + '/logging.git@05116e71625a25d325baa2e92c16476b905ddd65',
     ...
     'packages': [
       {
        ...
        'version': 'h979miNybae8jLIkqrCaAAwFy7ItBnmtjnhITkpH194C'
       }
     ],
