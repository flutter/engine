...
vars = {
  ...
  'skia_revision': 'e224e1dc5e2ca025d0abf97c10daa67907e4d3ca',
     ...
     'packages': [
       {
        ...
        'version': 'OJfJYAvhpAkE-kvbYtbKPRLGmVEq-EC5P-gt9jD_nxUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'v-9_Di17lm_C_mrpZT_cHLZRZnIOil-xx1rlaP_kd3UC'
       }
     ],
