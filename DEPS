...
vars = {
  ...
  'skia_revision': 'e09a3dae2347578871816b5f9a03ff5ae7264571',
  ...
  'dart_revision': 'e01af97dfff27e04f445129d61cdb82b85d405be',
     ...
     'packages': [
       {
        ...
        'version': 'JNkiOVYI77UM-mAlwvYB0vvilKDpJpnO08AMKKEYWVwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'BfJXLeLtrw1ZumMge7Hfb5p9ha1OhgkyN26W8b7-o7IC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
