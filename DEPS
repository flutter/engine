...
vars = {
  ...
  'skia_revision': '02ea811ce869e8d535bbc117269ba7cad50c0345',
     ...
     'packages': [
       {
        ...
        'version': 'y2eJ9z95VaPuszqyHs9Z30qybamUJLEGbmgNdDcbfuoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '-9uFZIRSLfHdJKoPYfefLyTBs9nRum-e30TUvHxvWckC'
       }
     ],
