...
vars = {
  ...
  'skia_revision': 'dd9449c23b9dae684208b2d5c3b446a3bf1ec859',
  ...
  'dart_revision': 'a80bedfd7bc30d5df8883c180dcea51434602f9b',
...
deps = {
  'src': 'https://github.com/stuartmorgan/buildroot.git' + '@' + 'a29a0317516e6f62ee6732899b4bad2421685837',
     ...
     'packages': [
       {
        ...
        'version': 'vY3-OtizQB2UgQhKnWgEZ144YwzTu6nHsvt0I-zFYRgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'flUwG0eOBmOH5peiyPD2R3ij3MoQ7aJe2S02krDeRFMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
