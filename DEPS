...
vars = {
  ...
  'skia_revision': '0954d27df9097ebee4c45f211d000e3e0af2fc2a',
     ...
     'packages': [
       {
        ...
        'version': 'PmjQQT3LQHs5zY0cfHGkYt_4pc0YsLVifKm8Qpn0tngC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'lnKNJfQPPPuJFRWMDwDfz93d1HCbTFXjbEt_d9ZCjgIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
