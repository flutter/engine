...
vars = {
  ...
  'skia_revision': '0a90c366ff87fb3dc238d0d29e322393ffbeb37a',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '3fe678c9b297f4029058e30ab68dd99d20d2ff44',
     ...
     'packages': [
       {
        ...
        'version': 'Bb2k375udWIltCEAxFF6_R5gP1NRKSTcUzab8OR0RI0C'
       }
     ],
