...
vars = {
  ...
  'dart_revision': '933439ba7f34a7b6c70dbe18cdee564a12c30a97',
     ...
     'packages': [
       {
        ...
        'version': 'Pz4ZHZrUpeq1gYJiEULJkq4IiYaqsBoFW0gJimsn0IAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'QqGvMWaYkaBu7vWQTXb6SvGjrDa6Z-o8Q2grp0v1cIgC'
       }
     ],
