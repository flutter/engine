...
vars = {
  ...
  'skia_revision': '0c57432149030c760f5a9eea8a353d81257952e5',
  ...
  'dart_revision': 'f4b4719d124351cf229302e72c31eed0db1f0de0',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '88c5029f0a78130f6c2e6eaf1cc0f38f76e60559',
     ...
     'packages': [
       {
        ...
        'version': 'yRFArCwDi-2UHUxwQl6rk0ISTua4FobB84XwaUZFC7cC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2URwvdZiLGMKsnYKqGCtPo6Vw4fiUnRuEp4OayAc0PQC'
       }
     ],
