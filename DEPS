...
vars = {
  ...
  'skia_revision': '0d6b0aadb065f957e69238729847faedbf5e73d1',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'b4848e85b6fa9ba9a720012c1c8a87d93f9267c5',
     ...
     'packages': [
       {
        ...
        'version': 'UCa49z8fu0hD9cypjheuQiKHVf0WO6mAuqEQBeedVz4C'
       }
     ],
