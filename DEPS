...
vars = {
  ...
  'skia_revision': 'b99622c05aa071606921ab35a4b59fba5305669d',
  ...
  'dart_revision': '7663bede13d194b69737fd513fb902121ac15462',
     ...
     'packages': [
       {
        ...
        'version': 'TSNvj5bMY9zYAXTbyU8Rx7DediXAaq2dQowgx__sMMkC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
