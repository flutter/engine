...
vars = {
  ...
  'skia_revision': '0f0109aa0f969da35ac3514a765d76f1fea48752',
  ...
  'dart_revision': '78cc201df487be983a5ce599553dc905130ee16c',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'c5de0c1ef5ff5f4fd8f6ce99674accb534643d75',
  ...
  'src/third_party/vulkan-deps':
   Var('chromium_git') + '/vulkan-deps' + '@' + '863435cf089823dbdeba040778b2e2182577e2e1',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@c8bc0655bbd4949cb49ca24ee9ff493439b7594c',
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '2d5defc7193520626de147e0c8b4f47d9e6360d2',
     ...
     'packages': [
       {
        ...
        'version': '86sYtCjRdJsVVoIZJx0NFapJO9L7aEnaiFwgW3Of4TcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'JIZ3JUIi-78MpuBlmF5oxrKerza4gJfUeaLak29d-rAC'
       }
     ],
