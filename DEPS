...
vars = {
  ...
  'skia_revision': 'ec403606f2939d3fb4edd6e79e6b5c538e9ca154',
  ...
  'dart_revision': 'a69cb6d700f591277f26e38072f7d1a1613a55d6',
     ...
     'packages': [
       {
        ...
        'version': '9-v-EzOcrY2YslQRSBCqKGZxU8v0yvQ1w2p8WB9BNEUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_dAFUp8FmOHtMlJyc8lu82twzMcXn8xmDQVogs53V6kC'
       }
     ],
