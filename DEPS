...
vars = {
  ...
  'skia_revision': '85894305bf48a95bda14bf5a4e4f82a94c195014',
  ...
  'dart_revision': 'fecc8163afc76f6accd461d59a7eb82fe4215d61',
     ...
     'packages': [
       {
        ...
        'version': 'hRul_TPnL7e7wi0EXh2svEojws7zSqoTyrbSkJpSPXIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'YfVT08txR9amKD1S6Afc5XI_D9fCU5X9NzM5dfyKa-8C'
       }
     ],
