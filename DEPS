...
vars = {
  ...
  'skia_revision': '46953123493602f5d0d8d40423bb42ecdd6ab1a0',
  ...
  'dart_revision': '4f0a08c346c5774bddfd8979219670fef1f8a74e',
     ...
     'packages': [
       {
        ...
        'version': 'KmSY84b_EfmzEtknHjdUkuY90Eim_WNZmCOgYxzONLEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
