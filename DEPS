...
vars = {
  ...
  'skia_revision': '6e58290ba6390c0032a47acdcadb0043a735fb34',
  ...
  'dart_revision': '9983424a3c50c623730fd43b4ce263df660eb455',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'c36bb971b4c11cd9136989ad5052d6f31521723d',
     ...
     'packages': [
       {
        ...
        'version': '95geBesdSL6fK7QEvdOACLyaxCi6GdUThJrPzdV86eUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'K1wweockjuvQ5i-vPbuhQRplYUpuEef7rJMm9qokpPsC'
       }
     ],
