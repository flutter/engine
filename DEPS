...
vars = {
  ...
  'skia_revision': '031a76756e245fdb862a5d17b8ed57d5b4d94ad2',
  ...
  'dart_revision': '12c5be745bb5d3a0f4fa5edc76b2269641860654',
     ...
     'packages': [
       {
        ...
        'version': 'wSCtFA1MjonYFdsd5tBuoF-uTjA3IUPlquag8pdLvQ0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'E3briMHHvl6dzqKjX5guHbUeXLA9aaG8ewbqj759wyoC'
       }
     ],
