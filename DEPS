...
vars = {
  ...
  'skia_revision': 'ba95fb4d300a490f4fc781541312a846eda70334',
  ...
  'dart_revision': '07a9404fa583ea8c5a4349b3d4ba8bfc852b24c7',
     ...
     'packages': [
       {
        ...
        'version': 'Co7x2NXDQ5vkfFBuONQ-Ad7gXGTck6TgUhJZJDmS3dIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'W8vne3wbVwiCcZkWd3WbxA5Ltc_xs_ckiS8M5o2PwUMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
