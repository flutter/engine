...
vars = {
  ...
  'skia_revision': 'cd33e4accde23637c50ba219c6bb92c666cfa8e6',
  ...
  'dart_revision': '88b9786db62bb0a634bb55b188dbe8c680cf750c',
     ...
     'packages': [
       {
        ...
        'version': 'oY-eFO3pIsUeTrcVihNaMDtmWhAcV97aCz42sre66OYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
