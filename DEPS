...
vars = {
  ...
  'skia_revision': '8f440b4e1e22ab95386b48dc0e1250704864aa74',
  ...
  'dart_revision': 'bb382005a603c55dd0eb5dc9fa3cdde94a834d14',
     ...
     'packages': [
       {
        ...
        'version': 'Suchs2RGtMg2dj5xdBZhHVdYqIQVeKzDcbsMs0M2bEoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
