...
vars = {
  ...
  'skia_revision': 'refs/changes/77/450277/3',
  ...
  'dart_revision': 'd5a092696895b2430ff874105db521adccaa3073',
     ...
     'packages': [
       {
        ...
        'version': 'aPxJXWrBJjKJ6H4XuzoamSq_8Dm6wGRgXRTJSUDNKkgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'i6udvN3jP4Nku60A69Tsxf8NajXh81IGROt3ZeUdRHEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
