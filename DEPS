...
vars = {
  ...
  'skia_revision': '121750c2efff175d9861b0232ca613f7e8d5b6d5',
  ...
  'dart_revision': '49850e6919f7802224777770041835c9c6ca1a6f',
     ...
     'packages': [
       {
        ...
        'version': 'fvWgEHJeocxBqc5JImHZwJu5qJKFPqa1Xv1ptQ8YLTIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'g2s3coONcNitS_R8VoSROcQ4CMCYDh0TCNFUyTgplyIC'
       }
     ],
