...
vars = {
  ...
  'skia_revision': '9d1cc0510039441dc542500623af8423137276cf',
  ...
  'dart_revision': 'fc2e183f4ea933568ca69e8d3850e59c731e8915',
     ...
     'packages': [
       {
        ...
        'version': 'jNlbyBr6pSn19H4Sp2x66sM4Z1onHELBIv58-z_6crsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
