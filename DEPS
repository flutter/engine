...
vars = {
  ...
  'skia_revision': '8206402f3c35a68378eba8334ec1c7138ecce4c9',
  ...
  'dart_revision': '4d7636806fcd58a266973da52d39385fdefb254c',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '7aa416379966c0ee821bf55b94339628392a37a5',
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'ab9bbb9b11b3522b891d8152b6c67ae1b1869f05',
     ...
     'packages': [
       {
        ...
        'version': 'A82pOZ3-NNgfJ2Da76Zu3A1TMRh7dpFbjB-G9Eu7FgIC'
       }
     ],
