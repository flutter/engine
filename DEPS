...
vars = {
  ...
  'skia_revision': 'b1590f15a32b8a429264e9f9a57dabb6ca02bcd0',
  ...
  'dart_revision': 'd2025958e3516a39eb328cedb3159b868ed58427',
     ...
     'packages': [
       {
        ...
        'version': 'z6trYeCMx3DorvFA_mNN-iE60cTMiAAuqOSU0il2V6IC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
