...
vars = {
  ...
  'skia_revision': '941812fdcc8426b29aca8072326cbeb9371cc9a3',
  ...
  'dart_revision': '1874cf4473071db1ed562b19610387ce2777d694',
     ...
     'packages': [
       {
        ...
        'version': 'HtSlIxjFqaMVFfL0l4sgvMfi7PA4l3c5Ik_epcmU2xUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
