...
vars = {
  ...
  'skia_revision': 'e34674502d65f55c925e023d62f01c9a4c8ff7bb',
     ...
     'packages': [
       {
        ...
        'version': 'wjEe2YO5RG24PRJ6sx3M8Si-MKokAotDNKc-JoQ5PhgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'b1-WJgPwb6lnHN9cof7GzkYCDFstbXsDSef012maNBwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
