...
vars = {
  ...
  'skia_revision': 'refs/changes/19/358019/1',
  ...
  'dart_revision': '748993c3997a57974ae186f47215c966f84df0c5',
  ...
  'dart_pub_rev': '267fb68add3b85a0f6698bf5ae2648f1a1df515b',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/html':
   Var('dart_git') + '/html.git@137be8db5d5b7f00530fca1591292849ce6779c9',
  ...
  'src/third_party/llvm-build/Release+Asserts': {
     ...
     'packages': [
       {
        ...
        'version': 'tuJCioUf3Ic17CI1pZFuIwq_Y8Y9_gBHAODBUnCgHRYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'edqShE0QEBIOiWejf5ksrhLj06gke5N2F90s0bID81MC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
   ...
   'src/fuchsia/toolchain/linux': {
     'packages': [
       {
         'package': 'fuchsia/third_party/clang/linux-amd64',
         'version': 'IJxh_9dNSxvKw8Pxw0lT6mNE1cMeoChN8fdFc_8BKCwC'
       }
      ],
      'condition': 'host_os == "linux"',
      'dep_type': 'cipd',
