...
vars = {
  ...
  'skia_revision': '45a4fdcc0cb05dab383c88dc774b91e1d42573f0',
     ...
     'packages': [
       {
        ...
        'version': 'j6dhXDhI_KUUyqTSFE83D_Fql2NPl6KUKgw-0WSnQw4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'D0jJKibnSzSOs68QJ6fExnw9mKO4mRrqQ0_NXEfAvzIC'
       }
     ],
