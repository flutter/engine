...
vars = {
  ...
  'skia_revision': 'fcc758cdc24e6e51e32e8412311128c063295850',
     ...
     'packages': [
       {
        ...
        'version': 'RsAmJzDpengZgZYgfS9flMsZEgUa-sXP50pA49LnXqIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'PNW_EvsrmQCDfp0pSzAHS5Q8xYGRfr0X_SK3qkuoBY0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
