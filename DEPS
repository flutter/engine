...
vars = {
  ...
  'skia_revision': 'bb0ed8e48790f3dac0fad9804d4ff25fcba630be',
  ...
  'dart_revision': '19b67901f26036c527983d1c980762d176b73e50',
  ...
  'dart_pub_rev': '255a3091fc278b04be74d246a3bec8743ef4d0b7',
     ...
     'packages': [
       {
        ...
        'version': '852xQjt_YCbf1ktz7FwWwnPweaj7FCICgDraDxfDpc0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'JgKFR3es2vPKClQ6Ame-xIguoxUatXDCCgTyJDDbExMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
