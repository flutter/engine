...
vars = {
  ...
  'skia_revision': '8b110fd65de90395492083a5af6c814d4e2b5835',
  ...
  'dart_revision': '34c06f0bcb2910b453b2e75a642e14e8de42ab73',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '5b7763f9d427e98d9be0319fc4c9ef645de63cb7',
     ...
     'packages': [
       {
        ...
        'version': 'XnH2CtqEH7byTHna7UVfQCBuffiqSMuugKcO-uitecgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'QLiomHC9D-GWh_gyK7_8zj8B7d_SPQ4hjjUKeVilBEQC'
       }
     ],
