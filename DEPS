...
vars = {
  ...
  'skia_revision': '92130329ce2fa707f32ddf8273fd9402975a88d3',
  ...
  'dart_revision': 'b560016446e7bdc55eb533e726b6c02afdbfc3ff',
     ...
     'packages': [
       {
        ...
        'version': 'av9O50IVmY1oENiv3QHVzENbsG_Dv1lgejkvsTsGk9YC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0UrAIsULSdj1vbzS8UlbiJXNxkETE6VfeTpqSp5biyEC'
       }
     ],
