...
vars = {
  ...
  'skia_revision': '34c7e114928aa931872f4f11fe22c388afbfbfbf',
  ...
  'dart_revision': '9ef3cef4a36c888c90d6f8d5750444231cfa8588',
     ...
     'packages': [
       {
        ...
        'version': '7jkJkkEngcwDQKsy0Zzil0ZJpIMKYpWBZ_M9qioGl8gC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'pJVz_1l7xyhfe_UAv_PteG6cQLcpIQxYzctgFtR8oiEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
