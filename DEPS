...
vars = {
  ...
  'skia_revision': 'fdb8dbe69cc2ee481694792a1c25aac3aaa89c23',
  ...
  'dart_revision': 'f5437c5fd9288a16eb008d2308ce1e2e5ded17a6',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dart2js_info':
   Var('dart_git') + '/dart2js_info.git@83504e459e13862cc6a61c147147ef7892a0d285',
     ...
     'packages': [
       {
        ...
        'version': '1EKjnjmePORPID4ifYP5vHoih1SvXy1OH28uF253rUsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'M_8svVndhWMLCNYVPpjc61Ely7Fg0Uzke3s4uzq8bykC'
       }
     ],
