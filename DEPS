...
vars = {
  ...
  'skia_revision': '49d32524f4b6272295fb247842cafaaa3f15114b',
     ...
     'packages': [
       {
        ...
        'version': 'lCQWEeR_Ert7t_qAbMRycwrRyZC-dIprYPyPJzwPmg4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KGmm_RIJoXS19zTm2crjM3RYpmp5Y03-fLUeVdylbTYC'
       }
     ],
