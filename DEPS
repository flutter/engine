...
vars = {
  ...
  'skia_revision': '3e7cd00126b86465c3f61aaf2dfb7b5c264c37bd',
  ...
  'dart_revision': 'b6afd560f4c9d6e3540adbf4c0c5285d3b547a64',
     ...
     'packages': [
       {
        ...
        'version': '0XCXzG3BWbpQyq0u04zQO0JTA0psrXRgC64mZoUTE5wC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'aSzZz6T3uFzeuf8qh8x2vHRijOW4zmJnJZGCnbArnfEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
