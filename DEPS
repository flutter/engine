...
vars = {
  ...
  'dart_revision': '6a65ea9cad4b014f88d2f1be1b321db493725a1c',
     ...
     'packages': [
       {
        ...
        'version': 'xGLLmzzqJUe3qXTkK5cF_y9TmFlcqzzRR37NWWcMxkQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_PqfDSNHxg0Dy-BEWQw_4dXmZMiRrx1S-iao8_bLayYC'
       }
     ],
