...
vars = {
  ...
  'skia_revision': '396cd1dfabdd40d3c7be7287c96e2581a8fb4de2',
     ...
     'packages': [
       {
        ...
        'version': 'TofGhqbUJWdkzkyujuiwE_zc_3QDkB46RdgvjVHB6WAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'b6atUpuKKAbhayeZ0In8NRdnmmcADHkt1GhySvikReoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
