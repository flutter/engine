...
vars = {
  ...
  'skia_revision': 'c9897a55650a59bcd8c28d55a7a6f39ee6bcc203',
  ...
  'dart_revision': '8234f00e521aaa9eae9f431654e1d00fd3e8b506',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '735b6f583b1fbce5bc748bffec82a8ceab7b6efe',
  ...
  'src/third_party/harfbuzz':
   Var('fuchsia_git') + '/third_party/harfbuzz' + '@' + 'e649fc2ea1de96fa6f68d62048a5b6f2c8a4ea08',
    ...
    'packages': [
      {
        ...
        'version': 'AA9aCrWNrXs7g4G7wq4Cyv1ICLD9eHJ65008O3q-tNgC'
      }
    ],
    ...
    'packages': [
      {
        ...
        'version': 'd9nnr4pVXG3B0JL8TTt0ZjWSs4xet-6Yc8438AXPWIUC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': '8L02NQinVUeZLRzldSLnc3ltYmwdQYLDuvrwGBj6h6cC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'pjxq0wD6bgGvR9Q3XAcKqWYTQ_KJC1sWFiIDwWYPcgAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
