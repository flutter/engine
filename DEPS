...
vars = {
  ...
  'skia_revision': 'e43714f490ecab72bd1dca73f296a37fc99ef415',
    ...
    'packages': [
      {
        ...
        'version': 'T2LfgbJBsfNwmlVIOK-2veEGK2U_B2MEk6IMW4kYNNoC'
      }
    ],
    ...
    'packages': [
      {
        ...
        'version': 'cIFYQ49spuolhk9gPdm90EtFiieA74cPwCEXcJo7X50C'
      }
    ],
