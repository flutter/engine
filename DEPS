...
vars = {
  ...
  'skia_revision': 'refs/changes/99/694699/28',
  ...
  'dart_revision': 'ade4dae923f3e5ce8846072c4bf4c98b910cd905',
     ...
     'packages': [
       {
        ...
        'version': '3C7P0w8ySmtqpyi3SZWDcHJ9zdLC09Fo45XjXGjJ1xQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'xBJq6PsO5ebblODMegtfmB5Q-Kaghtn_K0m3pR3dU60C'
       }
     ],
