...
vars = {
  ...
  'dart_revision': '8859206dba0c45069819159eec1a3157a558e8be',
     ...
     'packages': [
       {
        ...
        'version': '3GwxHo4BXgedSn9T7HO0Jc5ZHaFnaXXjETcuaBlm2CoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'v8utwl6_ppXZ88x4dYM_t94d7DdoWym237hIbfxSpS8C'
       }
     ],
