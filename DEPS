...
vars = {
  ...
  'skia_revision': '454bf27e2c40286ce57c2b1e95bf30733961af55',
  ...
  'dart_revision': '510f2648632870a5c867dbbdeebee3131b16db5e',
     ...
     'packages': [
       {
        ...
        'version': '7WNQRHsHNu7-8UVCi_DWSpmTZsR2NhG59-3yZUAqsusC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'AUWVgDkx6y2x3uFjez2i1gSbkNfbZ133S2GQPwnFXGoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
