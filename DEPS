...
vars = {
  ...
  'skia_revision': 'fe9b4316d8de469749812376684957347b0709cd',
  ...
  'dart_revision': '643d01d6a8e313916819b803f334119dd1d0e6b7',
     ...
     'packages': [
       {
        ...
        'version': 'hopGYPnVPHzxrQ2a-MUIDfDgET9B1X1x2hz4VB17duEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
