...
vars = {
  ...
  'skia_revision': '78a00998f8d0d9540f6a9aaee5ffc2c1d533e5ec',
  ...
  'dart_revision': 'a81fbf00dde7827a8d806e64be9f1213fcff7efd',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@a4ca86f9bf732d7adc4506f7373e0ed63251b646',
  ...
  'src/third_party/dart/third_party/pkg/sse':
   Var('dart_git') + '/sse.git@d505b383768889a1e3e90097684e929a9e6d6b8f',
    ...
    'packages': [
      {
        ...
        'version': 'XvHmkqWWHFZLS1g3Mz0S5oS2doqfs3MF9MSae1bdVHUC'
      }
    ],
    ...
    'packages': [
      {
        ...
        'version': 'dO8igrHyLDfgq8txd8Qx0mI9oJqFLswAMLcIBKLF6TYC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': '_HYADWCi9Y-eRKhH__YMkqzjm0Y3IuVm2fAAqECpsmUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'FQnJKIHw7q03I6WSq3IMypRIV83CjiI-S6Ng6Z18MfMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
