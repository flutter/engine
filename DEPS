...
vars = {
  ...
  'skia_revision': '4c964f8c4738a0e38c0fe15bb3dbc5c2849236c2',
  ...
  'dart_revision': 'ef97fe2415fd6f05b6380c03969748956e3f76fa',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '716c5d00b8b675ac6cd9c2ed30054794295bd1b0',
     ...
     'packages': [
       {
        ...
        'version': 'qyRH6zYfUEjo9L1x2uA4GgayvfwK-ZFhyR0I-cx5fKUC'
       }
     ],
