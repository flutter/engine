...
vars = {
  ...
  'skia_revision': 'd1d2b623799e2aafb8c1112d177ca00e5c796ef0',
  ...
  'dart_revision': 'ec95774043ecef404ea7bd359d7d40f15b6b5508',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '6eea5ff4db822c87bdb5d5540503037f5aaec33e',
     ...
     'packages': [
       {
        ...
        'version': 'SCshjyIlymHWD9W4DLT9CHMS3_5QMCQDb-m-DLzJi78C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ZABO4Om1vToxhI394y3P1X0fu7gcLz2d65YNEeNTBZUC'
       }
     ],
