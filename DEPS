...
vars = {
  ...
  'skia_revision': 'a78376bf2aea759082cb82658043e78463eaa6d1',
  ...
  'dart_revision': 'c0c5298d3629442f134a7d51b8e54c39adf77e8f',
     ...
     'packages': [
       {
        ...
        'version': 'd_4gHZXiGrq-mwBjg3Fr5ElqfkObHh_c5MMBjbhv0HwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'f9rffU-3CmQaZpbx9O0TEi7KjHy9HLfu2PEHqPp9SFkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
