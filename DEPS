...
vars = {
  ...
  'skia_revision': '43f0a7d724aab5efd32a7debb0bc79568fdd9a20',
  ...
  'dart_revision': '3e502e0c7e042a65df41a6ba0894ba0fd231c0fa',
     ...
     'packages': [
       {
        ...
        'version': '8ZF4hapvgu37hh6W-yjOpDME9NNmL9FBwTDnk9QuGU4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'fULjPqtx9XLIyCLmsefpi-nWPMnQl-gnVnU_TjPk8ZsC'
       }
     ],
