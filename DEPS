...
vars = {
  ...
  'skia_revision': '60ed6f47af08ae1f558ebebc19fba6089e01580d',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '5b504e12fb1dddf1cd232ef4cfde67b153287513',
  ...
  'src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@476d5cc872d45948fe682102595c3df6489b76a6',
     ...
     'packages': [
       {
        ...
        'version': 'jQHA0UEiQtfQTuWzMNAJ9IdRcWysiNHCsabyk7-vmBEC'
       }
     ],
      ...
      'packages': [
        {
          ...
          'version': '6126aab94a469ad17de6c170885b8dee8e8283cfd2383c4c77cf54c702374981'
        }
      ],
      'dep_type': 'cipd',
  }
