...
vars = {
  ...
  'skia_revision': 'c6577d328585be84442c1702a8c3bea6fb285087',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd61a50c155bd3d197343acee4b8bc62b26ad79b1',
     ...
     'packages': [
       {
        ...
        'version': 'q4GGFVR0teu1b9TWX0I8z1orZKt5YJ_YjbZxMCSZaSEC'
       }
     ],
