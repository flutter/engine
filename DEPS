...
vars = {
  ...
  'dart_revision': 'de5d8a2e24c6ad474ca198a359de5ae8ea5cebd6',
  ...
  # environment.
  'fuchsia_test_scripts_version': '5dqcFlKzRjJb6V95WYL1tuGfnL0SL4sVtGl3RFf-LY0C',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@e022fea9572390bd4f183492b6650209b49292c9',
     ...
     'packages': [
       {
        ...
        'version': 'BF-8UyvqW5l52-hP2WmO_qUHb4BjNmA1U-b8708uan4C'
       }
     ],
