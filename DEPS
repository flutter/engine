...
vars = {
  ...
  'skia_revision': '3b88c0772e89122cd1c999ce086cd7f2cb15dcb8',
  ...
  'dart_revision': 'adf546997a1ad395efd86fc0951c1b75aa805152',
     ...
     'packages': [
       {
        ...
        'version': 'xnB_uJM8TggeGkynVwfd7uJJ7J4V_ssoTDF1ItrL2hUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'BFLXvCMViJNBz6ngk5FHLRrlONDApA8lnqSsFQG48AUC'
       }
     ],
