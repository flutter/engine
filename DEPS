...
vars = {
  ...
  'skia_revision': 'ab054a88d7c710ff15be5d23f35282e532863505',
  ...
  'dart_revision': 'ae62765f137ba8728a418f8907cf662947975b60',
     ...
     'packages': [
       {
        ...
        'version': 'tklUfTsSOVKk49tYq-ReDJJn5aBOiePdJvsZLauF3asC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'lnmSnyJi-2H07tBnVE3mjFxVesUqF2j-AkeL3QOumhcC'
       }
     ],
