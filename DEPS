...
vars = {
  ...
  'skia_revision': '75994403a8a489796f5c131be0c5f2369d5b7a02',
  ...
  'dart_revision': '3d584310ee21b5bc4ac3b3811fd1b282e587afc1',
  ...
  # environment.
  'fuchsia_test_scripts_version': 'clqtZA8cx4GEXwcOeebvkyDYxKKVQ9f-KP_igeeySDQC',
...
deps = {
  'src': 'https://github.com/zanderso/buildroot.git' + '@' + '78d2d109a709177025bbcb9ff4a85e8a8a2e6ddd',
  ...
  'src/flutter/third_party/dart/third_party/pkg/tar':
   Var('dart_git') + '/external/github.com/simolus3/tar.git@d33204cb623b87bfe9cfc92ca37d9469feba126b',
     ...
     'packages': [
       {
        ...
        'version': 'pkL7F9aPLbFBRhsoLeue3X4oHZIQLoYZrqj9fxwf-wYC'
       }
     ],
