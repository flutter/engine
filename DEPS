...
vars = {
  ...
  'skia_revision': 'fb0fa24e31c81831f93a02d9bfc86db9619a2970',
  ...
  'dart_revision': 'f0f78da08ff2767dd5fda7a948c5df731426f916',
     ...
     'packages': [
       {
        ...
        'version': 'Pnfu1t-iGB1jjMyQOer0e2mHv8BSasw1z2Spl1wbRkwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Ii-fFcsGkH5ujr536XfCiT7OS91sXzEFsY8j_bl9broC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
