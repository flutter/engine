...
vars = {
  ...
  'skia_revision': '2b1a25a4d324ec667a9bef94eafcf2a10e3ddd1a',
  ...
  'dart_revision': 'f4a72bfc646c47a6a1639725b406a4eda19a870f',
     ...
     'packages': [
       {
        ...
        'version': 'wuAtwlwyr9u-xSDIrdrctLM64k3lcVEq1at5lQ3uYIkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'cknsiQFn1C-k-OjqBY6gRwSHbiMtHitEZJ1O-_vVxbgC'
       }
     ],
