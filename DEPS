...
vars = {
  ...
  'skia_revision': 'c61c895393eae47f9e42fa67e3719836b53d21ef',
     ...
     'packages': [
       {
        ...
        'version': 'ZAma6DD6CotCERMefZmSBoS76oXLpymX4x-vbWexdTMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'VGnJQMPQMYEhAk0v2a7UN3gwWYfVhLkAMdD0yb6gm9wC'
       }
     ],
