...
vars = {
  ...
  'skia_revision': 'f6ddffef16f6cdbed2faffdf64452ce0a96a20f0',
  ...
  'dart_revision': '27f6d32f083dfe2976394c82238adb5b58ef0bc7',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('swiftshader_git') + '/SwiftShader.git' + '@' + 'c6747d98397de4b906935a00ef3549ef58218380',
     ...
     'packages': [
       {
        ...
        'version': 'M5s9oCF7pxWyOKmGbPrTIpeVh3gWITFYbJcpgTWX_BwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ePY_4hKRD9w4_Zozn1LyJ3crz5xfAlxeHkmQhg-8HpcC'
       }
     ],
