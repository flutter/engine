...
vars = {
  ...
  'skia_revision': '64f13d5be3f7792594477037f3c35b9394708fbc',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '95fe7e470418cd5ac18d203eb29a25101c650f14',
     ...
     'packages': [
       {
        ...
        'version': 'ESkamdoXWIwkdWdP-n50xx1yA5FIFgq3FSSc8MCIGQcC'
       }
     ],
