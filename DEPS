...
vars = {
  ...
  'skia_revision': '9ced5e6a3ec5c13d75cfb2f430e3d2f94f1efe8d',
  ...
  'dart_revision': '21b7f864e3b9ff141639c33044d796aad259acb8',
     ...
     'packages': [
       {
        ...
        'version': 'FPTUvmyxz7q_NkD-QJ2WH-znY78Yjrunnf4P4D4_obcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'IiU1NqRtR9rL42mQ0RFgfB7Rf4Pfx6rYsvHmXECt_9UC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
