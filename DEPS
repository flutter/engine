...
vars = {
  ...
  'skia_revision': 'bff2939b624903efa4e99c9095c778f3edf63e6e',
     ...
     'packages': [
       {
        ...
        'version': 'bZKFxK3sVTeYLjs9ohb0RGkUaiPnhCoBv0Bun5_ezrwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 't0RagF4MaTp8dbNuL8PaVvRbMGnX7K0jRcnO-Vbw4k0C'
       }
     ],
