...
vars = {
  ...
  'skia_revision': 'eb5f21e12ece171795d2c701c073af8df4b55c21',
  ...
  'dart_tools_rev': 'd563c38c7cfb03bbf5d1f9360b49c36ba45b97ef',
  ...
  # environment.
  'fuchsia_test_scripts_version': '2fOjXGNxdSoRSGCL75TH1stC-srekmxERfAinqYutPEC',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/http':
   Var('dart_git') + '/http.git@76512c4cbf987361421030349fd1946e63e33359',
  ...
  'src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@8be3c948950c2c30e8f9c49d15ef6c04beb47238',
     ...
     'packages': [
       {
        ...
        'version': '3a16kOsyFmJh3lo7e5KcaOHqlXk_Ggr-ItYGaXpIyrgC'
       }
     ],
