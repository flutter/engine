...
vars = {
  ...
  'skia_revision': 'a48a3c9417c0e0a983f5c87dfa15c2b9a294d7fe',
  ...
  'dart_revision': '24bf86f164113079745a261022f794681bcbcb10',
...
deps = {
  ...
  Var('github_git') + '/flar/impeller' + '@' + '260097a9cdc98b2ffa2236eeee01624d676db42a',
     ...
     'packages': [
       {
        ...
        'version': 'jvlI1s78Ta29bLmxv9LBc43nJZ0_TwBEdpPFOTLLOn8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Ee9OX2o6PFEojFMXPb6BdeQ-83xfFL5lTBMpzXvgP1UC'
       }
     ],
