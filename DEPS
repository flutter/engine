...
vars = {
  ...
  'skia_revision': '2692b0dd119fb7847d21bd62f49bfb3f96e363b4',
     ...
     'packages': [
       {
        ...
        'version': 'ldByLqm7fFFsgrUh-C_yNcPmcZUojTy2g7imkt7s9DAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '3Xj5uw866nZkmta-RNPf1Gb4VReP8Qn2VYhuyZ9FUDgC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
