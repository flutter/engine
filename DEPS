...
vars = {
  ...
  'skia_revision': '75b3286ecaac2eb90602206545434c4a82c33eb1',
  ...
  'dart_revision': 'a0a940f07d5697772abf5087c7272d694e54277b',
...
deps = {
  'src': 'https://github.com/zanderso/buildroot.git' + '@' + 'bb77b0640c63af2032c3cb9cf2a7a7b19154ecd2',
  ...
  'src/flutter/third_party/dart/third_party/devtools':
   {'dep_type': 'cipd', 'packages': [{'package': 'dart/third_party/flutter/devtools', 'version': 'git_revision:73489f91e37c8f51161b3c63ffced83318e14424'}]},
  ...
  'src/flutter/third_party/dart/third_party/pkg/async':
   Var('dart_git') + '/async.git@09cba7fb16aa66886951872a68bbd49ad8d09cf8',
  ...
  'src/flutter/third_party/dart/third_party/pkg/source_maps':
   Var('dart_git') + '/source_maps.git@c4dc7d082608405049f0cc0bc23ca693e4532815',

  'src/flutter/third_party/dart/third_party/pkg/source_span':
   Var('dart_git') + '/source_span.git@1695904bca53ae6d3d51f05d25ce6568b376aecd',

  'src/flutter/third_party/dart/third_party/pkg/sse':
   Var('dart_git') + '/sse.git@f5ed4d6339794db5ec98969f3f60d0ce8c44dd60',

  'src/flutter/third_party/dart/third_party/pkg/stack_trace':
   Var('dart_git') + '/stack_trace.git@54c7b9da965bbdc4b49038ce0ab8ecdd0449e5fe',

  'src/flutter/third_party/dart/third_party/pkg/stream_channel':
   Var('dart_git') + '/stream_channel.git@ba351378fbddffd736e2faf6a412568f9aba0536',

  'src/flutter/third_party/dart/third_party/pkg/string_scanner':
   Var('dart_git') + '/string_scanner.git@6e893afd9a8f0ff746156acc103a2dd1646a85fb',
  ...
  'src/flutter/third_party/dart/third_party/pkg/yaml':
   Var('dart_git') + '/yaml.git@022ea6456d27ce6cc38f4d44833ba8865ac43b9f',
     ...
     'packages': [
       {
        ...
        'version': 'NbCi2ETfLHPLLB-JV-CbRyGWfH9aQyMWXB6ad7yxh1oC'
       }
     ],
