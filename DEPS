...
vars = {
  ...
  'skia_revision': '135a9a54212f42d9b4d8236df549571ae77ed6a3',
     ...
     'packages': [
       {
        ...
        'version': 'dcGnduqJ5C8ozmUHeeboHC76nOv7s4XfCKIfefQlGkQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'SuKWYMSXAMq1uTo9eaIdIOQqBb7Ro-zLyNk01GPOiU8C'
       }
     ],
