...
vars = {
  ...
  'skia_revision': 'b27f39c92410cae9795cb6a1b0225da36321fee3',
     ...
     'packages': [
       {
        ...
        'version': 'jh5hQRJskPs2mjEGaXQKdZ6bi2QKmOuWo3IcbiAqboQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Nmo4pkY2stnG1kXozfBOyfsykXYC9wml2Rh_QyJfj5YC'
       }
     ],
