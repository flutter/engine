...
vars = {
  ...
  'skia_revision': '333b938c958b8dec7cd0d68944f32a1a08f80c0f',
  ...
  'dart_revision': 'b0289f3d4835579186e8e1996be9a9dd9579601b',
     ...
     'packages': [
       {
        ...
        'version': 'im_i_FA0L5JIRDY7b4HHAsGlnyRn5qbrXOKQqhTBK3cC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'isLe3MZ_HHjCGlVAG08-ynKZeMQsxXsjzg__eCKDqvUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
