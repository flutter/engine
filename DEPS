...
vars = {
  ...
  'skia_revision': '7d252302268add4fe618a8eb5cc8f189765184be',
     ...
     'packages': [
       {
        ...
        'version': 'mcI8XmdRQvt7Ir8e9I0zqr8UwsqO1hqWeLvCo0OeCmEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'PGfiEKdkfh4C8tQ2WjlBgpqJfUAmNif7Q-QrdcNQeB0C'
       }
     ],
