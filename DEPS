...
vars = {
  ...
  'dart_revision': 'c0819e7b81c6f3724c122be8cada30fdfe97f395',
     ...
     'packages': [
       {
        ...
        'version': 'iImpFx19p3MLN4V7fDBlVqeKRFuUu7oVQyGasMpouasC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'sxapd5su1AZAo_sRAbSlapVMhj6NEgR1N5K3lR7wphQC'
       }
     ],
