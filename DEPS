...
vars = {
  ...
  'skia_revision': '6f62412c9203543f337ff90ff9123d5f84f2f05c',
  ...
  'dart_revision': '164335a4a621ea6444db332b932c79e236f58da7',
     ...
     'packages': [
       {
        ...
        'version': 'SkwL2IR5WdyLQSimkgk7VDJrGC8y98tGSMImwp8pzwYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'dmzjja7LjbwL_GwAvsRryGoDgqfJPWtCbZ0GG9IR5tEC'
       }
     ],
