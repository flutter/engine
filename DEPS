...
vars = {
  ...
  'skia_revision': '8803d93aeb6f43c864cd7fa745a2a14daba57d2d',
  ...
  'dart_revision': '32bd9cae0aaf0aaba60ac3c67114cfb39999f081',
     ...
     'packages': [
       {
        ...
        'version': 'pd6pTyJQpOyRgX93Cc8P_fg98Y7Kw8lJg0NMpOmoHKsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'bbim-9rQly-_814G5yI2uwbp92APBteoazGZknAa1mUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
