...
vars = {
  ...
  'skia_revision': 'f593c76adb1bc744ade1585aac1808f4e92c379c',
     ...
     'packages': [
       {
        ...
        'version': 'FQQdl8AGAsALFniHl_2oNGoQV0CThFvAqVaMmVP_AUoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'A0jnUUORf2LQu1z2Vh3xlfkzRpnMOlKCuJnzesf0hJ0C'
       }
     ],
