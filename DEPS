...
vars = {
  ...
  'dart_revision': '75fc15c7e1868e4b4478090e3aaf2f7507fbe8ff',
     ...
     'packages': [
       {
        ...
        'version': 'ZA31z7tJiMqognTfUFlHko_BkS89NiseByYFIt7z7gAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'WSslhcaUHmduSxhGHklseHk-YuqaB-K77zbZn_0D13QC'
       }
     ],
