...
vars = {
  ...
  'skia_revision': '4f065e286df6863b86dcf7382a4bb78e56b39626',
  ...
  'dart_revision': 'e9693f1b24011ec40a32a9b1c415c148525bfa24',
     ...
     'packages': [
       {
        ...
        'version': 'uJ8jPHroyamrqPkOFD-6ajTnLLN4b14eFXwre72aj3EC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
