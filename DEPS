...
vars = {
  ...
  'skia_revision': '38d53289269f56cbe8d9bd990b6c9512dea48296',
  ...
  'dart_revision': '7efcb7c36b0b395d77c5395730fc52535b1cd4f4',
     ...
     'packages': [
       {
        ...
        'version': 'y7m6Eyj07UN0c3pCSdjD4WXrEFFU1MiFLUqM3_ZtAtQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'mlFQI-cYg1OKrrccQGcyab-lyeAjuQICHb5D5AP-VuAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
