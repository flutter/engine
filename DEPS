...
vars = {
  ...
  'skia_revision': 'e9244938d2a00b1b0d7a5fd79f1072900cfcb173',
  ...
  'dart_revision': '00eaa3c60d317d629a46ea6cf2592fbe9178db96',
     ...
     'packages': [
       {
        ...
        'version': 'yIlbYYW5iSuDdQ0ljiQmbSF0lhQxRp_8dlQsNTJcwFQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'y_R-US0DLpoj0WMJmKK5vPQCnXJQoVmIlCeq_59ZRdkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
