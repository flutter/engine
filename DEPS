...
vars = {
  ...
  'skia_revision': '205b728a862371a90c4d65bcfa528060466fa49b',
  ...
  'dart_revision': 'f3e1cd38e8b04d4a2e8e506d3a2f6024109f150f',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '1ea49a2222e10ffeed93216663edf484fc8ad03f',
     ...
     'packages': [
       {
        ...
        'version': 'bMDZdOFfPiVkjIdivQYcrkiHrmY5jDZOrEVWkjDi_RUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Y9mDBoH4BSC6pWFXVTsG-Sj9vE9_PeviDet17VmNZF4C'
       }
     ],
