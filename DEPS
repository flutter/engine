...
vars = {
  ...
  'skia_revision': '2d4045f55fd50a6b712a869736a7f89aceaa94e6',
  ...
  'dart_revision': '955a3a964621fb2e23aeeda09ff27b2ae3759b05',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '34c8778b4a73855471c2b27e5ea221e2861a6d73',
     ...
     'packages': [
       {
        ...
        'version': 'mR_mhiacGiD-ObsoGowsGOUk-oAV9_nF3T0cqej6BZsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'vbw3Gwj-6eN7rSqb4Vr1B7xwLqxAr-xRKPqVeFzcDfkC'
       }
     ],
