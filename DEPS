...
vars = {
  ...
  'skia_revision': 'refs/changes/96/355196/4',
  ...
  'dart_revision': 'c962a50422d3791319934f04bceb6b25b68e08b7',
     ...
     'packages': [
       {
        ...
        'version': 'WDEyMachhyBVa9cK20uS3gAfFyoaaQJxaLiZA4cMKugC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '9jHAc8XalZIu-RNVe2FOvBdWRl3o3FlLk7C3fh_lBdUC'
       }
     ],
