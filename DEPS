...
vars = {
  ...
  'skia_revision': '990aa6016ff6247af6bc836a233edc766b8726c5',
  ...
  'dart_revision': '8961d36eaa0c9b4269d6e93c7520ef00565578e0',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '58cb5c8396a330ed6d81257b17dea63dc018825f',
     ...
     'packages': [
       {
        ...
        'version': 'd6O9t74z-k2svOmvzcrHJWB8fJmLJ7qu70VmFQYRF_kC'
       }
     ],
