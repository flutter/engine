...
vars = {
  ...
  'skia_revision': '117f57a5321530c35bce16f5ccf2b79bea171ab9',
  ...
  'dart_revision': 'ecca5857b3ba7fe2c368f38b203bbe393dc37658',
  ...
  'dart_webdev_rev': 'b58edb7d66d2b16c24e7e69e2cf2e9576b9432f1',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@793d575d3cc252c16cf32e37038238d5f149abb3',
  ...
  'src/third_party/dart/third_party/pkg/leak_tracker':
   Var('dart_git') + '/leak_tracker.git@2149e5c0b7a1a5ceaba24f55ccabb2f6567fc3ff',

  'src/third_party/dart/third_party/pkg/linter':
   Var('dart_git') + '/linter.git@f83b00f1185d6f8d22c7bf206ae7822c423f13d3',
  ...
  'src/third_party/dart/third_party/pkg/web_socket_channel':
   Var('dart_git') + '/web_socket_channel.git@af726526aa3613f5031036eaa64dea47a8428528',
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '7658525166a485ce51787638036f46ebd9b7c7c9',
     ...
     'packages': [
       {
        ...
        'version': 'Ylc35wOk0_j0NLzDvNFHjEC7qCaWcp7SCpbnRV7i3DwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '7EZeNE4aGd29VfDlyVpi5b9gX8LniFnQCV2K-ycoPaQC'
       }
     ],
