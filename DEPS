...
vars = {
  ...
  'skia_revision': 'c1b6b6c615a79fc0a748be87e90a2cf1f10f5037',
  ...
  'dart_revision': 'd59cb89f73feced2597fdb412e472efb9477fbd5',
     ...
     'packages': [
       {
        ...
        'version': 'GNyjTge9c1FJ9y7QeDCje6d_T8R-F8uNkFMTaGeVfMEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'MoY7UVVro7ipe1iv_a4DOSUU1s5joY8MtByFYf-1pDkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
