...
vars = {
  ...
  'skia_revision': 'fd1ff92efe17556c88b475009169c64a45758bf3',
     ...
     'packages': [
       {
        ...
        'version': 'mBQmFpqqIddBv_Sr91_SAn5j1B-ZkP3a93jwgxInEZAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'qywu-XJBKF2flZ65S3Hh1oOAQjPBsytfHXWhg8vvumsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
