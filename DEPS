...
vars = {
  ...
  'skia_revision': '4c50e08704610c793c7add9bf22d5526fd838f3e',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'c7b7972d8db90aeaa0a32475863e235f797860e9',
     ...
     'packages': [
       {
        ...
        'version': '6PrTSjMiSCsSb0muF_aumVDnNeyj4kDruWyGDGmjgCYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'SFM4ele7RYnVMhr7SeFYTHdGCF5IecvVZtl3Ee16lSQC'
       }
     ],
