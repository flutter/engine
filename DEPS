...
vars = {
  ...
  'skia_revision': 'bce627e38d256d9643f62b8d3c844b5663c3607c',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'b713be0081ebd7f1433aa214ec38fa4de18ee29d',
     ...
     'packages': [
       {
        ...
        'version': 'nGgFMB0Tjnpr-pvTYdxMBngF68l15LM9aExctS3wpD4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'qCxi4ThERe1MpDT9CW4oNEocUCbBLVmzyAkKcNtAxv4C'
       }
     ],
