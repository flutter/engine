...
vars = {
  ...
  'skia_revision': 'eaeb99625312513052170daaa2d0055fa0218d0e',
  ...
  'dart_revision': '301612d495b21752d9b3f0a94451ac0440fdc23d',
     ...
     'packages': [
       {
        ...
        'version': 'akM_dAPd5mFOGO5IPovHhZYnbfJsPYkz31AE2wvj3PcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '1UtoyM5xYhavd9YdlWErYMoR0-f45dTUqn7hhx1Iao0C'
       }
     ],
