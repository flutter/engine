...
vars = {
  ...
  'skia_revision': '58973cca0eddcc2fbd5b6056890ea0d8160a78f2',
...
deps = {
  'src': 'https://github.com/zanderso/buildroot.git' + '@' + 'e860853a6a08349d17d1aa0f29c53c5f0f0d1afc',
     ...
     'packages': [
       {
        ...
        'version': 'uQK4l0QeH_PlZO6cFBmMGrTf5nKOsMu3LEpWymyEyYgC'
       }
     ],
