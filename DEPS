...
vars = {
  ...
  'skia_revision': 'f9291b8942d8783f88ce421c1780231c90d365af',
  ...
  'dart_revision': '3c9e924073bafcc20887f7257fc07948323aceaa',
     ...
     'packages': [
       {
        ...
        'version': 'FQdiVAvvRBLXIOBI2l5xnfN-_wH-kCvbXL8Pz62qwGoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'VHWsKCT23LZe48X50wAxvE-ZbjyazzpKraaB_5YviXwC'
       }
     ],
