...
vars = {
  ...
  'skia_revision': 'e904a9f2010e063b19e9cf415fdf7b0838d56b29',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '3ad8d9127acbe33811806adc47036cc0bfeddd5d',
     ...
     'packages': [
       {
        ...
        'version': 'c18Y3Ga7cvdrmy8FQG_Pie4boO7nSoI8zSUksOjUaWEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '9Pl8nd13UI8rrS3JDriZPjP71hxAFS9t3dU3klvDmKMC'
       }
     ],
