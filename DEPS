...
vars = {
  ...
  'skia_revision': '842e92e2921682553e32904b455cf36df8079f28',
     ...
     'packages': [
       {
        ...
        'version': 'C6JdBdmk657BWmyNCLeyebgla2ihMDyladGCH_pr7loC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'N9HpdqEHzWZIcSV_3JN4PNlUNeoK-Pism-mc-a7L-IoC'
       }
     ],
