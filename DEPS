...
vars = {
  ...
  'skia_revision': 'e2aec43cfc3f3ba228ba3a4642909f8369ecc4ec',
  ...
  'dart_revision': 'f7b05f6e0636a5d7236c84b9b1652cbf9172e728',
     ...
     'packages': [
       {
        ...
        'version': 'ticLKPQn6fwM51s-r6pfkIZIFkvTdT9n1ET-CdK5fM4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '50gZrG82qReNNGOqpvnnzv1ER5YyrIGkySra16xqnUIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
