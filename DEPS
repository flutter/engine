...
vars = {
  ...
  'skia_revision': 'ddbb97d741ff645eeb0f3a09aec3cf163b938545',
  ...
  'dart_revision': 'acbcdc91a2c836df2c166dcb6858238a79c1aa81',
  ...
  'dart_pub_rev': 'a817863ee93241ff36fce6856c6d12fd8fde0907',
     ...
     'packages': [
       {
        ...
        'version': 'owSIykHxQayMejaYKNa64cpS_51LlgTdI_K1XvPdf-oC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'wGBwwbbE-ciy3sr2uQExRsRHMv9XdZwwrkifxxAXFCMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
