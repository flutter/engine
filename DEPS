...
vars = {
  ...
  'skia_revision': '821a84558bd40fe0c73ed0c15a400372bbbbe51d',
  ...
  'dart_revision': '970d74c424722d193047d0ccf70dd1d754b3d867',
     ...
     'packages': [
       {
        ...
        'version': 'MrtHftV0UMDxb5HFedM4NPXYJa7xeOtlY1QhW-MRM8cC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'E4eFE0Bz6VYC2prS7QunHJ0C6b47EFMMOHxprcaFj14C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
