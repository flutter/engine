...
vars = {
  ...
  'skia_revision': '067fe02ef7dfb79c9eb108f1e4c46f9d3ab31100',
     ...
     'packages': [
       {
        ...
        'version': 'BZhbrAXr0B2-i9X_cOkVnGNz7h1vFPhlwz9SQNk2Nu0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'xTvDcGzBT-38KIrk9PfV_IUaUh_d-_2MXjDHXklrfnoC'
       }
     ],
