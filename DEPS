...
vars = {
  ...
  'skia_revision': 'ecf10008c8bd9759dd35afc8b3128f8f3c90cafa',
  ...
  'dart_revision': 'd306bc3634c01787f2249a6147531fb09c3986f5',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'c40f1a04271f5a99fda8b9e48b521493210e13bc',
     ...
     'packages': [
       {
        ...
        'version': 'oPdJSBgOI25vZ9Jbyz4DkOrQFIvu0i9NC7IvM8RN0h0C'
       }
     ],
