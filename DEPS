...
vars = {
  ...
  'skia_revision': '3adc091af89f63b194661895b5a18814d7819e3e',
  ...
  'dart_revision': '2eea032403e2799e201a067bbaef42e672ed2deb',
     ...
     'packages': [
       {
        ...
        'version': 'F5TX4MaEgZsfH7eBI3flz6t88Kukb8teHJxbOb26fzIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'boele8geOQxFtPI5BPkdS0tnXdYBwC5QgklRukfDmiQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
