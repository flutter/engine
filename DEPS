...
vars = {
  ...
  'skia_revision': 'ae45496c55e26e41d8bf1e3419f247729e1dc377',
  ...
  'dart_revision': '9f5a6a2ccace926e9ca5bfeaee8589ffafeec582',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'e00995d4d51181fffdcaefa4132c5082f0708a8b',
