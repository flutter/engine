...
vars = {
  ...
  'dart_revision': '49972670ed757279ab21053832ac2ed1206a8b4a',
  ...
  'dart_protobuf_rev': '66593ca5a4d163b2f9a469a2b6368e12a710e550',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '0813fd008b5c01fbd8170a68482fd19fd00768b4',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@900432d8cb1e75c4f28c79d94c3036fd3b3ec21d',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@ed73bb93b06280cd47108d202cd96bcf3494df65',
     ...
     'packages': [
       {
        ...
        'version': '8vWVRI41jRrmBPFz46MaUgrr46T9D0OuWxdt0hLAAIkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'DYmJPcZvOexY7jNq9KXuOm8aGU94SLXyNKYTTBay9qwC'
       }
     ],
