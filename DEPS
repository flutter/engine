...
vars = {
  ...
  'skia_revision': 'a7623433dae12f8552fee7aadcc05656caecebf2',
     ...
     'packages': [
       {
        ...
        'version': 'JptPhro1iUK69TqJbKcBRp1QNXL5jWdPAhbEpK_zz2cC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'CtgxTwTrW60OEa4Gvd3fr4C7_nrDaqTZxpfkBB-ifYsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
