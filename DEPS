...
vars = {
  ...
  'skia_revision': '418eda2c599ab8fec96c6fed749fc117935e0a88',
  ...
  'dart_revision': 'b58cfe5ab24e7756d672c0257ed30888edfd3c27',
     ...
     'packages': [
       {
        ...
        'version': '_FaRRt69ZlrCACiYukNB6u_zVpyECR3W1gPgS__sm-kC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'mxnHADeCUcuCpCahDU505Lt6Ro-LH_HKVx_bvjUNdQsC'
       }
     ],
