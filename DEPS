...
vars = {
  ...
  'dart_revision': '5701c4fd3b11b4dbb1e7a3e9f6b1cc319ca5f1ac',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '8d663e2c5996abe8b760ef5fc91066fef769d304',
     ...
     'packages': [
       {
        ...
        'version': 'VQHsSxgf0eDnmsVYbdU6EEm1m-LsgGdhXW_24I-QiPUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ULy6ZIkyWHKKjlRv5Lw9xD-TvYOQ0ezZeKcE01x4q08C'
       }
     ],
