...
vars = {
  ...
  'dart_revision': '987ad1d9674893393daf948938960e4eb1859180',
     ...
     'packages': [
       {
        ...
        'version': 'LDdBUxWp_gfIL2aIibEYMKh-qMPj4Xd7V8cs6NVExOsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KYshYtqs4WuED_qqK3xTKdTC6w3zAcvvwBblb_gnpZ0C'
       }
     ],
