...
vars = {
  ...
  'skia_revision': '015c2feb1288540be8961857de29343b4c883934',
  ...
  'dart_revision': 'cbf6a233fc2b04ce7f6416acc9a2dd3a49948ada',
     ...
     'packages': [
       {
        ...
        'version': 'Q4sFHdLjgxH7TRfPA03aPNVTnpaXdZhnaBAYeChyYxwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'L_AELXDWxfSllKU4RAqe7LfNHuaC0AxuXOONoprvUvUC'
       }
     ],
