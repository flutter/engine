...
vars = {
  ...
  'skia_revision': 'f27c0f22232052c4be09602552df8cf3d75002a5',
  ...
  'dart_revision': '54ef02480719c081ff6e6cf65e7dcf70ab659928',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '481f381de8180930cb875fd112fd50f85da7d358',
     ...
     'packages': [
       {
        ...
        'version': 'SDPa6SfaKvRRSUCijZOk027aaPGCaoH0K8AEG_E3WH8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pI1BVH08V0eG0M7sw_nlrWaJy_xogu-nzBc3yy8lUmoC'
       }
     ],
