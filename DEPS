...
vars = {
  ...
  'skia_revision': '1ad80ef431670512d1d38eb5a3baba03ab740036',
  ...
  'dart_revision': '270181685689456a5507281c3f35f51238653578',
     ...
     'packages': [
       {
        ...
        'version': 'JzuwNgsTfSS-V4FWAViVMBgIpogVq3aV4UNhH5x6MEoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'gYlny6d_qQ7WV822TaMy3cWcmRULhiK-cYXUERmCUsAC'
       }
     ],
