...
vars = {
  ...
  'dart_revision': '393a24d37b393e1ff29ac027b1696b98e23e9a57',
...
deps = {
  # FIXME: Do not submit, local/CI testing only.
  'src': 'https://github.com/matanlurey/buildroot.git' + '@' + 'a12c806f8207ff0676db54e85c2a1085a80fa958',
  ...
  'src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@14d820f079b55428b472bda36ceb17af87588229',
     ...
     'packages': [
       {
        ...
        'version': 'imlnJ68ZziH-Lp2xkruld0R5YSmBjh1xGIPGlOU3CagC'
       }
     ],
