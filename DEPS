...
vars = {
  ...
  'skia_revision': '5bde3f4b2f152ffa301082e5f8eafdc9324c7aea',
  ...
  'dart_revision': '472c09f04423ae7e6b9718fad808f2ee3a48d9bc',
     ...
     'packages': [
       {
        ...
        'version': '_5q1k-2c-oi-VfKUEVjVaxD8eHbY_RrKlhDy_fjvNuEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Nd0ksuUx1pzA-As-SdWFCLHXXxXDlT2WztusZLuIVz4C'
       }
     ],
