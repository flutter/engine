...
vars = {
  ...
  'dart_revision': 'b59de86059f30174a8d19ea076387072597c1a62',
...
deps = {
  ...
  'src/third_party/skia':
   ...
   Var('liguisheng_skia_git') + '@' + '177e6919bb47446f4f352281eac9877ca56e5114',
     ...
     'packages': [
       {
        ...
        'version': 'RDUxjnng0IBvXRXOz2SZd2hY4ZZaP9JqhU9BjwZsnxsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'nkgnDjAl30sCQhZFEsQdRgkm_rsgXOrJc5M5tw3hDUIC'
       }
     ],
