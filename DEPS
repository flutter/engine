...
vars = {
  ...
  'skia_revision': '3bcc80e9c387122d4317d0170902e00f92f69665',
  ...
  'dart_revision': '52cf3a90f1b48bcf8e927e72d367db7684da26c9',
     ...
     'packages': [
       {
        ...
        'version': 'EcjcLVqarcKvvxeZUq-f0bQ_0FiMaNwqeulaoc5e9ioC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
