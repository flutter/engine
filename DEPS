...
vars = {
  ...
  'skia_revision': '322e4be6a1b1a445264a8cbbb51cbf142685a613',
  ...
  'dart_revision': '6b630c3719bd560399a5fb797970813630d510d8',
     ...
     'packages': [
       {
        ...
        'version': '-UZggYQXtkj5j_G7GkXFo-4k2-SPczSKeX8zcd54P88C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '3lfitkpybVNADXso-bvWi58--AwwVBonuFzD6Nr147UC'
       }
     ],
