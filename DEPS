...
vars = {
  ...
  'skia_revision': '7bfdb1044916cbe207d6adca90158e8b854bacd7',
  ...
  'dart_revision': 'c91b639b4cb3d39313249b20c0b7dec9353e9b3e',
     ...
     'packages': [
       {
        ...
        'version': '5gAsmg6ZStBbDY2iiqyAik04CLZZwnLATISzTKJkuX8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'EAlB-FVPLJ_DoHYgvDIkpZuEHb93P2yEWXLb0XFxnwEC'
       }
     ],
