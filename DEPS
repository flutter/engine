...
vars = {
  ...
  'skia_revision': '324b7a6f3a495030c1e3bc68da3da546150d34af',
  ...
  'dart_revision': 'f36420a912bb76b61fc8b934286df44dd1aff09b',
     ...
     'packages': [
       {
        ...
        'version': 'd48YMSgXi3NMlzxJZe8Z1nQbqJjVn0yMVL2KUFZ6n5kC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'TTxS3b-Vc_H0aQWgrC2xvCDJFfSvN07WOIzYfyeFxhMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
