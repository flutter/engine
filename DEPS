...
vars = {
  ...
  'skia_revision': 'b23630c509010bef0a325db251ffbb033acba4b9',
  ...
  'dart_revision': 'd68dff4d082077787df2a0a325fe9089904e5c6b',
     ...
     'packages': [
       {
        ...
        'version': '65ocmUBj58lZO7tnE2WlK3bL7jH9ehP3PAcABbm53GkC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
