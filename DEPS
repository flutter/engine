...
vars = {
  ...
  'skia_revision': 'bf03ac53f1d01a05e0340e6e03ec7e07f6b003fa',
  ...
  'dart_revision': 'b0d35855d88ca656abd97e914becc2bea740b1a8',
     ...
     'packages': [
       {
        ...
        'version': 'ornVJ7V0rQ6OtxRu-IPB3yoRLQ6R_qfgKaBvmqUseVUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'kEtiuXXESsLg2BNT2-rMBtE7amfMpABtpvV9f2br-kAC'
       }
     ],
