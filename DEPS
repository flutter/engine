...
vars = {
  ...
  'skia_revision': '450f8565c7f36205cc72e5f7f5e01eb024e8c38a',
  ...
  'dart_revision': '003fd0394ad30857daea7b1bdc38a9e18e04eea1',
     ...
     'packages': [
       {
        ...
        'version': 'mODEe2CNkcVaHnR5vX4DaSn1QMVEjd2RBljQap6dLbkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
