...
vars = {
  ...
  'skia_revision': '1f261da41ea4e0a3a9f668601dd1fe18b92c1bd4',
     ...
     'packages': [
       {
        ...
        'version': 'vfv7CH0zHiSS2UC61rI8yQ1MGifxa2yUZ_TjlXm8gpAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'RODnXSXQUmtA_IEave4W4fIlBHJdUrz4f1eg2qwlDswC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
