...
vars = {
  ...
  'skia_revision': '6a67f1f40f4cc585768b7b7f35d24093d78194ac',
     ...
     'packages': [
       {
        ...
        'version': 'GsgE6iOstUbZkD2RMlRreu8WYYl1rLSAMZaHbPKilF4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '10urDSi3_w_1K6dRwAr7pTPv0xJbVGpNlot_spAMaGYC'
       }
     ],
