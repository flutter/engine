...
vars = {
  ...
  'skia_revision': 'b9982f4928966bca7fab2867d0437b12fae7bb42',
  ...
  'dart_revision': '06093fe5921e86aaf4a7aae131c02225a7c40530',
     ...
     'packages': [
       {
        ...
        'version': '3pvmnxd8-3foJx3hVeafYGe74fS1EiQgX1x_t5YiG_UC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'sFMn4Ory_r_GWBYosMmmcWl6zCtG9sPYP7JjHMIPU08C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
