...
vars = {
  ...
  'skia_revision': '61a10b649aa7e84f15841a3abfb4e6197c42696c',
     ...
     'packages': [
       {
        ...
        'version': 'oqp6Q2nhF6CpwVguGm-IHCgWVYitf3m6Z6E5NuhLK2sC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'pZqYXLtTq5QExxRpkue6u383RFRgH8lRlISbLpDjIs8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
