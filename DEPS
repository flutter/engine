...
vars = {
  ...
  'skia_revision': '2f0debc807d1a2280d2d3b5e103da157fc58560f',
  ...
  'dart_revision': '2b84af1e5f1a295b9c94d070204e1965ea377aee',
     ...
     'packages': [
       {
        ...
        'version': 'KFpv7TMUEjuBebNL_ahk9MVl3tR7NB_Byx_1QIogr5EC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'l_sRi4CJL1xkXmBwJsUB4ioGVxjSyscwmFvDq63C-74C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
