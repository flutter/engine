...
vars = {
  ...
  'dart_revision': '6fcd1de98c2c946ac6cf0100a8b1c0fad5d4bf3e',
     ...
     'packages': [
       {
        ...
        'version': 'NHgyxqncEPUY3TQnWmZUWmfu2JJpfBxgrSb80vwQeJAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'jsuQqMxp_Ohv1NcaNJQWph38LsxymNVntcgkDU324UwC'
       }
     ],
