...
vars = {
  ...
  'skia_revision': '0e9d34d33c9dee86d0ca0ecf3fc908c6169d7dc5',
  ...
  'dart_revision': '3e8633bcbf8ff5444f885b91052fa0606cdeb1a1',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '9a37de9175d7c09b403d433d665ed560cdfc8520',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@5f39ec674d81f5c199151d823fa4ecd01fc59eb2',
     ...
     'packages': [
       {
        ...
        'version': 'DV0pzjjZ4SQdymCCuvHyjM5gb5n4gSt9-1Cbfa2TDgsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'WoiEzs7XB978DAHTTC7Ap5ly3QeC7vTWzOTRCa_2Il8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
