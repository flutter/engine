...
vars = {
  ...
  'skia_revision': '073737b7f4ab6093caca9fd4097af33e68f0ce9a',
  ...
  'dart_revision': 'b8fceaea291c28d123ca4b217e85bd8a74e8ddf8',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '3d75b794df0faee30b82ce9ef52b590ebf3511ae',
     ...
     'packages': [
       {
        ...
        'version': 'Q0h8rkXPNpWBnlAnSLNL5A6pto3js8axhJn5AUck6jEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'z_GRSMyHRsHjrpY48puQrM75okLbiRu2OqBeF0bI5SsC'
       }
     ],
