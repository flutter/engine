...
vars = {
  ...
  'dart_revision': 'f1387834bfd9f9259c969aff217ec19c2d15a3e0',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '341dabf8e58e999974d70295ee498cc10b266c17',
     ...
     'packages': [
       {
        ...
        'version': 'Xi3c5nti2LKnEOqYtWWexOTG5iXztpWipmEfWVk3h9cC'
       }
     ],
