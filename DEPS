...
vars = {
  ...
  'dart_revision': '40695d910591e21c097541742c1e6211ad4db701',
     ...
     'packages': [
       {
        ...
        'version': 'MKuIBsUt-Yh1RdIzBlUIbScKXIcCrlwsNZnQTkXZ68UC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'K3GdR1HfGm1GF0WS14DNzcnScbcYTlTXgS_lBxZPKA8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
