...
vars = {
  ...
  'skia_revision': '5a7d7da47c105d23b5d5a2aeb5a08c29a9b5df64',
     ...
     'packages': [
       {
        ...
        'version': 'R1rpDA1v0caZl5BFCalBdKCCkABCm-0rU_yI5QzBtb8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'uapMevjPUC6e5zeppfUnp8DeE0cep0yZSfVWjNxGcVoC'
       }
     ],
