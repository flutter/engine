...
vars = {
  ...
  'skia_revision': 'ae9b446bb44b33370ccc8e483f3e1e8f4160e7c1',
  ...
  'dart_revision': 'b3da4b661c48dd722c961bf88d70216bcd7e30fa',
     ...
     'packages': [
       {
        ...
        'version': 'ejEFL6p3B3orcACAyYJa4HWBBgiI3T0htLNgZ3-sGq4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'x3PP_nSNw77GTLDAWe2GEZO9njWycOE8vDJWGNLOy0wC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
