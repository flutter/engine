...
vars = {
  ...
  'skia_revision': '4b5d65561943c151d28ff227180d8104703b4778',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'fd9617aec9da4b3643a0390448ef316ce97ad9f2',
     ...
     'packages': [
       {
        ...
        'version': 'CGYQgli6H-WLIw2OAh_ki6f3Hv1OS6pj7VgczzVeUZ0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
