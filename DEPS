...
vars = {
  ...
  'skia_revision': 'refs/changes/36/345036/41',
  ...
  'dart_revision': '42d74caa7d26f270f0f08044ebf6aa113056ba14',
     ...
     'packages': [
       {
        ...
        'version': 'tWU3PEj6VBR5zsf0k6w7pMSfpVV1nCyzlJ7rMgY48J8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'pfJX5Fu8BJjJqbB_uuI5prYEdCtbhVGBbQAECUsJ2AQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
