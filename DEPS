...
vars = {
  ...
  'skia_revision': '7a6935a52814a871c0c9fd6f2bac08134ebc1c5c',
  ...
  'dart_revision': 'e2a4eaba73b8d16a1c7c517a9dad1fb13cfd04da',
     ...
     'packages': [
       {
        ...
        'version': 'k_lSjZxIH9ctmcerBvyO7lff8e6tNoUjB_Sp11z9C_EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'HNNs4gfuMIKWeJnK9njaZH6ei8UPjKuo-_FHGJ8pOecC'
       }
     ],
