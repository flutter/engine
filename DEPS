...
vars = {
  ...
  'dart_revision': 'e0ee7cbc7f309b20683219457c4f9dec5d69b3aa',
     ...
     'packages': [
       {
        ...
        'version': 'gvGDLzElkEmPrBTbtjW6rhPqr78z-b4ytTxE2k58CFAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'RfQgXVCVII4_oiWfVIkIMMVepj5wklCOhiClVRyYNucC'
       }
     ],
