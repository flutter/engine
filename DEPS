...
vars = {
  ...
  'skia_revision': 'd396cd50ff155c132ebc68d29725f59cabe90533',
     ...
     'packages': [
       {
        ...
        'version': '0u_DLzu4KkPoODoLKavZpsdBG64X3DqPDWM-ObqQJ1QC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'uMOnDLfvlQzFud36cVP5S8mCKQ8bGRvAJIwX-A1P_QMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
