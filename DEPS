...
vars = {
  ...
  'skia_revision': '8a2f29eae7a52adf4c30cd941dd3a683d06e2aed',
  ...
  'dart_revision': '01820c20a540f683ec93e7a0ed975b946f9f2a82',
     ...
     'packages': [
       {
        ...
        'version': 'sYtg-MryEUwGpPImm4x_DZqRp5DYOW0scYAQO3KWGSEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ylgThmi3nLIQPDOONm1rJpYdiISdFVYcfy5MagZkkvkC'
       }
     ],
