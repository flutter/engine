...
vars = {
  ...
  'skia_revision': 'aec80c6c8983f974ef76ed73c9dce9ed87ee006d',
  ...
  'dart_revision': 'c819e51c8a942561f2ace36dfe22378880a39d3f',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '777a46bfcb425818bdc5cab06520aefa93a5fdaa',
     ...
     'packages': [
       {
        ...
        'version': 'd4QNzZ6FjCCXUQtkThU8YeOax4hQsasnTl-l-iNR7lYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'tpiob-Qyh6oYiIznSegK2s0Qm_-Qx2oaFuWMiK66AaoC'
       }
     ],
