...
vars = {
  ...
  'skia_revision': '82665485077bee7109b7dd09c7eceef335ea63eb',
     ...
     'packages': [
       {
        ...
        'version': 'xPacy_rLieLS05d_gX-ieJe6i6Zq9PN_oQzDm0rPNWIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'm09trWspanWqlt4Clur_CsUrgafS-x14mdvzCIAZqfEC'
       }
     ],
