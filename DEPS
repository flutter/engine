...
vars = {
  ...
  'dart_revision': '80ae6ed91d6d1d3965fc913d1e5365f8c1ee577d',
     ...
     'packages': [
       {
        ...
        'version': 'BHVYYBrA9MXvpujaQy7cwg8GjY_IISnjQFPk6JMhAWEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'w9eoKrcm9Ws1RLzhzEvtkTMbiCJDqXcjOhp1NgVSwTwC'
       }
     ],
