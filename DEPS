...
vars = {
  ...
  'skia_revision': 'b5cd95b58fba65d22518edbfd2982c82da358fe4',
  ...
  'dart_revision': 'f82b36d0b4f01ad60309ddb1cb58e8d09fb454f2',
     ...
     'packages': [
       {
        ...
        'version': '665qcW5C1Rd_njvlT7v4QPuPAmN9j401FPwhcrBrK-8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
