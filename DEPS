...
vars = {
  ...
  'skia_revision': '9c682ecfc1ad7b824a3c8612bce19b7bf460a83a',
  ...
  'dart_revision': 'bc7cf49acc5c85225950c2ac904b2e39e5a83616',
     ...
     'packages': [
       {
        ...
        'version': 'EZSVwdQoz7p4S3wv284eN_VnqKHo07RjoUbWm05osyIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'czYvw1Rk3TMoRPeQeVchjYHZUeLG-bHpy7Q-eE0epo8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
