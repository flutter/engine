...
vars = {
  ...
  'skia_revision': '76cdd06cdc448a1f19bea3cea65f7a24aa57f6eb',
...
deps = {
  ...
  'src/flutter/impeller':
   Var('github_git') + '/dnfield/impeller' + '@' + '9049ff1e86a250063c786031e98bc5ab258d4e75',
     ...
     'packages': [
       {
        ...
        'version': 'xCyDNsuGeXQR15fv7TqOGvwXUPCDWyBa9Zw2frlvtRAC'
       }
     ],
