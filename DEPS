...
vars = {
  ...
  'skia_revision': 'ab013ebe9c73c120acfa569cee705e7e8a363852',
     ...
     'packages': [
       {
        ...
        'version': 'n9fZpXVmsbgKZzS8Q2GXxB453q8AbLpfGztsPsq47pMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'F9oY0d56X3aONxwv5vw9Gco--AHmC8SHuDXdhdWCnnMC'
       }
     ],
