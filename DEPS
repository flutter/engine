...
vars = {
  ...
  'dart_revision': '8749fdff07f5518abc0f759757fbd634eb7b1cf0',
     ...
     'packages': [
       {
        ...
        'version': 'w10eytxvcBul6eXwf3hInXlIoGtppP4ZOmXAFa4SiH0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'DzZi2gPbF49Flc37IGPWcCz33eZS3a6n_hZiO6ymY_wC'
       }
     ],
