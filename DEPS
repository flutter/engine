...
vars = {
  ...
  'skia_revision': '9ded59bbadb354e20d316e36db0ff9a8aa64e54c',
     ...
     'packages': [
       {
        ...
        'version': 'n7ocDhOf_t98kIbfbJMEoFhU5hhUwrabtRQJ8AF_4vIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'ctNKhIDQXT0GScdA-BRbz5rjuqQ3joGVYVZJtaSZiakC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
