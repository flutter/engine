...
vars = {
  ...
  'skia_revision': '81ea617ee386d822df0a5b89e199b647d6e6277c',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '1b17c91e42317013a38fc69207b9b63c58356257',
     ...
     'packages': [
       {
        ...
        'version': '0StTjIqUxGkc3nOWTPdEl-TR153yqChYQ6s1W4_EA-cC'
       }
     ],
