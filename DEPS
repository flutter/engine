...
vars = {
  ...
  'skia_revision': '34ef20100acc86d8363cfd4fe8b9f92f115bec5f',
  ...
  'dart_revision': '99fa0283f9d7f3d0cf5f85042a73dbe649ac4f28',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '563569acfcaf56ea87916d2ab5d50f09c8e0094e',
     ...
     'packages': [
       {
        ...
        'version': 'x2NzYMNhyodIwDl0IBUliJewbaM2QfYeIK2XK7H46AsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_TyF0etsONe5aqCbM85fL8F4rreIAEZMPkXNDE0kqdwC'
       }
     ],
