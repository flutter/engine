...
vars = {
  ...
  'skia_revision': '38daf0be45e49a7a6e0014a334cde9160db4392e',
     ...
     'packages': [
       {
        ...
        'version': 'w-3t4XiGPWI6UnY7zV2vTMAbS83-U8is0P168iq230oC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'jQ8awqEtcZVdusV29crejq9iQikDKImqn-HGtb4h3dwC'
       }
     ],
