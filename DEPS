...
vars = {
  ...
  'skia_revision': '653d2a4eee8b76655dd1180261cacdc1d88fe0ee',
  ...
  'dart_revision': '34893faa607998642249e4cb55b677ebbc0c1d33',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'c44791c89d2b51bfce864ab2cf5228d41ece1fcc',
     ...
     'packages': [
       {
        ...
        'version': 'ubThihH8aHhgJq5aXVLJ5GRM_nSCyI3BcjnQQ0joTscC'
       }
     ],
