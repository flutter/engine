...
vars = {
  ...
  'skia_revision': 'c0d3495e1ee2ac32de6878bc5057b7064a1aef20',
  ...
  'dart_revision': 'a2c9cae4dcd802dd2c2972b981a27ee7a58f659f',
     ...
     'packages': [
       {
        ...
        'version': 'TyNHQXzNUUtO1BkI-5susobWUwXVe_JOzhKmi8VQPOwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'coVjRTWSffbIOw7Av_fz_fLwq-cGZvnuNn3NIFurXFkC'
       }
     ],
