...
vars = {
  ...
  'skia_revision': '275bcb6d874d8c308bc865076f5ab41980eee463',
  ...
  'dart_revision': '8a3277696c52ed77c4a491b88c2bb53633fed0f4',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '135a24fc3706c5e09460356beb115f3624fe8c51',
     ...
     'packages': [
       {
        ...
        'version': 'UpzOzWyiGYKrIuKmG4iYsnQtEOaG6GKsiUyMOS2fPzIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '3uzA1Z-yaMQE_Cz5fKhxhQDh2rPVHRfbeldiVBTH0GEC'
       }
     ],
