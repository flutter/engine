...
vars = {
  ...
  'dart_revision': '95e1709c9e54127a59be4c4b3ebeaa48a3e4067f',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '15519113ddafd2e6bd37df39d2284e76cad95550',
     ...
     'packages': [
       {
        ...
        'version': 'a9yuHfriB1zflo_WTmU9VQWmUFCqORaa5SajSMwZHbMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'BA2UmYXNrQ8eBTOCjd8utGp2wi2igMeY21aJwlwEkisC'
       }
     ],
