...
vars = {
  ...
  'skia_revision': '033c4014b788e48af7d901c806a121df245bfdd8',
     ...
     'packages': [
       {
        ...
        'version': '-kKi5syI5sIIHLrQTxiVZstvxDR5-fappUgJCy_U_rUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'a8wlqxr91Roq1MKsCcWVXtXkRag_h7TWmogBULyTmmkC'
       }
     ],
