...
vars = {
  ...
  'skia_revision': '3cc4afc703091d8bb4af3040463670e185dfa9da',
  ...
  'dart_revision': 'a6d86f12bf003c7369bf21a59ff497e0cf4c8d6e',
     ...
     'packages': [
       {
        ...
        'version': 'KfIfizZ7odhDPJW8judayn8OOlpzc05d8sQQwn25d8MC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'blNDDMWIJoltG4jSxmSCMl1TbQ9siavGXWGL17mHRMsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
