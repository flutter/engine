...
vars = {
  ...
  'skia_revision': '11e41e0e2f9fd1dd319da4f924163ea2cf1b9a90',
  ...
  'dart_revision': '0732be6b823a506ffedebb91493bf3a4f584ba6f',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@524b2b677d977b3ef1b25a7fcefaa1f0b82bef20',
  ...
  'src/third_party/dart/third_party/pkg/mockito':
   Var('dart_git') + '/mockito.git@49859e4e4ae23ffd29181cd4235c44b5a9a6dab0',

  'src/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@fd21f5b9a2bcc7ee8fc252c50d5518cb4146fdf5',
     ...
     'packages': [
       {
        ...
        'version': 'mLc-VlVTg-p18HjiPuWYyEVUAwBWL8wsxyCpocEQtMkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'FX5YzwP_ZEnPP0b3vecN_Wn22Bhvzfw3D5dhME9tkXwC'
       }
     ],
