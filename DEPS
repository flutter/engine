...
vars = {
  ...
  'skia_revision': '30c9ead5014b5996cb78b898fb404a6371dfac39',
     ...
     'packages': [
       {
        ...
        'version': 'KjtjfsPeCuEYJH2icQjOg1h6KrDvuReXYoCQPPqBj1UC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'jxJH1K3IPajVuxjKWLuqaDV-0xJbgkEm27MA4ez1kOQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
