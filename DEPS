...
vars = {
  ...
  'skia_revision': '1d9fe0090a7e4748379489daa25562a588f8ee3f',
  ...
  'dart_revision': '4f1a93c0cd09e946470828fb7cdabd63f92bf136',
     ...
     'packages': [
       {
        ...
        'version': 'T_EmrITXOS3z7NRVZQMGgLLACtFX_pJV-A6XVpXMOagC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
