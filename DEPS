...
vars = {
  ...
  'skia_revision': '67ff541ac116d1ead1221468dc548b2813b70dc4',
  ...
  'dart_revision': 'd24a8341812dca8d8475e8af3885074044386409',
     ...
     'packages': [
       {
        ...
        'version': 'RNByJnyIrOmvhKVeHRsBQU_IhkbLc4-udwQzS3bJYhsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ThMeWtg6E08TNJXU8PPhS2gbE8MM9rNc9q0W-beKIGQC'
       }
     ],
