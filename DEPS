...
vars = {
  ...
  'skia_revision': '72412a86725a391f0d41d7a49ef5669b3ea81c28',
  ...
  'dart_revision': '8a8fb0972646c81ff2f33675bfa9a38454b7bdfa',
     ...
     'packages': [
       {
        ...
        'version': 'fSRFvvC1ccHNqcxHU0LwsHSlftMFoZ8Q_zc24V2vwREC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
