...
vars = {
  ...
  'skia_revision': '03da7cb8a386c7f792c1ada0771c5bd7830eb0c2',
  ...
  'dart_revision': 'f444e42359d613b1ee67fa85cb6f0369019756b4',
     ...
     'packages': [
       {
        ...
        'version': 'X9-CRs-hPK4brhgUCiw15JSBJwCX5GIUn30LibSPlsoC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'PpXQK1l7RwcryaxgGsY1A_OHTg1Cutm7ncFUrWRxsKMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
