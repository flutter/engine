...
vars = {
  ...
  'skia_revision': '360db877be35c7e33d345cef5ac0b601c803adbc',
  ...
  'dart_revision': '9ad577b3a3e4c5aa9d9e93717b13da76bae7ec8e',
     ...
     'packages': [
       {
        ...
        'version': 'igx6EXsq_xrH8tkrPjFYOx0L02ZiYVTtjb-N7WRQkU8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '8CGViPqZj89H7KOu0QPquGvrc9ftkzQnRh0wYC3jWTEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
