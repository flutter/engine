...
vars = {
  ...
  'skia_revision': '198ac15a907a4323347a9722e13d8b1500430d2b',
  ...
  'dart_revision': 'b7c2babecc8812fb81988b9c728785591c09b5d1',
     ...
     'packages': [
       {
        ...
        'version': 'Q22GCF6LeA5lylm3b0icJuz6MUaZWes7ZJl9MVGqqY8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
