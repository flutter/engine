...
vars = {
  ...
  'skia_revision': '3d2d0361e41d7c35b5ce2d5723d85fce260cab98',
     ...
     'packages': [
       {
        ...
        'version': 'IySDpHxKM0dEVtNnRpSuzEGA5X7yfuZSir4YEVKg6L4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'V6QbHXIf2UnjRjIdwWeSH9abDpSOrslqGNsOHMilGrwC'
       }
     ],
