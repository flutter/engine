...
vars = {
  ...
  'skia_revision': 'b960e9140f56675c0a2f6a8664967a56bd3e5158',
  ...
  'dart_revision': '53fee35b299f57c786dc8474ede49353a0009ed4',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '0005183b2ea341cc71ee591e7d2d53258ad76702',
     ...
     'packages': [
       {
        ...
        'version': 'VTlSkkxOaJrlxj_vv2f-dTwJ6fAXpF1GVsRyZqCadKkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'tcVA-iW-vOHPnwh_PEqDBNKDOXwW3HSesjKKvZvusugC'
       }
     ],
