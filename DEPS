...
vars = {
  ...
  'dart_revision': '58ff03f2c17f023dadd2744c4ffc89b558c153aa',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '4f09451ab4bc2b35c36ea8eb0caba127f4377776',
     ...
     'packages': [
       {
        ...
        'version': 'UXMnwzl-9_YZaE_aVAS1PxRilGRLoiYL9u2zSoClw90C'
       }
     ],
