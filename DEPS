...
vars = {
  ...
  'skia_revision': '38e60fd69349502a6cd44962133cae1936167352',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '1b8775f98e81092131e5d329d5c4e2d06e78c761',
     ...
     'packages': [
       {
        ...
        'version': 'Vqcs_2rbtDfbmu3WXK6DvY-d8m9y8UuwmEuZ8iO7k_MC'
       }
     ],
