...
vars = {
  ...
  'skia_revision': 'fea7089047e9e0c7fc6f21b4f039d5c4a8de0db9',
  ...
  'dart_revision': '57e44338da371bd3f378ad52180f8f2b194615d8',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@77d59945d3af50328aa28b87002437e8f2e6333b',
     ...
     'packages': [
       {
        ...
        'version': 'YHXIOcHEIEtyHcNG43f2QX-AdDA8b9Sf6-PYqnyDNUkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'kQnUhe74CH6d0V1vjnYMfd4hrpuJGwMFyXXqbbXbApsC'
       }
     ],
