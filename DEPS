...
vars = {
  ...
  'skia_revision': 'd0c369eaa6373b5239ea56e71f51ecd319665af2',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd1d41e11d20f018e623ea2070e22a963cfd83c26',
     ...
     'packages': [
       {
        ...
        'version': 'DoQ8KUxSk-5EU6VQ1y8J_jExb2kejowbTxAzuN59HjIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'VSvpNFoFjqXIQTcs6DNCULAdo8w6qvh778kBCzS6sToC'
       }
     ],
