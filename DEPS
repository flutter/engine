...
vars = {
  ...
  'skia_revision': '9271dcdade42430cdfea3f8b553df0af8767df39',
  ...
  'dart_revision': 'efd053daa2a621f6bda3d2ce6743f23fe87b28fc',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'c815735ad983a715d545f3ee8cc7fce885e8fbae',
     ...
     'packages': [
       {
        ...
        'version': 'pUQrgMfXgU8RmLuL4tkpVJHCEmcrav7vNnQnTWA-S8IC'
       }
     ],
