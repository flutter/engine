...
vars = {
  ...
  'skia_revision': 'b7af4875cbac14737cb98ceae337c60b7f5d50dc',
  ...
  'dart_revision': 'bbd701b4ba765886074709d0a1fa2e5ce2c6e9c8',
     ...
     'packages': [
       {
        ...
        'version': 'R1ENSI-odViJFj3-TixuIBokqtCFgMfYo_dK8i6LkYcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
