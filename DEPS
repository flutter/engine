...
vars = {
  ...
  'skia_revision': '0fef7d25a55f52cfb7153b4990e288a8e36f2a2a',
  ...
  'dart_revision': 'c9b5213943928daf77454b11ff87b2fcf75f961e',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '3d5308aac229dabf751b9ebf8a7e81fa2b0477cd',
     ...
     'packages': [
       {
        ...
        'version': '9injtwYqcyVLXJ22hUfWSg8xW_KLa9oMULpoYC6NhMcC'
       }
     ],
