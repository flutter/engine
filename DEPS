...
vars = {
  ...
  'skia_revision': '574b1eefd3bd1fa853b10e0e9ea77eb605da981f',
  ...
  'dart_revision': '9c3b6d5c2d6cb0acd3cedb4c473f66ee8e6c29db',
     ...
     'packages': [
       {
        ...
        'version': 'Q2XkmCZ1C5vUGoxvzRB0jOEBd4YPy58yiKvX57ZvgoMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'XYtiITCMi_qgdIapNoxlfQvAhH_L2vSbNMj2mOQzQjUC'
       }
     ],
