...
vars = {
  ...
  'skia_revision': '87e679db5d016e77ad39ddf57c35c2f333bc1f07',
  ...
  'dart_revision': '72aa28127bbf1c2f5eca6f1132abde15d5a366bc',
     ...
     'packages': [
       {
        ...
        'version': 'KyHYWmWPlhQzDAHFIerQrU0-ZfhlOBAtNOt_UBNgt8oC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
