...
vars = {
  ...
  'dart_revision': 'fb12f78665cb70262b04a626b207021182bd0a74',
     ...
     'packages': [
       {
        ...
        'version': 'r1_V5jkiliIKPmkrgviVsOMuU-rMPphRc2mswm5EoDAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Hx7fWXONLhftESS37gK2qPwtRaOYikf3z63-doaCEqQC'
       }
     ],
