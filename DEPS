...
vars = {
  ...
  'dart_revision': '046c78d307d71a4d60138bedee94256967f5056c',
     ...
     'packages': [
       {
        ...
        'version': 'EUG2_YQagdm0RPRlcwCFhUEYCz1ceY-WdAFPh3vuW_cC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'YmwAZF4GBrie49N1AIo-ClodNxaRI-_RKFPn4gLwmGkC'
       }
     ],
