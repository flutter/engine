...
vars = {
  ...
  'skia_revision': '8efbbbc0d1d4f05dae43e69dc81ea244e1b686d9',
     ...
     'packages': [
       {
        ...
        'version': 'tKvUBSZoYR-8s8xKYPqEnhBACvjbfOfU1Lxx_cP_-XYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '-jFTb6Nn6MiakW6cUrYdtqfT5UjYr2rUZT82XjPsU8MC'
       }
     ],
