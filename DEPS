...
vars = {
  ...
  'dart_revision': 'c7042dc03f43ef7329cc6ff6a04df90887873262',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'fd60f4e670814dbff3c8b34ffa60e968e572c760',
     ...
     'packages': [
       {
        ...
        'version': 'EEdHfWcEn3fHwQj46jITQbQhVSuOGiQKHp5fwD8t2SsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '8TJtGsJTpIHk5-Ss5IuvO5v3M955x0F2GjKcGzK7uWIC'
       }
     ],
