...
vars = {
  ...
  'skia_revision': '9fdddf6411da099476b14c86de555deacec86911',
     ...
     'packages': [
       {
        ...
        'version': '3XwiR_wVO3mk8gwZX0tOmJgSDvPIwhRXaIFgSIuqrIsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'd4pESQYnB_W-PUSjgVn0gRC2ALcI_8b38BeJulyIhJoC'
       }
     ],
