...
vars = {
  ...
  'skia_revision': '8276fa8ef102847b505a0af13fc9322a17f8929d',
  ...
  'dart_revision': '1e098b6e5ef0741ac3e942623c9a51c639a9514d',
     ...
     'packages': [
       {
        ...
        'version': 'kcEF0MZNbTfnYJ4PHzcuuM6jjIAqGGCNn7huBS4cibcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
