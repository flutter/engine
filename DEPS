...
vars = {
  ...
  'skia_revision': '22b9c7d9f834516789ab731175a01d4d79bb0a0b',
  ...
  'dart_revision': '88fa9330633e08b0a637e022ea9a0c7e56a0b06a',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'ac263582dda4a69260231820602dcba202334028',
     ...
     'packages': [
       {
        ...
        'version': 'QtQznuUmHMTyORqxJXugKZIlioO_P8iPRFcOsV8CZGkC'
       }
     ],
