...
vars = {
  ...
  'skia_revision': 'fbdf48ecb20410f62d3cbced3aeed9533946bc0f',
  ...
  'dart_revision': '28f21d4e992a9c8ef6b8dbff7352fef923f1717f',
     ...
     'packages': [
       {
        ...
        'version': 'JyZWzxuVvYdKhr3aMvsPMK5VTmk8kDXwJqRsZPXGK40C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'by2LLpxzVl69M0d-YyWbZQAh5vaWvtCCfpTEivCDiEsC'
       }
     ],
