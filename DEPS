...
vars = {
  ...
  'skia_revision': '8f9cc70337111370757661f47e9969fc46487a23',
  ...
  'dart_revision': '6095d12c274bd547d2ac1a80813d0a78c5522aff',
  ...
  'dart_webdev_rev': '1e7f9b7e55c4ab55db15275e8834a1e50e2d2832',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@2cc4144ea8cf93aa37b246ed4424c0d1d8bf02fd',
     ...
     'packages': [
       {
        ...
        'version': 'CyF7Zv5YjfR_wEsCItBcmGTwMmwIgVEJCxCEINMc12UC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ww3GtKA8aUqYozCTs6WRXSIS1h6VByJvRArjAdd0NEoC'
       }
     ],
