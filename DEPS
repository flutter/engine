...
vars = {
  ...
  'skia_revision': '0fcc56211514b64402f281d85a7634be4a2406bd',
  ...
  'dart_revision': '2c5d547dafe13a4f9f9f4bcffd46bd3822ee2c03',
     ...
     'packages': [
       {
        ...
        'version': 'ea86IrfGBkVMiiJBM_rYWGAF1cAil2V_yqsfzNkaHR4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'lPwzjY25ttlKYr0qHbVRJ2sMrSKLH5ZNLNmltVEzT7sC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
