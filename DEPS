...
vars = {
  ...
  'skia_revision': 'refs/changes/59/434459/18',
  ...
  'dart_revision': 'bedc39b7a80b0c289f91db4348cf60f2a97e4fa6',
     ...
     'packages': [
       {
        ...
        'version': 'a27NGktH6S6iYILxfAZnLPko0I0hgf02ho93BjCqNSUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '54i7Z2kLSPDoPWghBAk9KPW4LOW_I6ZKPTB0v0c0xyEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
