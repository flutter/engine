...
vars = {
  ...
  'dart_revision': 'ab009483f343d66b5c143756111ad57ca2d4fcb0',
     ...
     'packages': [
       {
        ...
        'version': 'wUg-tGGCLuw9sRj7M9v-89tyUBuxuli34m3RiOu5mXcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'hykYtaK7D2u6Ys-Xqau97xSb0gGK8DcsLEkedhRoNDcC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
