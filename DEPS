...
vars = {
  ...
  'skia_revision': 'db857ce628ff389c5b7f23e7147fb05ad26d0273',
  ...
  'dart_revision': 'fecde133832e1aab3e7a9957ba548c6b68660d6f',
     ...
     'packages': [
       {
        ...
        'version': 'kAQ_HmUN5Gf-dk1tcRCO5Zd9ZzSJLkVwqANB_ymedUUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'FJeJwYM81VAVyLjwvgtjjZTsW9-33LQVKaLokYne3I0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
