...
vars = {
  ...
  'skia_revision': 'd71dc2d25b8bbe500deae7fb9efe5e8adc8f23b1',
  ...
  'dart_revision': '06536d68ca0f27528b0bf729f4b8d673ed14beda',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '370a804ea29260d60f1c463a0dee97862d582973',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@v0.35.0',
     ...
     'packages': [
       {
        ...
        'version': '82ankF-HtxaO_Ah2BD65BSWnJSGDo3w-uggMX2BfkM8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Nw5-0_sVFBupjfHPxLzCaOMkNPcBTz_bGTlaiD4dDCUC'
       }
     ],
