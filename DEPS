...
vars = {
  ...
  'skia_revision': '4f23dec7427b7f04a29b0295aaaeeb3c755fab06',
  ...
  'dart_revision': 'a0d23d75fc231f631d84f4237f4e68401d3ab005',
     ...
     'packages': [
       {
        ...
        'version': 'hIpDO_txNpSA3K4BGJVmz-6459F67l0vcnMhJZzOxLIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'GK7mTxGcsKcvRn6PJ0Ts6wNkLanSSbeCYEuBRCznI3oC'
       }
     ],
