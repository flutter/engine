...
vars = {
  ...
  'skia_revision': 'cdeb0926559e7adfa3a5b66148be5af91ed3243e',
  ...
  'dart_revision': '6cca053b93742f0f853278b9dab225d2d79b8594',
     ...
     'packages': [
       {
        ...
        'version': 'JZjprx4iOIxvc9WfTklj-q2dOeLX4w8MG6J_WuPWrOUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'QL7ApN2YUeFUUOu2l3oixtuDIREL_Axdr2_1vb4aeWEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
