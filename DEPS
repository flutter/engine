...
vars = {
  ...
  'skia_revision': 'a52d2a9e2b01388ac89b05ed1152330ba79ca6b2',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'f56f97009543b0a93aca86fd425400e649aaf51d',
     ...
     'packages': [
       {
        ...
        'version': 'OudOcFarQhQQzKDBx1JkObBFdRX8SQcs2XFUjh3Mw6sC'
       }
     ],
