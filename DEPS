...
vars = {
  ...
  'dart_revision': '727ea68c62d87f6606f176e6f914ea8bf07bd3d4',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/leak_tracker':
   Var('dart_git') + '/leak_tracker.git@3d4c0d6db7d56af5fe52d6729ef373a3ec4de65b',
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '2937ee276cf5bd27fd5254091abdcf1e68a4155b',
