...
vars = {
  ...
  'skia_revision': 'bf43df6478f9debc405711b0e7ce70321259ae7c',
  ...
  'dart_revision': '494cd25b1d9a52bb5f4ea25e69ebfeaff91d03f9',
  ...
  'dart_sse_tag': '17b52bbdeee53fc54e5bdf9b80934460a9d63ba6',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/args':
   Var('dart_git') + '/args.git@c3c7fd4ae728d03cd43e723f11d099b07045ad01',
  ...
  'src/third_party/dart/third_party/pkg/ffi':
   Var('dart_git') + '/ffi.git@afb6b2c3a15c50e8f12ac15f368c7f1560f2d2f1',
    ...
    'packages': [
      {
        ...
        'version': 'QimZEUJUnXKYY55PhHEA7kHy_pAtInnGLvCba2IOJzEC'
      }
    ],
    ...
    'packages': [
      {
        ...
        'version': 'L9TEpKo-DobbrdqjfUspXnHj1HTM-Fipzw6fBh2LA1kC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': 'kyS_yAemlCEvloVr4s7DZHn0HbaUC4yFJ9rM9OFgFV4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'C2FaCuCLBodZ7wd7Nnx47CMW8mCNhEAn5WgwjbALW_EC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
