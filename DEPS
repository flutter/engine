...
vars = {
  ...
  'skia_revision': 'be3ea68fee98649572085a970989f4864e7f62fa',
  ...
  'dart_revision': 'd5ff386abeec2777adfdb85def52342bd73f5c3a',
     ...
     'packages': [
       {
        ...
        'version': '0CRIG3BQHCc7KyOuzzAm6uxa98-3VqHeRRd_HMEchRMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'lwp4mPZmwsVDXsxVLnxa0u4kAxUc-7tNFYZ9KRO8_EAC'
       }
     ],
