...
vars = {
  ...
  'skia_revision': '76e7a7f7c587dcec050c100b61850c5d66e24a9a',
  ...
  'dart_revision': 'fcafd43f2cf7e2981441c47b25cff6b0c73ec610',
     ...
     'packages': [
       {
        ...
        'version': 'r2ICEtbQIsXCINsovKpc4SNNO43kutZ0ovHVY6Jp7aUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'slTZ3doqsKQklPQqOsV94IC0i0HCTrF3z0oBm18kQWYC'
       }
     ],
