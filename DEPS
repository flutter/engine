...
vars = {
  ...
  'skia_revision': '85c8dca08cbee18930d5ea44ff8879915d4e3621',
  ...
  'dart_revision': '12f6559bd6ed47b58bf7c21e74b0ffa5cf3b68ae',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '493ca47c515b3e1e7dfdff4ba3dcc5cc44e40f0b',
     ...
     'packages': [
       {
        ...
        'version': '6E-cSq679DjzBMcqYCeaCiO28YBOmspEihuHpSPuCPEC'
       }
     ],
