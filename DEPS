...
vars = {
  ...
  'skia_revision': '9eda1bc57f76ab2d1051be5126a7c949d133aa3f',
  ...
  'dart_revision': 'b3e9621a423eaff2a4770224398e1aa7fdc610dd',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@de1b0ccf24a89315fe76116090d9fe1b8bd774bb',
     ...
     'packages': [
       {
        ...
        'version': 'qVHNy9nU6cQKtR_IB3S0nRZSp5_ln-MkeXGODrfDpTwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'EnRnFf_eyS6SGqpHiiWpv5xGotfyBLzeeSi85KTGhnwC'
       }
     ],
