...
vars = {
  ...
  'skia_revision': 'f17e4008a89b44f6fe8c9306249e411c3f9d101e',
  ...
  'dart_revision': 'e92d1fb9117c7fe975be4fe5ba0bceec9db9ff03',
     ...
     'packages': [
       {
        ...
        'version': 'crjfjPXZNdd5xWVowt8u3fH7ySOzcgkNbKi68ORoJAYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '7rmb7v6RnqQLJxIceXTHKkCeOd_IbCDBA6zdz80uMgwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
