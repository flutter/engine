...
vars = {
  ...
  'dart_revision': '9bc9e48fe90883562836a91e072d5309902f577e',
     ...
     'packages': [
       {
        ...
        'version': 'h7MctMDrmCcuggW8rpbmSKmcR71rnGkV5fOvRrsdq1wC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '4_MXZyYYEME2ZjtSmEx-JitHOLFanSEZNvlfJCPeB3wC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
