...
vars = {
  ...
  'skia_revision': '33807a735c328e4b4ac97a7cd1d85e828fc097e8',
  ...
  'dart_revision': '47b0d07e6be9c765f1d39a3f31c6a3203ceee0b9',
     ...
     'packages': [
       {
        ...
        'version': 'W0GUdjHi4gI48optNY-31_wbIRIYzisuj5KYQHuOR1kC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'iQT5jpUhipvetxSiHsBkeVgedBMtvCWXShpakF3mi8YC'
       }
     ],
