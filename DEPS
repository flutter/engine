...
vars = {
  ...
  'skia_revision': '0459a937347688a0efcdbd4a75c82e28002944e0',
  ...
  'dart_revision': 'fad8e8989ab61ed2be4a184fda161a2d0c407cc4',
     ...
     'packages': [
       {
        ...
        'version': '2KDbYfNb6lOWpcIemJ-OFPGHjWdpZwGqED_sqkDUSyEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
