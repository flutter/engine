...
vars = {
  ...
  'skia_revision': 'a05d27b170ee05efe7f1a724a21a7b78b1ff45c4',
  ...
  'dart_revision': 'db7eb25494806f376dfdb4a74e76b3812231ea8b',
     ...
     'packages': [
       {
        ...
        'version': '_e0onA6gYOYoL3NnKft-5urSMrJ9h1i2lr_S2dnObZMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'XcAUWQUZmm87mlWCVDheqPhjxUdpIhbkxpfisNStURMC'
       }
     ],
