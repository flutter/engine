...
vars = {
  ...
  'dart_revision': '40a4d9b44d724825d86439aa452592c12ea6821c',
...
deps = {
  ...
  # for the test.
  'src': 'https://github.com/HidenoriMatsubayashi/buildroot.git' + '@' + '403b381e24ccddad718e9bc2a6e68a9e86552954',
     ...
     'packages': [
       {
        ...
        'version': '9t3yDRxI82T5vjFSrJCW6d3LYiwHQ4HZXOpZDI7vWIAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pWW5QaeNe74StciQftdFVP_x7h3tCFKAwiPJu8DC-wkC'
       }
     ],
