...
vars = {
  ...
  'dart_revision': '4814f000de2b12405c0da02047b99c41dd957b33',
     ...
     'packages': [
       {
        ...
        'version': 'Pk4FjFJsy-p6py8HLONLbHGiIL0KI6-mVpqPLohFnD4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'XpyTdFDTY3xiID8tdMjQ6ye2B57zxLIhV-eZQPQni3YC'
       }
     ],
