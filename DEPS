...
vars = {
  ...
  'skia_revision': 'b9ead4140f8408a62a076006c0266286490443df',
  ...
  'dart_revision': 'b512191e9612cd611b1bf96412ce02a39d57182c',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '3698f3f3eb6d24dc4c0a9bfebe632b2734b6d96f',
     ...
     'packages': [
       {
        ...
        'version': 'M0zM3CJLIrd5lb0u0mm4GiJnBV3Ri_2bbyWJ63Qh3bQC'
       }
     ],
