...
vars = {
  ...
  'skia_revision': '3a5462d323764fdcd851b4c3267f6ea67019f63b',
  ...
  'dart_revision': '3a5ad2a2c0b7eae5d6d8676ce66af151b04bb41b',
  ...
  'dart_devtools_rev': 'f265c3028d5ed9a454762532bed144fa36b2e4d5',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'e7dbdae2e0c91e42c45462fd2508dc6ef18469e0',
  ...
  'src/third_party/dart/third_party/devtools':
   {'packages': [{'version': 'git_revision:f265c3028d5ed9a454762532bed144fa36b2e4d5', 'package': 'dart/third_party/flutter/devtools'}], 'dep_type': 'cipd'},
  ...
  'src/third_party/dart/third_party/pkg_tested/dart_style':
   Var('dart_git') + '/dart_style.git@6f894c0ca33686122be9085f06e5b9bf6ad55262',
     ...
     'packages': [
       {
        ...
        'version': 'GLmMoEuwc2EHiLldv9gEWSGzyBABQFKMN_GIcpCoZlMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '4hwi5xha3L0Aj5vabuGx7Uj3rdH34v7xcStgeAHbIcYC'
       }
     ],
