...
vars = {
  ...
  'skia_revision': 'e5c37860c792de6bba0c9465c3f5280cb13dbbb9',
  ...
  'dart_revision': 'f71ddbe0a50070d48b20489a1ee0d58575c0d6b9',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd2de74510c4fe246eb5df8b31861cf2ab54ef3b3',
     ...
     'packages': [
       {
        ...
        'version': 'jkQctnDMmHydahKfZP5lhsLVCKZkSeFitCOen4lNWEwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'eKYGl_wBcnT-n0J8n0CXoFTJEaRDAcYX-FIdnX2B99EC'
       }
     ],
