...
vars = {
  ...
  'skia_revision': '5dd678aebdaf5d32cd658acf892793eb8bf1e2e8',
  ...
  'dart_revision': '70066300aa8340f42e915d9edf136abb445b432a',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '6d1c0932fd1ca9f818676bc5c7c811715fdae62a',
     ...
     'packages': [
       {
        ...
        'version': '68DESTl_q6I45UJybf_gTTh2BU9FCq4XHR0QuJo5RJEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Ys38QMyFZToJxnXrF8aJ6ZaggHtrqx6mEO02Lk9seYkC'
       }
     ],
