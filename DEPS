...
vars = {
  ...
  'skia_revision': '4eb9b17d8e847923941c2cce2d7fa2657d34187e',
  ...
  'dart_revision': '0c121a6431cc6de5732f5638caf887df3280d148',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '9624db05ed7ef219d12b5210d06f37db99092e2d',
     ...
     'packages': [
       {
        ...
        'version': '_x3hf702RacYnw3E6sOdmEi6t8xZzaq4YxOLGSiRZ3UC'
       }
     ],
