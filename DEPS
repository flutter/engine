...
vars = {
  ...
  'skia_revision': '6388f0e8ef22868957980ff5b7579ca7628ba042',
     ...
     'packages': [
       {
        ...
        'version': 'Sg-XVB3PwRmk6Gu2Cvr7jyZvbZZdXiWniuOYAOk_cD0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'voGtvLTY7UjXHO_J6RVSEC3gA8ue1bADnaPCI6cFXocC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
