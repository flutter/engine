...
vars = {
  ...
  'skia_revision': '012f8497802e74d3c092d038ed2a5b1380309a1a',
  ...
  'dart_revision': '6facea722bde98daabb1784c212cd2fac20c60da',
     ...
     'packages': [
       {
        ...
        'version': 'J6ct_s65RMTtGAc0zMI55SNQ1-V0oUE74VbVl8oHP0gC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'cTw2CHPPyHxE921m979WtotEFB96C0u9C15fQchM4lQC'
       }
     ],
