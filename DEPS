...
vars = {
  ...
  'dart_revision': '80a965ee48ab6e71454f26fff734c24cc9464368',
  ...
  'dart_devtools_rev': '61d618843c76b328b1382193378d52eb9f3def04',
...
deps = {
  ...
  'src/third_party/dart/third_party/devtools':
   {'dep_type': 'cipd', 'packages': [{'package': 'dart/third_party/flutter/devtools', 'version': 'git_revision:61d618843c76b328b1382193378d52eb9f3def04'}]},
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'a2a16b45da3a53814418b3d18f6b8776297fd66d',
     ...
     'packages': [
       {
        ...
        'version': 'U334SygIkffMJVmduVhvR7c4L4qnQHz_9dPjcYKDwEsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '6Y22MutFhgL7ua18FzWslqS1baVCAG7l6MuPhp1vEs0C'
       }
     ],
