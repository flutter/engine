...
vars = {
  ...
  'skia_revision': 'f0140ee00f955ed2a2c0637159e04b45a0fc9ca9',
  ...
  'dart_revision': '684c53a6f174bcefd4e8202391a1a761abccead8',
     ...
     'packages': [
       {
        ...
        'version': '0Z8VFYja5HLTJXVItjqbtphdvf-wX_b9d-OeSTjLmrQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'X3Xm2czRkurpHi7WzysWlVYZlpywgV1tBK_yw1qfpNUC'
       }
     ],
