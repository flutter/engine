...
vars = {
  ...
  'dart_revision': 'b20c35c7d90f790048ae54520d88e7b5bb158eaf',
     ...
     'packages': [
       {
        ...
        'version': 'PGe1AnQiyP2TwPkh1BeKeVa3x26uV1XFUHFFeV4WR98C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Uc8XSzajFVbCi8y-PvZiTCf9GMCX6SmpsEYemCUw0a0C'
       }
     ],
