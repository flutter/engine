...
vars = {
  ...
  'skia_revision': '6bc126d24d1be28c2d870aa4e68e716cda082667',
     ...
     'packages': [
       {
        ...
        'version': '6XsAe3sPrNvJcRh75FU6Y4a-kwgDf9cbM73FVNDouWgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'GBIahjoek_zVfY9HOPHt5jSfocprfgkvd_dNoppYBvwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
