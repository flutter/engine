...
vars = {
  ...
  'skia_revision': 'fffef10476400601a867fb75f005c495414e1f84',
  ...
  'dart_revision': '65117290c3b0660d5916d0e0b1c96a5a6bdb60fc',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'ffd6ec26a212a86c70130b5d3cefb56605c2fe9e',
     ...
     'packages': [
       {
        ...
        'version': '-_edKGA5GTkDFxVglA5Eeh776tpMq4tePGwvozCb52gC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wWzXsy6kx1sp8Km34yMP4z_bIX4Hp2IigySu6bjGR-oC'
       }
     ],
