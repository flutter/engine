...
vars = {
  ...
  'skia_revision': 'a66a9c31a318eac556fd44a6858ff611fee95742',
     ...
     'packages': [
       {
        ...
        'version': '0r88gDzUP-fXOqnrvDwL2H6PWpRhVyBRLiLNdAgDb5EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'odFvFQV9Ze6QkoQceXhQ8iGkhS6dy4dteVGYQ0RJ4kIC'
       }
     ],
