...
vars = {
  ...
  'skia_revision': '81aa5ddb9404218c7e4ef09188446dc102074910',
     ...
     'packages': [
       {
        ...
        'version': 'uCq3VI2mcqK89t0ZcctQC3Rg2IYY6dOxxgWbitf1RxkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '99XLvb9SIiGLEgA7qizBhAVNKpcXt8DW80lXjMMhNPgC'
       }
     ],
