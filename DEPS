...
vars = {
  ...
  'skia_revision': '5ef3f98eaddae1172bfae1786fdc0ce222ae70e7',
  ...
  'dart_revision': 'a04f92c4dbff30567ab9a5f9735ab78a29572022',
     ...
     'packages': [
       {
        ...
        'version': 'to26OpvtksuglygRY7VWwWWDgcajpiM_ZwlAjRcT5BUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'gGLuymgJglx7WxJiQqE6pf6qW38CJdsJvxjCXTAw8QkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
