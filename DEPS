...
vars = {
  ...
  'skia_revision': 'a3aca7ae523e9d69d86172e8b7706ff6b4d7a42b',
  ...
  'dart_revision': '1df95f328d0c2f52611d1a4107befab1888fe903',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '8138ae9b1f3b924e39f1277efd2a1d612b2dd49e',
     ...
     'packages': [
       {
        ...
        'version': 'hVAAd2NqYOjUF_I998LDRT_IJPf5jijhH6q441hFXo8C'
       }
     ],
