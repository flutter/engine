...
vars = {
  ...
  'skia_revision': 'f6c3217822d2f6b2e062a50808bacb2d3ed7b422',
     ...
     'packages': [
       {
        ...
        'version': 'Fh2Uh8N-vwkaUb08BD1OtFoyenbqJ3lWomA-8c3S4RoC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'i-oxPy4-sVx2eVOPmMUPKkuis9NwK4M_iztEkA5rC4gC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
