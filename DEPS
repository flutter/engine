...
vars = {
  ...
  'skia_revision': '2345b9f2c943904de73fdcd8495d8412aa2dd4d9',
  ...
  'dart_revision': '7f2523c2fa9a74ef3cbe21ae885458fc1fb99d1b',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'e6708de26161da17a456ea7a51744444d83e82a8',
     ...
     'packages': [
       {
        ...
        'version': 'l0zn1BQFRjNyaZb-vbwy66ypImuf2ihhqLsVg6v_gxMC'
       }
     ],
