...
vars = {
  ...
  'dart_revision': 'b177e44ffa442d4bc5f55af5c60269a1a600e5ab',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'fe13f79dce4ce9aab3209f11988d825dcf580b4a',
     ...
     'packages': [
       {
        ...
        'version': 'iP6DEtpFZFlZM-2hjt5NwAo-ZVhSw0arGA-hX7dRAboC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'nK6R0-Z1LhGfmogq-nAUTlOomxkKUCV00iPPkXSgVgUC'
       }
     ],
