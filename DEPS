...
vars = {
  ...
  'skia_revision': '6c3097e6f833dba662440234eaa770f6454dc49e',
  ...
  'dart_revision': '1d26a1d57edf635b5f6395a4fe150a0ea0eb2aa9',
     ...
     'packages': [
       {
        ...
        'version': '6nMZjuYXTcnD_VZQIIhejhcL-FKJ5hAlphbOZ97Hv70C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'MVMTNxWJaWdwPWstzXPt1UidEwRuKmz5AdfVQ1D0aiAC'
       }
     ],
