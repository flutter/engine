...
vars = {
  ...
  'skia_revision': 'a12f6cbff348f063237a12325e2b0f2008310613',
  ...
  'dart_revision': '5fd6c8a3c19b062887b5830b37bfeb2347eb4d17',
     ...
     'packages': [
       {
        ...
        'version': 'zUbAffs9HEMTY2dpU1ndUlqsja4ouWFCPBGFh6C3kwUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'NgUEMhUSGDxOVn0B9PHTontMZyqlXiMJB885Se4yk20C'
       }
     ],
