...
vars = {
  ...
  'skia_revision': 'c026ade321b64f47d99fad7a746f4711f42a3049',
  ...
  'dart_revision': '77bc0eb4b39a73a7693853d9bc09b3d395778b5d',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'fc82ca44f1ae85c5fbfa06bd313477539ca50729',
     ...
     'packages': [
       {
        ...
        'version': 'krpEDaT56jlQY-BRVMMk_FfADIXxOs4oE1ln0BVZ6OgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
