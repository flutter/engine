...
vars = {
  ...
  'skia_revision': '7aec4b164e79c791530d14a86eab5b427ce20405',
  ...
  'dart_revision': '68ccd13498beb0db144744e204da9ecf3e480b67',
     ...
     'packages': [
       {
        ...
        'version': '6h6NwZw7zGuCe0LVXj0RZVm41pYaMWWSpfqXWEwNqfMC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
