...
vars = {
  ...
  'skia_revision': '714ae3262d0dbf7e6d6f0b70b70beced1e35201d',
     ...
     'packages': [
       {
        ...
        'version': 'ZA5ZzabQMTduCsECSB17iC2lroQB1_Nuiz21sCIT13AC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'yDo1mhBKz4eLEauzzVBUpoK7T8zk0LY-3erLnQpoq1UC'
       }
     ],
