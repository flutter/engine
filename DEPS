...
vars = {
  ...
  'skia_revision': '717dba9c94643f04a1a39008385ab5b11098e6e0',
  ...
  'dart_revision': 'dcbaffbd09ddea3bcb12356334909d3439356ae0',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '8aa3ca9d177c0ed54926b769de7d0bce0f8482d3',
     ...
     'packages': [
       {
        ...
        'version': 'EpwAiaHKf6M6YejtkAYHoX2uVmznnHYMFpeDjsu44tYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'FwIA6BaHtZg2mRS-0-VTUsPTeCQ8E0aEo2-B8u5TjLoC'
       }
     ],
