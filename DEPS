...
vars = {
  ...
  'skia_revision': 'fa5d6165e4d8997988cf580e72c3dd9ea1eeacd2',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '989b11435db26487f4bb3d40e14f0be1614701b1',
     ...
     'packages': [
       {
        ...
        'version': '8wu5EgBh1yJPNOd5WIdI-lOUfdlCY5SuR42rAxhPf5YC'
       }
     ],
