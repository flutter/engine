...
vars = {
  ...
  'skia_revision': 'd276e3f0099ae0e257d83927048ec5f64d6fcb54',
  ...
  'dart_revision': 'eb18db2116dc2fd40733eee8c1d2018117ad6621',
     ...
     'packages': [
       {
        ...
        'version': 'dqerHS2mu54wZhlbrLpAdKFOXrJ7aQfo1LscjfbZI3wC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Udupac5RMB5ivSEokSjG2BTEtxphge9ZlfTuALVW8PYC'
       }
     ],
