...
vars = {
  ...
  'dart_revision': '5969f5653830d04f5ff879ab3c48af45479f9564',
...
deps = {
  ...
  'src/third_party/skia':
   ...
   Var('liguisheng_skia_git') + '@' + 'cbf49b0b7a004313856f19ad99606cf2c09011a4',
     ...
     'packages': [
       {
        ...
        'version': 'chLTYsKMRF0cVLurybgn-hgJfh_5KSi7d9dNcFaL5lgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wu6yV-_BLd6NGRH7oK04A3W8neGw11lcR77oURhV4lgC'
       }
     ],
