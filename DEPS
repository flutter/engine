...
vars = {
  ...
  'skia_revision': '0490d8164997386e0261d9f005bbccf21c972c3b',
  ...
  'dart_revision': 'b177ece3a26561dacfdc4b527ef74ee504ba8907',
     ...
     'packages': [
       {
        ...
        'version': '0tQzhoyjtiVR2cEXa8wWQkTnoK_mINUb-xLVsxtym1AC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'x2DfaGq7LXsv_qYODsAUBlukLKZEjF7n5cPNjG3kmPcC'
       }
     ],
