...
vars = {
  ...
  'skia_revision': 'd390c642acfb18b81731c5c0a61a10eccbedc552',
  ...
  'dart_revision': '2ec59f6c0e47feec23d8a60009cb713fbc098ef9',
     ...
     'packages': [
       {
        ...
        'version': 'AI_KDVmMUu4XimXxWcuj4alrdyjUSAriePox0r7bfa8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
