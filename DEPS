...
vars = {
  ...
  'skia_revision': '45add166fdb9e52f80ff6a42cd4e91af298b5d29',
  ...
  'dart_revision': '36e3bae4fb958fda621a58997740d0998b8f3eaf',
     ...
     'packages': [
       {
        ...
        'version': '35pbnFFkn4BSOBteByb_STqapmC65lyu-Kl1AoQmqMwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '8Ns10ztmxBJEGI8SuXFaa_cSGRD2ySiNBEA941qqG68C'
       }
     ],
