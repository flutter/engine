...
vars = {
  ...
  'skia_revision': 'cc473cd92fc0dbc4a144c5c9f9af497207747e2a',
  ...
  'dart_revision': '42976b23388651d913bb7182f4d43ab73db4627c',
     ...
     'packages': [
       {
        ...
        'version': 'TzDuQG_sFU-_jAE76LGUZSkXGpkLeEajrUAPk8o4OCAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
