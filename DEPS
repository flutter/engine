...
vars = {
  ...
  'skia_revision': '1bddd42b98977740c7884aed7a87885c1e7e7864',
  ...
  'dart_revision': 'fff3a3747a18220ef8b95ffb4662c42c9da359ee',
     ...
     'packages': [
       {
        ...
        'version': 'vWnaCinzz60OI2ekKDBuoagNxSvMgoTXHhu4iLGIGfAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '4udsaggtHzID3i0iincr2YVUsHU2sb3Yh4fxzhRZ6AIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
