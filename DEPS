...
vars = {
  ...
  'skia_revision': '12449e09e422956c22ae3e8559c8de7a219397a8',
  ...
  'dart_revision': '7cbd8dc183c04b61127eff684e5e4dfea2456623',
     ...
     'packages': [
       {
        ...
        'version': 'kZJxkRRI82W2CW_nMUOVsrVaVrQIM1yi-d06o_5_ACQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'i7HhHxamwTC16efZ2HEccS4fabVfP0wTOc2-U1coVQwC'
       }
     ],
