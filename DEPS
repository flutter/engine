...
vars = {
  ...
  'skia_revision': 'b6689e5680504249d8c04c07a2fa6e8a1432308d',
  ...
  'dart_revision': 'b55f7a132f67044f861ba9f0880d43bc2199a0b8',
     ...
     'packages': [
       {
        ...
        'version': 'IKx9cvrtJZItMyYTkWSEf91n3P9IBngHaLw4rufsZYEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
