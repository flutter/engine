...
vars = {
  ...
  'skia_revision': '45812a1faa6121ad60cd587fc1e3a8e890526835',
     ...
     'packages': [
       {
        ...
        'version': 'dRCdbFWSZ50dNyaOj79yp-NiCMhTsdImLwQZc3koTxEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'BR_-u42YNVpjKfwFkHanjabAqWkfXGnPAfg-8KvmtaAC'
       }
     ],
