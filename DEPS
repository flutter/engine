...
vars = {
  ...
  'skia_revision': '05de3735b7237eaebe20717d38ead8ceee6a0416',
  ...
  'dart_revision': 'e7aa2cb110af44f0fb80ef79e6acc09e17376861',
     ...
     'packages': [
       {
        ...
        'version': 'KQ60Vu3d7qBKkGYJqVNfCbVdXHZYBNLcbkb4m1691C8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'gWYa9KhIKHAyPA0X8PYCcOfKfx5XdY8FV-7HI8Nc_TMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
