...
vars = {
  ...
  'skia_revision': '21b8cec137e161446a9cfb0c328d8b86b900ee07',
     ...
     'packages': [
       {
        ...
        'version': 'lzQvHw_Il1XPeT61qg4vD45MKxHlRvLAptn43wSHOwYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '5RGNLZoRSwj1ndKBctYc1dPw4s6NyjxV_gT4ttQ29H4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
