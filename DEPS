...
vars = {
  ...
  'skia_revision': 'cc1cbcf9e0bd17d5701673452a6839a455bfe65d',
  ...
  'dart_revision': '64a5583ffbc920080d1cc04c316d8a949f0ea317',
     ...
     'packages': [
       {
        ...
        'version': 'XxqTWS7q1lVTVdsTlnQfNhipL8nTziuM1Ivnn4OK3a0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'yDVPrfGq5tsPePID9JKo4ZGPt1RizaOqTl9M2wznlF8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
