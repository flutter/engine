...
vars = {
  ...
  'skia_revision': 'bd05d877db9d5c913ac957b32bffb4dd9fdcd210',
     ...
     'packages': [
       {
        ...
        'version': 'DO5MaQrsUVhzXvxpiLFiZBhgRmHoa4Hwg0o2PJDQHbAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Uu0LXxAIDbvw5ZAqt2cqPEkSzOjC-sgzR89n79KRKIAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
