...
vars = {
  ...
  'skia_revision': '9080a2fdb581a2ac6c6f7c76aef2648c12f6db95',
  ...
  'dart_revision': '59f9594aed9a2985869f931021dca0c9e51ad5fc',
     ...
     'packages': [
       {
        ...
        'version': 'qq5J5tHIADGDKscUZnOsAbGXUAPLhdw-0dTo45URyq8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
