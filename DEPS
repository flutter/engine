...
vars = {
  ...
  'skia_revision': '5c6258287461c3881edf08d4c00ed1fe5f236e1c',
  ...
  'dart_revision': 'ee10db4e826178a60b60cf8737ffb264ab711c1c',
     ...
     'packages': [
       {
        ...
        'version': 'eV1E54W8a9VTJpJM-lKV6xapZ46PG5E2R4l4_K50sxgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'R3xv3K9HzU2XJhGDcPKg6XGNT3s9BAp68S3vZNdg5xUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
