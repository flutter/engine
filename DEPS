...
vars = {
  ...
  'skia_revision': '55d339c34879f7047d1255c1ea9293087b2206f3',
  ...
  'dart_revision': '8697e05f98dfbb9bdce7cfe4697ccb7e36b709d5',
     ...
     'packages': [
       {
        ...
        'version': '57vjq86y7ZzN5GdpUBCu6FEFMhHCVJyZIiAtJmBLGDAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'MVQ4QtbNKysOsdye4yHluwwtNY5BJXSQTtKMaG35D28C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
