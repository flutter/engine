...
vars = {
  ...
  'skia_revision': 'af2f73c1bbd37d8c64ae253f25d782d30bac7ad8',
     ...
     'packages': [
       {
        ...
        'version': 'vPM5hitAHXnM0Q0I_jj6JeX2N0nYYPsVHkj6jXPYG5EC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'QsO40jt0Bpdv1OWz_dj1puUsN14-D498G9hVAw3GwyQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
