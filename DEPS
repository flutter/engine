...
vars = {
  ...
  'skia_revision': '16fa353926b8652238e7e4f354e054b9ca62bf71',
  ...
  'dart_revision': 'f8645091bdc855fd3f4c7f5ee75208be537f6adc',
     ...
     'packages': [
       {
        ...
        'version': 'egBfZMmTPuoUxHIIONU4-MOeMPUGCxEz9wDZY6OaXy0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'IZ7_b83xCnG0dNW-WJcMeD8rKBI4CtszbatDemd5micC'
       }
     ],
