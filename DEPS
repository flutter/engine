...
vars = {
  ...
  'skia_revision': 'eff697a78baaea1ef4485d4c64262cb1df4a783d',
  ...
  'dart_revision': '2d247d2bcfd4a32450bb2357252a4c9b7fcffb9c',
...
deps = {
  'src': 'https://github.com/gw280/buildroot.git' + '@' + 'af2745690843ad003c2b50f1e17fe0e4757cc78b',
     ...
     'packages': [
       {
        ...
        'version': 'dzre2TRPgkBH2Cw3914y6l8pUjJtxtTC7H6GUth5FSUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'neluWd0QF8brWYy_wRg1WlVe85l5mV4Rdyfj3hQC85cC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
