...
vars = {
  ...
  'skia_revision': '63a387395751fcd94de7e992c25926e968c31017',
  ...
  'dart_revision': '45358c5834ebd8f357732684e9d2e2a701a97898',
     ...
     'packages': [
       {
        ...
        'version': '_9Uy_LvnFfNQFmZYOPYOynW2pJk2pjU_sJTSqCPwOUYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'WpvU_ICg5oihZxBCrGkcfCMoSNXkzK9uIYH18rxdMIYC'
       }
     ],
