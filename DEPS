...
vars = {
  ...
  'skia_revision': '91b74f0bb965c2187f436415bf26b687e55def4a',
  ...
  'dart_revision': '843bd29908813296923190a78b828595084adb6a',
     ...
     'packages': [
       {
        ...
        'version': 'YPYqbrhiRI-aqsfjhtOclGOkPVZ0-wEmFCdQzWbMXAYC'
       }
     ],
