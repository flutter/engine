...
vars = {
  ...
  'skia_revision': 'c409951bea4fd24a52797996468fa35542a653bf',
  ...
  'dart_revision': '8cd01287b41d31ee0fedf1186a4ffb7a30aa6793',
     ...
     'packages': [
       {
        ...
        'version': 'C9SBXD7h52ZAK-aVmFGwu_1II7XYiP2OIxvE-G2q6bQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Gh0U-eDoCEEmvjdWvuvchbHXSaluEe1yHli0sBSDr_cC'
       }
     ],
