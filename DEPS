...
vars = {
  ...
  'skia_revision': '8261ed4cb685f3fa1c3946db21c36af9471552ea',
     ...
     'packages': [
       {
        ...
        'version': 'J-9pl9qVl7dKVaBrB7bR3-k-XNchbp1yuejxLmtbvZ8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'KwCitxtJlBPEHV6xlo6vSUfQ5Fguu4N8FMpIo_Eakm0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
