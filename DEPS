...
vars = {
  ...
  'skia_revision': 'c7d6e0ba0b6df9ea3ca0e30e8c497cbe2ac30b69',
  ...
  'dart_revision': 'ce08444763d9f25ba85c20e06101524cb30ec3d0',
     ...
     'packages': [
       {
        ...
        'version': 'TVGS3E2dTisTbQy8aFEyt7Jh8YAY4m8zFGljAv_KUgsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'JQoiZreUNodNZ3wEI2reVgIsL81VOHGRWquGwlzOANwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
