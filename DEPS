...
vars = {
  ...
  'skia_revision': '35906e0115e4b2161a63fb40dd310a49042901f1',
  ...
  'dart_revision': '761ed531161f6783252e5231dcee525c96c92f9c',
     ...
     'packages': [
       {
        ...
        'version': 'PRe0w0i4zseYubI60z_TT-6_8XGwraZRVvXshwgG_40C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'tJbtmEE4Q1NVs5BzMCzmsKyPQxUmZZ9RCJ75VKGJ3IgC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
