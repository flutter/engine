...
vars = {
  ...
  'skia_revision': 'ebbb67590a42ef9154383109078a7024cbc270ea',
     ...
     'packages': [
       {
        ...
        'version': 'qGsRXn7-DuBrrYDP3CixhkSD-wp2xF_dSAvfmqlMwgwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_mwyhkd9Hjv0o4KlgezBRadEtweO_9n5TNBYy7eaKgQC'
       }
     ],
