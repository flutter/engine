...
vars = {
  ...
  'skia_revision': '817dd601f85f986a99d102de8dc42ee8638a56f9',
  ...
  'dart_revision': 'f35040493b157d0e40763d5073dcc880acfb658b',
...
deps = {
  'src': 'https://github.com/dnfield/flutter_buildroot.git' + '@' + 'e7ec79b25ce3a80d023e9e33986de26cf9dfc2a1',
     ...
     'packages': [
       {
        ...
        'version': 'ygaqvi9oeeXCCSAena5EZQfLxlf3CUg7APkz02vQbecC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'sqbzSMhtcMMdYTMiyDyLVled24K1f5V1_4hR4cJOuGoC'
       }
     ],
