...
vars = {
  ...
  'skia_revision': '253b10915d322348bc502a97a30d5e1bf3e6aabf',
  ...
  'dart_revision': '0caad79385879e9aeede20c02b2c269cc7ad7364',
  ...
  'dart_tools_rev': '34fab90fed6d082eb1fee9cb8f2e25c14379f94b',
  ...
  # environment.
  'fuchsia_test_scripts_version': 'NWpblL_DFACOx_Spi9_s8s3hpYOESpZM4cGiKqUJl1AC',
  ...
  'fuchsia_gn_sdk_version': 'ALNKvSVWQSpw1uxPyh6OvWHf878FzEm6nvVEyTB8H-8C',
}
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@b4449742c0f7d7fa0179897cac163388e03236c2',
     ...
     'packages': [
       {
        ...
        'version': 'ZL8AvfXX5LFIH1LYNcsdK6q6Bzd-G1hrKJWG6L1jBlYC'
       }
     ],
