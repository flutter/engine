...
vars = {
  ...
  'skia_revision': 'ca7bd5e6b47b1c45ed25ccb96b326fb1c8da8dff',
     ...
     'packages': [
       {
        ...
        'version': 'LHLRXqOaQtcojptmKKhaxPf99QHZBdsBfNpRbtIjjnQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'DC_ub42DkPw6dxpy_4pscAkwrCDrgxvVG_cu7FFL18MC'
       }
     ],
