...
vars = {
  ...
  'skia_revision': 'f5931f3399e008d2b845a7eec3117970136f635e',
  ...
  'dart_revision': 'e74e4de7a430e5a2807ea5b0e8f30f618380b710',
     ...
     'packages': [
       {
        ...
        'version': 'ko0N4Pxl_nayW3wMqWFQu8Uxx__LgGLp_Sg2Z2rXczcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '4JYAs2BPbifnOdY8BL7CmDf7KWqiHNa6-KxZLJMv3K8C'
       }
     ],
