...
vars = {
  ...
  'skia_revision': '1a7fb9b3962ef9d609519ab1f2471b4e9090fb1b',
  ...
  'dart_revision': 'ac2439fbbef013e198880b919cdbafdcc80317b8',
     ...
     'packages': [
       {
        ...
        'version': 'Rbr2O4K3OqYQ6yalR_ICtPLmwc3NCwCXp0aoyo4uUpAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'kWrYHMQWQUTxPWb_TlrCpnKQQVkSpB3PUAlFliHdtgoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
