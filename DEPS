...
vars = {
  ...
  'skia_revision': '805eee00d900bd9bbed7df5516f95cee78c0d99b',
     ...
     'packages': [
       {
        ...
        'version': 'Cn1MLtDdPBKYcLxUYmbiqOGx33bUm1tdYtqW3iDpnPIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '_bFb8vcW9KmkQmw7c2DRW-Nf689lgxQ-PYR6XnR4lVYC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
