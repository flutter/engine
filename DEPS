...
vars = {
  ...
  'skia_revision': 'e2a9bdfba448ca308bf0430ea53958976ee98194',
     ...
     'packages': [
       {
        ...
        'version': 'Cijd5dDSLL-3u9e28CwM73q2bYc2SdFzwb7MEsqYvFgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Go31dJsEaDfjU0is3Vvh7p9MjCKr_h10kFcOSHiEOs4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
