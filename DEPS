...
vars = {
  ...
  'skia_revision': 'cdff3fcba6384563c48465f06eb10d48ab77e5b3',
  ...
  'dart_revision': '1f7dd915f40ace48b466a55a8d4a57da04b67ebe',
     ...
     'packages': [
       {
        ...
        'version': '5LKY3wsMOIJABJN7jYS3Bfp6baVsiZn7CSg3zeFvFesC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'zN1Y7c3i4HNlDD4W9cVox_mdJvdZs5LZhxQrYKBSNWEC'
       }
     ],
