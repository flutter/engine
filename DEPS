...
vars = {
  ...
  'skia_revision': '38edf6197aa9ba8078e9cf9502c4ce1edb8366b2',
     ...
     'packages': [
       {
        ...
        'version': 'N-iOLgSVYYh_AfC7QvTvFiUiSKrDd9pOwTMCb4SrkzEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'AE_mBWzdDqUvn4r1NQD5FLyu7gNrHHtBMnZasmCYzL8C'
       }
     ],
