...
vars = {
  ...
  'skia_revision': '81a7629b202fdf8e72512621936f9e496c4585ee',
  ...
  'dart_revision': 'b6f67aa2cc72ad3a2160887248b5c46aa5bbb1ba',
     ...
     'packages': [
       {
        ...
        'version': 'm7z9dEdGg7n_GGRaxbrdTS_9LYp0zMkbdf9jTUFz8CYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KA_kDgY7CR3sK8oJkE0dm_L1rmAwQIbSOOfD1MkhLl4C'
       }
     ],
