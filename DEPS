...
vars = {
  ...
  'skia_revision': '4935bed4260d2c90ec6dad0155314b3ecd889801',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'ea332c71557502a0b11d9a45b4a56d331100d905',
     ...
     'packages': [
       {
        ...
        'version': 'oTiMPVe_PvyCYnlqRZoQj2wnTcOeuoGspBRwax43t0MC'
       }
     ],
