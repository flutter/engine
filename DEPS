...
vars = {
  ...
  'dart_revision': 'a5cfdf658672e8f55cd694f174de8ab0dd3b814d',
  ...
  'dart_http_multi_server_tag': '98c2789fc1c47544afc8efbec5fa9c1499ecf5e2',
     ...
     'packages': [
       {
        ...
        'version': 'x6sVjdDJ5v08y_Vb3-Xy3o1zv5h83d5pY1AQsJFmCqIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '93K0dexTqZq58es6mJTynm9_YyRQvSahg4bLKlvLND8C'
       }
     ],
