...
vars = {
  ...
  'skia_revision': 'a31d9c3b45839e7512c300462d082b8e42423eb3',
  ...
  'dart_revision': '881c0b56a1f72108624ea82adf191b7587ef6a2d',
     ...
     'packages': [
       {
        ...
        'version': 'Bewt-eq7gNu6sU_ObE3pPFk98TYuoEo_Hb8p-4EBKRcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'AE3lAqTc632VsY14Lb39OLPiSsHPggqB5OOfX-Bw06wC'
       }
     ],
