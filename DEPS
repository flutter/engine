...
vars = {
  ...
  'skia_revision': 'c4624cc7135a8adbcb474f9e782f271463fea7c9',
  ...
  'dart_revision': '0c4f3ae7464c89624f7b09cf0e048dca1fc6794f',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '10380f4ba4735a03a27e190a2d0344b8f2a286ed',
     ...
     'packages': [
       {
        ...
        'version': 'UxuMYdEq-rI5WqUKJUstHN0fEVxooGAweJwIccrIe4sC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '6YiauAVOHpj7NQ1UAS7BCJoRPFWkcDPL3czsqAlrbW4C'
       }
     ],
