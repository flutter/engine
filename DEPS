...
vars = {
  ...
  'skia_revision': '8835d41e50290fdea1dbb18a814b90e812c09f89',
  ...
  'dart_revision': '88876d564247d4045e7a6097c215f3263369977a',
     ...
     'packages': [
       {
        ...
        'version': 'cXXSn3OsAYdQubXBBMSrN8z2cN3GjjpxFZGKHP44Ow4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pbcf1TmfFOwhgnuaN9hZKzvYY8tXuQ8K-0gaBX5JY3UC'
       }
     ],
