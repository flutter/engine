...
vars = {
  ...
  'skia_revision': '96bfeff55c58f7fcd44b51fd123e73e72b3c36e7',
  ...
  'dart_revision': '9a51d7003dd559d97354670bb1e2660a679a5065',
     ...
     'packages': [
       {
        ...
        'version': 'teyLcp5ejqE62omH_EVKbOMXuwUztpXORt1-muDEOCUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'qhvOdHY2MGojjnEizPas7dMrzFbMvtSGplO99Bsb5kkC'
       }
     ],
