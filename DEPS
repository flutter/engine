...
vars = {
  ...
  'skia_revision': '201d0c8d83f06bf949c65181456dfa27708160f4',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'bb7ac1825855c2a4dbdae0420030af96accf5389',
     ...
     'packages': [
       {
        ...
        'version': '4CZFCL5oL042nQihCihH0umxQpGhGvfh3vgi9yuhtcsC'
       }
     ],
