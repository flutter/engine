...
vars = {
  ...
  'skia_revision': 'adcf51cb52eaedbef4cd5117a7cb4bb2e1eae108',
  ...
  'dart_revision': '3a963ff14181c5d1bdc08a6e3a795879a0a97728',
     ...
     'packages': [
       {
        ...
        'version': '9DWt0M7vgpGEnos-Hg5AbLZKGiu-LuVZjJbd_NhJlvIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
