...
vars = {
  ...
  'skia_revision': '15de5cc6a09549d768ca9b0aead2a98a5ba1bb72',
  ...
  'dart_revision': '46bad70d0f7e50e542976ef6d250e7cc3ba40fc8',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '0afc3ec95439c0eca7111baaf479ebb67967dbc4',
     ...
     'packages': [
       {
        ...
        'version': 'GXgrnmetc14RPdheorFF2QUaTvtY-2ceYTD6nFzY6ogC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'a-BbzDtY3w8UXYgbKZI4BKjc61kI90tytahfKAhzyCgC'
       }
     ],
