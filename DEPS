...
vars = {
  ...
  'skia_revision': '7b3b916c7c9e8b72a662818dfd6f92ccbc96a3e4',
     ...
     'packages': [
       {
        ...
        'version': '3k_RoW0B3dR7I20MUG1qxV9EOVnHyBmXOyrj7UrOcugC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '9Vsn4gUTLI4wLcpmLRjdFdqTBuy9Z499f8O0LC-hncQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
