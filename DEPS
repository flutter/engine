...
vars = {
  ...
  'skia_revision': 'f65cd9be733039d871e23eea8566bc2827dcbd6f',
     ...
     'packages': [
       {
        ...
        'version': 'bmShnqcSD0GGOgrEnp6p2Gquc3y9TELmJ8gI3lvoEp4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'eYuGUghZ1uXOU4OTu8sy8fxuyjJo7SG79xXP-nghf5wC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
