...
vars = {
  ...
  'skia_revision': 'aac2d55d35ebb9d1cf1f390a1bdda7f36ca7739a',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'ae8a5cfd919548ee1801b2ce5d811557117b1633',
     ...
     'packages': [
       {
        ...
        'version': '961_tJawsbLMdy5i09FvefiD-ckFh6S_8yhK0SdtgW8C'
       }
     ],
