...
vars = {
  ...
  'dart_revision': 'c8f75afabaf1c95c73753b6b06fa646b88759ade',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '8e8b4dc940dc1873683563d7a208bfc0e24248ed',
     ...
     'packages': [
       {
        ...
        'version': 'sBjtpAHoetjF77qxgTxAOxZVN-K0i3ybX_F1jYJHrusC'
       }
     ],
