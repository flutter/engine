...
vars = {
  ...
  'skia_revision': '3ac7216f1f6d5ebeb0547cc20a3218701128115f',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '676dab7eda33f4483af9a1019951aab1edf555df',
     ...
     'packages': [
       {
        ...
        'version': 'wmM4lS2lYcphFSHPVTPzMZFgHmhVuVY0mGV8vLOWE_EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'NaQb_BU6PSbKXSAoUmx0A02V4d5gDferyWZXG8lCcjIC'
       }
     ],
