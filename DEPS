...
vars = {
  ...
  'skia_revision': 'efb8daa0503be276dafe17a30ac2687a67641ce4',
  ...
  'dart_revision': '55d7c1b35902e561f91860229fdac0a0e77450d5',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@9b1828f4c2456e8ee5612705d5992f60c6378e29',
     ...
     'packages': [
       {
        ...
        'version': 'JKTVoxVrHjZjBaxG4cdtYRkXlgD-QKknAFLrCcS91nQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'yr5wa34bzOBfEgzDH0dAgw9hz2auaQ7qLNdAEEyKD4IC'
       }
     ],
