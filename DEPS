...
vars = {
  ...
  'skia_revision': 'fb0440e5bcb6a4e9d1662b042ddf0c25d40ee093',
  ...
  'dart_revision': '207232b5abe0e8ca48ba936918fa6a17cbf2ae79',
     ...
     'packages': [
       {
        ...
        'version': 'ufdC-mDPS5KWcIM_CWwjKjEXztDPd7L1LZ7LL3wEOnQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
