...
vars = {
  ...
  'skia_revision': '9fbd7296de9a735b0ac55fbff23bd37b0d24d75d',
  ...
  'dart_revision': '0816d590a22033a61c267355b54ed158c8fd1921',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd2a6b2a0dee3a388c772f2c230fdfed7781b819b',
     ...
     'packages': [
       {
        ...
        'version': 'mlT1Bm0L9bVynvMFF3lpUMOuUpsv0P8aWBdkIb3UmWYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0Jd9VPJCX145RGnqrZ-yxgc9-QoGboEeDDGf8cbwiyMC'
       }
     ],
