...
vars = {
  ...
  'skia_revision': 'b8bc0c080aa84ae2351601c3ef1cd06949df9974',
  ...
  'dart_revision': '692273b46610c0bc12ae76fa8a95ebdcfa5abed9',
     ...
     'packages': [
       {
        ...
        'version': '0Jl20zAW45rRsTNEuuX3QIp835kbZeZevlzjb6BT7PYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'VKAiabs4VzJ1Py-oAN6-gffPf6vdWYlXuxYr8qboThQC'
       }
     ],
