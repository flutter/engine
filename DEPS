...
vars = {
  ...
  'skia_revision': 'f278a8058eaa8a13e0b3fb6b2d9075781c020a00',
  ...
  'dart_revision': '8121233ce158b93e2f33bf2bfb5d0465d5ea80fa',
     ...
     'packages': [
       {
        ...
        'version': 'MaLRScmfUUsqPEIcHqNOmkhtJ9vxmSM-zTfeGThs1AYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'NJK-w4N99BKi0MtfEcfBejWXu5pn-0aCHc4PxMdqw7kC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
