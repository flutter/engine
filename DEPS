...
vars = {
  ...
  'skia_revision': 'd3f67dbf9f36471a30c144022d9f788701de9bd8',
  ...
  'dart_revision': '4093d08271f6838974a28d718b1efb7d81b673ef',
     ...
     'packages': [
       {
        ...
        'version': 'r_oCIi4f4p_CI6qo9yAgBEsa85ebjaJshJI_bW3aEjQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'v32mJWB9n4UYKqJoJTd6ASYrptBC8r25yRRBlumR3KAC'
       }
     ],
