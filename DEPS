...
vars = {
  ...
  'skia_revision': 'a7eb07268026a4a785feae22622f08632230a843',
  ...
  'dart_revision': '7d165bd0bb5e022abecf1b40d5f0eabd7a81d45a',
     ...
     'packages': [
       {
        ...
        'version': 'OcPCdaE17MAihaCrDU8umPzit6Tu-4FWX0W2sMQUM-oC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'AoPEjX8Xfq1v0h4kxb21K8zy4RpTLOvgm-5deLH9vV0C'
       }
     ],
