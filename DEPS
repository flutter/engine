...
vars = {
  ...
  'skia_revision': '74b244c06e9ee8043cab81db41952c7008d103c8',
  ...
  'dart_revision': '1384854b5f23a8b34bd68f597e0b30d0a3cfe1a7',
     ...
     'packages': [
       {
        ...
        'version': '6mCy5hqoM1pnSOHnGafo5xnLuB-4NQqzEgYzgGy0y7MC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Ri1cHalR_Z99DMrVinHTLWSiltc68KNGmX-DHRJ8wV0C'
       }
     ],
