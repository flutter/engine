...
vars = {
  ...
  'skia_revision': 'a7b7964a237a06feb74d1204bf87e16f094de63d',
  ...
  'dart_revision': '996a581228215f7db426a18c2f003078138b87cb',
     ...
     'packages': [
       {
        ...
        'version': 'de_114mvQcHRxbFn5D5RNBzOb6AqkpbuGoNesFLOPdUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '5jKxFxRiQQBZD-C1zWUysCnlYX4xrOgvsml42rOUDBMC'
       }
     ],
