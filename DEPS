...
vars = {
  ...
  'skia_revision': '6518d77a22000cf4343e6ddba56f01943a191104',
  ...
  'dart_revision': '1c887123b92cdfe06fb1f0bee67a1327164d4919',
     ...
     'packages': [
       {
        ...
        'version': 'ggoll70iR4BCzRoi6DYMeXuU5eoqBBNon-FqzXbBX2EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'J6Eb-3pGzjmYjCMPE9AOpe9yyy7qMIuAWhzCYloQDFEC'
       }
     ],
