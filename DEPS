...
vars = {
  ...
  'skia_revision': '1bb0f15f2cffa1f57346ecacb5d2a27138bf0bb3',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '9740b01b4e7232e0a98d0ee5f052c86aa89d0409',
     ...
     'packages': [
       {
        ...
        'version': '51fG0shrG6fW64BtN1B2n9Lrnq0A8GI_gbX4D9udU3MC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'i9IPFS-XpkPjlH235d8PSdtIJk5TQ-Kobxu4CcD_CAMC'
       }
     ],
