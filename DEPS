...
vars = {
  ...
  'skia_revision': 'fb5e0ebef07c998880d72d70910a532c8ae74049',
  ...
  'dart_revision': 'e6aa07296ebb2be877e7c1b5bd2aafa3402485e9',
     ...
     'packages': [
       {
        ...
        'version': '5o9onBKYdvvPQvElXDgSbjWs13rh307Sop-EppvFpPQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'l8baHga4cRuFUj9JsCy62LO4Y_JHUtMIQlRNRgYZg94C'
       }
     ],
