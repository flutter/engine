...
vars = {
  ...
  'dart_revision': '559da0f2d2a427a099d7b34fd1df42e8bf6d2067',
     ...
     'packages': [
       {
        ...
        'version': 'chKeQc7Mz3t2p0m3LovDcG5W6TwOV48I-HOGMHjiih0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'GbnevjaIL0kt8zwnvf5X-aFjUYujld9HuyrO6N40SW0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
