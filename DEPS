...
vars = {
  ...
  'skia_revision': 'fde20db7cab795e979d0ef92a91cfffdd761bbda',
  ...
  'dart_revision': 'cae3737b6ae6e7515841487144dfb010584e8e3e',
     ...
     'packages': [
       {
        ...
        'version': '_4V492Yx4FurLEC6rz9a3CEwTw2RI78dIzNNQGbn-9MC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
