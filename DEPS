...
vars = {
  ...
  'skia_revision': '602c29929ebb2f050c7e0bea0055f13d2f81553b',
...
deps = {
  ...
  'src/flutter/impeller':
   Var('github_git') + '/flutter/impeller' + '@' + '5b60aea4ae628ea64d1e7f65259d38e38c69910d',
     ...
     'packages': [
       {
        ...
        'version': 'sDqKOClarTNxXypkF2UssF272ZarPaa4jd3dZAk-8ucC'
       }
     ],
