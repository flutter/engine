...
vars = {
  ...
  'skia_revision': 'bc7c754ce3957640efdfd39aea8ff700a8cc6f26',
     ...
     'packages': [
       {
        ...
        'version': 'TB587FHc5bPVS_VMIXjP0NZc09_BLadr8CUdHU21FqcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'q_v1AFsEqEWhiTJLhLclDsVv9yCfutunkAOYe0E_aqAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
