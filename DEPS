...
vars = {
  ...
  'skia_revision': 'ed289e777cfa41c059b94e64e0c749fe47db563b',
  ...
  'dart_revision': 'a06d469024fd8d94691e32a0525308aabfa50f51',
     ...
     'packages': [
       {
        ...
        'version': 'gg0rd9L8jzoKRMhbpWkXtCo05t_Awsr6J78hJJJsRd8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'aAb3NJv_h2CIxQhobJ6Kh5sENigufHobkwdYJTUbjtMC'
       }
     ],
