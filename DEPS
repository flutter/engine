...
vars = {
  ...
  'skia_revision': '56892dc9338025ef253462b112fa3c080cc2b073',
  ...
  'dart_revision': 'b5cd2baf642fab2e983ec8227647cf96ac24b6b2',
     ...
     'packages': [
       {
        ...
        'version': '0dM14Kk3AMLNXf_5Gc7Qn7lU9XcEdCrcVNdCrlO4E3oC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '3AhDN6ITO3oUCleonku7HnZEjGLVnqFm4q9weN3Oq3kC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
