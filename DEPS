...
vars = {
  ...
  'skia_revision': '1a01d5a1f13a353c2106ac09b18e6135a2359125',
     ...
     'packages': [
       {
        ...
        'version': 'pWucjLN69bBrdjxaE7B5ABOe9QaJEjF2eonm1yyhbrUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'an6xkzyWJAGBCOKNzLPvHwaRJxbDfyAqB7fnen8aoaIC'
       }
     ],
