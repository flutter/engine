...
vars = {
  ...
  'skia_revision': '799a23cf0602b9ab75a5c591db63382ac0d392e1',
  ...
  'dart_revision': '3883c6070942e4e3ed8348fbd05d542375166788',
     ...
     'packages': [
       {
        ...
        'version': '06MUzn1Mxtv0PVoOQJO21EiXODf5EHfbTBR6C9HzrpwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2W9XrkeDxoyt81DSZ142QN-FcKzGJkhGgbZ8Bth8wO4C'
       }
     ],
