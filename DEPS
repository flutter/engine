...
vars = {
  ...
  'skia_revision': '727df60abd3cf66ee2f02a53abe1cb43d9fdd496',
  ...
  'dart_revision': '8b4a4a7018f0fa6e1b67ca18bcf96f521b04fd4b',
     ...
     'packages': [
       {
        ...
        'version': '3lWQzTswrPcQOqAEyZvt8LfBmn5e-QuK-hax4H3xoMIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'a24HIbo9eddkzoDUZ3tlCxvElPoITWG7_CG1txCR6cUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
