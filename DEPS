...
vars = {
  ...
  'skia_revision': 'b3956dc6ba6a71c399451c072909bad9de80585c',
     ...
     'packages': [
       {
        ...
        'version': 'UCAnzi4k9pA30l_iZ2Ru51Tc3Ke6iacIdjFMgVUVdRMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'gTG1jp04GzBudVJqRxulXYOEQgbYTUQgnqLDYAq7z3sC'
       }
     ],
