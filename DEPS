...
vars = {
  ...
  'skia_revision': 'cdd6cced452015ec6a96cead22b185567d4271b5',
  ...
  'dart_revision': 'baa92e08fee4642325beaf3d49765aa468416078',
     ...
     'packages': [
       {
        ...
        'version': '8cOXjqyWNP4Fr4cma-YVLP0sS5NUmYSast-DRcPcjlEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'hIxVxIVhEMsBiWuqbVUQFlp36wB8V-h-JKxKFkGXxQcC'
       }
     ],
