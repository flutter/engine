...
vars = {
  ...
  'skia_revision': 'ff418c512205ac288581a8c02f95fe8884f3392a',
  ...
  'dart_revision': '33307e78db2b499305274339b46a0d81c6661848',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'f773a79fef3814af079b9648e9c4395c5a5123b3',
     ...
     'packages': [
       {
        ...
        'version': '0pD5ceqf-e9y9NTNnO7y9qV_aBlu41zcbDYLK8Y6jlkC'
       }
     ],
