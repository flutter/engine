...
vars = {
  ...
  'skia_revision': '73518c4ee9d1f7888fe8ead3c954243e11d79dda',
  ...
  'dart_revision': 'f527ddd39bb1b22c04189e20dbae7e046b9c1a57',
     ...
     'packages': [
       {
        ...
        'version': 'YhRvbuj9cCycPDe7XHtsYPSfio_1PSu0LVuCjuhspSMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
