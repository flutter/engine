...
vars = {
  ...
  'dart_revision': '193ac812ac3a20e54f70373bb5836e3ab933655a',
  ...
  'dart_protobuf_rev': '11983dafc42775c56698af06107d626780e9cb69',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/linter':
   Var('dart_git') + '/linter.git@b677397483251d55ce1aec8d170be7720b53fe26',
     ...
     'packages': [
       {
        ...
        'version': 'kP-yebuRgWYJ6_f1FfLyRz5Ax98cvWNY5e3Z6STYNBkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'IfIhCrtMDOZTReFzSAxoyboXKqNEH7WRdaFXWTjctD4C'
       }
     ],
