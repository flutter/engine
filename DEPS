...
vars = {
  ...
  'skia_revision': '2febb5b4233e4c937ed6a13b012661513c660807',
  ...
  'dart_revision': 'd31a6683999e82e992aeab283e5165df51edf2c3',
    ...
    'packages': [
      {
        ...
        'version': 'TC0M_mkz9VVc36TpIm3aDxSDgBqcql_i-WySBWu90fcC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': 'Up0KimH9762TomgENNcYUTJ6PAHi-dDgGXz6O54mL5EC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'R-p04Lkby7QTmDW6vBbLJ9z6OEovEj3glk26hUt9L0kC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
