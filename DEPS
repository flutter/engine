...
vars = {
  ...
  'dart_revision': '5713caaf09db849145b21068e67444cf4c9cde3a',
     ...
     'packages': [
       {
        ...
        'version': '9EcA--gzHNo80R_fAuB_Tq7ECubTP0Uz3UrycPIvRpsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'NrExSKBKIhY3SnE4sD0-vHjEMCBYYffzarRM2rWONUUC'
       }
     ],
