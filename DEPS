...
vars = {
  ...
  'skia_revision': 'ecbad283619c9c86e38050b981e08dc90e981b7e',
     ...
     'packages': [
       {
        ...
        'version': 'xEQkW8iPZrJ4hyQrkN5mv-UFua1xc_RR5gEXuMNIx9gC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'ApA7xAqGG_t_NxvWX1gJ7SIOPZiF9z46eTNsXb1HAIEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
