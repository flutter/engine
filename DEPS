...
vars = {
  ...
  'skia_revision': 'e74cebefdeeb2aeeb162a0ddc912c833247e5789',
  ...
  'dart_revision': '62aea7e5112ad9f531648929d3c8e287a111b011',
     ...
     'packages': [
       {
        ...
        'version': 'v7dguVBSAysVL7LEaQ-ZD0x_OgrbyaK1iZQeIhhbiggC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'NeYDIjo58uDZbmq30ljQ1uMoKWSbjHMlioC4GKrSe58C'
       }
     ],
