...
vars = {
  ...
  'skia_revision': '14318c140949d28bbc972ec0d12869fbb06dbfc0',
     ...
     'packages': [
       {
        ...
        'version': 'vDk4633kGyW0WoREt-ke6sV_PxlFWJ-VXZh6TR2tYNEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '7gDBNFady4lIP1eJTgAfOEr1OOzt6LIbZMVSI7TboVMC'
       }
     ],
