...
vars = {
  ...
  'skia_revision': '92f1bc0083bf2fa1d7eca2857c0d837a8dcf1f17',
  ...
  'dart_revision': '904ca10d48a7b7e4256fc1c28e6790ddd50463d1',
     ...
     'packages': [
       {
        ...
        'version': '90jKZc0CFxsZejqTQ_BdOVFlixs56d2KEFzIdWJ2N1IC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
