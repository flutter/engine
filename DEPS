...
vars = {
  ...
  'skia_revision': '407563760529fd782e78eb087643b924f3dccf2a',
     ...
     'packages': [
       {
        ...
        'version': '049_bWW1vivXrlb41r_SxQwfou5QHie-TfQetLh_Q58C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'mtwYrvsxlv3Dh-5s822DanpkFhk0aRCKLarlTbUQE8sC'
       }
     ],
