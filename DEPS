...
vars = {
  ...
  'skia_revision': 'ec24154521f3d1531efdf4936a4a95904b81936f',
  ...
  'dart_revision': 'add1eac3622ca6658132df28d901546eb3b5c343',
     ...
     'packages': [
       {
        ...
        'version': 'WIqUEANCHaurd4PGrR6j3hSQgHHIfqKjZS9iBXisROUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'YMY-cajLa0mbiTko8OiQa39OM-XGbbP0toxNPnw6bS0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
