...
vars = {
  ...
  'skia_revision': 'd1215b38667cb25279fddf703261bdd8cace002a',
  ...
  'dart_revision': '6c4eb86ecd258fac93e87ef47812c5a8e1899411',
     ...
     'packages': [
       {
        ...
        'version': 'OMrTgAfDg9PKXTzq02S-SPbjInFqsBoiPrFMP-k3TNYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Lg6FR6iDnZeV6y-E8iVqEsPfDyNRkT_ZnJSGtO2OH2UC'
       }
     ],
