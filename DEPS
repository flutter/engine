...
vars = {
  ...
  'skia_revision': 'cc185c5a31f349d2e7c6fa59b93d043d47ef4f02',
  ...
  'dart_revision': '22d0f712b0a60a6d7f6c67af064248187b8dc950',
     ...
     'packages': [
       {
        ...
        'version': 'CxbV_a22uKXKuDJwkc4fzTPTIZDtsMj-st_AIs6kURsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'dyV8TNd7wjEYIeNIbj56Qul_1AXy9wbJS-j72tyDJ4MC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
