...
vars = {
  ...
  'dart_revision': '610c1e41a046adb81d27f2e5e30adfc08937d1aa',
     ...
     'packages': [
       {
        ...
        'version': 'Vk6uTmItutHsAW2A6z3s8WbPBNts8tUxqVi_c1ehDrgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'MwGkB2XzjHFjLDeCHgg_uUyoLUY7VkaOT-yD_gPc7gQC'
       }
     ],
