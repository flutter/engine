...
vars = {
  ...
  'skia_revision': '8d19d04472e19dcc6f137a19cfeea1aacc94bbd7',
  ...
  'dart_revision': 'a013e7bf089e82f00e787c0f225f5b2815eced92',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '4dcaad2a894d90c1f3910d1a11489d64cffdffdd',
     ...
     'packages': [
       {
        ...
        'version': '7kGBjmX-zBXcg1svEd78lkHB3n85_cD7LYmNYYdeQlMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '-SNz0augjLKFVsUWnMnuevifpykHjCqZd5_eL7gslrMC'
       }
     ],
