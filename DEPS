...
vars = {
  ...
  'skia_revision': '997c907f1190b41f6babf9a05aa668007443a139',
  ...
  'dart_revision': '99a233505f5ae4102f6537425e625fe8960c5cef',
     ...
     'packages': [
       {
        ...
        'version': 'R1zocs5zSvW_Q-4C4dEJ1c1T5JTQtgPPmCWbnG47_hcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'PTa5JR_iJtlJBVRX05X6dJ9aYlK98WeScoebpIxwKTMC'
       }
     ],
