...
vars = {
  ...
  'skia_revision': '2508d582b5b68029f03b61b7103b3140f95bd071',
     ...
     'packages': [
       {
        ...
        'version': 'U04SkHuh45uhKOJowKIG9SItx6B62FfTNEGTaw19inoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'yOcs1gqJp_51G9JRWvo747-2KHi_eFTBdIfUEsFiePQC'
       }
     ],
