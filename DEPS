...
vars = {
  ...
  'dart_revision': '5d44fae9a591179e7954200b3140626a9721af9e',
     ...
     'packages': [
       {
        ...
        'version': 'mdcw2qyY6qxn805SkY-DLHdAP9CLuJczorztYXhxmIkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'smlBCS1MmnOzZgmB71NYvh_9Nkj5CYAwzad-nIEkN2gC'
       }
     ],
