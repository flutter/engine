...
vars = {
  ...
  'skia_revision': '83da27e4cd3ae802e6c7f7243ca1b237d09dd7b3',
  ...
  'dart_revision': 'f4064c8c25e0b7156794ca742ec0b4a1f853aa85',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/html':
   Var('dart_git') + '/html.git@f118e004dfe68a4d101246106e775c0231efb79a',
     ...
     'packages': [
       {
        ...
        'version': 'jD_N9MDLvRtOuBMgYTRE2wZn3mB_ng8oAF0DbXJhhQAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wlbzrDXNCXQZV0QdGBv58Ie9UqYYNozgxuhFRH42AE0C'
       }
     ],
