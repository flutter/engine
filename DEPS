...
vars = {
  ...
  'skia_revision': '568f0ae77834f0e3de83d9c482852ff4c1d68e4f',
  ...
  'dart_revision': '2ddf810f71f6cdceb0032faaec4e680807caf960',
     ...
     'packages': [
       {
        ...
        'version': '6swTf93jzjdjw6XQwJOLScJcdElu8xxtiG9GJcNNc1MC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'VYUnZ3TbhX0zkacLRR0eogDYBVE72F1Z9Wqyu_193eUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
