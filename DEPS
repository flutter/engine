...
vars = {
  ...
  'skia_revision': '30ecaac60b470fe2e81aae58f05d99a4f440e984',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'fba482b7107ccf3e178f6bf56b6b0285407ace3a',
     ...
     'packages': [
       {
        ...
        'version': 'IK4xyRtZkDwqT6pXAFvX-JUnOhqlqASQWGy3ecKGdesC'
       }
     ],
