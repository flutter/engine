...
vars = {
  ...
  'skia_revision': 'b41d5bb3a7b6b3125853d1eb61b793b512d5c9fe',
  ...
  'dart_revision': '89cd39c6eee43006adfeddb816474bf36243b20c',
     ...
     'packages': [
       {
        ...
        'version': 'FtwF654ce9V8NR_OPrv12dKDDFOLMU4x-yzuD9ne9fIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
