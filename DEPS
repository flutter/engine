...
vars = {
  ...
  'skia_revision': '6bdb0ef30cb64884fc0ee619706f691fde8f0104',
  ...
  'dart_revision': '605fd026151bca5d0f7612420c5f5680d81033cc',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'f1e1987261215891dd310f886544c32e1d5dbbcf',
     ...
     'packages': [
       {
        ...
        'version': 'J-zU9HGYXYU5UWJO9E8s_xast11bWCZ9Xfwicw1nRAgC'
       }
     ],
