...
vars = {
  ...
  'skia_revision': 'cec6e0af2bee09777b6660cbbcf08999e81cc70b',
  ...
  'dart_revision': 'c7eb3230248ab60b95eb0d495b853b3b3d8d6814',
  ...
  # environment.
  'fuchsia_test_scripts_version': 'oGxqx29_HA1eEBnt9pRiZYDa_BkzACC6l3_3xYYKLjYC',
  ...
  'fuchsia_gn_sdk_version': 'OKGFjciA5Vd0TQks4ow7-ppfxy_Y6v5hSjjn2w6LWjwC',
}
     ...
     'packages': [
       {
        ...
        'version': '5uR6WvDV5FX-aZgKQjRGljspwaJKRzm75TyPQIH3xmMC'
       }
     ],
