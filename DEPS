...
vars = {
  ...
  'skia_revision': '2d44549a1f3aac38ca1060ad991234cb5f3bdb02',
     ...
     'packages': [
       {
        ...
        'version': 'zCiq3y-6pXIRkmLDbEJN1xm8VK4f7wpnds7LXAwRxtIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'byrJ9URZUMnO3xUslrmIQT3-8kVMgxMPkmvxY1nlHMEC'
       }
     ],
