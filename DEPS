...
vars = {
  ...
  'skia_revision': 'aad4b80fa625d6e1d1ef18d67ba2c63d5e4c2be8',
  ...
  'dart_revision': '657d6dbde4851c7e6a9e4d1ad03a322d73d710cd',
     ...
     'packages': [
       {
        ...
        'version': 'ICWUopirblwYxw9zbAnpnU_-16N899vjmG3lEjtWtRgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '6CBxGudrvRnR-EAlHfvMkXYApx4fTgp9-BEZXb3kfawC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
