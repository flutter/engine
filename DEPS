...
vars = {
  ...
  'skia_revision': '725705f6630b1ef89132c704df4172157ba524b8',
  ...
  'dart_revision': '05febe0a78600b8a68bcf5999d20dc8c35c59aa3',
     ...
     'packages': [
       {
        ...
        'version': '6BYh8qaYo2ILsqciM-lrWxqPhFACcWp0ZCv_FU_kD3wC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Ci-Vji1rxanJzUKbt_qNWy2xggpI2M6kCVSTJ1dPtRAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
