...
vars = {
  ...
  'skia_revision': '7588f07cd92889d56c68237dc81b110cf79b3f16',
     ...
     'packages': [
       {
        ...
        'version': 'H1QjcreN94UHPo6hcDhBG96-VOwYIlhjAzcs9fuVS6QC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '2IT_bBWGjJkafoxd7wZbLv6YKcQU68LtYjjbgLYYKRYC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
