...
vars = {
  ...
  'dart_revision': '9b7b9f73586655ad1c5978ffd9359fb6e85a9d32',
     ...
     'packages': [
       {
        ...
        'version': 'Bdm6sG4U3pe3Cika23BWFFeh-8ynxqWWHJMpu6x1sJ4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'H_WclqYkWkeRFbPKqEsxuNot0QbNN6NU_0ZVb1S7EO0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
