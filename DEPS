...
vars = {
  ...
  'skia_revision': 'afa75c6cf697fa6aadbe42402e842023ef9503ec',
  ...
  'dart_revision': '691e4650ce919ba46a8c03159b92df4b21e6985a',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'df5e37b0dcd5f1b6833643de1a8061d05be91369',
