...
vars = {
  ...
  'skia_revision': '5a183eeeda867c9534488be624d8aa6ae8b7313c',
     ...
     'packages': [
       {
        ...
        'version': 'sk-SFXAARqkT7wGmfhZtARERPLfNAiC09DamWWKBs-EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'gp1k1agqxQIz0oTXVoq9kQgNYP6bS1TOj_Tz63lANUoC'
       }
     ],
