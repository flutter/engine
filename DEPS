...
vars = {
  ...
  'skia_revision': '82ad7af58fd74b969a9ca34fd97bcc33823d3387',
  ...
  'dart_revision': '526b85706ed704331e22d8cbbe455ba64a4376e2',
     ...
     'packages': [
       {
        ...
        'version': 'xpyKHzaGr1Kncj66pJ3JoLTHAWXQBYdv7lWuAMr1GQUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Q1DG3XKnAsTw9Lj5Akl_txhsM_aPzs8mV9eOFFshCDYC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
