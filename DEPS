...
vars = {
  ...
  'skia_revision': 'b409f78083ee27f55fe1ee956eb3e402f17fdf2d',
     ...
     'packages': [
       {
        ...
        'version': 'ZVemDAxDnR3UJQFdeVjdrLbuTrCiQ9tOlKon7AgDvnsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '7hrRH_ILuxwU-k8275lHv_TwnYCD4jojkCuau0-vxBsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
