...
vars = {
  ...
  'skia_revision': '4ec5259b90eea1d4fb9a49dcc2fc3351c558c885',
  ...
  'dart_revision': '1330b0206fe0227055a6732118576c7a75758573',
     ...
     'packages': [
       {
        ...
        'version': '9JvU5CtfXIOCWZLzleFemA-KsKIJtKCH94S5DYAovWEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'DIv7If9q5GcxMqZ-J9z3vBx9Qy6i0-VR6OcEXIwExX4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
