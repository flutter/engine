...
vars = {
  ...
  'skia_revision': 'f2362d22abcf32204905c1f216bc18b679fdabbc',
  ...
  'dart_revision': 'aab0233f76b79cab344ae989998034e1742442c3',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '179924cbfaf3f4ec073fadac65748da0a5579722',
     ...
     'packages': [
       {
        ...
        'version': 'e_QdQPRjE5lCfa2HyVLehbHm-XAfLRGPUDPNldy4gaMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wgkZmRBHTT7DehhULrQ8SrVkdx_WwjSJq7RfVtyI85sC'
       }
     ],
