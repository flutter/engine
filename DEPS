...
vars = {
  ...
  'dart_revision': '5c9e79e6636464c9bbe5e2f0deabe7512af5e4e8',
...
deps = {
  ...
  'src/third_party/libpng':
   Var('flutter_git') + '/third_party/libpng' + '@' + '30d16fb3b45d5e1bdad3d4597c141642256fb90b',
     ...
     'packages': [
       {
        ...
        'version': 'RVHAIKU50ogkiV-LjqGMenlaBlAy2QNDBpQQIRIIdjoC'
       }
     ],
