...
vars = {
  ...
  'skia_revision': '8513867ced398256835400a8d895f38e024967d7',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '09735f5cd5fafe7173d0c9e4b2db015c8f3ef982',
     ...
     'packages': [
       {
        ...
        'version': 'vzpWHX5jSIjCnNx42IOTa4yFtGWSxZ7OPuKlsNsfoG8C'
       }
     ],
