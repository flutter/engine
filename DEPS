...
vars = {
  ...
  'skia_revision': '87e9ddb675b611a9161cc445fb9ea2ba8becb9d2',
  ...
  'dart_revision': 'e50d98cd56518a90bb767f68cc56302cb2af1edc',
     ...
     'packages': [
       {
        ...
        'version': 'Ykb4byCXA4sFkdJhnBGU1Uk4f12Q20t7WaSDqJzRa54C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'uFFWWwQOTwvoGwsaekgf-DKDmc8YAvNNlfHSVXbx3XAC'
       }
     ],
