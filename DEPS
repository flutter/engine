...
vars = {
  ...
  'skia_revision': 'b509bbb81f36f6cd17da0f2e90b724d379de43de',
  ...
  'dart_revision': '2eab25e4b239d6a028eaea0cf71c3c6a847c2f47',
     ...
     'packages': [
       {
        ...
        'version': 'gZ122oeKO8o63jCEfdrVDN8mIa9IIcta8bJSAAuVoHgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '8EvelbjqfxB3wn8AZ87H43bfUHvYKPxYeeticZzeTZoC'
       }
     ],
