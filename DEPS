...
vars = {
  ...
  'skia_revision': '8c73a59cd417b3f8fae08dd2919840ca5a0848cc',
     ...
     'packages': [
       {
        ...
        'version': 'SBV4OIwp1ahu_iq_vk_A-_xdsIkYPtmRHDXzq_HmHZQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'GvWjlKsW1ybhJZzUpH4gyKZ_z7SsPzQRiGUmqhftKNwC'
       }
     ],
