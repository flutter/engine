...
vars = {
  ...
  'skia_revision': 'c1e1fbbe137d9c79b163d33fde675aa0d496ba8f',
  ...
  'dart_revision': 'bebc7d3af5bded5ea3f549e90b42c264fe9d1d45',
     ...
     'packages': [
       {
        ...
        'version': 'nbeLeAQzAzSIky0eS6-YcmZ-QTizmcuk4JekC982nicC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'xYmDFXL_pS6hLzWjNPzkJVDVhE-VsYwbd4wVHVRvWpEC'
       }
     ],
