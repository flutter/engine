...
vars = {
  ...
  'skia_revision': '02eecda395baf8bb71760b3799384d3d6cbaea3c',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '0b648252039f18bac08f8a95102d6fdd228c83e6',
     ...
     'packages': [
       {
        ...
        'version': 'P8oeVw3whCGS6pCjLvJJ2d-sF1ivQ4USejrGM94CCRYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'XoUnFqSvX9mhbXqBJhDSiuW1WVgNGWSoUhG51u1Yd4MC'
       }
     ],
