...
vars = {
  ...
  'skia_revision': '4eea73a072d3336760a1934f3afae735bcf7f4d2',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '1f1b5ee82e66f792f960bd45b8a44e16ab895617',
     ...
     'packages': [
       {
        ...
        'version': 'VciXahwZgiusifyh8fc6jIjfaKr6VGDrWeIN0Lul1yYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'a024p4HJVVgmCW5JoT7TXrMrB319HQQOAhRYtitFPhAC'
       }
     ],
