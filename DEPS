...
vars = {
  ...
  'skia_revision': 'db3422668bd8a3403b09cbbb5d70381385bb1f1a',
     ...
     'packages': [
       {
        ...
        'version': '5OhE9jj8oIxnQZG8UcFJaxBGrz81FqfrHJKvJsKhDFgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '5-RB9TzQHoA1tIAWEtW-IK1r3L4jyXfznEw9slyuy7MC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
