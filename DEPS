...
vars = {
  ...
  'skia_revision': 'c9653c80c68967447c14e0f0ba7bb423e319815a',
     ...
     'packages': [
       {
        ...
        'version': 'gNitpShXxsIonmK3DTyrSHoiTywz3RXumvmL8WgCpqoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2rLoqyIreoVMYDlv6fts5ftYaJgu7kqpHqGRJbPhzpMC'
       }
     ],
