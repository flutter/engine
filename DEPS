...
vars = {
  ...
  'skia_revision': 'ccef63db2666ed79d86dace2660ff15f4db945e5',
  ...
  'dart_revision': '347d212e63699a27d83dc598e4057191dde26ea2',
     ...
     'packages': [
       {
        ...
        'version': 'CcH9sMEUb4rHWqVRbewOci3hetlW2PVVG57m7tqO0RYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'oSwtt3qS9kDrN5FqlXLnLIty3iBacJJ-5W3flUrehOsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
