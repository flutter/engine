...
vars = {
  ...
  'skia_revision': 'c6a3d531880eafd55a92b36123bb3faf90d10356',
  ...
  'dart_revision': 'b9471aadaa1aee3a2a98819581b5aaada66d042f',
     ...
     'packages': [
       {
        ...
        'version': 'Z-pl5laFzrkLUF3hjMGUlvVdR6ILocNTSdYnephG3IYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'dl1JUKVujkyS70zdA8KaK0N_EUYaUfflDjJ3CulJ9PoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
