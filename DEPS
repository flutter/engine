...
vars = {
  ...
  'skia_revision': '93297d54df57ea3e77d37c804664d95122938e6d',
  ...
  'dart_revision': 'ac425a3ae2b12ecb541ab5ecf47ec0e6a5a221a5',
     ...
     'packages': [
       {
        ...
        'version': 'eJH_BpC8Vtx6nYHBqmXoI7RQVU4dk4fPCl9GgTnG55kC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'n-AJfzUMFozC7yzLvyxib4WOIUVVlukRzcWz9eni1yAC'
       }
     ],
