...
vars = {
  ...
  'dart_revision': '6eab35f49cbb7740f54162e1e57c864b3b0ea06b',
...
deps = {
  'src': 'https://github.com/stuartmorgan/buildroot.git' + '@' + '53cb4ed6aa2981975b357e09b4b0e65d79b6802f',
  ...
  'src/third_party/dart/third_party/pkg/csslib':
   Var('dart_git') + '/csslib.git@166d3e07eabc8283c6137cfde17fb25b8bb40080',
     ...
     'packages': [
       {
        ...
        'version': 'sI2DAAmSIPFpoSRKVuU-K8lxECFNgEvTmP4XADA_LYwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_SVZn8uN29ChCSHo5MzviLagX5er-rvbxq1TCGIknToC'
       }
     ],
