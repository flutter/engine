...
vars = {
  ...
  'skia_revision': '4fb13e026b6b26e7714421b463b5d37ea9709ef5',
  ...
  'dart_revision': '52fccfb392b49f74bac6c3a8998efe6a865bf921',
     ...
     'packages': [
       {
        ...
        'version': 'pmsuWkRQAS3j65ZBvJ5ZqM2tcTu6QF8RoTUTVfebNDAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'aRqEDMjwClWi7kqhF9Im8cwfYO9oRBo98KFWtt9NOLIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
