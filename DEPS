...
vars = {
  ...
  'skia_revision': 'refs/changes/59/633459/3',
  ...
  'dart_revision': 'de14a48187ce7d6063ae1d31a3a51b323a2c03f4',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'f8d0fe6494e35c84b069a09ddac9eecf303b1510',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@19582a8d45670a53fa4fca8d06a3746d1616d46e',
     ...
     'packages': [
       {
        ...
        'version': '_H53AyDxR9Pm2TbwNGuozNh9lNZ1xW-yT2_4RuHy3PAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pGX7tanT1okL8XCg-uOPtKPzEwpxK3W3lhrFYrE77zcC'
       }
     ],
