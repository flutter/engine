...
vars = {
  ...
  'skia_revision': '22d1ae035048c43fec4590790358d2d987a0a4f4',
  ...
  'dart_revision': '318c46832196b496253a82ac9ef073fcb920f3d1',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'f29f73d9f0633ac0b6d14382608510fc86e45195',
     ...
     'packages': [
       {
        ...
        'version': 'SQrHxRVqMo5arcS3pKfvDqGxWx4HHmM4X-0BsKXuSmMC'
       }
     ],
