...
vars = {
  ...
  'skia_revision': '64bdd87fadfe3812de10db6abb312374725e4c1a',
  ...
  'dart_revision': '858f83d6d993a4990a0809f3fe4d2c889bda5c61',
  ...
  'dart_clock_rev': '6b9df3eedec2d4389729106e380608174a6f6544',
  'dart_collection_rev': '6abff472ff09a0e4f9e9e386642bdcb674af15f4',
  ...
  'dart_watcher_rev': '94305928766b98ed523337dd21b0ccf289d4c059',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/async':
   Var('dart_git') + '/async.git@0f368d36fa949f6d946242d2bc6ea595ca8fa3f0',

  'src/third_party/dart/third_party/pkg/bazel_worker':
   Var('dart_git') + '/bazel_worker.git@1b86d3c1253a9c2cf85fd12c8194a65b91d0997d',

  'src/third_party/dart/third_party/pkg/boolean_selector':
   Var('dart_git') + '/boolean_selector.git@7eed40256e0bdfcecd3ae533666699d866536e3a',
  ...
  'src/third_party/dart/third_party/pkg/crypto':
   Var('dart_git') + '/crypto.git@4e9dde199bbf591db5154ba85ba0168a92968ea1',
  ...
  'src/third_party/dart/third_party/pkg/logging':
   Var('dart_git') + '/logging.git@4779d7ecc445df17efef2d58a457e276ff912765',
     ...
     'packages': [
       {
        ...
        'version': 'rO5qs4MpN6WfJcu64eJALAaoegaUj9h45s4ukOERn_wC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'bddx8p5907poNnZTqqVW3ts46pG-CggbiOSHX569c40C'
       }
     ],
