...
vars = {
  ...
  'skia_revision': '36c5796f0bd09ffef98a35598c26163c071ec1f1',
  ...
  'dart_revision': '3c595684faca5ffde7fead10cf9480ca6babfc97',
     ...
     'packages': [
       {
        ...
        'version': '3AWY87vDbmwfziZyetuQLx8SKaKoQfO3YtiDfM50Y7oC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
