...
vars = {
  ...
  'skia_revision': '3469c0aec843793bb50f05c1389f9c216789e4ef',
  ...
  'dart_revision': '3d878d714420ddcf2f58c9993ba618fd3a9fc007',
     ...
     'packages': [
       {
        ...
        'version': 'KLoErmoN0TPIiqqa-QdeSD5MdUHzIGQ9ciipJOSUmMIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'O1wNtYV6bgNqZkqQY2VlIm-nB1asnhCBoKE6Au8veQMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
