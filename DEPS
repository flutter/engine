...
vars = {
  ...
  'skia_revision': '80e101dc5813cd2e753ac65a7588d00c2b2628d0',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '938ee1e80fc8c56a5c0915f2d4659e2729381c8c',
     ...
     'packages': [
       {
        ...
        'version': 'UgZ9epS2Jkz7Yrymp9fnT2vZnmIUtBJdIuN2a54v_SIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'LZJYHQeLdXALTMMmjxIngbM_8F_RBx5-YiDR9mc0C5wC'
       }
     ],
