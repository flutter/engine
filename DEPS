...
vars = {
  ...
  'skia_revision': '77e1f84a84a7d9dd4beae2e7c83ce63f00500cc2',
  ...
  'dart_revision': '582727a4ec3b4ec3ad145ff421499e54d683763b',
     ...
     'packages': [
       {
        ...
        'version': 'LGwl3DYaMapCogX9yPpPhlmMoqZnqqhSfegzlri0T7MC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'N502wX6jqxTGeJqMp3uer561GBy5uxcNv-AN5tqWqDwC'
       }
     ],
