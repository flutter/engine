...
vars = {
  ...
  'skia_revision': '575044c99aac80cc9a732b9cb981073474630dc6',
     ...
     'packages': [
       {
        ...
        'version': 'VT5K0o_6ChscXMND-kMxhUIgJeqFIqw6oR1QMZa48H0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'VLpNsp5eHa62OQf6HKA1H7AcB9dLN1bDgDDa_L5QE_QC'
       }
     ],
