...
vars = {
  ...
  'skia_revision': '511aa59461f38d273d3e45cb8e510e7ba3c4dd28',
  ...
  'dart_revision': 'c15cdb978761c711bcc7b17588a14a592e4c97a5',
  ...
  'dart_webdev_rev': '47c1c3317da20dc2cfb542aeafcd04a0f1f381f1',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/crypto':
   Var('dart_git') + '/crypto.git@e175a95619ce23bfbd2ab34a4066f86aa0c108db',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@4b2e01b6e8c7c4e5e365026c182006b9616ecc28',
  ...
  'src/third_party/dart/third_party/pkg/linter':
   Var('dart_git') + '/linter.git@657fa6d60373c144777ddb3ca0ab6ee7805ea2b3',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@f3fb3ab6a6e6068b2daaed95ca13e526238def26',
     ...
     'packages': [
       {
        ...
        'version': 'd4l6A1aPw6Z0YjxmA8zNSE-YvfKkbkOkDzRNtjziSmIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'FYtT0f6GyizRS1F4pWUq-XT32bOa5uzbWmy39rL-wC0C'
       }
     ],
