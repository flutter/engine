...
vars = {
  ...
  'skia_revision': '4deae93198f99ce34f2dfc5938109ef0e44ba5d8',
  ...
  'dart_revision': '2bca8d21721b7fb324028eab013f057c3a0fc544',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '5d4b3645d0dce1e35cdec634a38097f6f83f414e',
     ...
     'packages': [
       {
        ...
        'version': '3JSF6hXLRdAK1wUN1Dm-zuCSIcF_57AI4CBly7UZJ2MC'
       }
     ],
