...
vars = {
  ...
  'skia_revision': '40586cf1f8851f4834c714f545ff770537a1104a',
  ...
  'dart_revision': '586ecc5a0697628337f5e9afa871c7936e9876ad',
     ...
     'packages': [
       {
        ...
        'version': 'YKiGmmdKTUQT35MWqg7Jp7RtBBTWgsUAmFX7OuYs_zQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'CEpfImAgAUVeiIjSVHl-A5VBzEwYNowTLlR1a49wyQwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
