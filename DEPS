...
vars = {
  ...
  'skia_revision': 'a73b9b519d678ddbee2cf6f40b466ce0b963c2e6',
     ...
     'packages': [
       {
        ...
        'version': '2mqASXqnsTocK-Opy5X0kX5w1sQQMI9O3dX81ak1yY8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'AjZrvhqGblU60JVYMDHiSQUsNK1316BRRJOZPKBG9VgC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
