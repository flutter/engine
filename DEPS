...
vars = {
  ...
  'skia_revision': 'fb72136c9325b91273b7c47c7e4ed6443419669f',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'eca38a1094652b6d3515a0a36c15b2bdd26c5a45',
     ...
     'packages': [
       {
        ...
        'version': 'akT2HxdLNPWSG-gbVEAvwRWUtoGQji35_FiOazHkUaIC'
       }
     ],
