...
vars = {
  ...
  'skia_revision': 'b8108412832504761a799be9a83f56a399d4f16c',
  ...
  'dart_revision': 'fac111d4acb325fdddd2746126f0e1fd09323600',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '959ccb9630a9aad1737b9c3146aafd7891774bd8',
     ...
     'packages': [
       {
        ...
        'version': 'WwFjJuQF_rpToCYPJ3yjlNSYb07ecmP2dIyh7of3O9MC'
       }
     ],
