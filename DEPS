...
vars = {
  ...
  'skia_revision': '5209dc7702d07de875ccff4db3859efd14d9746b',
  ...
  'dart_revision': '81cdbe69a16b4cf7a92a5739cda53a11cf0cf0d9',
  ...
  'dart_webdev_rev': '6fe17fe80a3580edd41d6d839504c4d90fbce0ea',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '02292814a9d3f4a8451930e2327f2b0315032359',
     ...
     'packages': [
       {
        ...
        'version': 'r8OegiCiL2ors-7TvJVzLWXTeFjED-faSVX52FYBaxYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'bj_X2Se1zObk_l_CCEM8WntPD0yX540521Rb4CP7YGUC'
       }
     ],
