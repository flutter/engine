...
vars = {
  ...
  'skia_revision': '681e409625b9ce5c383e285d68408129a6132acf',
  ...
  'dart_revision': '5204465f71bee142060cbb5b0792d47ed1c0c852',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '823808de422a8912bcec8a06f548da96d72cc682',
     ...
     'packages': [
       {
        ...
        'version': 'ddbxEQera8cgVTEiUg1CLsNEgirWqb9G2VOe4NbU8YAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'XClZ-9fktlisCjXkCJKWBtmiBHPkqTA5MCE_7PbnILsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
