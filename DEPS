...
vars = {
  ...
  'skia_revision': '8c3adb8b1adb3b0eb9d6f3adba1d3552dbe281f0',
  ...
  'dart_revision': '87a4768078b2a1709a8943b3167f73614e357a60',
     ...
     'packages': [
       {
        ...
        'version': 'FwgLM4h6tJNU-E90a5BSQu0QyOl8AN0hQFiHUOpWxT0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'dQkk1o8zS3ProgvNdhBiKbiSq3lM0rp0ylQQw8hzLosC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
