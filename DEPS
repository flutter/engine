...
vars = {
  ...
  'skia_revision': '288ddb98b751bff540fc2920956db0bfd05f3a5b',
  ...
  'dart_revision': '661cbbcd47b3cfd7707b6a80be8cc3641dcddf21',
     ...
     'packages': [
       {
        ...
        'version': 'lmR_Aqf8sl46XOTSpqMeDz_1dYJC-uajDrNVi_pPuDUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Fi9OzLVMXKg4TdtpOyyX8ObTwgFsAk3TrYrbKejMaIEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
