...
vars = {
  ...
  'skia_revision': 'aecf8d517143d2dac74f197280cb64c398d51347',
  ...
  'dart_revision': '5f2eba7f852300c668324d8d31b26b792b8a5eb4',
     ...
     'packages': [
       {
        ...
        'version': 'a6aB7cNgl94HHvEnoUjoKvp1n8V_pD1mgXXMPnOobHAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'CudXaX-jLvlqgJ9rV-zVp3n53Bo59sWLxsoWBdukvf8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
