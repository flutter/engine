...
vars = {
  ...
  'dart_revision': '9f907e198970a05047bc68736744487ba59a2378',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@39cec16700839847876849fef4f0769f8689b6c8',
     ...
     'packages': [
       {
        ...
        'version': 'pZ9FgVZTKe6ZwrCLTXs-s6HRYReW0XqmPJy6dnITrPcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'lPMs_KwnUp27LASOqwbTfKnX1rXsDfbnstsgVJYi-zEC'
       }
     ],
