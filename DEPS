...
vars = {
  ...
  'skia_revision': 'c29810e882a35d82db8f5fd98cc86c8313797046',
  ...
  'dart_revision': '7dcf180a625a03546649aece7e0db2502326b73f',
     ...
     'packages': [
       {
        ...
        'version': 'b88AaXCwvYFDDAesZzjRF6eRe9iip6-jH04VsZ_aqScC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
