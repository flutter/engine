...
vars = {
  ...
  'skia_revision': 'db10b0e8022e1df3e231a6d9d6f1d6fe26666b7e',
  ...
  'dart_revision': 'c274ba72ec739e557bd2e8dc130baa354458408f',
     ...
     'packages': [
       {
        ...
        'version': 'F4eUNa2mhmz3JyCzTMsL8M-Wm4AEoJ1HRS5dW4XKlm4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'b22xnKMfp9yI9OrpgJs7e1g24KMfNvLIfbRh82LbGsIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
