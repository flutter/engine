...
vars = {
  ...
  'skia_revision': '42582fc97bb3ddc457b1b99866a43321799041e1',
  ...
  'dart_revision': 'fc5e80cbdc6f695bedd4fd5f77f9ee511386b4ca',
     ...
     'packages': [
       {
        ...
        'version': 'SP8bksW54vstaIWkUQadtLS0caB_JRlQ5yMOWC8ZJcEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'elAhIisHyiDFkJn3QtKiszy5_gVuVxYBXOaq8G1UdIYC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
