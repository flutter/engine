...
vars = {
  ...
  'skia_revision': 'ffd61ca012468852c0c88aae6cdbb727543ce065',
  ...
  'dart_revision': '84c3eacc7ba015f14f11336eecd2dd40ee50d468',
     ...
     'packages': [
       {
        ...
        'version': '_4kJfDM-LoMZeSx65S6cIdEJM7cPxqjkb6UAFQ_zHesC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'URyuiPqyXT9zb3HJ0uiZZO1x5Pf8maGDyvMy9GdKiI0C'
       }
     ],
