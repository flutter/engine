...
vars = {
  ...
  'skia_revision': '1a496c507e4412d363fa29d5fd2678b650e0bb4d',
  ...
  'dart_revision': 'e84bea25df23ea5f149fc808a6423c7500b9cace',
     ...
     'packages': [
       {
        ...
        'version': 'LAOYsjX6ZDVImYkmRkUrVUNoVUJh5Wt4uSY3Osl503EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Wc7e4g06OyPlamITsziDdH3Fbh2FB5zsrXQb6f9ztHgC'
       }
     ],
