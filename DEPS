...
vars = {
  ...
  'skia_revision': '186866c46179af3afeb93d23889fe7a4386cf090',
     ...
     'packages': [
       {
        ...
        'version': 'C73kzh_IF-WsPj3beobfjmOXgsiqapwsHfGowfV9FAIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0XXjmMun1e_Rhi6Dm1viU1_x8ughWd8QA0dHEi1y98kC'
       }
     ],
