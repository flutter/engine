...
vars = {
  ...
  'skia_revision': '5f1d2f52d32c7de6485d77618fd5d548d4667d1b',
  ...
  'dart_revision': 'bfa317943967fc28ff5c3a133fcd7de6dc566e7e',
     ...
     'packages': [
       {
        ...
        'version': 'ako3u9MBgSSt-YtF6ckwXzkXPzInMmOVSw74WgYd5y8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'itIdMnhgq-5ulecEDYO7eJFrAXE5IiUP6RWeQg-hMskC'
       }
     ],
