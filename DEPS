...
vars = {
  ...
  'skia_revision': 'cd4db3adbd6a9b680487eeb878796337110af6de',
  ...
  'dart_revision': '9bcc1773ebf062cdf25c5e6bdbf4d1bf25c45e9c',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'c02da5072d1bb26d492a6ba5eee227af81f15be2',
     ...
     'packages': [
       {
        ...
        'version': 'IdMSzll1VeWJMV6v8CH0u9aR9PS7XKOagS1Tfu6FIfMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '71lEeibIyrq0V8jId1VOeGPufCGeB350bn6ANCQF6DoC'
       }
     ],
