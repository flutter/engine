...
vars = {
  ...
  'skia_revision': '188443be8d18b270a9f5810448d667e6ba009cb0',
  ...
  'dart_revision': '959f46974552193fcd5c536a1e9af557b6a95829',
     ...
     'packages': [
       {
        ...
        'version': 'hta7phjBVpGrmp3yI5tpbMPnWWNbfZ4DAgGiunWYqnkC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'ObWWD9sx4OpfA7G9v98p4LMbglJXPR3wTcLEynknWkQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
