...
vars = {
  ...
  'dart_revision': 'a78eae43582dbc1203e993788fc13f6484923878',
     ...
     'packages': [
       {
        ...
        'version': 'Y_9lCzY64bhUKLLqiM24mmoUe_3ArhOUX-3MT8o3t8sC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'NAkkk-Vn5BpOOl1w2J8en1pqt78vE20fDrH_uczAPMwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
