...
vars = {
  ...
  'skia_revision': '55c215cfb650300419033ea9a0af364acfd3976c',
  ...
  'dart_revision': '68593f7ac1724cfbd66344a813c661f43cac1cb8',
     ...
     'packages': [
       {
        ...
        'version': 'bGW3xlB1DoAmVsFugvQ9CfapwZ1zCVXelfK-Op0yFzcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
