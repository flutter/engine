...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '7b1777e6a007054a92a537f48d5d899fd5927e03',
     ...
     'packages': [
       {
        ...
        'version': '7DmdwgtGmIxyejFDlL7-HuTsOjxOTSn_eTIb6vNsAU4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'v33NyNdr6Y1sKZDze0sHWQP_VGO-Qi5XMe2Za3-mg0AC'
       }
     ],
