...
vars = {
  ...
  'skia_revision': '030e21befbc98fe0e509560e4ce2a92505cc3c5b',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '383df961157e868c2ae8c477848f1316a456b4db',
     ...
     'packages': [
       {
        ...
        'version': 'VcFEJiUUTYwkhEAlJ3KJjUXFFFwsKWYjZH00EOgSXJEC'
       }
     ],
