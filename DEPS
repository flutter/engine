...
vars = {
  ...
  'skia_revision': '047d5bb8d39cd9dd320cf2c238dcf864809dc7dc',
  ...
  'dart_revision': '9f2bf44adea99b1ab71b7e92ee032772077a9b25',
     ...
     'packages': [
       {
        ...
        'version': '80NV-ZWKClA0QujpoNQiRfJTf54RL_2Jkf31WKU-x28C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'kYdpRwQ7Ne0GKti5WwTujXGGr5xPiRhRKGRglANsmx0C'
       }
     ],
