...
vars = {
  ...
  'skia_revision': 'b65f0fa084c47e1ea688d61a65d0fc8dfdf9eb03',
  ...
  'dart_revision': '314057a2d7d3e487b267be7b4efcfdb30308d0e1',
     ...
     'packages': [
       {
        ...
        'version': 'WE4QO6YjwQhKtFFhGOHfgUAsiJw0bdE4TuiQwHNaP5cC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'xW7v3nxI0cUFFubAYFHkJKREHbO94Xku_bmnwrY9hQwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
