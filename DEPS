...
vars = {
  ...
  'skia_revision': '4d1a935835ead32fb697b4423a1557c76db29003',
  ...
  'dart_revision': '9cb9c6d71976ee68c37124aac34da4c1b59ec01c',
     ...
     'packages': [
       {
        ...
        'version': 'gva17p1YbmGRnSxxywVIj7EvGkeQvvcefvZ7d-PG_TMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
