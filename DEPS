...
vars = {
  ...
  'dart_revision': '574c4a51c6d87d6179657dd4ad046e5e20f49fe7',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'f2bddfc8e39ac9f162864a1a8283e3f4de83fe1a',
     ...
     'packages': [
       {
        ...
        'version': 'eB-F0bhC-VwXt9APJQ_ynYj29cwU9_4XEhEt34BUEGkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'W6ZtVAnJrwcTUmgRc1Yy0HCSJMaU35oaNbbsCo5QHA0C'
       }
     ],
