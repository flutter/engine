...
vars = {
  ...
  'skia_revision': '5bc5b4fdbe54f75bf95a4f9efa86dbf4701ee50e',
  ...
  'dart_revision': '02e6d943f1a7fa3d42dd7553b702b2104b4a0bd5',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'cd6b265c262346dca0c236b9bcc99f403a43197c',
     ...
     'packages': [
       {
        ...
        'version': '6fWBgb3bC9xULwq_k6Zvbj_sRkS7gXtRcgHKsSOBJR0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ATLkmtMOIbHDqp6a_9ub6uycvrHbSeJfzRdHNgm7cu4C'
       }
     ],
