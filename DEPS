...
vars = {
  ...
  'skia_revision': '3cffe81f0d16af0da0033c77c86faa0e92bfccdc',
  ...
  'dart_revision': '7379283a735f2d9301ed61e05cdb467e2683da60',
     ...
     'packages': [
       {
        ...
        'version': 'qkWDPuWbYufP3fUOsqETPLnPx6n_DoaA2WTaIJgCI4IC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'RWbGpeGDAdbWDlPCX6j5Utc8f6qDDu_PgeombY2XNQEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
