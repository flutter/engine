...
vars = {
  ...
  'skia_revision': '6b3c2f653b21062f3be449d2bcb0e5a376855eaa',
     ...
     'packages': [
       {
        ...
        'version': 'NqQtPDAdOhg9TkDWvsDrKqJDBEz7ZPkxi4p4KkBaqxYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '57GPNeoZ7U4p8r1mUJi0Smw6wWRpUzuqLlfG3fK9eUQC'
       }
     ],
