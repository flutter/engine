...
vars = {
  ...
  'skia_revision': '68d6983acd82735a8a5d58d72285fc0319452e0a',
  ...
  'dart_revision': '82e9a9e0dc8adf74456f807207774e7ed27803d3',
     ...
     'packages': [
       {
        ...
        'version': 'BPvUey1RNxtZeH00lNgBTXvHs4E0O373PAaDTuj6s78C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
