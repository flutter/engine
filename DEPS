...
vars = {
  ...
  'skia_revision': 'refs/changes/17/631517/2',
  ...
  'dart_revision': 'ddf70a598f27dbc4cab712e180a5ad7047dff73d',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@a99abd4ba40758dffdb112b725b7a96c16345684',
  ...
  'src/third_party/dart/third_party/pkg/http':
   Var('dart_git') + '/http.git@c955c7e33cc7b02e10f8fded071272d541518cdd',
  ...
  'src/third_party/dart/third_party/pkg/intl':
   Var('dart_git') + '/intl.git@6140b600b3fd42d86e289f7d92c18488fe7e4bb9',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@43fd92843c5d3cb43dede2b971c69923d9f7308c',
     ...
     'packages': [
       {
        ...
        'version': 'tlYMsnCv86Fjt5LfFcwU4vI_l79XgP-Sm2yi90eT5foC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'rPo4_TYHCtkoOfRups4wfQHs9aQKCjTqh7_VasyQt_IC'
       }
     ],
