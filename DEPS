...
vars = {
  ...
  'skia_revision': '8b43af48e7ab22dee2c2d5f11c6d17f64b1831df',
...
deps = {
  ...
  'src/flutter/impeller':
   Var('github_git') + '/flutter/impeller' + '@' + 'ed490bb416ca3fc547e66a5b037cf48c8195a184',
     ...
     'packages': [
       {
        ...
        'version': 'VUqxW8oScjLcHrOY6UnFkUBjmUofRM8MftSmrfZrP3wC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '6Zlz46hKWmbeimpa2HaAieWRc7L3mI_kSKM6y2q7ZhUC'
       }
     ],
