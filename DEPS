...
vars = {
  ...
  'skia_revision': '537b7508343deb9f770684c606d5a4704cb50794',
  ...
  'dart_revision': 'aa4574cc476046ae58794e5d8cd1b8fec537bd1c',
     ...
     'packages': [
       {
        ...
        'version': 'q1qWG9XiNCGhtZPG4KUlra3RAIVTipvWk8c5JAvdDeMC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
