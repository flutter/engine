...
vars = {
  ...
  'dart_revision': '4f9b25e410ed63028945e47386b434ed8cd8c313',
...
deps = {
  ...
  'src/dart/third_party/observatory_pub_packages':
   ...
   Var('dart_observatory_pub_packages_rev'),
