...
vars = {
  ...
  'dart_revision': '1897e02f5b1ce5d11a142e68c624b56a4fafc95b',
     ...
     'packages': [
       {
        ...
        'version': 'pis4h1dA0YAfGaISLZrgZJdv3SODeKTScSwpsD6Tt-0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '33fGX8ZWr0H_651qltKgt823ESuI7ETNzxOkb6BT9rkC'
       }
     ],
