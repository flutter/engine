...
vars = {
  ...
  'skia_revision': 'e99aea2cffefd1c8247feefd2f5bec4231de23f4',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '2d999f74480983de81a409528f3756e5354c647a',
     ...
     'packages': [
       {
        ...
        'version': 'DO73K2Twew-a51xHmckh0RK_5BUC2HvIkLrY8We-jKcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0FGyRuRBWqDlx-H1bGv3LvPT0ynaz9xue7UC11gTb_oC'
       }
     ],
