...
vars = {
  ...
  'skia_revision': '8e5ecbe6a4bb39117c21e14f96a9d3fb814ce9ee',
     ...
     'packages': [
       {
        ...
        'version': 'oyZzinh6Uka1HD-NtEytP1tDwka0DIgTEITdWqduFM8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'obtypxiCAsuaTXoaTChKbTKtKNeqxEUnd1oEKxHmsOEC'
       }
     ],
