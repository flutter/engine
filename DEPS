...
vars = {
  ...
  'skia_revision': 'd4ab439f9f6f51c041038ce556b611fe9af2e956',
     ...
     'packages': [
       {
        ...
        'version': '6pAt7HCKiAHuMdUSHr8HziryaCzqne4eBhZNt0RxIsQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'oU0932u8-sUypOboNj4T0LPYPUqb-tK8n-eobFp5ROYC'
       }
     ],
