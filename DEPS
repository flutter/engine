...
vars = {
  ...
  'skia_revision': '91b5f668e84871fb6ed306431481fe080330a140',
...
deps = {
  ...
  Var('github_git') + '/flutter/impeller' + '@' + '788c84ccea7fde11839d52d0684afd4427e9f2f4',
     ...
     'packages': [
       {
        ...
        'version': 'WhJJCGflgANzbo5aSTQMTRuu0U7VqRE8pmA0O4hEWYEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'rPkESbOjKt4C5mZrV5c_uerxYuSuk6E7zT-gXfA14SkC'
       }
     ],
