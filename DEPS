...
vars = {
  ...
  'skia_revision': '549325c87e9daecffe445226773ed3fac4721622',
  ...
  'dart_revision': '262fadc6cfc55b1b568f9f5dd7d7be308ec5d712',
     ...
     'packages': [
       {
        ...
        'version': 'p7XYMyqBjiwKtVX96fcdldWSJBNUs_m2eWvYya73jjUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'nhX22CXm13NWeLljTAGmHaH4D4GK5Qlx_s1x2py8KncC'
       }
     ],
