...
vars = {
  ...
  'skia_revision': '32b010baf507fa5ede881a553c6efead3eac78c8',
  ...
  'dart_revision': '19fc1016da374ac2dac2393a4f61d670b7860963',
     ...
     'packages': [
       {
        ...
        'version': 'OSk8h97wpfy2e7hem2Bg7lEkZqW-XCr80qpQGWrNRKUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2Nav3tcxx2Ds1aiVVybULj9D8HgFjiGX1mDizCy5Vh4C'
       }
     ],
