...
vars = {
  ...
  'dart_revision': 'f5216bb23cc34c6225996e9b1a987c19073d335c',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '6d3fc554f438789aacaabd82d794b1c6b66dee0d',
     ...
     'packages': [
       {
        ...
        'version': '4BVJFrqacT5kBTO2SlMO8O1OUxHHiPhPWT9acM0hBlkC'
       }
     ],
