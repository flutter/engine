...
vars = {
  ...
  'skia_revision': '100d67ed0b61c86be2710825af41b05b44efb18c',
  ...
  'dart_revision': 'e851b8e49aded3a0cd21561080192af8ccd132e4',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '613eefa3a70fb7f767a78a20f961efffc17acbf4',
