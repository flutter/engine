...
vars = {
  ...
  'skia_revision': 'e36966e69188861e1072356f7be3faa5eee00a77',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'e691a4edb19a9a3deef0108966697e786e40dc9d',
     ...
     'packages': [
       {
        ...
        'version': 'qe_q1aYCmE0eC-2Yz5DC7mZxNJ4U69wKSVOzAroN7-kC'
       }
     ],
