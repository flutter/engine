...
vars = {
  ...
  'dart_revision': 'b5f079c2936e9ac5f20d17f03cd78fafec1604f8',
  ...
  "upstream_buildroot": "https://github.com/yaakovschectman/buildroot.git",
...
deps = {
  'src': 'https://github.com/yaakovschectman/buildroot.git' + '@' + 'cc52b7a444a41a933573045fb7dd7d5818d21fbc',
     ...
     'packages': [
       {
        ...
        'version': 'gBWzGuicxu76K82lgv4GlyIQgzT4_cL5amo3g4mbDqsC'
       }
     ],
