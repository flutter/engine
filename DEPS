...
vars = {
  ...
  'skia_revision': 'ec7b63a7458545f4bdf149b930707134774772d9',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '480e54b791ebb136fbac15f2e1e9bc081b52653a',
  ...
  'src/third_party/dart/third_party/pkg/pub_semver':
   Var('dart_git') + '/pub_semver.git@baeea5ac3503546269d25c66523d4334c784a4f9',
     ...
     'packages': [
       {
        ...
        'version': 'N5vbbACOm8_iOOxN-rtYmmqF1LFY8Qn9X1aOE1tXQLgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'evxB7RykfDJ2H9QQ7iPIV-3VYA51Yv3Fnozd7LZd9FkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
