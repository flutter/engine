...
vars = {
  ...
  'dart_revision': '374c9c448fdc04c11672de8663d8ac47794faf8c',
     ...
     'packages': [
       {
        ...
        'version': 'FS4mmBthn7wmUUuKsG0K-0aJwCD3GMAoaAFKyBMzy9AC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'CNbNp20cOASzh7r48Ztwa2H66QFHcDq1MOqLK8-yTDQC'
       }
     ],
