...
vars = {
  ...
  'skia_revision': 'a11e221a13df64f827f834121ff5985d8fecd576',
  ...
  'dart_revision': 'e66ff9bf63b6ca8881dc38127e05f6afd93b850a',
     ...
     'packages': [
       {
        ...
        'version': 'Irj8m3Y-7Swltmgg__bLlp3yZvbLvqLE_51jm90uV7MC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wk98y5LCGUFIlD2v6L85fHoYxRo6r3gAWqsZ2WWr2xkC'
       }
     ],
