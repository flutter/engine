...
vars = {
  ...
  'skia_revision': 'fc48cb5b39c22519680678ffa6d4c34c7d6f0c97',
     ...
     'packages': [
       {
        ...
        'version': 'cS_Ucfr4bvDLcPY34oGVG0mqGxJl7exGVhWxhxljlpAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'oImrFnr8wPcgRfLfxxS0zh3Rm5QYbIQspk81fVC_dTgC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
