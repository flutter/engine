...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'e6c83ddcc5a2d1ca9bf727d4aae13c2cf8d9999e',
     ...
     'packages': [
       {
        ...
        'version': 'rMD6SyXwOErgYFOl1jRK41qiti4WGTUpE2bzeSebzDEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KMV-UCyzKpy_-YSe2ler7liv3dWyvwCzmqL6X9RUECgC'
       }
     ],
