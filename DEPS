...
vars = {
  ...
  'skia_revision': '3e139364766a8926ba67cd1fe8495e9ee921b56c',
  ...
  'dart_revision': '7d957c006c4f7ce18752de791ecba32d0e7e398f',
     ...
     'packages': [
       {
        ...
        'version': 'J1UwDWO_Vh9Hw061BytuD19KibqA3nnBsvygxOoCehQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '8wLWcmqi8_j1txZLGAbB6eIxg6TZbDyy4Tdqz8TySacC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
