...
vars = {
  ...
  'skia_revision': '8837c919fb8b5ef3a4683a57bc31df8ecda4fca1',
     ...
     'packages': [
       {
        ...
        'version': 'uhLYz8rWnQORKSvE-VsKV3PSxrYgV96vyVDlZOxtFMoC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '1yUmKH13EwLKZRrLNlIwCefCnJu-NJqvri-pYFH1UkkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
