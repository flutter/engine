...
vars = {
  ...
  'skia_revision': '898873c90b1b42f1d81f3a40ce73dd999504cecb',
     ...
     'packages': [
       {
        ...
        'version': '3Jf5Eo2s0xqdWQQSVqoUUR3eXaZoy5L1cBGaIG3Z1TcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'f1Wrk8zSnKe0bT38iWnF0LZL3Hr2TQj37aE1bcBehH4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
