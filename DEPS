...
vars = {
  ...
  'skia_revision': 'c969e4aff32ca47ef0755c2a7d269a7a532a5ff3',
  ...
  'dart_revision': '0023fc324ff08c77cd56d90a1db8af55879c9d38',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '04ce14af00a7266e6729085e48ebd7084c87289d',
     ...
     'packages': [
       {
        ...
        'version': 'EYr1hCR6hxkSGhtis6Jsd4HKgC8lSbjnOoNM6Puti18C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'dCjN58uZQBmAFWSxN7mYaGjc1w2sj-1Hni3eXw7yQJIC'
       }
     ],
