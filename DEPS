...
vars = {
  ...
  'skia_revision': '6253b5787df8771452a9b582b237a504278e1c11',
  ...
  'dart_revision': 'b6b348dab738b8c9ebd06a54bede0fc764da2f73',
     ...
     'packages': [
       {
        ...
        'version': 'arL8NjPHWZZHM_ALBBUbQj4RAt_mnTAJ-ulZN7mUy10C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'zKQw_oHsxf_-fEyEcAjU1dfhaastAQVMNqmgRCWIvYAC'
       }
     ],
