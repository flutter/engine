...
vars = {
  ...
  'skia_revision': '766eeb2ac325e4c9fd1982e20d64e8dc77752671',
  ...
  'dart_revision': '200e8da5072a602e1b39e3178610de2a0beafedf',
     ...
     'packages': [
       {
        ...
        'version': 'SUSVNJcX5piymqUdNI530hv9rRrco1MJkWU3Lc5QaUIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0nW5DAxcC7B75wT2ixNCkvfUjwzC1zdY2JH6QTqtlQYC'
       }
     ],
