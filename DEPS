...
vars = {
  ...
  'skia_revision': '16026fe31984b11c3de188edc74b82cc393a93f2',
  ...
  'dart_revision': '80095cbb6e13da88adf0ed074074544043e64a2f',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '0626ae6d76245e15ec31b5d8965f8ef7227a6e7e',
     ...
     'packages': [
       {
        ...
        'version': 'tkgkEsRLKXHmBfwZ5Cah6yQvqr5z0qzLiNJV9oRp2FkC'
       }
     ],
