...
vars = {
  ...
  'skia_revision': '2185901ceddef0ddda22e404f0f9bb7ea94aadc0',
  ...
  'dart_revision': 'c066c7b294bf3efd6a9c6058b753b9e304a1f098',
     ...
     'packages': [
       {
        ...
        'version': 'IHHTb9H-BB4CNnkjl3Q5GVGAyoadw9yuVCgVCRtQbfsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
