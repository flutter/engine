...
vars = {
  ...
  'skia_revision': '0861eaf302346dc8d027ca067acc930fa48e9bf1',
  ...
  'dart_revision': '8466800422eca3276c47933be6541d643007e5bc',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'e9f403958ddb8115efd75cf8f9ecb34e3303f66a',
  ...
  'src/third_party/dart/third_party/pkg/csslib':
   Var('dart_git') + '/csslib.git@f746368a0a53cf8f68fd71b218239034e88841d5',

  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@57761bb61e455eedf93e18c99082445f82116300',
     ...
     'packages': [
       {
        ...
        'version': 'FuBT85a79tKlTW3vJUgoQNtFjdzw-8ZdBGX34D_42TEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'vRL2T3YW1MCpz4pUGS7BBSR9RNfMuaVlOPWT2IIX3IoC'
       }
     ],
