...
vars = {
  ...
  'skia_revision': 'a18d44682d954e32c390eb33f0945e6be5395f54',
  ...
  'dart_revision': '0db7573c6b7022ba38a30d0a685e342bb777f824',
     ...
     'packages': [
       {
        ...
        'version': '25mb67G0L_sZ_OQCCEQ-BcZCneIv3V_GHrTetvr1P3EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0RfFdaUCok_sFfUN1UG01VxmSKpVpGRLNewrjl9pUEQC'
       }
     ],
