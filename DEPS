...
vars = {
  ...
  'skia_revision': '6284b3152ae4e1cb56e79940794398e43eeed2b7',
  ...
  'dart_revision': 'ebcb7aee8c0ddf26addb8e7c472a6866eb60b16b',
     ...
     'packages': [
       {
        ...
        'version': 'lEV2crBx-07cJKXglL3Wytb0ONbM8XRvaouWLga9vNAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
