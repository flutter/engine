...
vars = {
  ...
  'skia_revision': '59f62253759a9fb725b1bd0dbc4048b05959dd26',
  ...
  'dart_revision': 'a4a29db16711b5f038603b4f46926f74860e5524',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '16086afbc5d09bfe1a6df8585ed224a433528c2d',
     ...
     'packages': [
       {
        ...
        'version': 'ujelFOdQOKGYzoj2611R_EIV-eZEfkKK5BQq3iXbw5EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'HZHIjaqYGV-JOwWfn9gF0GskTRjiKyM6xInWpm3obzgC'
       }
     ],
