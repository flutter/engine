...
vars = {
  ...
  'skia_revision': '9be7372e1dcdbb78b11b86380f66e88ca90db73d',
  ...
  'dart_revision': 'ffc4fabe2841bf51fc04f3a3ffade53121a0367b',
     ...
     'packages': [
       {
        ...
        'version': 'fDVk03UL4a9BYTgbO5n-KgvoCgVLysuTsEh8ibij6pIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'KHNPi3m0Wv_dnk-AbBuKWMSQc3I-BX4QYCan51vbmisC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
