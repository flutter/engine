...
vars = {
  ...
  'skia_revision': 'f061c59792b2ba8f4474748a8c6f70d580773e47',
     ...
     'packages': [
       {
        ...
        'version': '-F-5r68i6P7G0f_4VNlno2v6HbmFDzJX3hpcmF3sO3MC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'oT8kKQch3m5YGfBB-NLazO38uaZKaJ8zoV0Y7lufQOEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
