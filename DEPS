...
vars = {
  ...
  'skia_revision': 'c9601553b0f3ab5dd8d927a9bb4d1733658dc330',
  ...
  'dart_revision': 'c8143a7c026f35f22d00daaec29db749784d3a71',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@5156398c17ff7ab8defd87c7a5b9de1ee7e4564a',
  ...
  'src/third_party/dart/third_party/pkg/sse':
   Var('dart_git') + '/sse.git@e190744aab3260887e99f94078858ac6ea0e9bc5',
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '6154bd93b4da5dacec1a6c6a2531b96dc71f846c',
     ...
     'packages': [
       {
        ...
        'version': '4DwpR2CMJECZJ8EKz4P5Z3wTZAZar15pdTc-0PqtE3AC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wBb32R567S1alWbfncrArHzAnIFEGH2yOYibSgHozIIC'
       }
     ],
