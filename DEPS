...
vars = {
  ...
  'skia_revision': '7cb0f6e9702a1929efa9aef419835b12daae2ed0',
  ...
  'dart_revision': '39dc634393968ee146c5b3ffe7d5d0680c65e7ab',
     ...
     'packages': [
       {
        ...
        'version': 'eG4TqZBn9_INWPNwIkB8VRhzfJcRqCHfby_c0kqMlUwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'KKD5xVYLOuDqtyynSEmNB193WNtiq1wU7gYGCrAoGWIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
