...
vars = {
  ...
  'skia_revision': '0f9c660aa939621a38d18e423002f680172cb1d2',
     ...
     'packages': [
       {
        ...
        'version': 'EH_61w2lpSn0UmpJkynWM6tiT0nnKk1GhTRRKK2cGMwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'MCDItwEzechMpZAiI0QOzuiTtNUGArUa4TprH0Er-7QC'
       }
     ],
