...
vars = {
  ...
  'skia_revision': 'af11a00f78494adce5f8ab33d110e1954899f3fa',
  ...
  'dart_revision': 'f1e6a33d1db589924f9dda6dfefaa6d93c056eea',
     ...
     'packages': [
       {
        ...
        'version': 'G_O-vV26OJXPdaom8eiq5GANKzvp0YEJM-nTTAjD8A4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0kx01Ik6YMytjdSaAZhfshhwH1ceoPrWnF5AiVzcdr0C'
       }
     ],
