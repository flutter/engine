...
vars = {
  ...
  'dart_revision': 'd01a840fa25bb98fc65d865f937c7c19ac526506',
     ...
     'packages': [
       {
        ...
        'version': '2FIILk5GNQspYy1sgiri5ssMGgoqCbwsidR1jF7FZXEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'eMHAbJpmOD9JH8Ce9Iv9on-Z94QPyR-X_BvKpjSEOjMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
