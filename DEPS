...
vars = {
  ...
  'skia_revision': 'e526b7ed688ac7a91debbc5f604c5a7199ce6239',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@c58f21042ebd95014c5426a2f34411876685ecc7',
     ...
     'packages': [
       {
        ...
        'version': '1X6QvGKcETkQZEsoRbFqLlX4QTuBUFWdnNpWltPgYaAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'f8Fy-iyy3L4NdKSN2MjZ89AI_Mzl6_c-o2q-GqaaiI8C'
       }
     ],
