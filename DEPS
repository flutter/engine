...
vars = {
  ...
  'skia_revision': 'cb6de9f661f31146cd9407202fa80250d9f208b5',
  ...
  'dart_revision': '63b5fa170980fa017065745db0044a9dd8117e1e',
     ...
     'packages': [
       {
        ...
        'version': 'KH7Tvt1i6n_XNJl0SwI_HoDgZb18kL1bnyBqbbtO9lQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_0Sq8bDmuagY-hn_M35I8qb87P6uVVLQLtTXAzf8LicC'
       }
     ],
