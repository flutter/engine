...
deps = {
  ...
  Var('github_git') + '/flar/impeller' + '@' + '51e884952d78840ccd035a440261a08ed7890f2c',
     ...
     'packages': [
       {
        ...
        'version': '1_UWcom9Q_BvcbGvMiynICk5XTEpbqRoxKWwwYFD2CgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2ENmcDb4prtw36rhaGFGfPaUzIrzh90_JQKPLIcU6YcC'
       }
     ],
