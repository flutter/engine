...
vars = {
  ...
  'skia_revision': '99438408b1e0cfbc694cc2cf255b35577ad10984',
     ...
     'packages': [
       {
        ...
        'version': 'o-xARpyOXgd8HiEfZ-0jm-H5ceB4BpFCa-IILlXu2BwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'lzyM0FRihCJaYNmbZSHgkOP79TlG-J0zjo0RYFbRqaAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
