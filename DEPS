...
vars = {
  ...
  'skia_revision': '4f22188e51033abeee2aec982fd718957dd80a62',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '170ba8c91095144785e088a5234fcaf5ef815ed3',
     ...
     'packages': [
       {
        ...
        'version': 'Bcq9TZdt-vtTSL5YHhXDnpkenk_8kEHMu7l2uSgno2YC'
       }
     ],
