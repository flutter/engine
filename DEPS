...
vars = {
  ...
  'dart_revision': '7aa128f98118c96009b820ae605ffd27d705707b',
  ...
  'dart_webdev_rev': '9487a4595f84891b1a01eb6fe998a7b1277dd2d4',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@adc76e6d5057b70318a1e36797c9dbe081258ce3',
     ...
     'packages': [
       {
        ...
        'version': 'fSmVaZwp41ZGp5hKnDIGj56IAdgVpbpMTPwN21pR_DYC'
       }
     ],
