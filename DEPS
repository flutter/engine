...
vars = {
  ...
  'skia_revision': 'e1c0de51d1238cc79855a5d85ac8e0f9201116f4',
     ...
     'packages': [
       {
        ...
        'version': 'YBiCU3Z3r-bB5TiPqaA-wuFJrI6VHtjjslESs0WzJ1QC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '-8KkhcJ3hYTqnDMUp3OfotXpGvd3S0MQWnkbbl29V30C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
