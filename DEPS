...
vars = {
  ...
  'skia_revision': 'ad94fabf74000293826d9eb82735e5b63f9b6a6b',
  ...
  'dart_revision': '1f97ab20d07813df654fcee2c3ac2e64ab353f1d',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/async':
   Var('dart_git') + '/async.git@a00437017231ebb6c3e3e8ecdfc9dd03522ab828',
  ...
  'src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@14d33d3a120ad3ce621bbcf0a545dc3adeccd7e7',
  ...
  'src/flutter/third_party/dart/third_party/pkg/shelf':
   Var('dart_git') + '/shelf.git@4c54af6b6baa9404826d234385c1bf69575dfd47',
     ...
     'packages': [
       {
        ...
        'version': 'u8WOst9tlXsVQ02eJ8ToSiWHzsk3sqLl5Db-cqeJ6igC'
       }
     ],
