...
vars = {
  ...
  'skia_revision': 'refs/changes/17/593917/3',
  ...
  'dart_revision': 'e06db8e1b6202bd11f5bc9d3f6fd257e4233087f',
     ...
     'packages': [
       {
        ...
        'version': 'IdQEnRNQNY7ZrLZ04rRZdQ4Z6YdBYyglbOcrJMNYVeAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'g6-kU8so3PDiR1106nnAkr35Kpk4MBV5gZ6vFVIbNgkC'
       }
     ],
