...
vars = {
  ...
  'skia_revision': '745825a1844413bb155a6c83c71e1bde579ea52c',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '9f9c35f347eff2ba9bded8c6e002fd8d5ffc54ee',
     ...
     'packages': [
       {
        ...
        'version': 'ho9FqsUD0hxh0b8tokqPUkjdd0Ww-1oajSp5T8wpRcEC'
       }
     ],
