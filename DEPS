...
vars = {
  ...
  'skia_revision': '58a8ccc59190f259d65aa9bdd3495f5de8a7f718',
  ...
  'dart_revision': 'e7983fd4adb93252907f5c0c13b01d16c8584a4c',
     ...
     'packages': [
       {
        ...
        'version': 'UxTIYduaGsk_qGHKbZcDzckJm5U2g4PmLRxXK9dK8cYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'lbQ4FeXvVHi_L3rLMoewcNDQtcBzCR56sAvrre1V4igC'
       }
     ],
