...
vars = {
  ...
  'skia_revision': 'e7dc7cbe1f4e813520c31f60e7572f81863be451',
  ...
  'dart_revision': '62b0361d470faf7117c3badcfbaf2c5514f56057',
     ...
     'packages': [
       {
        ...
        'version': 'PzW6aMw3AGVDd2ZZvzEFcNCXESq6Rw9LO_tlp8M-FmkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KR8LcMqAcEi-Z1JEITwB6QIRi3kuPr-6xRYbirpNysQC'
       }
     ],
