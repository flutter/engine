...
vars = {
  ...
  'skia_revision': 'e476fa36680620f033c26d44808dec578b9b7bc1',
  ...
  'dart_revision': '01350005aab7a7bfe2dc98066cb7acc95a811f7a',
...
deps = {
  ...
  'src/third_party/dart/third_party/devtools':
   {'packages': [{'package': 'dart/third_party/flutter/devtools', 'version': 'git_revision:bf15e7348d53dc83531d503be94e0c035b604984'}], 'dep_type': 'cipd'},
  ...
  'src/third_party/dart/tools/sdks':
   {'packages': [{'package': 'dart/dart-sdk/${{platform}}', 'version': 'version:3.0.0-322.0.dev'}], 'dep_type': 'cipd'},
     ...
     'packages': [
       {
        ...
        'version': 'yz_AXiZUgmA5Xk8GRendRDDWkiSvyOJ0yXJ2JYSwQ-UC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '9aQCaR8elBT7fpYzLXw7wrN5NgFY5Y0V99F3okH87CcC'
       }
     ],
