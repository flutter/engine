...
vars = {
  ...
  'skia_revision': '1859386f9a60149c98418e86eba6fdbb2b219261',
  ...
  'dart_revision': '6eb25c34b8247c59afc228dfb68b820112527649',
     ...
     'packages': [
       {
        ...
        'version': 'fZ9Ts9cOefCWJSM1aER6QPTRjb1kYOujsOvF1xtpqD8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'PTl8Vh38NHaFGLmjTw8Y4o9GIYXiu4vUM1-s_SAvc_IC'
       }
     ],
