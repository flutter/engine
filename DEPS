...
vars = {
  ...
  'skia_revision': '7b41798fd606acd58c4df269c3ce5d48ea5e9204',
  ...
  'dart_revision': '07c67e891edba6f8af183d41b19f8235bc15cfcb',
     ...
     'packages': [
       {
        ...
        'version': 'hi6ArsnrcTSJ-R2llkMwre1eo2z-t0dc9nbKy0ySD5IC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Jsuz_VU7LzbzrMYcxQ609vWi0Hb6hozN_QjAFs7vb9IC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
