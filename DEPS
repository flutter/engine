...
vars = {
  ...
  'skia_revision': 'b7f5e1b20db1bd66389604a04ca881880f9596e8',
  ...
  'dart_revision': 'a50a893560083719a88bb8452c480167ffe716cf',
     ...
     'packages': [
       {
        ...
        'version': 'FySKX5LKdUNqhRBuQ2lqFtnW_1pVcyT6lM2N0w5nsywC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
