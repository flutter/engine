...
vars = {
  ...
  'skia_revision': 'f9d5940fef55233addd492d6d26418437dc130aa',
  ...
  'dart_revision': '2e838b7b4503f055da8b90f8bc5c6c48f630812e',
     ...
     'packages': [
       {
        ...
        'version': 'Phn3nF_BJ32VJwVxyG0cPQty1A0eC3de1N5RoePot9MC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'eBus_y4DNETQVLaXdTqHksolPXUOh4DPBx8zXSGvHF0C'
       }
     ],
