...
vars = {
  ...
  'skia_revision': '10fa1c84b4b2352fc03fa848ceb2dbe145bd8261',
     ...
     'packages': [
       {
        ...
        'version': '8tsd1ptRi1gQXGcKCTIpah2Q1ImPEgrBnnoZKRAXI9sC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'ExKaxwFaiC2Q0MPvXzFDXS6Zsm57fGinuw-0ku_sHkUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
