...
vars = {
  ...
  'skia_revision': 'eae5c1619083fb9e49dbf4219fea54fcbce4d4ef',
  ...
  'dart_revision': '36781ba6f12ab3b4693e8c5333a9caf1430bab89',
     ...
     'packages': [
       {
        ...
        'version': 'kPkJqgYZ-PySEqhkOqlCstIgx8s-lnv8g1ihLNdjb0wC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'nVvyfiqlpYcUlRJdkOlnN3-vfRNT1Dq1S2HICXeQpwEC'
       }
     ],
