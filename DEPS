...
vars = {
  ...
  'skia_revision': '0d8c1aefd127fe4a4e7e28aba433f5ee8a2d6faa',
     ...
     'packages': [
       {
        ...
        'version': 'UsrGfX7Fj96MljgqUFc_A-o_ufsa_FX3eaG14ZSDWMAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Y3kUPtfq2frI60zx7VssO-WG733jtODCmnESyz0UGdEC'
       }
     ],
