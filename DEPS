...
vars = {
  ...
  'skia_revision': 'b5ea90187c0a831efc25de3ccd0079408fa291cd',
  ...
  'dart_revision': 'abfd936d2a0b915e8fb9755c4af048dc387c1511',
  ...
  'dart_protobuf_rev': '58f49c50f93d190adaec213ad500d7de5fe20b2f',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '8d9932dd0f5165d5558a326ba14c8048a672433e',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@6d656f60f2c486efce5f4f22ff00dbb037a825f1',
     ...
     'packages': [
       {
        ...
        'version': 'CLkx5KoelaDPH0aSixIKfpiFVfw1sLA65xLAXWTblmcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Lo1fDwA0a7T2yxisouZL5PcQMyv9gg31Iq64_CQkj5cC'
       }
     ],
