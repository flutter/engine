...
vars = {
  ...
  'skia_revision': 'c3dce0336272ea1811b9722c6c6a4127775a2894',
  ...
  'dart_revision': 'edf2936a5e06db6487be4a6249ea584e8d1e8f39',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/async':
   Var('dart_git') + '/async.git@ecb3835c5b746f7762327d5f57bdc92e0a2e0450',
    ...
    'packages': [
      {
        ...
        'version': 'xdUzo8i189DojvBAYnMzx_V2NQajx2kpUNbQbZV7CggC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': 'VbLDH0aNKQaLnZWtd4_gdCLDuzAYLGy-bcr5Jq-ztycC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'pypCKSnUc7ayVQKriPjYNZ0n242XJAR-vp4ZS1buKMkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
