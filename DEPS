...
vars = {
  ...
  'skia_revision': 'b6981fb6a4c1f6c2dd044d19782ab6ed428b2e56',
     ...
     'packages': [
       {
        ...
        'version': 'cDn94pElaaI23pUNlAWgyQWW-PZtC6HPJnmJWJC-pqgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'BP1AUqX5mnq0JHRhcJQp5alfxe_24hGISKhtbJwpJt4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
