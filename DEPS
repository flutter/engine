...
vars = {
  ...
  'skia_revision': '1e62a2d4c429247f0ec5472dd1113988993af627',
  ...
  'dart_revision': '121fcbd8124c364400ce2cbacff577858fff91f1',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd85de0e9c66d2c93035c9891d2261c102dded568',
     ...
     'packages': [
       {
        ...
        'version': 'Tnp43n_nAR2N0l_gYiE0YBpA4loAnzR2Zp_vGd3v_IMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '7xOzci7fempFgHNk9DxPxpBKoI2onNU4Ye8ElQaNa_QC'
       }
     ],
