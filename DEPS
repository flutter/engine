...
vars = {
  ...
  'dart_revision': '23a8788f6a9c453f3786c4330c4876e9d14608ef',
     ...
     'packages': [
       {
        ...
        'version': 'zCKPvsueceqBCaNV0iSuGUljmzilg7wYD_NZJPixOiEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '57LBarwkdFmOVqa2HZVgDfmLQrbpRduvpDy6B70JNMkC'
       }
     ],
