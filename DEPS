...
vars = {
  ...
  'skia_revision': '51d33982adf44e3e874bb6638cf142b1fafeb7f7',
     ...
     'packages': [
       {
        ...
        'version': 'Rw36pWO5J5-u6nNGkFedDhUF-FVarfpEzFQD8qBLbl0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'hnDJ6SZhJxWg-puSGENjOoniRt0qSB0kp0ogVsgSpg8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
