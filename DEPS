...
vars = {
  ...
  'skia_revision': 'fae7be2a9c5bf61a687e6dc38ec3509dc8b14f20',
  ...
  'dart_revision': '04cbb698616301e066aff0beb68ed1a21c54e3df',
...
deps = {
  ...
  Var('github_git') + '/flutter/impeller' + '@' + '0ce2e789fc0852d6d9ee63fb68097327447cd7d8',
     ...
     'packages': [
       {
        ...
        'version': 's177R8DTP3tAdYsLA2NsOukrwVZgecgH4DPa7IQrjaMC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'NGp06jCdCxDUXahOaM-HVYIw5PXHv6nNDJ-EB7EVDD8C'
       }
     ],
