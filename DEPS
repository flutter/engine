...
vars = {
  ...
  'skia_revision': 'c33c0619b892dcb2517c9f9d0da75eee94ec1ea0',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '143fa68f50b72153f65bcaa4fb590f697356a3dc',
     ...
     'packages': [
       {
        ...
        'version': 'VIjw2bdybUo-rgC0t6Sam8yl_fIMJttcNX20tJmnZ5YC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '38hspwoyzrqU6GbsMhcLAMpKyQa-Jc6V53-ElMuevakC'
       }
     ],
