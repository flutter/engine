...
vars = {
  ...
  'skia_revision': 'fa8133347cbb9d3276bf292b3ce3fc6b7793baac',
  ...
  'dart_revision': '366b33929a85c6cf2bb7a32d498857691a9b1405',
  ...
  'dart_dart_style_tag': 'a1d65dd9c4b83c9702ba409465879b94caeb04ea',
     ...
     'packages': [
       {
        ...
        'version': 'h6TPz98hI_yfRdZD7NUFOtPLDWttwWdpblp5hoPqpysC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'wCRD8AhIiyQ8JefkREVG6PZrr818isd2pzn-Fu-JnfcC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
