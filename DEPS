...
vars = {
  ...
  'skia_revision': 'e6c0f0157c6f81a953ff29cc37f53b74b7ceb1e2',
  ...
  'dart_revision': '4fd02f1463b1789e55ab1ac9aba8389be35671d4',
     ...
     'packages': [
       {
        ...
        'version': 'fqYfP5y9ViNtYnJv1R7rozTqFVBcB_k1nRvM1nKqTAAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'qeXDifXBrSIrOzMWaExYJfPOgn7SQtl_DgnpPSNE2GUC'
       }
     ],
