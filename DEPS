...
vars = {
  ...
  'skia_revision': '899b5fcb2b06c4c5a2e607272a752e8fcef2fd59',
     ...
     'packages': [
       {
        ...
        'version': 'MOE3luKafIefk-HKwNDbxR6w3NvYKQTBjOBrYBZ2kFAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '4uCOxhP9zlVYflwHV-xaPgciFu9pfwvM7-OYIKvKrVUC'
       }
     ],
