...
vars = {
  ...
  'skia_revision': '529d3473bf39b267178f267305ead35896b10c7c',
     ...
     'packages': [
       {
        ...
        'version': 'em-ZJ_eSMX4jwhIOeGnRp5bjobOKzQCEAiDLvXT5-KkC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '2R1NvPB_xz2XwQdEW4c-e45wcrmsP3K1Jxz1b3f7r3wC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
