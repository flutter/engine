...
vars = {
  ...
  'skia_revision': 'd67f1f8f5074a405033ef2462f5d6b968edd15f9',
     ...
     'packages': [
       {
        ...
        'version': 'Rpy_p6Zu1Ndnh-GN-30AWloJHBRiLzJe-vB2gP-kkHUC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '-hODuSqyIxRUBB7Di089Ss-DioZNbQ4gr0M2E8rqmZ8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
