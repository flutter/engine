...
vars = {
  ...
  'skia_revision': 'f88eb656c123cd069f85f9ac1f11007777ce633a',
  ...
  'dart_revision': 'c696ecf5a8a0ec23000aaadc2d81d77d799a4fd7',
...
deps = {
  ...
  'src': 'https://github.com/HidenoriMatsubayashi/buildroot.git' + '@' + '8621b6aeab968279c57a7736afcedf82c583e3d7',
     ...
     'packages': [
       {
        ...
        'version': 'nRqbdi_ZK_p2G0gWqoi0_hVUjs_Gn_EYfbcz0xC4eeMC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'l5hYeTpdW57p8RtVJheYO2KWXd-Eohat3owdfogaSWYC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
