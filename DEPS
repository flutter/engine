...
vars = {
  ...
  'skia_revision': '399ecfeb50d57bff6869c6948989cb4586ff93fe',
  ...
  'dart_revision': 'be96b5476852cb5651cd9384adc936e1298543e0',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'a237fca3756ea1580ab05b0c3f6f8fde722731ef',
     ...
     'packages': [
       {
        ...
        'version': 'thzQ3Eamr4bpD4qXSJKbUQDouXf-2O52apKmDkHQUicC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '64AKvws9D_pywDW-fdX5ROXiYALDtNHwvbs3S6muBVEC'
       }
     ],
