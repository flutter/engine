...
vars = {
  ...
  'skia_revision': '0c9a6e702d9936acfa52f6548ab3313a302252b0',
     ...
     'packages': [
       {
        ...
        'version': 'BH-k5YzBV5NLO0XTD7A4k4XE6LGYQ8YxU7KvfcvVZRIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'YFjMrv6dHS0tGpmWOG2rYAuCzXtiGl5MQcc6E5Q_3DoC'
       }
     ],
