...
vars = {
  ...
  'skia_revision': '1b53191539fca8c6878bbbc4d8c1042562ae25c5',
     ...
     'packages': [
       {
        ...
        'version': 'giU1d8T7pC6K7vuX0_0ZQpH_ZkzIbgvyao2ICAW6PS8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'vHQ3m9W_pv1OLg6ch-uP3bu-VhWS-4PKZm4YrxjP-fAC'
       }
     ],
