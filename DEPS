...
vars = {
  ...
  'dart_revision': 'f6a382af556ac4257725280d497baff33e83224e',
     ...
     'packages': [
       {
        ...
        'version': 'n2TrYwVe9Um5W4VO-k7YudCQWXAHvOuZ0W3c-xsCzBgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '4JTh8dWnTGylc5CF9DONn5gM_cXdiy8fnQ4EIREAG_MC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
