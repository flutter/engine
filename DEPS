...
vars = {
  ...
  'skia_revision': '1c0bba7c105358a52bcd03997fc8a75240ce4702',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'a21631c02e45f48a6af7a0d667616e36c5c8ca8c',
     ...
     'packages': [
       {
        ...
        'version': 'MS9oGi07CamSAX7Tw4Ph8eLa3JVZMqf_S1nO4AMBy5QC'
       }
     ],
