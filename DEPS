...
vars = {
  ...
  'skia_revision': '4f09dd47da6ee00643d15de9396dceceef5439df',
     ...
     'packages': [
       {
        ...
        'version': 'U2Cd8uL4-2RlaVrEKlJAyesXfZIeI7lpVgaC47laOzsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'GEYgsTBRMM7gba_hii1JYeBIMKWHNF-nw4W-1PyXjnsC'
       }
     ],
