...
vars = {
  ...
  'skia_revision': '8299245af8a8fbcaf3cc18619508a80f0fc1b2ff',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '4cc9e0afa0e979f42dbc7c346f66cfcf1ce7388f',
     ...
     'packages': [
       {
        ...
        'version': '32ukjtetQl4pbXfTwkxYvbTCRFCbV67r6Sq-xgtcLFQC'
       }
     ],
