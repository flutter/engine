...
vars = {
  ...
  'skia_revision': '022636b15aff6379c26c2bed114c92a5cdba3802',
  ...
  'dart_revision': 'f79253a6b1899cbfc323347a142c7d4b2f3345e9',
     ...
     'packages': [
       {
        ...
        'version': 'KZTNTwf_ZcdPeQrWRqF7p371OA-Gy4rhW1Emz2rlxx4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '9ujC5zDr6pjUTGvE85VU7SRDjcBC5oc6Ew9Yf4AS9cwC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
