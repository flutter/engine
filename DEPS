...
vars = {
  ...
  'skia_revision': '71624de2c5d96c017178cdcc5808f39aeb69e3fc',
  ...
  'dart_revision': '9bc7d4604277dd545a7d902a3d81bffe7021df00',
     ...
     'packages': [
       {
        ...
        'version': 'NimIr5BT-8fpscvGnSsjHa1Mo46x2_kOQZy3dPlqIzIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2rLs0vAIz0vrYTJhx-EKY43-vS6KP23wLCbO8mB2ZD4C'
       }
     ],
