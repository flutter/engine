...
vars = {
  ...
  'skia_revision': '3ab1292dad488d4f964adc9597076b936476c1e5',
  ...
  'dart_revision': '7ce3e6f67fff2f080ca1d759b50b3c094f285214',
     ...
     'packages': [
       {
        ...
        'version': 'jN5n0Wzssv_F4Kl7eDji-UCEQ_KKCNoLP0r8BmFzKG4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
