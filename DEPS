...
vars = {
  ...
  'dart_revision': 'cae08c681398a881ce01afa6c3e4b4dc2c0c4b6d',
...
deps = {
  'src': 'https://github.com/stuartmorgan/buildroot.git' + '@' + '682af356144c06b10a8d64474227accda05addac',
     ...
     'packages': [
       {
        ...
        'version': 'VdFWDTtCLmjvpaUNKDkEbK7-a1aXi--qPKarMibOsz0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '_fvZN6xp-OqQ-xD_QeQW4cxBPqTeacO2MWLCDKHH_aYC'
       }
     ],
