...
vars = {
  ...
  'skia_revision': '3af709f71a60c2302aea8d6d75d015958af522c3',
  ...
  'dart_revision': '377e694a78fef0a03e6173dfb8de02d41dcbce86',
     ...
     'packages': [
       {
        ...
        'version': 'anl_Ge_vzyyRogWm40ZbQGAg6xAwmUwSzjiYMASXFwkC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'kn_6DzM7h-X0epCCU9AqD6z0PIkJVepEpTcEACx6iB4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
