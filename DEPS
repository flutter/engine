...
vars = {
  ...
  'dart_revision': '3067d697ae261b40aebbe0883c77cb873840867d',
  ...
  # environment.
  'fuchsia_test_scripts_version': 'fzYZqZlIcd43ltaV5CyRLTh3O3xCxNHaLWArkaSgn3MC',
     ...
     'packages': [
       {
        ...
        'version': 'Y4TdnTpLdkI107K42QJpph-xr8_tS-0BVyiEtvu546UC'
       }
     ],
