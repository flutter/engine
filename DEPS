...
vars = {
  ...
  'skia_revision': '064f144adedd8ad8ac9c613c54e6354268041912',
  ...
  'dart_revision': 'b121fbe079e896867f4772a11b95e9779e2d06cf',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '84c30b761e4f4cc704df27fe8e8535016e2d26db',
     ...
     'packages': [
       {
        ...
        'version': 'xq7mAZt0ekqth1hZV8wiZM56TmNEvt9IBE4R9JT0Yb4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'ZzYmXHUmcE0gMgZn1dSOpa8s2pvw8vYnsx5ysSeLPtUC'
       }
     ],
