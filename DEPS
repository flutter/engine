...
vars = {
  ...
  'skia_revision': '6a7b6367bfd89fa87babc8870040cb4a14071cf6',
  ...
  'dart_revision': '2bfe7945d2aa24afaacb34d99e17215a80ef478c',
     ...
     'packages': [
       {
        ...
        'version': 'MQoH-sefjYwKG_X2hv8qKJfSW15nnrtuAJbJMEHFsOsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '-NNSCH3WIpT1x-ZpP3cDjMDYEmdhGciRL4ixvBkopcEC'
       }
     ],
