...
vars = {
  ...
  'skia_revision': 'f0de96f7b82a35ce1cd385da8c5c77b83fa2a617',
  ...
  'dart_revision': '041a6dd2e76ba9efeabe2c742536338479e1dd8a',
     ...
     'packages': [
       {
        ...
        'version': '4TE5n81B-21JtU-3vZjKDwJItbMEOy9qY0a2NfsnwiwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '_0kewDFPJV9ToFe5WRzZTGD7umEU9mNV2hkEMirmstoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
