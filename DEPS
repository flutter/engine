...
vars = {
  ...
  'skia_revision': 'cc360436396ecca696249d57b8ee37c36e97c687',
  ...
  'dart_revision': '3701605e0abfa190b4d5d0993d984a53e2c2dbdb',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@d716fa363b36d4ae54fe236501dc2d6689193223',
  ...
  'src/third_party/dart/third_party/pkg/leak_tracker':
   Var('dart_git') + '/leak_tracker.git@56752316847e0ddd023650d35a9c7a5da1581d96',
  ...
  'src/third_party/dart/third_party/pkg/mockito':
   Var('dart_git') + '/mockito.git@ffbbb4ce8057fc5f793cc3e2fd635f0903fee3a3',

  'src/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@acad39612a2575ecc46c80ffad52157d7b8baae4',
     ...
     'packages': [
       {
        ...
        'version': 'Z-1lzZAOYHvVrdjQ8BvAyXjjPHDVMAdLAAxqb4caxGQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'LZPMbHnVPFdbXndcXVTMyrYiv-0ooqPmxW2FSTAilQgC'
       }
     ],
