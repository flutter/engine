...
vars = {
  ...
  'skia_revision': '6e82db35a69504afbb19179bf72a6062c8a31175',
  ...
  'dart_revision': '6ccacc2e69a981b3fc647bb6346b937f6b974f7f',
  ...
  'dart_pub_rev': '11c2a0978e66fbc2c182dc6a8174db1a3651276c',
     ...
     'packages': [
       {
        ...
        'version': 'pCoQB3Wr-3pvoDfpF9a4Ivs93c8EpTlqfDDfWLFgSv4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'MVkOwZQtvWPhv7LSsaOaSqgSD5-vpAn71_A9z_rXk-4C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
