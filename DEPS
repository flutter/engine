...
vars = {
  ...
  'skia_revision': '2d7973afc29d0178b13b72999a3e599665f3e50d',
  ...
  'dart_revision': '9f810fa15a9ef46abf10c0ca7bd4121cfc4c6fba',
     ...
     'packages': [
       {
        ...
        'version': '1i9GaCxm83LAkPJB61QsV9YDFuiLiZdDsNWSEXAbqSAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'qTpm_pzmYw3ZXRv5BO8CJq2rssaOAepOVfueuVgOgLkC'
       }
     ],
