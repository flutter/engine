...
vars = {
  ...
  'skia_revision': '8d475ae01f098f137f939572aca311fb3df4ac4e',
  ...
  'dart_revision': '14162b5f5a1a8d94ca4f876c0faa14c82cb3b071',
  ...
  'dart_protobuf_rev': '7d2d29340e10b1e1d7d298dd5166dbe0da7f0be5',
  ...
  'dart_webdev_rev': 'd74fadd6e971278a93bccbec3a688ae71245346a',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'a4fed9b333da159519f7cd5e2796b7459b8dc923',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@b9c35c0437be7c1f0b4f50a3c38f317449d7ff39',
  ...
  'src/third_party/dart/third_party/pkg/http':
   Var('dart_git') + '/http.git@dfec389ba5e5bad98d657ff0c7095b249ec89057',

  'src/third_party/dart/third_party/pkg/http_multi_server':
   Var('dart_git') + '/http_multi_server.git@a209cd59d99b52ff08b32ba37bdc9fc1a79bc9f2',

  'src/third_party/dart/third_party/pkg/http_parser':
   Var('dart_git') + '/http_parser.git@1ef3e56ebc5e505dbf375f2e27faa40956eb0da1',
  ...
  'src/third_party/dart/third_party/pkg/leak_tracker':
   Var('dart_git') + '/leak_tracker.git@9c6e9b370ebedc93696299b76ab49fcb8bb41983',

  'src/third_party/dart/third_party/pkg/linter':
   Var('dart_git') + '/linter.git@27b46ce246204a2c0170a4bd5b23b94095e89a22',

  'src/third_party/dart/third_party/pkg/logging':
   Var('dart_git') + '/logging.git@7ba155ac2cf09ab29d0bf41a5e67d03e12760cf0',
  ...
  'src/third_party/dart/third_party/pkg/mime':
   Var('dart_git') + '/mime.git@e5169af6a467b14988af283ed75c1d4c66106c86',
  ...
  'src/third_party/dart/third_party/pkg/pool':
   Var('dart_git') + '/pool.git@a10a0f918802f7b3856cb1f4c78f9073f28a0dd8',
  ...
  'src/third_party/dart/third_party/pkg/shelf':
   Var('dart_git') + '/shelf.git@56919a10d8898ae9cceab7dea1fa2ff6272ae263',
  ...
  'src/third_party/dart/third_party/pkg/term_glyph':
   Var('dart_git') + '/term_glyph.git@9d8956f4a355cc8c7e4695438266852488e3bbd4',

  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@309596e4e8d0d26fe0fc61d825f10a7371c58257',
  ...
  'src/third_party/dart/third_party/pkg/tools':
   Var('dart_git') + '/tools.git@81ff996e48962ccfa008a94fd9fe323b98e08798',
     ...
     'packages': [
       {
        ...
        'version': 'f94C9eArSWIUjOTM6CUdCdlCU3kRivcbvRJQQb-un7wC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2-z8tqXe3ZkKqeb3etLmx-npjJVVc7as3eU_KtlUUUwC'
       }
     ],
