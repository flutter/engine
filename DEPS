...
vars = {
  ...
  'skia_revision': '536720de3bbaacca2490e802eabcc53a21260ee2',
  ...
  'dart_revision': '29cf7ad692865bc0e3540e1dc4fd56a6831b4c80',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dart_style':
   Var('dart_git') + '/dart_style.git@4aebeb3bcce2a62c1d37fd48decf6e90259a4715',
     ...
     'packages': [
       {
        ...
        'version': 'kGVG1Npf12LqF5SemiIJeI3EDVRWx8CDdO5EF_sqynsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'P7tW-U4C3wMb1wWUocTU3kNEmcMsvwq9NkSgzllxbFoC'
       }
     ],
