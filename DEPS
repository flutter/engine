...
vars = {
  ...
  'skia_revision': 'ed82686819a9472655af293902d76bdaee908236',
  ...
  'dart_revision': '2d30896744b5baf2e028ae549651eb7793fb554b',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/shelf_web_socket':
   Var('dart_git') + '/shelf_web_socket.git@dedd6040d45159bd0661eb5252c7e936d6b7514a',
     ...
     'packages': [
       {
        ...
        'version': 'Fote78jZnUNOpd5Q3bzJ81oiVZ7jLXIYSSx9HQUoeAoC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'c9naFjip3vu2KywfVVS1dhODSNyAX5eCBTPmOJzhddAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
