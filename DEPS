...
vars = {
  ...
  'dart_revision': '2ca55ab863e9b2afeaac4032a836edfd93b45ae1',
     ...
     'packages': [
       {
        ...
        'version': 'CYrOc5v2avLTsJyU2zjGDHS3MFil_X1izJ9mr6RYQOEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'jR25k8ZvYeIrgIdQUl9VyNZCySoscA0bl45Iafh7UqEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
