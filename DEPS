...
vars = {
  ...
  'skia_revision': 'bb30fc16e1be69f1631b200835c05c14950ade03',
  ...
  'dart_revision': '715a98df1828e34f4933564fc0e8ab12830f2b07',
     ...
     'packages': [
       {
        ...
        'version': 'NM9FaaYaygGxZ-iQM2Oa2QK1f2DBVq8m7Ev3cJNu96YC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
