...
vars = {
  ...
  'skia_revision': 'cdde253e40829a8ec85d721cb941bb0a4f59d6a2',
  ...
  'dart_revision': 'df54886d12953bab553b90e257d3844dd72c7165',
     ...
     'packages': [
       {
        ...
        'version': 'zMCnd-3cPgVQGT3xnWo8d7xAY5XVJQQD2x9nSoPcOssC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0R7_vIAMLWO3mx2C9-gDbFGReA3jm1dLITtuff-Jz8wC'
       }
     ],
