...
vars = {
  ...
  'skia_revision': 'f6e58b60201152d989a2f770e7efb70ec1615a73',
  ...
  'dart_revision': '689b7f75901299db0543606a61d1e2c9abd0de43',
     ...
     'packages': [
       {
        ...
        'version': 'RGkN0yPbJ6JTNIV7dRXgGsszSW51fEjfhYgV6ERTKtYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'holaEy-o0UTGk5mMY93H5FbEiMrsGrOJTPKjUvNaQ2EC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
