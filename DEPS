...
vars = {
  ...
  'skia_revision': 'c9b70c65436e83262a24532106a4b485ecb4d170',
  ...
  'dart_revision': '302c6dd3c29c5620bffcfa1b6303f10f4cb43aa1',
     ...
     'packages': [
       {
        ...
        'version': 'mDjEP9hR9Hwnp7R6NcsCywl2lUvMXkrhf5AD7UXEUtIC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'xi7pltS1FQK-8OmSHt-JjGN31wN6DF0A2WsJQ-MBh0cC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
