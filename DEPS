...
vars = {
  ...
  'skia_revision': 'bebf8e34c37111ab9306516d8714ab103cbedc59',
  ...
  'dart_revision': '8d7d7ed98f4f491f62c987eae1a703290c5cea07',
     ...
     'packages': [
       {
        ...
        'version': '8fsi3BivFXDqHS1wdI-ZsgiMQrNDD-XrHK7oGDb-iggC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '0LrSN0vh6Wbmk-aWBdab7868chJqBife4e2Squ0pjvQC'
       }
     ],
