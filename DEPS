...
vars = {
  ...
  'skia_revision': '45290179e017ae792c449927a193b6b96321bd59',
  ...
  'dart_revision': '197fc0d7fea2e9540415c28b791b0f6bfe5cddc8',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'b53d99d87e6ae4865b64a4110e4d4a86ecb40e28',
     ...
     'packages': [
       {
        ...
        'version': 'g0dgOL2IlZQJCK4ElZLeLCjBZgNGtbUXHXCRguBgBREC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'lwCo6le6r0X-Srvx31N-hp4SodcF_-U6Q5J9SpLc9zoC'
       }
     ],
