...
vars = {
  ...
  'dart_revision': 'ba8506bdcef7e13dfff613695421337c14cd882f',
     ...
     'packages': [
       {
        ...
        'version': 'y3xw-lhxWWkPAWsWOYgUYVj64hyTq9JEa0MobBqQ7ZAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'uffIHSwYtgVpEuIffC6ytUez97GOUEPWTsvqs5avr4EC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
