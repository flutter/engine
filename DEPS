...
vars = {
  ...
  'skia_revision': '31a94580b7008b3527c4ccd82432e117a6f27743',
  ...
  'dart_revision': '280a0c3efb21592cbf9cab86f28f755078da27d2',
     ...
     'packages': [
       {
        ...
        'version': 'Lx_DI2yrclxG77535B-3S61DxXcYznpEzo5znBbfYAQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'eEt3ktTjqjsNOqsN27x-h9IXBNpWkpVt3PtIDmc5FHcC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
