...
vars = {
  ...
  'skia_revision': 'e6ae4761c14ae77520be7aa56364a29b9c51ca5b',
  ...
  'dart_revision': '5a249d2ce54f4d8cc01ed0168bdfd34e160be3a5',
     ...
     'packages': [
       {
        ...
        'version': 'BfkGYQEHBbJu9dl456Pq7WkEdAZAer_DhRS1Wsr4M3YC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'lF6-o-EaToArFxwYWa9ayQL2ZKa3myoJ32o-ptrMeJoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
