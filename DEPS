...
vars = {
  ...
  'skia_revision': 'db5210fbab5d989ad6035499a16cfac24016a04b',
  ...
  'dart_revision': '82f657d7cbe11f410c8dfc1c5e55562cf70b04c3',
     ...
     'packages': [
       {
        ...
        'version': 'A21rwGAUjpjVTX8HgpT9Iyx6J_QZBRDhu-5GAclrf00C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'gQ3ztEQmdEh3iE6n9EO6iGRdmDSX-edmP5WyE-Ui4BEC'
       }
     ],
