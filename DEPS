...
vars = {
  ...
  'dart_revision': '0f0cff3922adb7e1183f743363dc888c09394e54',
     ...
     'packages': [
       {
        ...
        'version': 'sih5f60Gt1RXFZJYvkOqpaXjIePkeO5lPNI4oz2RnB0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'A0PKwETaylAF-UxpNtfZ5Es69duHlQ2po2jLpauiTb4C'
       }
     ],
