...
vars = {
  ...
  'skia_revision': 'c5e4b2546049d2ff848258408c405a360e10ec54',
     ...
     'packages': [
       {
        ...
        'version': 'U2pgmH2x-yjMNtPVWJ_jgA2A_nlmEoh7e7ZciOwHwD8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'dkB0v_vTxmecUG_7rZx6ej057_Mzb4RScXmmkE1bkTkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
