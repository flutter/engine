...
vars = {
  ...
  'skia_revision': 'ea8e18f4d9e1e5f5f6bd495c75349cafc9aa02af',
  ...
  'dart_revision': 'e9bdbe3084785e86abc956391c2ea50ba2637551',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '99f1178a9e81423515a3e4cb2b3a3c9666fb77b3',
     ...
     'packages': [
       {
        ...
        'version': 'vTivaP4a62tRMYue1jFX3rppEAZqwWa_8tjz5CydwCUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'OMmwdXn8XxipooPBos19JXsr9NEghQ6xeM3bGPJnE9oC'
       }
     ],
