...
vars = {
  ...
  'skia_revision': '5527735121f5972266138587fdf9e76d893badee',
  ...
  'dart_revision': 'c2429dee845e0bd07bfc2011c8b3e270c720b789',
     ...
     'packages': [
       {
        ...
        'version': '3k3-vCrm5vcTFClBCMqY0G3v39f0S3E0OxprEuq5-qAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'JD40LpEJOINC8TFOm5YVGECRP-YNoQlq_-X_XcSJPN8C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
