...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'ae3af8ee0c586fe4e8b6838a60d3066221710828',
     ...
     'packages': [
       {
        ...
        'version': '5GLArzquQ4eL56vdyGqjsDp85tjXFGMSbpUSAgf8ff8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '8tJt8KJzTzbwwQlUE1Y97gTCmMG_nGi_Qnzhv9boUFQC'
       }
     ],
