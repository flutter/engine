...
vars = {
  ...
  'skia_revision': 'c46008e5a839f9d11b3a6f7bd54524e7be82d1f8',
  ...
  'dart_revision': '7f3ea1c3bc2744aa5d949ff3047e0fa52cb2c0be',
  ...
  'dart_webdev_rev': 'c08a65c93c8504af27bf9169d17037e6abf3cd9c',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/markdown':
   Var('dart_git') + '/markdown.git@7fdfa557dc29e00c94bb637a34869e67d57fdb26',
  ...
  'src/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@14f6da1d58d23bb0b726e703dd92827a5dafeceb',
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd3f2288168ade011b60da3137fb669c08efe1345',
     ...
     'packages': [
       {
        ...
        'version': 'gJuGKaWsKazIrvQeOEF6q6xW1fINYFcjwUn3R9J1CGQC'
       }
     ],
