...
vars = {
  ...
  'dart_revision': 'ca0c1c1429a5adf39de6d82942afa9633536f6f3',
     ...
     'packages': [
       {
        ...
        'version': 'tWzndyFoHy2nuoz9plkQAAVyb0N9zexHJO8qMitonWsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '8zNNVrRJrouy1CSf51AuUrbQ_g_QnXf7yjzISPaPGwQC'
       }
     ],
