...
vars = {
  ...
  'skia_revision': '3744b2a36638566bd706d3d6d13929326ae31c62',
...
deps = {
  ...
  # for testing.
  'src': 'https://github.com/HidenoriMatsubayashi/buildroot.git' + '@' + '157b4c74c396f36ea7a823f6a89e1b1290db21db',
     ...
     'packages': [
       {
        ...
        'version': 'm1uK0SlYNKTkk7vdFRLdIArGzX-4VklEhpb1-5xXx8EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Z1HqmxtPRvn_pHks8IIdqsmGZwvuHM4DS5vgJqpxOaAC'
       }
     ],
