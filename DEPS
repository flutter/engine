...
vars = {
  ...
  'skia_revision': '8b3f2ef48a90fb7cb926a2caffa31b66e1119857',
  ...
  'dart_revision': '99ce477503f85f2ee1d3db19459bbea761ee52d2',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'fb3275ddd1a7d5790d8d9c1d996a7f41119b569c',
     ...
     'packages': [
       {
        ...
        'version': 'E0Ui7KmD3u5JSKEk5iViIEsUw5Jw63H8h9jOKPQA5ZgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'VtEx0R7lepGAvwAMUqFlbQA4JhRqeI2kSZId899mLE8C'
       }
     ],
