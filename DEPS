...
vars = {
  ...
  'dart_revision': 'e32502573fca1c39f38f88a2ffb82205664e134d',
     ...
     'packages': [
       {
        ...
        'version': 'us_8V5gGK-ES3R7iB6pvN-6mu-idSfpGzeo12Wwn6iwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'FeukZ89D0e5ceuycK9eVrvyXUTnMESjeWBQww2SF910C'
       }
     ],
