...
vars = {
  ...
  'skia_revision': 'b1486268f2fcdfee7e14c81c38683bc5028e47b7',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'af5bf5b8245e0c6ac49a1397a32a39500aa688b4',
     ...
     'packages': [
       {
        ...
        'version': 'pgJmG2-qZVMzlMuq8qMVyfXgoqnHwUjaOdpn4gzN0YkC'
       }
     ],
