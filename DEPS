...
vars = {
  ...
  'skia_revision': '5726d457cf15e709e34cdd3aa94c1820eec5b506',
     ...
     'packages': [
       {
        ...
        'version': 'vpa6vKu7UnBXdN0grC1QlZaWHft2d_-2E9L5IhTwsuwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'IvdBsdSlnObNmowZgENdwRi6DAiNUNPq2Wr0CjvX5NoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
