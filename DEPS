...
vars = {
  ...
  'skia_revision': '6dc14ded91ea72c9b7bb8c89453c377be3236c89',
  ...
  'dart_revision': '53bda3946658d54b1f1a53f1499c1e5b29c496d2',
     ...
     'packages': [
       {
        ...
        'version': 'xNAaLqZJk8Bkz00BaHGzE8hCpiohggO7KabM3g2wdsQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'M5an7VPM8DiCcNcKe6J0CkAtLk8X9oMeJUqGOrZATIsC'
       }
     ],
