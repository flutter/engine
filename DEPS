...
vars = {
  ...
  'skia_revision': '0e75000214021cc21d92d0b916f5ce1972a26de5',
     ...
     'packages': [
       {
        ...
        'version': 'ncc-KGB6L1EyA1WJy_G_rPooDQsf4CU-J3xVpbMWtYIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'eUBosCTIUQna3ic69F3XlB8Oo5IiuxE2-bIg0kGoHKIC'
       }
     ],
