...
vars = {
  ...
  'skia_revision': '6e6bceeeea1e9321bc14a3d09d0c29f5a943e35c',
  ...
  'dart_revision': '1a4db5ddd0eac741980ad4583d3012ba228a13d7',
  ...
  'dart_pub_rev': '15a46117da29cc572fba620241c83a2117cdae09',
     ...
     'packages': [
       {
        ...
        'version': 'AaBCvnaBN0mm5M2onA9UX8yLMRASKoC82cWli7WsZ2AC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '7erU_Nlq2DzS43H1BCN6TeR7_Y0yf9CAH7vgRPpTeOgC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
