...
vars = {
  ...
  'skia_revision': '4f8f2ecadfb6f59b73961b7ffae0ff97798c956c',
  ...
  'dart_revision': 'f3e3dc44b1dcd588e7045cb640e8a1f136f17cd8',
  ...
  'dart_http_rev': 'f5ec11c07fa25e1a481d6939e51369ba97226a29',
  ...
  'dart_tools_rev': 'f7b2b53dee019834942b32278c3cfaf3e843bc6a',
  ...
  # environment.
  'fuchsia_test_scripts_version': 'zgMf0EAOU767AF8IWjG4fnnoAYTZhBgCe8EslyNz0fUC',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/markdown':
   Var('dart_git') + '/markdown.git@207bb4416f9ca3bb60086e56ed8581da929916ae',
  ...
  'src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@fe38650453e200ae559134b581e0bddd3f5d4e99',
     ...
     'packages': [
       {
        ...
        'version': 'dDWvmfG4AxSEs0BQAmRGx5piUviXGNIr4cCY4EHROqkC'
       }
     ],
