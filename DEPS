...
vars = {
  ...
  'skia_revision': 'b18b594b230db2df150ab4f96b82313a59f24f1e',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '9a70fc9046644c2a3b4bb1ea9f0e56fe19473941',
     ...
     'packages': [
       {
        ...
        'version': 'P3HXI8K3eIeoBYhdX0LzdWOwv0wH6B_QN9Yb0g7gS64C'
       }
     ],
