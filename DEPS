...
vars = {
  ...
  'skia_revision': '43a400456ab41b8357847e38a2a7c69ec1ee8499',
...
deps = {
  ...
  'src/flutter/third_party/pkg/pc-dart':
  Var('flutter_git') + '/bcgit/pc-dart.git' + '@' + '6ff86a9d0c81ad92a4a879acad84ed9b96536240', # 3.6.2
