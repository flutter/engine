...
vars = {
  ...
  'skia_revision': '8941e05187e88a97d1db8434d5ec484304b66081',
  ...
  'dart_revision': '4d40ff624a321e940623e85a52050bef4324b291',
     ...
     'packages': [
       {
        ...
        'version': 'Hesny8PCo_AwxfJ6IXRnScBpViU-YEYBa1vLy9j0UKkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'oMrS1TjaSIjntnBvRFGaHNtukJDyfpmx60Fb6TuewRQC'
       }
     ],
