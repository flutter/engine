...
vars = {
  ...
  'skia_revision': '7c79a871c08421f5da589553d4f5158560e613da',
  ...
  'dart_revision': '332fc295191cb59ad0486f87c822043005f4ee2f',
     ...
     'packages': [
       {
        ...
        'version': 'JuA3-RaN-f8fYpC6O4DAVMKeQRg7ilEim0CqG1DmqGYC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Y9N1cBuxaO9XAjOt7GVRdS0yj1XtAyhF0f7cZX7DmoUC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
