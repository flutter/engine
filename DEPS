...
vars = {
  ...
  'dart_revision': 'bd008dd1e40625f0dbaadaba12dc4c23394fabb6',
     ...
     'packages': [
       {
        ...
        'version': 'h4iiTcBIYoRoQm3RJHJX2ISBLO3ZfbQ0sRxp2cdjA8EC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'kVY2t7n9TILMMl8MV_hx-xyQipy4IjMWDgaDuWgS75EC'
       }
     ],
