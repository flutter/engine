...
vars = {
  ...
  'skia_revision': '1846ba3f08ed9164bfa2127f88c5950a558aeccc',
  ...
  'dart_revision': '8a4f5835718167cc0b7ea435ac34cf9881c24c74',
     ...
     'packages': [
       {
        ...
        'version': 'Nvy8AXgJtuywaDwjxDIuOXhtFdW_dsvpYrZYQHSvc2sC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'hHZAK2r0ujhBNopm4EyPzr8MevCyiTEnxPzQDoeHvYgC'
       }
     ],
