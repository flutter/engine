...
vars = {
  ...
  'skia_revision': 'a9405c2a296796d9faa3d71f2d281c0696871c9f',
  ...
  'dart_revision': '4310f50edc952bd3b4a1f4027cb881a5664f5500',
     ...
     'packages': [
       {
        ...
        'version': 'FLFOwEA0nethScDbqn7ygdQggeNTj2C0QqvfeXM9vD8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'LvSlHdY5_Ms5DB4Xll9Q7GJ2I_tGzYT7mtRFHCY13NkC'
       }
     ],
