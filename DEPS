...
vars = {
  ...
  'skia_revision': '429f0d380c2855d40b8ccfd5577bace2354ff698',
     ...
     'packages': [
       {
        ...
        'version': 'Ne2UAfcMbJ2ALsRuc1qeokiuwoIYjWvLnH92VbjPxmsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'vuG5qwMicvPLNBjxJV_l4YzshK9ss-Ty33tIliQHA5EC'
       }
     ],
