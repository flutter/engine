...
vars = {
  ...
  'skia_revision': '3e6e29cf2e1b3584488a7ffd2f26eb38d2b8e53b',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'cf82ff859b0ef52c59bfa9dd0b24fc9e3619bb26',
     ...
     'packages': [
       {
        ...
        'version': '5_CZ81mTDQyofABj2-1zyGJpDltSPowMI5puVCN7hKIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '4VEg4eRJSk4KRQgZdH_4-6qW2JPHntzZtRTOwvjVKSIC'
       }
     ],
