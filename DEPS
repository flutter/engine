...
vars = {
  ...
  'skia_revision': '4c6f57a23e63d9a3ab0509798ce3adbbf10e03ec',
  ...
  'dart_revision': '2e7f6aa71be86e7b165a744432b477eb2b0f80dc',
     ...
     'packages': [
       {
        ...
        'version': 'qpkZl0s5J-NwdmoguE8Zs6cNBNWCMLoBsAsR9-L60T8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Bnaeivv073toX9buVcBemk-hh-JEa4SYA2t0zNHdZLkC'
       }
     ],
