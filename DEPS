...
vars = {
  ...
  'skia_revision': '8d09d4ace93904fd88cf4a2eb4c6a5172044397b',
  ...
  'dart_revision': 'cd7b857e70a7eb9da62694024f96d1cb3a90d31b',
     ...
     'packages': [
       {
        ...
        'version': 'aXfbrLuUKHrys0W5NmEE8PFgV9r8Yt6FMIDio938UXEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'eyiA9UhTGepareJhbCRXoahHoMFLM2pf10ei1Mi0DZ0C'
       }
     ],
