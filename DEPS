...
vars = {
  ...
  'skia_revision': 'b2bb3af36da3ab1f53e5bd80b5928dfaf5c68ec3',
  ...
  'dart_revision': '11b33e0fcdf4dba8968e01045e02b17e6122557d',
  ...
  'dart_browser_launcher_rev': 'f9b48d2e5de3721c939dbd65cedbffda5a74dc99',
  'dart_clock_rev': '8dfee808c53302269c62954726d0db049f53bbc6',
  'dart_core_rev': '9ad68884a10ad75bb859dcac9ab057e78b0d7df3',
  'dart_devtools_rev': 'dcef4f6efe986f110f55dbbe7f3731802e86690a',
  'dart_http_rev': '8db0d0ae3e8dece7cf56c025e30ecb1082cf9c5d',
  ...
  'dart_tools_rev': '5f4f9451f1cdd0f2018ba2ffa1032ee385addc13',
  'dart_watcher_rev': '3b850778ad0b62db3aa2cfe48832870c2461db30',
  'dart_web_rev': 'd3a61aa9b4e43cdaf949a69c159038cdecf5681a',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/bazel_worker':
   Var('dart_git') + '/bazel_worker.git@7d36032df76891b84500e548f8c518cb217aa3ef',
  ...
  'src/flutter/third_party/dart/third_party/pkg/cli_util':
   Var('dart_git') + '/cli_util.git@6a61e53ba1a9f200becaaa7210ac0d7ec3e8aef9',
  ...
  'src/flutter/third_party/dart/third_party/pkg/csslib':
   Var('dart_git') + '/csslib.git@7f5f84ea22a26bd635379b65adba00128b25b73b',
  ...
  'src/flutter/third_party/dart/third_party/pkg/glob':
   Var('dart_git') + '/glob.git@3e414a2a86476be46d2bdc2d36f64cc6b7e8b009',

  'src/flutter/third_party/dart/third_party/pkg/html':
   Var('dart_git') + '/html.git@929b6de1ba53772205413d5329c9a90f1159cde5',
  ...
  'src/flutter/third_party/dart/third_party/pkg/http_multi_server':
   Var('dart_git') + '/http_multi_server.git@a9e71fa1b37316326ad178e97a91a1392fad7a31',
  ...
  'src/flutter/third_party/dart/third_party/pkg/json_rpc_2':
   Var('dart_git') + '/json_rpc_2.git@cd94cefbe3deda854c85f3df2795148fad020930',
  ...
  'src/flutter/third_party/dart/third_party/pkg/markdown':
   Var('dart_git') + '/markdown.git@a4b1d2cae8042a653e41ea31c0a24cde7d8a6499',
  ...
  'src/flutter/third_party/dart/third_party/pkg/pub_semver':
   Var('dart_git') + '/pub_semver.git@72317ea34c518e8a3b4f2d6c777d485e77522578',
  ...
  'src/flutter/third_party/dart/third_party/pkg/source_span':
   Var('dart_git') + '/source_span.git@e518512775c5d6a835f68027b178168c06cd323b',

  'src/flutter/third_party/dart/third_party/pkg/sse':
   Var('dart_git') + '/sse.git@1b020116af2be83a572b168b8b9d7ad9ed6232b1',

  'src/flutter/third_party/dart/third_party/pkg/stack_trace':
   Var('dart_git') + '/stack_trace.git@582891cb1ee74953d9d6a36eb2e0ea84878efbab',
  ...
  'src/flutter/third_party/dart/third_party/pkg/string_scanner':
   Var('dart_git') + '/string_scanner.git@4de83f03fd01dbae7b10c74c5a6a224adcbf9825',
  ...
  'src/flutter/third_party/dart/third_party/pkg/web_socket_channel':
   Var('dart_git') + '/web_socket_channel.git@1f15eca5550fd0228415d3322c11032b9c282e41',
  ...
  'src/flutter/third_party/dart/third_party/pkg/yaml':
   Var('dart_git') + '/yaml.git@6cc274544605adc9dac5118dc53f102de9028624',
     ...
     'packages': [
       {
        ...
        'version': 'amgHXcqtplha8LuI_6ZkNmZ7JiKBzq_o_-RAISL_Tx4C'
       }
     ],
