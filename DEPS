...
vars = {
  ...
  'skia_revision': '31baf15e8f2cd0ed6ce46b21f8e68d6a93116a66',
  ...
  'dart_revision': '8109103e041b54c51578492c17bae7e58937d017',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '2768c8c489232c25fe58f0c05ab9bd2d9fe6f62f',
     ...
     'packages': [
       {
        ...
        'version': 'onEHyyETXAMieDyfP8hzVi3zqabh27iPDE9waYIkPc0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pSqQ556xmZp7S4np5xyQXWu-Ul-5qoxDxu8WXLe2_xIC'
       }
     ],
