...
vars = {
  ...
  'skia_revision': '49657f39d45743ff24575f49db876ef0efeed5b2',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '276e0c7864d5e668db2845b9a81e5fcca8eccc44',
     ...
     'packages': [
       {
        ...
        'version': 'pzOoo5Zcrqst6Cl3XUxm1hieFQHbQt6VmtiNGalmmekC'
       }
     ],
