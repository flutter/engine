...
vars = {
  ...
  'skia_revision': '8a43e206609e2c1542fc8d27fd7b2922f4687ac4',
  ...
  'dart_revision': '066c5625ac7bfffcdfaf6e9a761ab12f43909975',
     ...
     'packages': [
       {
        ...
        'version': 'koO5t2tfwprGj4698pqsVJRL1cBhD67c8apqNSEMVAoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'jyKllAGRuKGLEzTfCqkVIsGC-gCib6j7MJS1VsX8OtMC'
       }
     ],
