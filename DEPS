...
vars = {
  ...
  'skia_revision': 'c0ca9f2fd8283adce7ab8098dd9b1ef041639cd4',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'f441e3ee4f3524678a058d98e3114a973acbe367',
     ...
     'packages': [
       {
        ...
        'version': 'y-hqwYkPPVT6RwmASotBxclkKGn-9CpYh4JgGkyxPOoC'
       }
     ],
