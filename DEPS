...
vars = {
  ...
  'skia_revision': 'b780fc21c3498b5abee4e70c54510db11434ed2d',
  ...
  'dart_revision': '0d0a4b1e0a3a642dbb4f603421b6bb779fccbfd1',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@d8195107d3e65e20094bb2ca0a8e8576e3a765bf',
     ...
     'packages': [
       {
        ...
        'version': 'KfThq-hkpiyooglfYiKn_TkXL4qLreQqsxDwXagDqRcC'
       }
     ],
