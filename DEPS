...
vars = {
  ...
  'dart_revision': '52dc94238144268f948a194c4b3248f7b7d4cff0',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '2e0671b824e5228b1a8b6bed2fee41aebbb9b46b',
     ...
     'packages': [
       {
        ...
        'version': 'EAFnGijD0l5QxaPxFJ-rzqY-d7wbDhALiDV1xlx4vQsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'xTXbcsPr5GJvFSLhaUdSZUbq-RZwBTju1haGmLEfpEIC'
       }
     ],
