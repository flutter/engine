...
vars = {
  ...
  'skia_revision': '0734c6223cb878116f2dabb50d8437d8755bd0bf',
  ...
  'dart_revision': 'aefb0345e7e22cdc18a639d4516815de4b73d138',
     ...
     'packages': [
       {
        ...
        'version': 'OzIwVa3oFviELO-llxpWVWo2JgTF-BQ35I30nTZLZTAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
