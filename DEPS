...
vars = {
  ...
  'skia_revision': '8043b787554bb791ce9b66e1d5cb6a490122dcb3',
  ...
  'dart_revision': '8c39136ffb2f6dd44df28ca4392082c2add3f008',
     ...
     'packages': [
       {
        ...
        'version': 'kwPlXsW2qt4KfFS07mO6k0K686wNY_MgQrzLwlwnebEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'crZl1GUdqvlNzx2OozdJAWGBdjSRDMwz_t0_bLQgIZsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
