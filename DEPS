...
vars = {
  ...
  'skia_revision': '50dd7e15af47fd8fe7cd6e852a80ec0d2bc3dbc7',
  ...
  'dart_revision': '99fd8adbfad95d77414e06ce4f97f877f2ca67d9',
     ...
     'packages': [
       {
        ...
        'version': '8q8xxvY60JciigoRrzCTBTxHVMgtcDNRE16uRF2qmRIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '-iBBiPj1CeUAJKHEMLsNqN_q4r1GPJL3hit4z4_C-SoC'
       }
     ],
