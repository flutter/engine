...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '9e885103f1b4019314e001cf68153c23936d2783',
     ...
     'packages': [
       {
        ...
        'version': 'QLxrAkriNYkoLbr1KyKqNcpt8jW-yD6XwDBP55mO0PUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_2DtWbNRj22uwqQhQvJYJHzdfE5sRVSxrIXru3eEQ78C'
       }
     ],
