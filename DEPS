...
vars = {
  ...
  'skia_revision': '25a8f601f5fa36010b9b29dd931098d4907fe82c',
  ...
  'dart_revision': '5b8588d7db40808e4c9af62604a7989b8bfc3601',
     ...
     'packages': [
       {
        ...
        'version': '051aLHuwEl1PMtO1d3XlkkmIi6Dkl_6LCpEuzO9hivwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '1HMCKyjKDtA5OxxAlQjQmi7H0TzYKuKKmsdDy4r1PPwC'
       }
     ],
