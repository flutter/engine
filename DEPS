...
vars = {
  ...
  'skia_revision': 'f4ad8c537982e430b52cca5b2ed7fa7319a44efc',
     ...
     'packages': [
       {
        ...
        'version': 'h_iq6T_cfxeKgs1TLv8DR0AgBhFedeUQcgOIPfp_hJEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'RpLap5pIvpLoUv4JzJNZHFCnGsa4fvH6EdZ8oqFVxbQC'
       }
     ],
