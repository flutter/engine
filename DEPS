...
vars = {
  ...
  'skia_revision': '89250a0bd6bb669631b5782fddc077ffa51a6bca',
  ...
  'dart_revision': '5a666e8d8259098182eb89ea48ac271e4efab751',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '3b555e8da6c05ca5d0ed3a097c9e7c53dcc5cb91',
     ...
     'packages': [
       {
        ...
        'version': 'jCjz-imbNBDjiRVa1ZGnjlkwNO4vctk5EC2e9ikMyh8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'zf2xLsbeoVrbnEDiHF7EvZA7gghC1TWEhsIOSY48tJQC'
       }
     ],
