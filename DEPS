...
vars = {
  ...
  'skia_revision': '4284f75ed7975d3c54518c1dea83db543385db40',
  ...
  'dart_revision': '6d06476bae6b0d1c40f6b3c9e0ef874ec3b631b7',
     ...
     'packages': [
       {
        ...
        'version': '-v4bLrOlbLEYw-4w31pDvQb7ibL37VvGJMSGrYGiPzEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'QWI76Qlrf1tRL3Xm9uXXUQ0IyXhEh_w0ga3_ntIHbN0C'
       }
     ],
