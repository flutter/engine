...
vars = {
  ...
  'skia_revision': '516357c4290771f399206b4128cc3c41e9098b37',
  ...
  'dart_revision': '99d9cf9bd05ad5926581c2f5a0ff3949d64cb46a',
...
deps = {
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'c69e482534a59f76e74d3b5eb0b664731aefee4c',
     ...
     'packages': [
       {
        ...
        'version': 'Q3HcTitDF90ZOPWDam_v6bIKuSA_s6MT71sg96GTulQC'
       }
     ],
