...
vars = {
  ...
  'dart_revision': 'ed1e0e199eceb4ce0b0530acdb231f0c3bc989bc',
  ...
  'dart_tflite_native_rev': 'ff18d205bb4eb4db98439658066e72a238044e28',
     ...
     'packages': [
       {
        ...
        'version': 'KVDL4VNkg_KWKDXRePr-mVp_yfHajTgYCZp2wPNy-FsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'xTJWsVOBwkgkNZAG-XYL3U9izfD--sux1-H1lrDPmCwC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'oTVahQ78dvVjUF9CL5mkDbDL5Xr5a56sHtdFSNF-8LAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2EAvs0R5WziQIOZEocVAw1_3s_Rp5mhMDpd7r9HJHpoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
