...
vars = {
  ...
  'skia_revision': 'b7f2215bbb5017873b3ac071f6847f59e04d77d8',
     ...
     'packages': [
       {
        ...
        'version': 'Gou0gs-PcshSV9PgFYTtXg68HDhp5F6l146CnGCA6woC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'G1rAOfmj_dlbO3XsOUcXcelL7XOgNpQLn833myNPbeMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
