...
vars = {
  ...
  'skia_revision': 'd2dc8ddcdf5ef24269302b33bc23c02c63539910',
  ...
  'dart_revision': '7aa8656d1dd8440ec9a96d4a71b6bdb37b9f769e',
     ...
     'packages': [
       {
        ...
        'version': '3o9aQQIMtRcCVJe7E5fFtkh240rXaqiS62FrYsaGvoAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KcllflWGsg4gI9SnO8NFIIFt-OyPRt6hYhZUavLkoN4C'
       }
     ],
