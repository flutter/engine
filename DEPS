...
vars = {
  ...
  'skia_revision': '04449cda5a0a6af3fb52173597d5e33f387a2929',
  ...
  'dart_revision': 'ea86103e06b198c2ead7cc60a096d8fce159e96c',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '4da231bba47b67f876267b40a036c8880f454882',
     ...
     'packages': [
       {
        ...
        'version': '0hLSNJ_DCTzRvTVJeTNCI2xer43DX4ZPkTDI8l9ES_4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Z2mOZ5cuPJWvKn22Pj1XAJX8XbAClEEfLgLjsYO9Q7IC'
       }
     ],
