...
vars = {
  ...
  'skia_revision': '0ed278b42de3c2ac0803825015b2f61f98a237b7',
     ...
     'packages': [
       {
        ...
        'version': 'c0W6I_W1nFxK_xJV4-M3PVa6Zno7P6PNJRelBSoLNqAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'mTdpFJ0LJm-f7Z2XaxTOW2yRh8_sl6QtEUHLv_t79tAC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
