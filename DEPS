...
vars = {
  ...
  'skia_revision': 'feb4d10f7b2de68f383311f34d2d112477c662fe',
     ...
     'packages': [
       {
        ...
        'version': 'i2PBGu2n-YDDYPeretvkWaEkR5qISPBj7afjAjLy4EcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'JGEIJ-V7HUVUJpPiyx6ZtqBKg11W9p5ofhonDl104bMC'
       }
     ],
