...
vars = {
  ...
  'dart_revision': 'ca2f68e5f58d09df5d0161c3ea97b42dab0ab7b7',
     ...
     'packages': [
       {
        ...
        'version': 'coHoqJILOmgDHgis3o8iYrqcs8EbWxV1q2IDQwkUFJwC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'L-ih4MtyRX5R5euDCZ8MD4hmzbhrfKh-uPsm_txetPAC'
       }
     ],
