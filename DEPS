...
vars = {
  ...
  'skia_revision': '189ecd485ade30950fda041ca1f91ecf7e6b7d50',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '868906d1a33fdce9cfc6d3dbc354589d7e0e17fc',
     ...
     'packages': [
       {
        ...
        'version': 'n-yA0KEMTC4wnTBuE1kY8iwyI67JKLv2EmswT11ZZM0C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '5teTtbQ9-G8M_aj2CH3ZGlMi_9z0zV4rKWQ0kVBrhn0C'
       }
     ],
