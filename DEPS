...
vars = {
  ...
  'skia_revision': 'cb6373954bf93f25624812802dcbfb80a433ef34',
     ...
     'packages': [
       {
        ...
        'version': '4auF-1FZpXmOCP9GQR7jN-pJ9z3idIFvptJgOz-wtIsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'zn1YjnshPG5NX5fCx6rVtyXI3MuNkSpvvEfyptmwO3sC'
       }
     ],
