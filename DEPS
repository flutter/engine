...
vars = {
  ...
  'skia_revision': 'refs/changes/07/449807/6',
  ...
  'dart_revision': 'eba0c93d96deb8e0f9c387afe270294819186490',
     ...
     'packages': [
       {
        ...
        'version': 'c3_45l-RdCa_KBPP1bL3ZL2hLogxw6h7aMwJ6fglQ1UC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'vUHzQsB3fKBxaYdbdRkg30Gt2IbJCZADfCvVXj1IH9cC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
