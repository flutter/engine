...
vars = {
  ...
  'skia_revision': '88d5e1daa3ba3aae65139d4a3ded1e1b7078d59b',
  ...
  'dart_revision': '13317278a6fa481c7138c99ac0aae1240b709949',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'd52046c499c0238a15373b7b5aa550b07be3a50b',
     ...
     'packages': [
       {
        ...
        'version': 'hdjihTvRxbNprHI9xGvPV7rtu-TXd1KORZXTW_2t8T4C'
       }
     ],
