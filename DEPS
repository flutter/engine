...
vars = {
  ...
  'skia_revision': '768843b52f9ddbefa676818d61ce36718fed723b',
  ...
  'dart_revision': '83a559e0a9bd2e0288e4873cffdd66f876ea372d',
     ...
     'packages': [
       {
        ...
        'version': 'pt_XKNLXbMZ3eGivKdsZw_Z9xWOgdrZIsn_uYdhJ3TsC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'OPhOQ6shBcLovUkOz1D4z1jWnlXOvnt5mFHfk-Ty0w0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
