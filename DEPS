...
vars = {
  ...
  'skia_revision': 'fcd68167a2612206c059dd2130ffadd0e4db517e',
     ...
     'packages': [
       {
        ...
        'version': '716FtmoF4QtZeRxclzw5BGbjn-qAVc-7cqfNtvxnkqQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Lj6L6i7vjWzy9Te3qE8VSdbKML6EOFsqjFXYCQPJFhwC'
       }
     ],
