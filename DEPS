...
vars = {
  ...
  'skia_revision': 'fa2edac74af81de2d50aee934903dc5d081d28fa',
  ...
  'dart_revision': '46934d8475ffbe904d3e67f14aac2701d4cf7ad2',
     ...
     'packages': [
       {
        ...
        'version': 'L2bsr8go8rOqg66ejuy5nYIyN95gyq9BgUi5HtTgrqkC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Vxe912PZCUczEy4j4CxmND2X__eVlUmomxuaLiZqFmIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
