...
vars = {
  ...
  'skia_revision': 'fc11fd4d0bb458824bc0a78768171af23f038fd0',
  ...
  'dart_revision': '5bd3e5a63f1b9c8257e2e6397d2a008772a27ebd',
     ...
     'packages': [
       {
        ...
        'version': '0Pffy4ES28fCmnMdZ_Y19pUKsW0X7NmsvBIakgG7GNQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'bdHtMYnwHhGoKTyFSrDS6rf9n1ya6zjNI6WxrzxzDqYC'
       }
     ],
