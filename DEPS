...
vars = {
  ...
  'skia_revision': 'b9b82a02e1739a1f1d005e9c37c353d1fe853525',
  ...
  'dart_revision': '066c0f3824482474e4ece701d055c82389a3f5e6',
     ...
     'packages': [
       {
        ...
        'version': 'nj4pClkOciFXkzMRKIKvAiGg1eQ1tt6G8Xt8z61qav4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '2H5Y5sYlKgM74XQtrK1Vq4n9zCUYkpqlRbSMZmTuJqEC'
       }
     ],
