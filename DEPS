...
vars = {
  ...
  'skia_revision': '9e35fa235af926f43b78bac1c18c311c22cc64d8',
  ...
  'dart_revision': '5573a23b0312e32270c535e65a415b005c9c80a2',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '68b0a8c2a9d5cff54cabcca485fdd58d7f37a700',
     ...
     'packages': [
       {
        ...
        'version': 'FAGt3OEY8Yi1-SaFjOXzB2-fTZowtLUMLTdxBoqLGhIC'
       }
     ],
