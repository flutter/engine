...
vars = {
  ...
  'skia_revision': 'b701fa0ac07049c359587bc892f5c902bdafb35b',
  ...
  'dart_revision': 'cee6ac3df70e181f9dece0035b0a5d0bd2c280ef',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '6b9d7c1c4bd0eeb176e0334b20f085d11e2f65bb',
  ...
  'src/third_party/dart/third_party/pkg/usage':
   Var('dart_git') + '/usage.git@016dd302b494e4ff70a7850957ec895eced9d220',
     ...
     'packages': [
       {
        ...
        'version': 'iychQeTRDOlMwvGpW6T4iIPT4Byb7JNFT-076Kj1ZMQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '2eVinpLwxgKH6nYuHMK48oSafgY0z5ROQjaFTaVZ2kEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
