...
vars = {
  ...
  'skia_revision': '8a85ab0d96a1128c64fa21133518e835506b3895',
     ...
     'packages': [
       {
        ...
        'version': 'dqmZSiV7Q2lNa7xKvOmWf3HgGcymP-y5lasUDjSudGAC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'UIJLAtvaZeBIp6zoP-RVikJcdzk0X-SP5o2zRx6Wpv0C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
