...
vars = {
  ...
  'skia_revision': 'a149e8ff0503025320aed6db537f1e545e7b92ac',
  ...
  'dart_revision': 'c514a807e19dd1bc8e2e8454c631c50b096281f9',
     ...
     'packages': [
       {
        ...
        'version': '4MLcvcjCHy-1pEaYwHlmBCLrAhN415JzSWc7v84CfyMC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
