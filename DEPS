...
vars = {
  ...
  'skia_revision': 'edb7aa70fcf375f77305528e5daa5696a31506d8',
  ...
  'dart_revision': 'cf57ec820c2e4bab34223ed67952dfd99340b224',
     ...
     'packages': [
       {
        ...
        'version': 'JuoV30Dy2Gzu4MWeIDZHNHJBCtLUcDla8goFcZmXo0IC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
