...
vars = {
  ...
  'skia_revision': '354b30fe7ab54c325bf07e92126b57dcd608a131',
  ...
  'dart_revision': '38bb74f63829eb08a2bd191226c40064aa457ee0',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'ef1bb419537f7bb16d4b7df0ed7a5e6f57a8d1fes',
     ...
     'packages': [
       {
        ...
        'version': 'n2dgSmMCaCO7ujvmrHIPlsgMLgz3zcicHJUi7-7_zgkC'
       }
     ],
