...
vars = {
  ...
  'skia_revision': 'c9d263c1213e91dc6b77b34d323ed6217f78e64e',
  ...
  'dart_revision': '830f29177386f7e45a5669e44250f0ca84cc7735',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '0fec442d067a0998352ea12706fcae0a53b62884',
     ...
     'packages': [
       {
        ...
        'version': '8X5fE11JpnM-gk8db0X0DfrQ4qrEFncy92Rsq8dVbHsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'kSMF7s2jUaj1ejmNzMWNOHM8ATJx8KSoKOH-rNC5V2AC'
       }
     ],
