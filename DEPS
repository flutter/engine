...
vars = {
  ...
  'skia_revision': '3dc6c190dabbe424345f3a8220be87bb92cdaf05',
  ...
  'dart_revision': '4693d6d4f88e5e94ad9916e9d085514f7ff882e4',
    ...
    'packages': [
      {
        ...
        'version': 'MRLGJYv8VhIKOwBw26UHL3PULHC3yh7r81I4LPYphrsC'
      }
    ],
    ...
    'packages': [
      {
        ...
        'version': 'SrCqaGdSFo-cB6V-fK5sQyQkaVwDXkKtEHNooXlXtXIC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': 'PPdB-GHCtDoX6-2G3T0GTRcOCHrs0_Ysx1GlqlfMUgoC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'zPlM6iYY3N49R_1QO_TbO4HN0jpKAW6NG8pFQQerYpoC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
