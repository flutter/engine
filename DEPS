...
vars = {
  ...
  'skia_revision': '52b040968a4cc61b47906405d8dfc0bff7dbe1e4',
  ...
  'dart_revision': '1f56684930f79b43c3da4e7bc858fe748bfe7da9',
     ...
     'packages': [
       {
        ...
        'version': 'yavYvH-XJyYGxgSI7wZDvDzErKXbIJtGqqQzRsZqErsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '4TD1ZCrSBjAP8-dynVFxNB__LgyZcAzurb-8wwWFH1oC'
       }
     ],
