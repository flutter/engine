...
vars = {
  ...
  'skia_revision': '4f0166baf5a40b077ef78dc25ce8de237c4b573b',
  ...
  'dart_revision': '73b03bb636d38ddc988b9a1d5e53601bd23549e8',
     ...
     'packages': [
       {
        ...
        'version': 'rqjJA8z_K0gdGcsvA_gacTMQ7ViNNZO74NJ8W5DCwiUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pWloCaRzjLEAUvQEznan889GdcQbmxQckj6vAexditcC'
       }
     ],
