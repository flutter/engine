...
vars = {
  ...
  'skia_revision': '64688229fd4bb30a7c7cc14029d0f8dee6b07004',
  ...
  'dart_revision': '0f15f8722e2972ccfc058fb6bb46d983624db6c9',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + '79b4ffcdf4dc0e41b9b60098ca7e672f22f13165',
     ...
     'packages': [
       {
        ...
        'version': 'P46X2iorlpiOEunTzvNSz6eCuwxeDye-wd6ET0A4Jh8C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'LwsffthReD15hnEJRjm3nJrmgFhOegKo7Hk-KYjtFfUC'
       }
     ],
