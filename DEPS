...
vars = {
  ...
  'skia_revision': '6ee21fa70879485dbaec2570803853440819cac1',
  ...
  'dart_revision': 'eb13cce1514e1896bd613ac33c9c64a2b5646a7f',
...
deps = {
  ...
  'src/third_party/fuchsia-vulkan':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + 'fb37e0542c7c704ac761be15a1883f56516597fc',
     ...
     'packages': [
       {
        ...
        'version': 'c0Pr9uG-46yC83ZVyXxcwx3Gm7d-fPDraC6robzSXDUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'SqCbKBft29XeD2QvwCTbO3aqeNoNPgJs7NXiVmR9kX8C'
       }
     ],
