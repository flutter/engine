...
vars = {
  ...
  'skia_revision': '0e7d1499dc5689397b36633e2911f97fb76348f4',
...
deps = {
  'src': 'https://github.com/loic-sharma/flutter-buildroot.git' + '@' + 'ab9b11e999e48ba0b6769f42c14aafa437e1c417',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@51464a30fad5ff38f52f60602c0f02ff205edd0c',
     ...
     'packages': [
       {
        ...
        'version': '_lRxanZVLlIUwu-A3fKd0x8GrouTlrhOht5ccZUoNNcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'tcuZNWh27o76NQPoxUuKRFvFgiZHRfcc9aCb0e5HCV0C'
       }
     ],
