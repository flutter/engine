...
vars = {
  ...
  'skia_revision': 'b1a97caf71e53fba6ea61fc21f0acd12d21999af',
  ...
  'dart_revision': '7b6056f9db7f05bf0e182796b7fec8edbe9c8231',
     ...
     'packages': [
       {
        ...
        'version': '1DgBWWOWVXWR3vx3EcqU_4L-zTIcEWSE3TJIiCD4aBgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '3rLypXNTd-2ymajyI3rnhPr5mkEJAqugCl9EqZcLdIEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
