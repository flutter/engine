...
vars = {
  ...
  'skia_revision': 'f5bd4e4b9f6bd1b508dd5eb67129bfca528ef39b',
  ...
  'dart_revision': 'ae01d698532bf29f49636751d9a414741eb761be',
     ...
     'packages': [
       {
        ...
        'version': 'HXQigwdUexD7V1t7sEgQKvgx8i1GKNt90InheSg8Hl4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
