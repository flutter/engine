...
vars = {
  ...
  'skia_revision': 'bba1880625032f534e1976004f63651b0d821199',
  ...
  'dart_revision': '2e5ada685fa7b35ee5c42c9c3a0dfb982bbf4880',
     ...
     'packages': [
       {
        ...
        'version': 'eXx5DUal48BiZwD_91_p3ZpmlQ_yVXYd33MYlUa6rsgC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'T_kNQ9dqg_avaNGZgr7K_HRcpBWnlCISm6UtikMf6wIC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
