...
vars = {
  ...
  'skia_revision': 'f52bca10695bb9f639d2d3e4b8eeb11aa8a6a346',
  ...
  'dart_revision': '712e35f7fd0b335babe651b84d0f1db080f78a04',
     ...
     'packages': [
       {
        ...
        'version': 'LyP59nILnJ9QL0a6qKKuda_yXO-bYlK0TNSge82fAvsC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'wrXNShr_8ceuCFP4YqU8sotRokTyMkAC0UIW2Ib31VAC'
       }
     ],
