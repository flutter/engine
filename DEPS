...
vars = {
  ...
  'skia_revision': '8a6f2ed4ffd4437cb758dd59a4dd94a5e412d773',
  ...
  'dart_revision': '53601ecc18e533d1415347c9fdfdb4edb741229d',
...
deps = {
  'src': 'https://github.com/stuartmorgan/buildroot.git' + '@' + '0844ba252eeca2e7b20fac70d1fc9e8c5942c99b',
     ...
     'packages': [
       {
        ...
        'version': 'WqvORIWPKo-aJU9X9Fwl0QrqEVs9koQ31QPLAGEGPYAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'sKCYLh2pJByUwVEDj9O4fUw_mVDIXytrIABJ8vgqRjIC'
       }
     ],
