...
vars = {
  ...
  'skia_revision': 'e425088757923b2a82a5fe95019401bb2675169f',
  ...
  'dart_revision': '81c5961865cfd380ad769edd483f7eaf8465645c',
     ...
     'packages': [
       {
        ...
        'version': 'l8aXovOpet3lkC-mCsPV_NvNMpNJ8GhmrJ73x8TZ4bcC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
