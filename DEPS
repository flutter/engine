...
vars = {
  ...
  'dart_revision': 'b44368cd814101d2915ee9a0eb9ecd1a1f940b44',
     ...
     'packages': [
       {
        ...
        'version': 'xFEwU5hU7YnR_NC_zjH1thxf49D7FbrbutlP0alNeL4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'd3HGOZddMHRMGx3A4SjNsl9ydchAR7ssIY7bDS5QNr0C'
       }
     ],
