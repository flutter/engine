...
vars = {
  ...
  'skia_revision': 'db1d93f3b43dddfea0a1eedb8f3d9a2afe755ffc',
  ...
  'dart_revision': 'd4e388e04060d31639df83b27eb5201e608711ce',
     ...
     'packages': [
       {
        ...
        'version': 'pDYU86u_YXYVnJbsdP-lYuFznR3hh27ILNHnhao5Gi4C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
