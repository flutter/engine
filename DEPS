...
vars = {
  ...
  'skia_revision': '9c401e7e1ace239d0c734b5300e5a23743c50a86',
  ...
  'dart_revision': '2b917f5b6a0e1524516f214c6d0df49f4abfd378',
...
deps = {
  'src': 'https://github.com/stuartmorgan/buildroot.git' + '@' + '8b837d1452253baea093f2de88ff22c4da185dd8',
  ...
  'src/third_party/dart/third_party/pkg/yaml':
   Var('dart_git') + '/yaml.git@62e9f6b3a933b1f76dd3007d1a5ce0be8e429b2d',
     ...
     'packages': [
       {
        ...
        'version': 'oWhypFySb_c0LldoEmIDb_G192y45dbnpgPemTCI7K4C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '8AiUMhG_j62zwF95QyMzPLdL2FWpJVw26nYK7LTNYcMC'
       }
     ],
