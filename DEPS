...
vars = {
  ...
  'dart_revision': '7e5a69f6b25f1e62dafa1967cfccf8d8da024a43',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@14581efa5b7a6083b51f8406ae9e3c5466316a03',
     ...
     'packages': [
       {
        ...
        'version': 'NwG1XTWHxB9R3XcU5RnI7-xe864ILf4QRkQAWYNeFy4C'
       }
     ],
