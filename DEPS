...
vars = {
  ...
  'skia_revision': '4db57264955f39cd840a833d8dd899809c54882a',
  ...
  'dart_revision': 'b9302efc8d9a62c5333ebc547e0ebd668b70f586',
     ...
     'packages': [
       {
        ...
        'version': 'kPp_BF0q3Qst_sGkSa5cB-TxrHC8LoRRExbd9RTrXqEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '_vRi_XkB7ZV5vIGlcxCeV8uBAso4Qb1ysfgTugDZBSgC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
