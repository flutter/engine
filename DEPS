...
vars = {
  ...
  'skia_revision': 'ce99ad7b587e40977e549fa689b2182f945ea4d2',
  ...
  'dart_revision': '5d3ab5db503748d295bf40eb4989ccfeff382a21',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@e14837350492494bc693d69d29b9e21f50c224d0',
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '0f7c39a2abbf516443d6e11ba90bc6a3d084e8ca',
     ...
     'packages': [
       {
        ...
        'version': 'u44zzvYd85WSDMpS3HByB6bT_uFdClQ4RtTDaYFpC40C'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'AQZddYgKiWrQL8vnyZlhYg3ltgH_oGTnzETLJ12cODkC'
       }
     ],
