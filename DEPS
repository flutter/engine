...
vars = {
  ...
  'skia_revision': '816d4125510565e9b3b3816a67cf88810bb6ca36',
  ...
  'dart_revision': '15558b6ae7d508b3d377dab495f8a3fb0022aece',
...
deps = {
  ...
  'src/third_party/pyyaml':
   ...
   Var('chromium_git') + '/angle/angle.git' + '@' + '9a5d75de4b501216963dd5f7b6eca048172ea6b1',
     ...
     'packages': [
       {
        ...
        'version': 'G6icdRMZm9dD9Oky1IUsddaJQS3sjiezDhYZIySyQ2kC'
       }
     ],
