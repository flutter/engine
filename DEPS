...
vars = {
  ...
  'skia_revision': 'fad584324d85c795e89635e277ccb88b1a55b572',
  ...
  'dart_revision': '0b77fbab8cf5ab30ffbeb3867bb2d21fe8e9bc58',
  ...
  'dart_webdev_rev': 'd46cf50eb72215003e9e23b3a715ed0959a4574b',
...
deps = {
  ...
  'src/flutter/third_party/dart/third_party/pkg/http':
   Var('dart_git') + '/http.git@4722e035a0981e3ec2b5ac4f335350dc5dd5c729',
     ...
     'packages': [
       {
        ...
        'version': 't2ec5aBf2Jap4Dx_vT9-s9s4_qxuLG73eqtOqZLPJ68C'
       }
     ],
