...
vars = {
  ...
  'skia_revision': '13f244c95cf5b2acd40890e214b31d18cee47997',
     ...
     'packages': [
       {
        ...
        'version': 'o5gDSfoIywcTGREJcUNv5IOT-l0PkVhIMc1wvmyRDnQC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': '90CqrVj-UVqqoy6V3v9lBnwciZG-rQrhfB1plzbd6lkC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
