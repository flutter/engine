...
vars = {
  ...
  'skia_revision': '9fbe9e945359eb627ae592dd5109555e1dc80611',
  ...
  'dart_revision': 'd60cfe5b356f782ea874a09034c9e6e1802b0d2d',
     ...
     'packages': [
       {
        ...
        'version': 'it9o93w6hXvQvCSqg30xEjsZpP0CajQlZHtLxvzyeKAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'rbgMu1hMmWG9wHB_6cmCl2-qX5cm77-Wz0M7Tbd1HOwC'
       }
     ],
